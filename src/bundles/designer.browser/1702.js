        ...
        var r = _interopRequireDefault(require(1278)),
            s = {
                value: function (e) {
                    ...
                    function o(e) {
                        if (n) {
                            ...
                            var o = n.options && n.options.postfix !== t ? n.options.postfix : null;
                            if (e && e.length && n && o) {
                    ...
                    function a(e) {
                        if (n) {
                            ...
                            ("number" != typeof r && "number" != typeof s) ||
                                (("number" == typeof a && isFinite(a)) || (t && n.options.allowEmptyValue)
                                    ? "number" == typeof r && null !== a && a < r
                                        ? (e = r.toString())
                                        : "number" == typeof s && null !== a && a > s && (e = s.toString())
                    ...
                    function r(e) {
                        if (((e || 0 === e) && (e = (e = e.toString()).replace(",", ".")), n)) {
                            if (
                                ...
                                n.options.replace && null !== n.options.replace.oldValue && e === n.options.replace.oldValue)
                            )
                                return t.val(n.options.replace.newValue);
                            var o = null;
                            "undefined" != typeof gDesigner &&
                                gDesigner.getActiveDocument() &&
                                (o = gDesigner.getActiveDocument().getScene().getProperty("ut"));
                            var i = n.options && n.options.postfix !== o ? n.options.postfix : null;
                            e && e.length && i && e.substr(e.length - i.length) !== i && (e += i);
                        }
                        var r = t[0];
                ...
                onMouseLeave: function () {
                    var e = $(this),
                        t = e.data("ginputbox");
                    t.leftMouseMoved || t.insideClicked || !t.options.mousemoveIncrement || (e.css("cursor", ""), e.css("border", ""));
                },
                leftMouseDown: function (e) {
                    ...
                    if (((n.strValue = t.val()), !n.insideClicked && n.options.mousemoveIncrement)) {
                        ...
                        var r = null,
                            l = t.scrollParent();
                        "undefined" != typeof gDesigner && l && gDesigner.isTouchDevice() && l.css("overflow-y", "hidden");
                        var c = function (e) {
                            ...
                            d = function (e) {
                                ($("body").css("pointer-events", ""),
                                    ...
                                    t.off("touchmove", c),
                                    "undefined" != typeof gDesigner && !gDesigner.isTouchDevice() && n.leftMouseMoved && t.blur(),
                                    "undefined" != typeof gDesigner &&
                                    ...
                                    n
                                        ...
                                        .on("keydown", function (e) {
                                            ...
                                            ((38 != e.keyCode && 40 !== e.keyCode) ||
                                                ...
                                                n.trigger("focus")),
                                                13 === e.keyCode && o.options.triggerChangeOnEnter && n.blur());
                                        })
                                        ...
                                        .on("mousedown", function (e) {
                                            r.default.isEnabled() &&
                                                1 === e.which &&
                                                (s.leftMouseDown.call(t, e), $(this).parents(".properties-panel").addClass("noscroll"));
                                        })
                                        .on("mouseup", function (e) {
                                            r.default.isEnabled() &&
                                                1 === e.which &&
                                                (s.leftMouseUp.call(t), $(this).parents(".properties-panel").removeClass("noscroll"));
                                        }));
                        }),
                        this
                    );
