            ...
            exports.XMLHttpRequest = function () {
                ...
                ((this.open = function (e, t, n, o, i) {
                    ...
                    (this.setRequestHeader = function (e, t) {
                        ...
                        if (
                            ...
                            ((e = f[e.toLowerCase()] || e), (f[e.toLowerCase()] = e), (h[e] = h[e] ? h[e] + ", " + t : t));
                        } else console.warn('Refused to set unsafe header "' + e + '"');
                    }),
                    (this.getResponseHeader = function (e) {
                        return "string" == typeof e && this.readyState > this.OPENED && s && s.headers && s.headers[e.toLowerCase()] && !_
                    ...
                    (this.send = function (n) {
                        ...
                        if (y) {
                            ...
                            if (u.async)
                                ...
                                try {
                                    ((this.responseText = r.readFileSync(b.pathname, "utf8")), (this.status = 200), w(l.DONE));
                                } catch (e) {
                                    this.handleError(e);
                                }
                        } else {
                            ...
                            if (((_ = false), u.async)) {
                                ...
                                ((t = T(A, function e(n) {
                                    if (301 !== (s = n).statusCode && 302 !== s.statusCode && 303 !== s.statusCode && 307 !== s.statusCode)
                                        (s.setEncoding("utf8"),
                                ...
                                for (
                                    var L =
                                            ...
                                            D +
                                            "');});" +
                                            (n ? "req.write('" + JSON.stringify(n).slice(1, -1).replace(/'/g, "\\'") + "');" : "") +
                                            "req.end();",
                                        I = a(o.argv[0], ["-e", L]);
                                    r.existsSync(D);
                                ...
                                (I.stdin.end(),
                                    ...
                                    k.err
                                        ? l.handleError(k.err)
                                        : ((s = k.data), (l.status = k.data.statusCode), (l.responseText = k.data.text), w(l.DONE)));
                            }
                        }
                    }),
                ...
                var w = function (e) {
                    (e != l.LOADING && l.readyState === e) ||
                        ((l.readyState = e),
                        (u.async || l.readyState < l.OPENED || l.readyState === l.DONE) && l.dispatchEvent("readystatechange"),
