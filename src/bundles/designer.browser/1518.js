                    ...
                    typeof (o = function (e) {
                        return e.widget("ui.sortable", e.ui.mouse, {
                            ...
                            _mouseStart: function (t, n, o) {
                                ...
                                if (
                                    ...
                                    r.cursor &&
                                        ...
                                        (this.storedStylesheet = e("<style>*{ cursor: " + r.cursor + " !important; }</style>").appendTo(
                                            a
                                        ))),
                                    r.opacity &&
                            ...
                            _mouseStop: function (t, n) {
                                if (t) {
                                    if (
                                        (e.ui.ddmanager && !this.options.dropBehaviour && e.ui.ddmanager.drop(this, t), this.options.revert)
                                    ) {
                                        var o = this,
                            ...
                            refreshPositions: function (t) {
                                ...
                                for (
                                    ...
                                    ((o = this.items[n]).instance !== this.currentContainer &&
                                        ...
                                        ((i = this.options.toleranceElement ? e(this.options.toleranceElement, o.item) : o.item),
                            ...
                            _createHelper: function (t) {
                                ...
                                return (
                                    o.parents("body").length ||
                                        e("parent" !== n.appendTo ? n.appendTo : this.currentItem[0].parentNode)[0].appendChild(o[0]),
                            ...
                            _convertPositionTo: function (t, n) {
                                ...
                                return {
                                    top:
                                        ...
                                        ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : a ? 0 : i.scrollTop()) * o,
                                    left:
                                        n.left +
                                        this.offset.relative.left * o +
                                        this.offset.parent.left * o -
                                        ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : a ? 0 : i.scrollLeft()) * o,
                                };
                            },
                            _generatePosition: function (t) {
                                ...
                                return (
                                    ...
                                    this.originalPosition &&
                                        ...
                                        i.grid &&
                                            ((n = this.originalPageY + Math.round((r - this.originalPageY) / i.grid[1]) * i.grid[1]),
                                            (r = this.containment
                                                ? n - this.offset.click.top >= this.containment[1] &&
                                                  n - this.offset.click.top <= this.containment[3]
                                                    ...
                                                    : n - this.offset.click.top >= this.containment[1]
                                                      ...
                                                      : n + i.grid[1]
                                                : n),
                                            (o = this.originalPageX + Math.round((a - this.originalPageX) / i.grid[0]) * i.grid[0]),
                                            (a = this.containment
                                                ...
                                                : o))),
                                    {
                                        top:
                                            ...
                                            this.offset.parent.top +
                                            ("fixed" === this.cssPosition ? -this.scrollParent.scrollTop() : l ? 0 : s.scrollTop()),
                                        left:
                                            a -
                                            this.offset.click.left -
                                            this.offset.relative.left -
                                            this.offset.parent.left +
                                            ("fixed" === this.cssPosition ? -this.scrollParent.scrollLeft() : l ? 0 : s.scrollLeft()),
                                    }
                                );
                            },
                            ...
                            _clear: function (e, t) {
                                ...
                                for (
                                    ...
                                    (t || o.push(i("deactivate", this, this.containers[n])),
                                        this.containers[n].containerCache.over &&
                                            (o.push(i("out", this, this.containers[n])), (this.containers[n].containerCache.over = 0)));
                                if (
                                    (this.storedCursor &&
