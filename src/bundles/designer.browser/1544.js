module.exports = function (module, exports, require) {
        ...
        function C() {
                                ...
                                $("<label></label>")
                                    ...
                                    .append(
                                        $("<input>")
                                            ...
                                            .prop("checked", !o)
                                            .on("change", (e) => {
                                                (gDesigner.stats("newdocumentdialog_toggle_show-welcome-screen", o ? "enable" : "disable"),
            ...
            (t.forEach((e) => {
                ...
                r.SHOW_BETA_BRANDING && gDesigner.isBeta() && $("<div/>").addClass("beta-badge").attr("title", "βETA").appendTo(o),
        ...
        (GObject.GObject.inherit(C, GObject.GObject),
            ...
            (C.prototype._updateForUserLicense = function () {
                ...
                if (!this._isSpectatorMode())
                    return (
                        ...
                        n.find("input").removeAttr("readonly").removeAttr("disabled").removeAttr("data-title"),
                        n.find("select").removeAttr("disabled").removeAttr("data-title").removeClass("g-disabled"),
                        n
                            .find(".cloud-button")
                            .removeAttr("disabled")
                ...
                (this._dialog.find(".start-option").addClass(this._spectatorModeClazz).attr("data-title", a),
                    ...
                    e.find(".select-overlay").length ||
                        $("<div>").addClass("select-overlay").attr("data-title", a).insertAfter(e.find(".preset .g-input select")));
            }),
            ...
            (C.prototype._loadCloudFiles = function (e, t, n, o, i, a) {
                ...
                var r = new GFilesPanel({
                    ...
                    s = () => {
                        ...
                        (this._closeCallbackListeners.splice(e, 1), this.handled || (n && n()), r.handleParentClose());
                    };
            ...
            (C.prototype._newDocumentFromPreset = async function (e, t, n) {
                ...
                if (
                    ...
                    try {
                        ...
                        (o.hasClass("loading") && o.removeClass("loading"), this._newDocument(r.width, r.height, r.unit, r.dpi));
                    }
            ...
            (C.prototype._newDocumentCustomSize = function () {
                ...
                var e = this._dialog.find(".preset.custom-size"),
                    ...
                    s = i ? 0 : parseInt(t),
                    l = r ? 0 : parseInt(n);
                isNaN(s) || isNaN(l) || !o || (!s && !i) || (!l && !r) || this._newDocument(t, n, o);
            }),
