module.exports = function (e, t, n) {
        ...
        (o.GObject.inherit(s, r),
            ...
            (s.prototype.getShortcut = function () {
                return [i.GKey.Constant.SHIFT, i.GKey.Constant.META, i.GKey.Constant.F8];
            }),
                ...
                if (e) {
                    ...
                    if (t && t.length)
                        for (var n = t.length - 1; n >= 0; --n) {
                            var i = t[n];
                            if (i instanceof o.GSymbol && !i.isMaster() && i.getMasterSymbol()) return !0;
                        }
                }
                return !1;
            }),
            (s.prototype.execute = function () {
                ...
                if (t.length && t[0].getScene()) {
                    ...
                    try {
                        ...
                        e.commitTransaction(
                            o.GLocale.get(new o.GLocaleKey("GDetachSymbolAction", "text.number-detached")).replace(
                                "%number",
                                n > 1 ? "s" : ""
                            )
                        );
