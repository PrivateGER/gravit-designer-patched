        ...
        (o.GObject.inherit(s, r),
            ...
            (s.prototype.execute = function () {
                var e = gDesigner.getActiveDocument(),
                    ...
                    a = [];
                if (n) for (var r = 0; r < n.length; ++r) n[r] instanceof o.GImage && !n[r].getStatus() && a.push(n[r]);
                if (a.length) {
                    t.beginTransaction();
                    try {
                        var s,
                    ...
                    if (((p = u[h[t]].l), (f = t + 1 < h.length ? u[h[t + 1]].l : -1), (g = u[h[t]].p), 0 !== d[p].a)) {
                        ...
                        for (var C = 0; C < w.length; C++) {
                            ...
                            "L" === x.type
                                ...
                                : (m.addVertex(o.GVertex.Command.Curve, x.x3, x.y3), m.addVertex(o.GVertex.Command.Curve, x.x2, x.y2));
                        }
                        if (p !== f) {
                            m = new o.GVertexSimplifier(m).simplify(0.4, !1, !0);
                            var S = o.GPathUtil.createPathFromVertexSource(m);
                            S &&
                                (S.getPaintLayers().appendChild(new o.GStylable.FillPaintLayer(_)),
