module.exports = function (module, exports, require) {
        ...
        (GObject.GObject.inherit(S, l.default),
            ...
            (S.prototype.setCorporateStorage = function (e) {
                if ((l.default.prototype.setCorporateStorage.call(this, e), S.LAST_TEAM_DRIVE_ID_PROP_NAME)) {
                    let t = null;
                    (e && ({ id: t } = e), this.saveLastTeamDriveId(S.LAST_TEAM_DRIVE_ID_PROP_NAME, t));
                }
            }),
            (S.prototype.getPreviousSelectedFolder = function () {
                return l.default.prototype.getPreviousSelectedFolder.apply(this, arguments).then((e) => (e ? g.from(e) : e));
            }),
                ...
                return this._search(
                    ...
                    return (
                        this.isRootFolder(t) &&
                            ...
                            ((this._rootFolderID = n && n.length && "root" === n[0].getParentId() ? n[0].parents[0] : null),
            ...
            (S.prototype._buildSearchQuery = function (e) {
                ...
                return (
                    ...
                    e.hasValue("parent") ? "*" !== e.parent && t.in(e.parent, "parents") : t.in("root", "parents"),
            ...
            (S.prototype.folderExists = function (e, t) {
                ...
                return this._search(u.from({ type: g.Type.Folder, parent: n, exactname: e })).then((e) => !!e.getItems().length);
            }),
                ...
                return new Promise(
                    async function (n, o) {
                        try {
                            ...
                            var i = await this._createStorageItem(o, await this.getRawFile(e));
                ...
                return new Promise(async (c, d) => {
                    ...
                    try {
                        ...
                        return p
                            .deserializeData(_)
                            .then(async () => {
                                (e.getFileFormatVersion() && p.setFileFormatVersion(e.getFileFormatVersion()),
                                        ...
                                        async () => {
                                            (e && e.getEditor() && gDesigner.removeDocument(e, null, true),
                                                ...
                                                gDesigner.hasEventListeners(r.default) &&
                                                    ...
                                                    gDesigner.trigger(new r.default(r.default.Type.Activated, p))),
            ...
            (S.prototype.generatePreviousSelectedFolderPath = async function () {
                ...
                if (this.isRootFolder(e)) return ((this.PREVIOUS_SELECTED_FOLDER_PATH = []), this.PREVIOUS_SELECTED_FOLDER_PATH);
                this.PREVIOUS_SELECTED_FOLDER_PATH.push(e.id);
                let t = e.getParentId() ? e.getParentId() : e.parents ? e.parents[0] : null;
                if (t && t !== this._rootFolderID) {
                    let e = await this.getFolder(t).catch(() => null);
                    for (; e; )
                        (this.PREVIOUS_SELECTED_FOLDER_PATH.push(e.id),
                            (t = e.getParentId() ? e.getParentId() : e.parents ? e.parents[0] : null),
                            (e = t && t !== this._rootFolderID ? await this.getFolder(t).catch(() => null) : null));
                }
                return this.PREVIOUS_SELECTED_FOLDER_PATH;
            }),
            (S.SearchEngine = {
                SortMap: {
                    "-updated": "".concat(f.SearchEngine.OrderBy.ModifiedTime, " ").concat(f.SearchEngine.Sorts.Descending),
                    updated: "".concat(f.SearchEngine.OrderBy.ModifiedTime, " ").concat(f.SearchEngine.Sorts.Ascending),
                    "-created": "".concat(f.SearchEngine.OrderBy.CreatedTime, " ").concat(f.SearchEngine.Sorts.Descending),
                    created: "".concat(f.SearchEngine.OrderBy.CreatedTime, " ").concat(f.SearchEngine.Sorts.Ascending),
                    "-name": "".concat(f.SearchEngine.OrderBy.Name, " ").concat(f.SearchEngine.Sorts.Descending),
                    name: "".concat(f.SearchEngine.OrderBy.Name, " ").concat(f.SearchEngine.Sorts.Ascending),
                    "-viewed": "".concat(f.SearchEngine.OrderBy.ViewedByMeTime, " ").concat(f.SearchEngine.Sorts.Descending),
