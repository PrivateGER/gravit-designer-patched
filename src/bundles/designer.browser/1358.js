module.exports = function (module, exports, require) {
        ...
        (function (e) {
            ...
            var d = (function () {
                                        ...
                                        for (var u = s(Object.entries(e)), p = u.next(); !p.done; p = u.next()) {
                                            ...
                                            switch (h) {
                                                case "$set":
                                                    try {
                                                        for (
                                                            var m = ((i = void 0), s(Object.entries(f))), y = m.next();
                                                            !y.done;
                                                            y = m.next()
                                                        ) {
                                                            var v = l(y.value, 2),
                                                ...
                                                case "$unset":
                                                    try {
                                                        for (
                                                            var w = ((r = void 0), s(Object.keys(f))), C = w.next();
                                                            !C.done;
                                                            C = w.next()
                                                        ) {
                                                            delete d[(_ = C.value)];
                ...
                u = "undefined" != typeof globalThis ? globalThis : void 0 !== e ? e : self,
                p = (function () {
                    function e() {
                        ((this.identityStore = new d()), (this.eventBridge = new a()), (this.applicationContextProvider = new o()));
                    }
                    return (
