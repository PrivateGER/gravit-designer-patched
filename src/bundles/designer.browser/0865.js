module.exports = function (e, t, n) {
        ...
        var o = n(25),
            ...
            m = function (e, t, n) {
                for (var o = -1, i = n; ++o < 6; ) ((i += t * e[o]), (e[o] = i % 1e7), (i = u(i / 1e7)));
            },
            y = function (e, t) {
                for (var n = 6, o = 0; --n >= 0; ) ((o += e[n]), (e[n] = u(o / t)), (o = (o % t) * 1e7));
            },
            v = function (e) {
                for (var t = 6, n = ""; --t >= 0; )
                    if ("" !== n || 0 === t || 0 !== e[t]) {
                ...
                toFixed: function (e) {
                    ...
                    if ((s < 0 && ((h = "-"), (s = -s)), s > 1e-21))
                        if (
                            ...
                            for (m(u, f(10, o, 1), 0), o = t - 1; o >= 23; ) (y(u, 1 << 23), (o -= 23));
                            (y(u, 1 << o), m(u, 1, 1), y(u, 2), (_ = v(u)));
                        } else (m(u, 0, n), m(u, 1 << -t, 0), (_ = v(u) + p("0", l)));
                    return (_ = l > 0 ? h + ((i = _.length) <= l ? "0." + p("0", l - i) + _ : g(_, 0, i - l) + "." + g(_, i - l)) : h + _);
                },
            }
        );
    };
