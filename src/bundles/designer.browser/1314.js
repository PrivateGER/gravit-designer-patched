module.exports = function (e, t, n) {
        ...
        (o.GObject.inherit(l, s),
            ...
            (l.prototype.isEnabled = function () {
                ...
                if (e)
                    for (var t = 0; t < e.length; ++t)
                        if (e[t] instanceof o.GElement && e[t].getPaintBBox() && !e[t].getPaintBBox().isEmpty()) return !0;
                return !1;
            }),
            (l.prototype.execute = function () {
                ...
                if (n)
                    for (var a = 0; a < n.length; ++a)
                        n[a] instanceof o.GElement && n[a].getPaintBBox() && !n[a].getPaintBBox().isEmpty() && i.push(n[a]);
                if (i.length) {
                    ...
                    try {
                        ...
                        if (r) {
                            ...
                            c && (s.insertChild(c, l), s.removeChild(r), t.updateSelection(!1, [c]));
                        }
                    } finally {
            ...
            (l.prototype._groupStuff = function (e) {
                ...
                for (
                    var t = gDesigner.getActiveDocument(), n = t ? t.getEditor() : null, i = new o.GGroup(), r = [], s = 0;
                    s < e.length;
                    ++s
                ) {
            ...
            (l.prototype._convertToImage = function (e) {
                var t, n;
                (e instanceof o.GImage || (t = o.GPaintCanvas.getScreenDPI() * o.GLength.DPI),
                    e instanceof o.GElement && (n = e.getScene()),
                    e instanceof o.GImage || (t = Math.max(t || o.GLength.DPI, (n && n.getProperty("dpi")) || o.GLength.DPI)));
                ...
                return (
                    a.setProperties(
                        ["iw", "ih", "url", "trf", "itrf"],
                        [i.getWidth(), i.getHeight(), i.toImageDataUrl(o.GBitmap.ImageType.PNG), l, l]
                    ),
                    a
                );
            }),
