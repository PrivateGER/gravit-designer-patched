            ...
            (r.prototype.init = function (e, t) {
                ...
                var n = function (e) {
                    ...
                    try {
                        ...
                        n.commitTransaction(o.GLocale.get(new o.GLocaleKey("GBoolOpProperties", "action.modify-merge-mode")));
                    }
                }.bind(this);
                ($("<div></div>")
                    .addClass("compound-row")
                    .gPropertyRow({
                        label: o.GLocale.get(new o.GLocaleKey("GBoolOpProperties", "text.boolean")),
                        columns: [
                            {
                                width: "25%",
                                content: $("<button></button>")
                                    ...
                                    .attr("data-title", o.GLocale.get(new o.GLocaleKey("GBoolOpProperties", "text.union")))
                            ...
                            },
                            {
                                ...
                                content: $("<button></button>")
                                    ...
                                    .attr("data-title", o.GLocale.get(new o.GLocaleKey("GBoolOpProperties", "text.subtract")))
                            ...
                            },
                            {
                                ...
                                content: $("<button></button>")
                                    ...
                                    .attr("data-title", o.GLocale.get(new o.GLocaleKey("GBoolOpProperties", "text.intersect")))
                            ...
                            },
                            {
                                ...
                                content: $("<button></button>")
                                    ...
                                    .attr("data-title", o.GLocale.get(new o.GLocaleKey("GBoolOpProperties", "text.difference")))
            ...
            (r.prototype.update = function (e, t) {
                if (
                    ...
                    for (var n = 0; n < t.length; ++n) {
                        var i = t[n];
                        if (i.getParent() && i.getParent() instanceof o.GCompoundShape && i.getPrevious()) this._elements.push(i);
