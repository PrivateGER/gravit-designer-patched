            ...
            !(function (n) {
                module.exports = (function (e) {
                    ...
                    function r(e) {
                        ...
                        for (var n = new (d.ArrayBuffer ? Uint8Array : Array)(e.length), o = 0, i = e.length; i > o; o++)
                    ...
                    var h = (a.prototype = {
                            ...
                            _checkBounds: function (e, t, n) {
                                ...
                                if (0 > e || e + t > i(n, this.byteLength)) throw new RangeError("Offsets are out of bounds.");
                            },
                            ...
                            _dataViewAction: function (e, t, n, o, i) {
                                return ((this._offset = n + g[e]), t ? this._view["get" + e](n, o) : this._view["set" + e](n, i, o));
                            },
                            _arrayBufferAction: function (t, n, o, a, r) {
                                var s,
                                    l = g[t],
                                    c = e[t + "Array"];
                                if (((a = i(a, this._littleEndian)), 1 === l || ((this.byteOffset + o) % l == 0 && a)))
                                    return (
                            ...
                            alignBy: function (e) {
                                return ((this._bitOffset = 0), 1 !== i(e, 1) ? this.skip(e - (this._offset % e || e)) : this._offset);
                            },
                            ...
                            _get64: function (e, t, n) {
                                ...
                                for (var o = n ? [0, 4] : [4, 0], a = 0; 2 > a; a++) o[a] = this.getUint32(t + o[a], n);
                            ...
                            _set64: function (e, t, n, o) {
                                ("object" != typeof n && (n = e.fromNumber(n)), (o = i(o, this._littleEndian)), (t = i(t, this._offset)));
                    ...
                    for (var m in ((h._nodeBufferAction = function (e, t, n, o, i) {
                        ...
                        return ((n += this.byteOffset), t ? this.buffer["read" + a](n) : this.buffer["write" + a](i, n));
                    }),
                    g))
                        !(function (e) {
