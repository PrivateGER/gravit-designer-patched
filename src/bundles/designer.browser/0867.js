            ...
            (l.prototype.execute = function (e, t, n) {
                ...
                if (t && !t.isEmpty())
                    if (this._type === l.Type.Horizontal) {
                        e.sort(function (e, t) {
                            return e.elbbox.getX() + e.elbbox.getWidth() / 2 - t.elbbox.getX() - t.elbbox.getWidth() / 2;
                        });
                        let a = null;
                        if (!n)
                            if (e.length > 1) {
                                ...
                                o <= t.getWidth()
                                    ...
                                    : (a =
                                          (t.getWidth() - e[0].elbbox.getWidth() / 2 - e[e.length - 1].elbbox.getWidth() / 2) /
                                          (e.length - 1));
                            } else n = 0;
                        ...
                        e.sort(function (e, t) {
                            return e.elbbox.getY() + e.elbbox.getHeight() / 2 - (t.elbbox.getY() + t.elbbox.getHeight() / 2);
                        });
                        let a = null;
                        if (!n)
                            if (e.length > 1) {
                                ...
                                o <= t.getHeight()
                                    ...
                                    : (a =
                                          (t.getHeight() - e[0].elbbox.getHeight() / 2 - e[e.length - 1].elbbox.getHeight() / 2) /
                                          (e.length - 1));
                            } else n = 0;
                        o.GEditor.tryRunTransaction(
                            r,
