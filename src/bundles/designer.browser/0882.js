module.exports = function (e, t, n) {
            ...
            (t.handleCollabsData = async function (e) {
                ...
                if (n && n.length)
                    for (let e = 0; e < n.length; e++) {
                        let o = n[e];
                        if (!o.getRole().is(i.ShareRoles.Viewer) && !o.getRole().is(i.ShareRoles.NoAccess)) {
            ...
            (t.showAssigneeRow = function (e) {
                ...
                e.mentionsInput("getMentions", (e) => {
                    if (((this._mentionsCollection = e), this._mentionsCollection.length)) {
                        ...
                        (this._assigneeRow.hide(), (this._shouldAssign = !1), this._assigneeCheckBox.prop("checked", this._shouldAssign));
                });
            }),
            (t.updateAssignee = d),
            n(58),
        ...
        const s = (0, r.createAdditionalMentions)(),
            l = {};
        async function c(e) {
            return (l.hasOwnProperty(e) || (l[e] = i.gApi.getUser(e, !0).catch(() => null)), l[e]);
        }
        function d(e) {
