            ...
            (function (e) {
                ...
                var p = (s.SHA3 = a.extend({
                    ...
                    _doProcessBlock: function (e, t) {
                        ...
                        for (var s = 0; s < 24; s++) {
                            for (var p = 0; p < 5; p++) {
                                for (var g = 0, h = 0, f = 0; f < 5; f++) ((g ^= (G = n[p + 5 * f]).high), (h ^= G.low));
                                var m = u[p];
                                ((m.high = g), (m.low = h));
                            }
                            for (p = 0; p < 5; p++) {
                                var y = u[(p + 4) % 5],
                                    ...
                                    _ = v.high,
                                    b = v.low;
                                for (g = y.high ^ ((_ << 1) | (b >>> 31)), h = y.low ^ ((b << 1) | (_ >>> 31)), f = 0; f < 5; f++)
                            ...
                            for (var w = 1; w < 25; w++) {
                                ...
                                S < 32
                                    ...
                                    : ((g = (x << (S - 32)) | (C >>> (64 - S))), (h = (C << (S - 32)) | (x >>> (64 - S))));
                                var E = u[c[w]];
                                ((E.high = g), (E.low = h));
                            }
                            var A = u[0],
                    ...
                    _doFinalize: function () {
                        ...
                        ((n[o >>> 5] |= 1 << (24 - (o % 32))),
                            ...
                            this._process());
                        for (var r = this._state, s = this.cfg.outputLength / 8, l = s / 8, c = [], d = 0; d < l; d++) {
                            var u = r[d],
                                p = u.high,
                                g = u.low;
