module.exports = function (module, exports, require) {
        ...
        (require(58 /* polyfill:Array */), require(57), require(356 /* polyfill:RegExp */), require(20 /* polyfill:RegExp */), require(3), require(71 /* polyfill:String */), require(34), require(91 /* polyfill:String */), require(4), require(41), require(13), require(32), require(38), require(33));
        var i = _interopRequireDefault(require(883)),
            ...
            f = {
                ...
                templates: {
                    ...
                    autocompleteListItemLetterAvatar: '<div class="avatar g-user-commit-avatar"><%=letterAvatarsValue%></div>',
            ...
            S = function (e) {
                ...
                function R() {
                    var t;
                    (P(), (t = I()), (E = (E = E.filter((e) => e.value && t.includes(e.value))).filter((e) => e)));
                ...
                function U(t) {
                    (t.addClass(e.classes.autoCompleteItemActive), t.siblings().removeClass(e.classes.autoCompleteItemActive), (S = t));
                }
                function j(n, i) {
                                ...
                                if (((l = t.getUserNameInitials()), t.avatar))
                                    if ("assets/icon/notification-icon.svg" === t.avatar) {
                                        ...
                                        ((t =
                                            ...
                                            (s = $(x(e.templates.autocompleteListItemAvatar, [{ key: "<%=avatar%>", value: t }]))));
                                    } else
                                        t.hasOwnPictureAvatar()
                                            ? (s = $(x(e.templates.autocompleteListItemAvatar, [{ key: "<%=avatar%>", value: t.avatar }])))
                                            : (s = $(
                                    ...
                                    (s = $(
                                        x(e.templates.autocompleteListItemLetterAvatar, [{ key: "<%=letterAvatarsValue%>", value: l }])
                                    )).css({ "background-color": t.getUserColor() });
                                s.prependTo(r);
                            }
                            r = r.appendTo(a);
                ...
                function V(n) {
                    E = [];
                    for (
                        var o, a = y(n), r = new RegExp("(" + e.triggerChar + ")\\[(.*?)\\]\\((.*?):(.*?)\\)", "gi"), s = a;
                        null !== (o = r.exec(a));
        ...
        $.fn.mentionsInput = function (e, t) {
            ...
            return (
                ...
                this.each(function () {
                    var o = $.data(this, "mentionsInput") || $.data(this, "mentionsInput", new S(t));
