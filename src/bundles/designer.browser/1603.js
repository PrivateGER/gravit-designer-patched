        ...
        (i.GObject.inherit(l, r.default),
            ...
            (l.prototype.isChecked = function () {
                ...
                if (t) {
                    ...
                    return !!n && n.paintMode === i.GScenePaintConfiguration.PaintMode.Fast;
                }
                return !1;
            }),
            (l.prototype.execute = function () {
                ...
                if (t.paintMode === i.GScenePaintConfiguration.PaintMode.Fast) {
                    ...
                    if (((t.defaultEffectDetailLevel = null), n && !n.isFixedSized())) e = i.GScenePaintConfiguration.PaintMode.Full;
                    else
                        e =
                            (n.getProperty(a.default.CLIP_PROPERTY_NAME, !0) || a.default.CLIP_CONTENT_ENABLED) ===
                            a.default.CLIP_CONTENT_ENABLED
                                ? i.GScenePaintConfiguration.PaintMode.Output
                                : i.GScenePaintConfiguration.PaintMode.Full;
                } else
                    ((t.defaultEffectDetailLevel = 0.5 / i.GPaintCanvas.getScreenDPI()), (e = i.GScenePaintConfiguration.PaintMode.Fast));
