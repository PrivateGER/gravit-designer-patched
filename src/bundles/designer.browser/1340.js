module.exports = function (e, t, n) {
        ...
        class c extends l {
            ...
            execute() {
                const e = gDesigner.getLeftSidebars().getActiveSidebar(),
                    t = gDesigner.getLeftSidebars().getSidebar(s.SidebarsIds.GOutlineSidebar),
                    n = t.getLayerPanel(),
        ...
        ((c.ID = "edit.rename-layer"), (c.TITLE = new a.GLocaleKey("GRenameLayerAction", "title")), (e.exports = c));
    };
