module.exports = function (e, t, n) {
        ...
        (o.GObject.inherit(c, s),
                        ...
                        (e) => {
                            if (e) {
                                ...
                                if (isNaN(s) || !isFinite(s) || o.GMath.isEqualEps(s, 0))
                                    l.alert(o.GLocale.get(new o.GLocaleKey("GOutlineAction", "text.invalid-value")));
                                else {
                                    t.beginTransaction();
                                    try {
                                        try {
                                            ...
                                            for (c = 0; c < i.length; ++c) {
                                                ...
                                                if (p) {
                                                    ...
                                                    (f && (o.GElement.prototype.assignFrom.call(f, u), p.insertChild(f, g), n.push(f)),
                                                        p.removeChild(u));
                                                }
                                            }
                                        } finally {
                                            ((0, a.releaseChanges)(t, r), n.length && t.updateSelection(!1, n));
                                        }
                                    } finally {
            ...
            (c.prototype._dialogPromptMessage = function () {
                return o.GLocale.get(new o.GLocaleKey("GOutlineAction", "text.dialog-prompt-message"));
            }),
            (c.prototype._makeOffsetter = function (e, t) {
                ...
                var r = e > 0 ? e : -e;
                return (t instanceof o.GPathBase && !t.isClockWise() && t.reverseOrder(), new o.GVertexOffsetter(t, r, !0, !0, 0, n));
            }),
