        ...
        e.exports = (function () {
                ...
                o = (function () {
                    ...
                    function a(t) {
                        ...
                        return (
                            t.forEach(function (t) {
                                ((o = t[0] >> c), (i = t[1] >> c), (a = t[2] >> c), (n = e(o, i, a)), (r[n] = (r[n] || 0) + 1));
                            }),
                            r
                        );
                    }
                    ...
                    function s(t, o) {
                        if (o.count()) {
                            ...
                            if (s == i)
                                for (l = o.r1; l <= o.r2; l++) {
                                    for (u = 0, c = o.g1; c <= o.g2; c++) for (d = o.b1; d <= o.b2; d++) u += t[e(l, c, d)] || 0;
                                    ((p += u), (g[l] = p));
                                }
                            else if (s == a)
                                for (l = o.g1; l <= o.g2; l++) {
                                    for (u = 0, c = o.r1; c <= o.r2; c++) for (d = o.b1; d <= o.b2; d++) u += t[e(c, l, d)] || 0;
                                    ((p += u), (g[l] = p));
                                }
                            else
                                for (l = o.b1; l <= o.b2; l++) {
                                    for (u = 0, c = o.r1; c <= o.r2; c++) for (d = o.g1; d <= o.g2; d++) u += t[e(c, d, l)] || 0;
                                    ((p += u), (g[l] = p));
                                }
                            return (
            ...
            return (
                ...
                (e.prototype.getPalette = function (e, n, i) {
                    ((void 0 === n || n < 2 || n > 256) && (n = 10), (void 0 === i || i < 1) && (i = 10));
                    for (var a, r, s, l, c = new t(e), d = c.getImageData().data, u = c.getPixelCount(), p = [], g = 0; g < u; g += i)
                        ((r = d[(a = 4 * g) + 0]),
                            (s = d[a + 1]),
                            (l = d[a + 2]),
                ...
                (e.prototype.getImageData = function (e, t) {
                    ((xhr = new XMLHttpRequest()),
                        ...
                        (xhr.onload = function (e) {
                            if (200 == this.status) {
                                ((uInt8Array = new Uint8Array(this.response)), (n = uInt8Array.length), (binaryString = new Array(n)));
                                for (var n = 0; n < uInt8Array.length; n++) binaryString[n] = String.fromCharCode(uInt8Array[n]);
