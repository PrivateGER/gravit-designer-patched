        ...
        ((r.DEFAULT_PORT = 32119),
            ...
            (r._closeLauncher = function () {
                var e,
                    t = 0,
                    n = function () {
                        if (this._isInitialized()) return (console.log("initialized: finish"), void clearInterval(e));
                        if (!this._taskLock) {
                            if (((this._fontList = null), this._cachedInstallButton)) {
                                var n = this._cachedInstallButton.parentElement;
                                (n && n.contains(this._cachedInstallButton) && n.removeChild(this._cachedInstallButton),
            ...
            (r.prototype._getInstallButton = function () {
                ...
                return (
                    ...
                    n.setAttribute("value", "host=" + escape(r.HOST) + "&appurl=" + escape("/assets/data/fonts.air?no_redirect=true")),
                    e.appendChild(n),
                        ...
                        for (var n = 0; n < e.length; n++)
                            e[n].cachedPreview ||
                                (e[n].addPreviewCallback = function (e) {
                                    var t = document.createElement("div");
                                    ((t.innerHTML = this.family), (t.style.fontFamily = this.family), (t.style.fontSize = "13px"), e(t));
                                });
                    }
            }),
            ...
            (r.prototype.load = function (e, t, n, o) {
                if (!this._isInitialized()) return (this._listCallbacks.push(o), void this._initialize());
                o.done(
                    this._fontList
                        .filter(function (t) {
                            return e.indexOf("%") >= 0
            ...
            (r.prototype.resolveFont = function (e, t, n, o) {
                ...
                if (!this._taskLock) {
                    ...
                    var l = parseInt(n);
                    ((a[s] = (65280 & l) >> 8), (a[s + 1] = (255 & l) >> 0), (a[s + 3] = "N" == t ? 0 : 1), this._connection.send(a));
                }
            }),
