module.exports = function (module, exports, require) {
        ...
        function p(e, t) {
            ...
            return e && e.state
                ? ((o = e.state),
                  ...
                  t && (t < 8 || t > 15)
                      ? -2
                      : (null !== o.window && o.wbits !== t && (o.window = null), (o.wrap = n), (o.wbits = t), u(e)))
                : -2;
        }
        function g(e, t) {
            var n, o;
            return e ? ((o = new c()), (e.state = o), (o.window = null), 0 !== (n = p(e, t)) && (e.state = null), n) : -2;
        }
        var h,
            f,
            m = true;
        function y(e) {
            if (m) {
                var t;
                for (h = new o.Buf32(512), f = new o.Buf32(32), t = 0; t < 144; ) e.lens[t++] = 8;
        ...
        function v(e, t, n, i) {
            var a,
                r = e.state;
            return (
                null === r.window && ((r.wsize = 1 << r.wbits), (r.wnext = 0), (r.whave = 0), (r.window = new o.Buf8(r.wsize))),
                i >= r.wsize
                    ? (o.arraySet(r.window, t, n - r.wsize, r.wsize, 0), (r.wnext = 0), (r.whave = r.wsize))
                    : ((a = r.wsize - r.wnext) > i && (a = i),
                      o.arraySet(r.window, t, n - i, a, r.wnext),
                      (i -= a)
                          ? (o.arraySet(r.window, t, n - i, i, 0), (r.wnext = i), (r.whave = r.wsize))
                ...
                e: for (;;)
                    switch (n.mode) {
                        case 1:
                            ...
                            ((n.dmax = 1 << D), (e.adler = n.check = 1), (n.mode = 512 & f ? 10 : 12), (f = 0), (m = 0));
                            break;
                        case 2:
                            for (; m < 16; ) {
                                if (0 === g) break e;
                            ...
                            (n.head && (n.head.text = (f >> 8) & 1),
                                512 & n.flags && ((F[0] = 255 & f), (F[1] = (f >>> 8) & 255), (n.check = a(n.check, F, 2, 0))),
                                (f = 0),
                                (m = 0),
                                (n.mode = 3));
                        case 3:
                        ...
                        case 7:
                            if (2048 & n.flags) {
                                ...
                                w = 0;
                                do {
                                    ((D = c[u + w++]), n.head && D && n.length < 65536 && (n.head.name += String.fromCharCode(D)));
                                } while (D && w < g);
                                if ((512 & n.flags && (n.check = a(n.check, c, w, u)), (g -= w), (u += w), D)) break e;
                        ...
                        case 8:
                            if (4096 & n.flags) {
                                ...
                                w = 0;
                                do {
                                    ((D = c[u + w++]), n.head && D && n.length < 65536 && (n.head.comment += String.fromCharCode(D)));
                                } while (D && w < g);
                                if ((512 & n.flags && (n.check = a(n.check, c, w, u)), (g -= w), (u += w), D)) break e;
                        ...
                        case 16:
                            if ((w = n.length)) {
                                ...
                                (o.arraySet(d, c, u, w, p), (g -= w), (u += w), (h -= w), (p += w), (n.length -= w));
                                break;
                            }
                            n.mode = 12;
                            break;
                        ...
                        case 21:
                            ...
                            for (
                                n.back = 0;
                                (E = ((O = n.lencode[f & ((1 << n.lenbits) - 1)]) >>> 16) & 255), (A = 65535 & O), !((S = O >>> 24) <= m);
                        ...
                        case 22:
                            if (n.extra) {
                                ...
                                ((n.length += f & ((1 << n.extra) - 1)), (f >>>= n.extra), (m -= n.extra), (n.back += n.extra));
                            }
                            ((n.was = n.length), (n.mode = 23));
                        case 23:
                            for (
                                ;
                                (E = ((O = n.distcode[f & ((1 << n.distbits) - 1)]) >>> 16) & 255), (A = 65535 & O), !((S = O >>> 24) <= m);
                        ...
                        case 24:
                            if (n.extra) {
                                ...
                                ((n.offset += f & ((1 << n.extra) - 1)), (f >>>= n.extra), (m -= n.extra), (n.back += n.extra));
                            }
                            if (n.offset > n.dmax) {
                        ...
                        case 27:
                            if (n.wrap) {
                                ...
                                if (
                                    ...
                                    (e.total_out += b),
                                    (n.total += b),
                                    b && (e.adler = n.check = n.flags ? a(n.check, d, b, p - b) : i(n.check, d, b, p - b)),
                                    (b = h),
                ...
                return (
                    ...
                    v(e, e.output, e.next_out, b - e.avail_out)
                        ...
                        : ((_ -= e.avail_in),
                          ...
                          n.wrap &&
                              b &&
                              (e.adler = n.check = n.flags ? a(n.check, d, b, e.next_out - b) : i(n.check, d, b, e.next_out - b)),
                          (e.data_type =
