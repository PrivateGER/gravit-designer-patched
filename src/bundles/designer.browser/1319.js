        ...
        (i.GObject.inherit(l, s),
            ...
            (l.prototype.isEnabled = function () {
                ...
                var e = gDesigner.getActiveDocument() ? gDesigner.getActiveDocument().getEditor().getSelection() : null,
                    t = !1;
                if (e) for (var n = 0; !t && n < e.length; ++n) e[n] instanceof i.GPath && (t = this._isPathSplittable(e[n]));
                return t;
            }),
                        ...
                        try {
                            ...
                            for (r = 0; r < o.length; ++r) {
                                ...
                                if (u.getProperty("closed"))
                                    for (d = h.getFirstChild(); null !== d && !d.hasFlag(i.GNode.Flag.Selected); d = d.getNext());
                                else (d = h.getFirstChild()).hasFlag(i.GNode.Flag.Selected) || (f = !0);
                                var m = d,
                                    y = m,
                                ...
                                for (
                                    ...
                                    null !== m && (m.hasFlag(i.GNode.Flag.Selected) || f) && null !== v;

                                ) {
                                    var b,
                                        w = new i.GPath(),
                                        C = w.getAnchorPoints();
                                    if (((f = !1), w.assignFrom(u), p.insertChild(w, g), c.push(w), (d = h.getNextPoint(m)), _))
                                        ((b = new i.GPathBase.AnchorPoint()).deserialize(m.serialize()), (m = b), (_ = !1));
                                    else h.removeChild(m);
                                    for (C.appendChild(m); null !== d && !d.hasFlag(i.GNode.Flag.Selected) && h.getFirstChild(); )
                                        ((v = h.getNextPoint(d)), h.removeChild(d), C.appendChild(d), (d = v));
                                    if (null !== d && d.hasFlag(i.GNode.Flag.Selected) && h.getFirstChild())
                                        ((b = new i.GPathBase.AnchorPoint()).deserialize(d.serialize()),
                                            C.appendChild(b),
                                    ...
                                    w.isLine() &&
                                        (w.getPaintLayers().getBorderLayers(!0).length ||
                                            (u.getPaintLayers().getFillLayers(!0).length
                                                ? w.getPaintLayers().appendChild(new i.GStylable.BorderPaintLayer(i.GRGBColor.BLACK))
                                                : w.getPaintLayers().appendChild(u.getPaintLayers().getFillLayers(!0)[0])));
                                }
                                p.removeChild(u);
                            }
                        } finally {
                            ((0, a.releaseChanges)(t, l), c.length && t.updateSelection(!1, c.slice(-1)));
                        }
                    } finally {
