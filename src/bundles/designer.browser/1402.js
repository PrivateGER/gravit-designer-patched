module.exports = function (e, t) {
        !(function (e) {
                ...
                ((this.init = function (e) {
                    ...
                    (this.writeUint8Array = function (t, i) {
                        var a,
                            r = o.length,
                            s = o;
                        for (o = "", a = 0; a < 3 * Math.floor((r + t.length) / 3) - r; a++) s += String.fromCharCode(t[a]);
            ...
            function v(e) {
                ...
                for (t = 0; t < e.length; t++) o += (n = 255 & e.charCodeAt(t)) > 127 ? i[n - 128] : String.fromCharCode(n);
                return o;
            }
            function _(e) {
                                  ...
                                  o.init(function () {
                                      0 === d.compressionMethod
                                          ...
                                          : (function (t, n, o, i, a, r, s, l, c, d, u) {
                                                var p = s ? "output" : "none";
                                                e.zip.useWebWorkers
                                                    ? f(t, { sn: n, codecClass: "Inflater", crcType: p }, o, i, a, r, c, l, d, u)
            ...
            ((i.prototype.append = function (e) {
                for (var t = 0 | this.crc, n = this.table, o = 0, i = 0 | e.length; o < i; o++) t = (t >>> 8) ^ n[255 & (t ^ e[o])];
                this.crc = t;
            }),
                ...
                if (null === e.zip.workerScripts || null === e.zip.workerScriptsPath) {
                    ...
                    ((s.codecTime = s.crcTime = 0),
                        ...
                        s.addEventListener("message", function e(t) {
                            ...
                            "importScripts" === i.type && (s.removeEventListener("message", e), s.removeEventListener("error", l), n(s));
                        }),
                        s.addEventListener("error", l));
                } else o(new Error("Either zip.workerScripts or zip.workerScriptsPath may be set, not both."));
                function l(e) {
                    (s.terminate(), o(e));
                }
            }
