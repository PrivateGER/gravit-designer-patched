module.exports = function (module, exports, require) {
        ...
        (GObject.GObject.inherit(_, d),
            ...
            (_.prototype._documentEvent = function (e) {
                e.type === v.Type.Removed && this._panel.find('select[data-property="master-page"]').empty().append($("<option></option>"));
            }),
                ...
                if (e instanceof GObject.GPage) {
                    ...
                    o.length &&
                        e.getSlavePages().forEach((t) => {
                            var n;
                            t.setProperties(o, ((n = []), o.forEach((t) => n.push(e.getProperty(t))), n));
                        });
                }
            }),
            ...
            (_.prototype._updateProperties = function (e) {
                ...
                var u = this._panel.find('select[data-property="master-page"]').empty().append($("<option></option>")),
                    p = -1,
                    g = null;
            ...
            (_.prototype.updatePropertiesAvailability = function (e) {
                ...
                (this._panel.find("[data-title]:not([default-data-title])").each(function () {
                    ...
                    this._panel
                        ...
                        .each(function () {
                            const e = $(this);
                            e.attr("default-data-title").length && e.attr("data-title", e.attr("default-data-title"));
                        }));
                const p = (e) =>
                    $("<div></div>")
