module.exports = function (e, t, n) {
        ...
        function f(e, t) {
            ((this._container = $("<div></div>").addClass("window")),
                ...
                (this._document = e),
                this._document.addEventListener(c, this._documentStatusChanged, this, void 0, void 0, !0),
        ...
        (i.GObject.inherit(f, i.GEventTarget),
            ...
            (f.prototype.centerAndZoom = function () {
                ...
                if (t)
                    ...
                    } else if (g.CDR_ORIGIN_PROPERTY_NAME && t.getProperty(g.CDR_ORIGIN_PROPERTY_NAME, !0)) {
                        var r = t.getContentBBox();
                        n = r && !r.isEmpty() ? r : t.getPaintBBox();
                    } else n = t.getPaintBBox();
                else e.isFixedSized() && (n = new i.GRect(0, 0, e.getProperty("w"), e.getProperty("h")));
            ...
            (f.prototype._releaseScene = function () {
                this._view &&
                    this._view.getScene() &&
                    (this._view.getScene().removeEventListener(i.GNode.AfterPropertiesChangeEvent, this._sceneAfterPropertiesChanged, this),
                    this._view.getScene().removeEventListener(i.GNode.AfterFlagChangeEvent, this._afterFlagChangeEvent, this));
            }),
            ...
            (f.prototype.activateCancelLoading = function (e) {
                ...
                this._overlay
                    .find(".cancel-loading")
                    .text(i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.cancel-loading")))
                    .on("click", function () {
            ...
            (f.prototype._documentStatusChanged = function (e) {
                switch (e.status) {
                    ...
                    case l.Syncing:
                    case l.Downloading:
                        var t = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.loading")),
                            n = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.loading-file"));
                        e.status === l.Saving
                            ? ((t = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.saving"))),
                              (n = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.saving-file"))))
                            : e.status === l.Syncing
                              ? ((t = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.synchronizing"))),
                                (n = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.synchronizing-file"))))
                              : e.status === l.Downloading &&
                                ((t = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.downloading"))),
                                (n = i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.downloading-file"))));
                        let c = e.data && e.data.filename ? e.data.filename : this._document.getTitle();
                        c && (n = n.replace("%name", c));
                        let d = c ? n + "..." : i.GLocale.get(new i.GLocaleKey("GDocument", "text.opening-your-image"));
                    ...
                    case l.SaveCancelled:
                        ...
                        break;
                    case l.Saved:
                        (this._document.setErrored(!1), gDesigner.intercomStats("File saved/exported"), this._setOverlayContent(null));
                        break;
                    case l.Loaded:
                    ...
                    case l.LoadFailed:
                        ...
                        break;
                    case l.SaveFailed:
                        if ((this._document.setErrored(!0), this._document.isCollaborativeTextEditing())) return;
                        this._setOverlayContent(
                            $("<span></span>")
                                    ...
                                    $("<p></p>")
                                        .text(
                                            "string" == typeof e.data
                                                ? e.data
                                                : i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.unable-to-save"))
                                        )
                                ...
                                .append(
                                    $("<button></button>")
                                        .text(i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.try-again")))
                                        .on(
                                            "click",
                                            function () {
                                                this._document &&
            ...
            (f.prototype._updateScene = function () {
                if (!this._view || this._document.getScene() !== this._view.getScene()) {
                    ...
                    !this._document.getScene() ||
                        ...
                        this._view
                            .getScene()
                            .addEventListener(i.GNode.AfterFlagChangeEvent, this._afterFlagChangeEvent, this, void 0, void 0, !0),
            ...
            (f.prototype._sceneAfterPropertiesChanged = function (e) {
                !e.temporary && i.GUtil.containsOneOf(e.properties, ["w", "h"]) && this._updateWindowBackground();
            }),
            ...
            (f.prototype.getVisibleBBox = function () {
                ...
                return this._view ? new i.GRect(0, 0, this._view.getWidth(), this._view.getHeight()) : null;
            }),
            (f.prototype._afterFlagChangeEvent = function (e) {
                e.node instanceof i.GPage && e.flag === i.GNode.Flag.Active && this._updateWindowBackground();
            }),
