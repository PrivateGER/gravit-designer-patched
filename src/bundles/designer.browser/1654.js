        ...
        (o.GObject.inherit(r, i),
                                            ...
                                            $("<input>")
                                                ...
                                                .on(
                                                    ...
                                                    function (e) {
                                                        ...
                                                        (gDesigner.stats("frameproperties_toggle_frame", t ? "enable" : "disable"),
                                                            this._assignProperty(
                                                                "frm",
                                                                t,
                                                                t
                                                                    ? o.GLocale.get(
                                                                          new o.GLocaleKey("GFrameProperties", "text.switch-frame")
                                                                      )
                                                                    : o.GLocale.get(new o.GLocaleKey("GFrameProperties", "text.frame-off"))
                                                            ));
                                                    }.bind(this)
                                                )
                                        )
                                        .append($("<span></span>").text(o.GLocale.get(new o.GLocaleKey("GFrameProperties", "text.frame")))),
                                },
                            ],
                        })
            ...
            (r.prototype._updateProperties = function () {
                ...
                (this._panel.find("[major-item-only]").css("display", ""),
                    this._panel.find('input[data-item-property="frm"]').prop("disabled", !1).prop("checked", !!e.getProperty("frm")));
            }),
