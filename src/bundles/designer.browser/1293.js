module.exports = function (e, t, n) {
        ...
        var o = n(1);
        const { FILE_FORMATS: i, CLOUD_SYNC_FEATURE: { NEW_LAYOUT: a } = {} } = n(10),
            r = n(18),
            s = n(31),
            l = n(119),
            c = n(448),
        ...
        (o.GObject.inherit(f, s),
            ...
            (f.prototype.getTitle = function () {
                ...
                if (e) {
                    if (e.isSynchronizing()) return new o.GLocaleKey("GCloudSynchronizationAction", "text.syncing");
                    if (e.isCloudFile()) return this._getSyncInformation(e);
                    if (e.isCloudSyncOn()) return new o.GLocaleKey("GCloudSynchronizationAction", "text.unsync-from-cloud");
                }
                return new o.GLocaleKey("GCloudSynchronizationAction", "text.sync-to-cloud");
            }),
                ...
                (n.setProperty("cfs", t),
                    n.getProperty("cfs")
                        ? e.chooseLatestDocument(
                              ...
                              function () {
                                  g.alert(o.GLocale.get(new o.GLocaleKey("GDocument", "text.sync-to-cloud-error")));
                              },
                              function (e, t) {
