        ...
        class G {
                ...
                return new Promise((l, c) => {
                    try {
                        ...
                        (0, s.syncImagesToCloud)(
                            ...
                            i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.untitled-image")),
                            p,
                            u,
                            async (e, t) => (0, s.createFileAndGetSignedPutUrlsFn)(e, t, g, h),
                            async (e, t, n) => (0, s.updateFileFn)(e, t, n, g, h, o.COMPUTE_SHA256_FOR_FILES, r.getFileSHA256Digest),
                            (e) => {
                                try {
                                    var t = d.getDictionary().merge(e);
                                    try {
                                        var o = i.GNode.serialize(d, i.GUtil.extend({ save: !0 }, n));
                                    } finally {
                ...
                function n(e, t) {
                    ...
                    return (
                        ...
                        (r.value.length > a.GPlatform.maxImgDataUrlLength &&
                            new g(i.GLocale.get(new i.GLocaleKey("GDocument", "text.image-in-design-too-big"))).open(),
                        e.resolved(r.value),
                        !1)
                    );
                }
                    ...
                    if (n(e))
                        if ("string" == typeof r && r.startsWith("123rf://")) {
                                            ...
                                            (o.onload = function () {
                                                if (this.status < 200 || this.status >= 400)
                                                    ...
                                                    if (n.size > a.GPlatform.maxPngDataSize)
                                                        new g(
                                                            i.GLocale.get(new i.GLocaleKey("GDocument", "text.image-in-design-too-big"))
                                                        ).open();
                                                    else {
                                                        var o = new FileReader();
                                                        ((o.onload = function () {
                                                            if (this.result.length > a.GPlatform.maxImgDataUrlLength)
                                                                return void new g(
                                                                    i.GLocale.get(
                            ...
                            if (!n.isAnonymous() && !d && t) {
                                ((d = (await o.gApi.createFile({ trashed: null })).id), t.setReservedId(d));
                            }
                        ...
                        (o && (c.width = o),
                            ...
                            (c.onload = function () {
                                ...
                                ((c.width > a.GPlatform.maxImgLinearDimension ||
                                    ...
                                    (new g(i.GLocale.get(new i.GLocaleKey("GDocument", "text.image-in-design-too-big"))).open(), (u = !0)),
                                    (t.width = c.width),
                                    (t.height = c.height),
                    ...
                    !(async function () {
                        try {
                            for (var a = 0; a < e.length; ++a) {
                                var r = e[a],
                                    s = r.parent;
                                t !== s && r.id !== t && (await o.gApi.updateFile(r.id, { parent: t }));
                            }
                            n();
                        } catch (e) {
                            i(e);
            ...
            static createFile(e, t) {
                !(async function () {
                    ...
                    (e.getReservedId()
                        ? (await o.gApi.updateFile(e.getReservedId(), s), (n = e.getReservedId()))
                    ...
                    try {
                        ...
                        if (e && r) {
                            ...
                            if (i) a = await o.gApi.getShare(i);
                                ...
                                var c = n ? "/version/" + n : "";
                                a = t ? await o.gApi.getFile(e + c + "?edit") : await o.gApi.getFile(e + c);
                            }
                        else if (t) {
                            const t = a ? a.id : e;
                            t &&
            ...
            static performSave(e, t, n, a, r) {
                ...
                if (e.hasPagesWithInfiniteEmptyCanvas())
                    return void (n
                        ...
                        : d.alert(i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.error-emtpy-infinite-canvas"))));
                var l = a;
                function u() {
                    let a = !1;
                        ...
                        (g.rollback(),
                            s ||
                                (o && 507 === o.code
                                    ? d.alert(o.message)
                                    : d.confirm(
                                          i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.save-to-cloud-failed")),
                                          function (o) {
                                              o
                                                  ? (gDesigner.stats("savealert_save-failed_click-save-local"),
                                                    gDesigner.executeAction("file.save-as.".concat(b.ext), [null, e], void 0, !0))
                                                  : (gDesigner.stats("savealert_save-failed_dont-save-local"),
                                                    "function" != typeof n || a ? "function" == typeof t && t(!1) : ((a = !0), n()));
                                          },
                    ...
                    try {
                        ...
                        !(async function (t) {
                            ...
                            try {
                                    ...
                                    if (p) {
                                        ...
                                        try {
                                            ...
                                            (e.getScene().iteratePages((e) => {
                                                !!h.findAnnotationsListForPage(e, n) || n.push(i.GNode.store(e.getAnnotations()));
                                            }, !0),
                                                (t.annotations = n));
                                        } catch (e) {
                                ...
                                (n && ((t.width = n.getWidth()), (t.height = n.getHeight())), await o.gApi.updateFile(u._id, t));
                            } catch (e) {
                                n = e;
                            }
                            t(n);
            ...
            static getRecentStorageItems() {
                let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o.FILE_FORMATS;
                var t = this;
                return new Promise((n, i) => {
                    !(async function () {
            ...
            static resendEmailConfirmation(e) {
                ...
                return o.gApi
                    ...
                    .then(() => {
                        ...
                        return (
                            d.custom({
                                title: i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.email-sent-title")),
                                subtitle: i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.email-sent-info")),
                                icon: "ok",
                    ...
                    .catch((e) =>
                        d.custom({
                            title: i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.something-wrong")),
                    ...
                    if (!e.ok && e.code)
                        switch (e.code) {
                            case o.gApi.ERROR_CODES.ERR_SUBSCRIPTION_COULD_NOT_BE_DEACTIVATED:
                                const e = $(
                                    "<div>".concat(
                                        i.GLocale.get(new i.GLocaleKey("GCloudUtil", "text.err-subscription-could-not-be-deactivated")),
                                        "</div>"
                                    )
                                );
                                return (
                                    e
                                        ...
                                        .on("click", (e) => (e.preventDefault(), gDesigner.runDeepLink("purchases"), !1)),
                                    d.alert(e)
                                );
                            case o.gApi.ERROR_CODES.ERR_SUBSCRIPTION_IS_ACTIVE:
                                const { nextBillingDate: t } = await o.gApi.subscription.getNextBillingDate();
                                return d.alert(
                                    i.GLocale.get(new i.GLocaleKey("GCloudUtil", "text.err-subscription-is-active")).replace(
                                        "%date",
                                        o.DateAPI.format(t)
                                    )
                                );
                            case o.gApi.ERROR_CODES.ERR_SUBSCRIPTION_IS_NOT_EXPIRED:
                                return d.alert(
                                    i.GLocale.get(new i.GLocaleKey("GCloudUtil", "text.err-subscription-is-not-expired")).replace(
                                        "%date",
                                        o.DateAPI.format(gDesigner.getLicense().getExpirationDate())
                                    )
                                );
                            case o.gApi.ERROR_CODES.ERR_SUBSCRIPTION_IS_LIFETIME:
                                return d.alert(i.GLocale.get(new i.GLocaleKey("GCloudUtil", "text.err-subscription-is-lifetime")));
                        }
