module.exports = function (module, exports, require) {
        ...
        var o,
                        ...
                        t = "",
                            o = (function (e) {
                                for (var t = null, n = 1, o = null, i = 0, a = 0; a < 8; a++)
                                    0 !== e[a] ? (i > n && ((t = o), (n = i)), (o = null), (i = 0)) : (null === o && (o = a), ++i);
                                return i > n ? o : t;
                            })(e),
                            n = 0;
                        n < 8;
            ...
            ue = function (e) {
                var t;
                return e.length > 1 && de(j(e, 0, 2)) && (2 === e.length || "/" === (t = k(e, 2)) || "\\" === t || "?" === t || "#" === t);
            },
            pe = function (e) {
                return "." === e || "%2e" === K(e);
            },
        ...
        Oe.prototype = {
                ...
                for (
                    ...
                    switch (((a = i[u]), d)) {
                        ...
                        case _e:
                            if (!c.isSpecial() || ("/" !== a && "\\" !== a)) {
                                if ("/" !== a) {
                                    ((c.username = n.username), (c.password = n.password), (c.host = n.host), (c.port = n.port), (d = De));
                                    continue;
                                }
                                d = Ce;
                            } else d = we;
                        ...
                        case Ee:
                            if (!O(z, a)) {
                                if (a === o || "/" === a || "?" === a || "#" === a || ("\\" === a && c.isSpecial()) || t) {
                                    if ("" !== p) {
                                        var x = D(p, 10);
                                        if (x > 65535) return "Invalid port";
                                        ((c.port = c.isSpecial() && x === ce[c.scheme] ? null : x), (p = ""));
                                    }
                                    if (t) return;
                                    d = Pe;
                                    continue;
                            ...
                            if (((c.scheme = "file"), "/" === a || "\\" === a)) d = Te;
                                ...
                                switch (a) {
                                    case o:
                                        ...
                                        break;
                                    case "?":
                                        ((c.host = n.host), (c.path = m(n.path)), (c.query = ""), (d = Ie));
                                        break;
                                    case "#":
                                        ((c.host = n.host), (c.path = m(n.path)), (c.query = n.query), (c.fragment = ""), (d = ke));
                                        break;
                                    default:
                                        (ue(F(m(i, u), "")) || ((c.host = n.host), (c.path = m(n.path)), c.shortenPath()), (d = De));
                                        continue;
                                }
                            }
                            break;
                        ...
                        case Pe:
                            ...
                            break;
                        case De:
                            if (a === o || "/" === a || ("\\" === a && c.isSpecial()) || (!t && ("?" === a || "#" === a))) {
                                if (
                                    (".." === (l = K((l = p))) || "%2e." === l || ".%2e" === l || "%2e%2e" === l
                                        ? (c.shortenPath(), "/" === a || ("\\" === a && c.isSpecial()) || N(c.path, ""))
                                        : pe(p)
                                          ? "/" === a || ("\\" === a && c.isSpecial()) || N(c.path, "")
                                          : ("file" === c.scheme &&
                                                !c.path.length &&
                                                de(p) &&
                                ...
                                "?" === a ? ((c.query = ""), (d = Ie)) : "#" === a && ((c.fragment = ""), (d = ke));
                            } else p += le(a, re);
                            break;
                        case Le:
                            "?" === a
                        ...
                        case Ie:
                            t || "#" !== a
                                ? a !== o && ("'" === a && c.isSpecial() ? (c.query += "%27") : (c.query += "#" === a ? "%23" : le(a, ie)))
                                : ((c.fragment = ""), (d = ke));
                            break;
                        case ke:
                ...
                if ("[" === k(e, 0)) {
                    ...
                    if (
                        !(t = (function (e) {
                            ...
                            if (null !== d)
                                for (r = c - d, c = 7; 0 !== c && r > 0; ) ((s = l[c]), (l[c--] = l[d + r - 1]), (l[d + --r] = s));
                            else if (8 !== c) return;
                            return l;
                        })(j(e, 1, -1)))
                    )
                    ...
                    if (
                        ...
                        (t = (function (e) {
                            ...
                            for (n = [], o = 0; o < t; o++) {
                                ...
                                if (
                                    ((a = 10),
                                    i.length > 1 && "0" === k(i, 0) && ((a = O(q, i) ? 16 : 8), (i = j(i, 8 === a ? 1 : 2))),
                                    "" === i)
                                )
                                    r = 0;
                                else {
                            ...
                            for (s = M(n), o = 0; o < n.length; o++) s += n[o] * I(256, 3 - o);
                            return s;
                        })(e))
                    )
                        return "Invalid host";
            ...
            setPort: function (e) {
                this.cannotHaveUsernamePasswordPort() || ("" === (e = _(e)) ? (this.port = null) : this.parse(e, Ee));
            },
            ...
            setSearch: function (e) {
                ("" === (e = _(e)) ? (this.query = null) : ("?" === k(e, 0) && (e = j(e, 1)), (this.query = ""), this.parse(e, Ie)),
                    this.searchParams.update());
            },
            ...
            setHash: function (e) {
                "" !== (e = _(e)) ? ("#" === k(e, 0) && (e = j(e, 1)), (this.fragment = ""), this.parse(e, ke)) : (this.fragment = null);
            },
            update: function () {
