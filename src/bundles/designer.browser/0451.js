module.exports = function (e, t, n) {
        ...
        function s(e, t, n, o, r, c, d, u, p, g, h, f, m, y, v, _, b, w, C, x, S, E, A) {
            ((this._root = new a()),
        ...
        ((a._Change = { ExpandedSet: 1, ExpandedRemoved: 2 }),
            ...
            (a.prototype.getNestLevel = function () {
                for (var e = 0, t = this.parent; null != t && t instanceof a; t = t.parent) ++e;
                return e;
            }),
            ...
            (a.prototype.handleChange = function (e, t) {
                (e != a._Change.ExpandedSet && e != a._Change.ExpandedRemoved) || (this.parent && this.parent.handleChange(e, t));
            }),
            (a.prototype.handleExpand = function (e) {
                e.target.id === s.COLLAPSE_ID && this.expanded
                    ? ((this.expanded = !1), this.handleChange(a._Change.ExpandedSet, this))
                    : e.target.id !== s.EXPAND_ID ||
                      this.expanded ||
                      ((this.expanded = !0), this.handleChange(a._Change.ExpandedRemoved, this));
            }),
            ...
            (s.prototype.expandAndFocus = function (e, t) {
                for (var n = 0, o = e; o.parent && o.parent !== this._root; )
                    (o = o.parent).expanded || ((o.expanded = !0), this._expandCallback && this._expandCallback(o));
                    ...
                    : this._updateCounter ||
                      (null === this._invalidationRequestTimerId &&
                          (this._invalidationRequestTimerId = setTimeout(
                              function () {
                                  (this.requestInvalidation(!0), (this._invalidationRequestTimerId = null));
                              }.bind(this),
                              25
                          )));
            }),
            (s.prototype.handleChange = function (e, t) {
                (e != a._Change.ExpandedSet && e != a._Change.ExpandedRemoved) || this.requestInvalidation(!0);
            }),
            ...
            (s.prototype.getNextNode = function (e, t) {
                ...
                if ((!n.firstChild || (t && !n.expanded) || (o = n.firstChild), !o && n.next && (o = n.next), !o))
                    for (var i = n.parent; !o && i instanceof a && i !== this._root; i = i.parent) i.next && (o = i.next);
                return o;
            }),
            ...
            (s.prototype.removeNode = function (e) {
                ...
                t &&
                    ...
                    t.expanded &&
                        ...
                        t !== this._root &&
                        t.expanded &&
                        (t.handleChange(a._Change.ExpandedRemoved, t), (t.expanded = !1), this._expandCallback && this._expandCallback(t)),
            ...
            (s.prototype._renderViewport = function (e) {
                ...
                if (this._rowCount && this._renderer && this._rowHeight) {
                    for (
                        ...
                        ((d.id = s.ROW_ID), d.classList.add(this._rowStyle), (d.style.top = (l * this._rowHeight).toString() + "px"));
            ...
            (s.prototype._initComputedVals = function () {
                ...
                (e.classList.add(this._rowStyle), (e.style.visibility = "hidden"), this._container.appendChild(e));
            ...
            (s.prototype._insertNodeBefore = function (e, t, n) {
                return (
                    ...
                    null != t
                        ...
                        : (null != e.lastChild && ((n.previous = e.lastChild), (e.lastChild.next = n), (e.lastChild = n)), (n.next = null)),
            ...
            (s.prototype._expandRenderer = function (e) {
                e.id === s.COLLAPSE_ID ? (e.innerHTML = "&#9660;") : e.id === s.EXPAND_ID && (e.innerHTML = "&#9658;");
            }),
            (s.prototype._separatorRenderer = function (e, t) {
                ...
                (e.id == s.UPPER_SEP_ID
                    ? (o.classList.add(this._upSeparatorSpan1Style),
                      (i = this._upSeparatorSpan2Style ? this._upSeparatorSpan2Style : null),
                      (e.style.top = "0px"))
                    : (o.classList.add(this._downSeparatorSpan1Style),
                      (i = this._downSeparatorSpan2Style ? this._downSeparatorSpan2Style : null),
            ...
            (s.prototype._nodeHasSomeParent = function (e, t) {
                for (var n = !1, o = e.parent; o && o instanceof a && !n; o = o.parent) n = o === t;
                return n;
            }),
            (s.prototype._nodeClick = function (e, t) {
                (!e.expanded && !e.firstChild) || (t.target.id !== s.COLLAPSE_ID && t.target.id !== s.EXPAND_ID)
            ...
            (s.prototype.setAnimatedDragEnabled = function (e) {
                this._animatedDragEnabled !== e && ((this._animatedDragEnabled = e), this.requestInvalidation(!0));
            }),
            (s.prototype.isAnimatedDragEnabled = function () {
                return this._animatedDragEnabled;
            }),
            (s.prototype._onScroll = function (e) {
                this.isAnimatedDragEnabled() && this._isDragging() ? e.preventDefault() : i.prototype._onScroll.call(this, e);
            }),
            (s.prototype._nodeDragInit = function (e, t) {
                this.isAnimatedDragEnabled() &&
                    ...
                    (this._dragOffset = this._dragStartPt.subtract(this._dragBBox.getSide(o.GRect.Side.TOP_LEFT))),
            ...
            (s.prototype._canDropUpper = function (e) {
                ...
                return this._dropHereAllowed(e) && this._dropUpperAllowed(e, 0, null, t);
            }),
            ...
            (s.prototype._drag = function (e) {
                ...
                const a = t.subtract(this._dragOffset),
                    r = new o.GRect(a.getX(), a.getY(), this._dragBBox.getWidth(), this._dragBBox.getHeight()),
                    s = [];
            ...
            (s.prototype._nodeDrop = function (e, t) {
                ...
                if (((n._specCounter = 0), this._dropHereAllowed(e))) {
                    ...
                    if (this._dropUpperAllowed(e, o, i, a))
                        if ((i.length || (i = this._dragNodes), this._isDuplicateEffectCallback && this._isDuplicateEffectCallback(t)))
                            e !== this._root
                                ? this._duplicateCallback(e.parent, e, e.previous ? e.previous : null, i)
                                : this._duplicateCallback(this._root, null, a ? e.lastChild : null, i);
                        else {
                            this.beginUpdate();
                            for (var r = 0; r < i.length; ++r) this.removeNode(i[r]);
                            if (e !== this._root) {
                                this._dropCallback && this._dropCallback(e.parent, e, e.previous ? e.previous : null, i);
                                for (r = 0; r < i.length; ++r) this.insertNodeBefore(e, i[r]);
                            } else {
                                this._dropCallback && this._dropCallback(this._root, null, a ? e.lastChild : null, i);
                        ...
                        if ((i.length || (i = this._dragNodes), this._isDuplicateEffectCallback && this._isDuplicateEffectCallback(t)))
                            ...
                            this._dropCallback && this._dropCallback(e.parent, e.next ? e.next : null, e, i);
                        ...
                        if ((i.length || (i = this._dragNodes), this._isDuplicateEffectCallback && this._isDuplicateEffectCallback(t)))
                            ...
                            for (r = 0; r < i.length; ++r) this.removeNode(i[r]);
                            if (
                                (this._dropCallback && this._dropCallback(e, null, a ? e.lastChild : null, i),
            ...
            (s.prototype._dropHereAllowed = function (e) {
                for (var t = this._dragNodes && this._dragNodes.length, n = 0; t && n < this._dragNodes.length; ++n) {
            ...
            (s.prototype._dropUpperAllowed = function (e, t, n, o) {
                var i = t <= this._freeHeight && (this._dragNodes.length > 1 || e !== this._dragNodes[0].next);
                return (
                    i &&
                        this._dropAllowedCallback &&
                        (i =
                            (e !== this._root &&
                                this._dropAllowedCallback(e.parent, e, e.previous ? e.previous : null, this._dragNodes, n)) ||
            ...
            (s.prototype._dropLowerAllowed = function (e, t, n) {
                ...
                return (
                    o &&
                        this._dropAllowedCallback &&
                        (o = this._dropAllowedCallback(e.parent, e.next ? e.next : null, e, this._dragNodes, n)),
                    o
                );
            }),
                ...
                var o = n || this._putLastChildWhenInside,
                    i =
                        ...
                        !(
                            ...
                            ((o && e.lastChild === this._dragNodes[0]) || (!o && e.firstChild === this._dragNodes[0]))
                        );
                return (
                    i &&
                        this._dropAllowedCallback &&
                        (i = this._dropAllowedCallback(e, o ? null : e.firstChild, o ? e.lastChild : null, this._dragNodes, t)),
                    i
                );
            }),
            ...
            (s.prototype._rowHasSep = function (e, t) {
                for (var n = 1, o = e.childNodes.length; n < o; n++) if (e.childNodes[n].id === t) return !0;
                return !1;
            }),
            (s.prototype._rowAddSep = function (e, t, n) {
                ...
                ((o.id = t),
                    ...
                    t == s.UPPER_SEP_ID ? e.insertBefore(o, e.firstChild) : e.appendChild(o),
                    (e._hasStyle = !0));
            }),
            (s.prototype._rowRemoveSep = function (e, t) {
                for (var n = e.childNodes.length - 1; n >= 0; --n) e.childNodes[n].id === t && e.removeChild(e.childNodes[n]);
            }),
            ...
            (l.prototype.enableAScroll = function () {
                ((this._aScrollEnabled = !0), (this._timerId = setInterval(this._tryScroll.bind(this), this._scrollDelay)));
            }),
            (l.prototype.disableAScroll = function () {
                ((this._aScrollEnabled = !1), this._timerId && (clearInterval(this._timerId), (this._timerId = null)));
            }),
            (l.prototype.takeOnOffAction = function (e) {
                if (this._aScrollEnabled) {
                    if (e.layerY == e.clientY || e.layerX == e.clientX)
                        return ((this._aScrollY = l.AUTO_SCROLL_Y.OFF), void (this._aScrollX = l.AUTO_SCROLL_X.OFF));
                    for (
            ...
            (l.prototype.offScrolls = function (e) {
                e.target === this._elem && ((this._aScrollY = l.AUTO_SCROLL_Y.OFF), (this._aScrollX = l.AUTO_SCROLL_X.OFF));
            }),
