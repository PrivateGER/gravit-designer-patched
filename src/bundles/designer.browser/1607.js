module.exports = function (e, t, n) {
        ...
        class c extends l.default {
            ...
            execute() {
                ...
                if (o && e === t.getId()) {
                    ...
                    e.hasFlag(a.GNode.Flag.Selected) && n.gLayerPanel("toggleHideStatusOfLayerOrItem", e);
                }
            }
            toString() {
        ...
        ((c.ID = "view.toggle-layer-visibility"), (c.TITLE = new a.GLocaleKey("GToggleLayerVisibilityAction", "title")), (e.exports = c));
    };
