                        ...
                        return (
                            ...
                            (e.widget = function (t, n, o) {
                                ...
                                return (
                                    ...
                                    (a.prototype = e.widget.extend(r, { widgetEventPrefix: (i && r.widgetEventPrefix) || t }, s, {
                                        constructor: a,
                                        namespace: l,
                                        widgetName: t,
                                        widgetFullName: c,
                                    ...
                                    return (
                                        r
                                            ...
                                            : (s.length && (a = e.widget.extend.apply(null, [a].concat(s))),
                                              this.each(function () {
                                                  var t = e.data(this, i);
                                                  t ? (t.option(a || {}), t._init && t._init()) : e.data(this, i, new n(a, this));
                                              })),
                                        l
                                    );
                                };
                                ...
                                option: function (t, n) {
                                    ...
                                    if ("string" == typeof t)
                                        if (((r = {}), (o = t.split(".")), (t = o.shift()), o.length)) {
                                            for (i = r[t] = e.widget.extend({}, this.options[t]), a = 0; a < o.length - 1; a++)
                                                ((i[o[a]] = i[o[a]] || {}), (i = i[o[a]]));
                                            if (((t = o.pop()), 1 === arguments.length)) return void 0 === i[t] ? null : i[t];
                                            i[t] = n;
                                        } else {
