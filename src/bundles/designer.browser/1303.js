module.exports = function (e, t, n) {
        ...
        ((V.ID = "context.menu"),
            ...
            (V.prototype._createContextMenu = function () {
                ...
                (n.setCaption(i.GLocale.get(new i.GLocaleKey("GContextMenu", "text.arrange"))),
                    n.getMenu().createAddItem(gDesigner.getAction(s.ID + "." + o.GEditor.ArrangeOrderType.SendToFront)),
                    n.getMenu().createAddItem(gDesigner.getAction(s.ID + "." + o.GEditor.ArrangeOrderType.BringForward)),
                    n.getMenu().createAddItem(gDesigner.getAction(s.ID + "." + o.GEditor.ArrangeOrderType.SendBackward)),
                    n.getMenu().createAddItem(gDesigner.getAction(s.ID + "." + o.GEditor.ArrangeOrderType.SendToBack)),
                    e.addItem(n));
                var L = new D(D.Type.Menu, P);
                (L.setCaption(i.GLocale.get(new i.GLocaleKey("GContextMenu", "text.align"))),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignLeft)),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignCenter)),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignRight)),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignJustifyHorizontal)),
                    L.getMenu().createAddDivider(),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignTop)),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignMiddle)),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignBottom)),
                    L.getMenu().createAddItem(gDesigner.getAction(r.ID + "." + o.GEditor.ArrangeAlignType.AlignJustifyVertical)),
                    L.getMenu().createAddDivider(),
                    L.getMenu().createAddItem(gDesigner.getAction(h.ID + "." + h.Type.Horizontal)),
                    L.getMenu().createAddItem(gDesigner.getAction(h.ID + "." + h.Type.Vertical)),
                    e.addItem(L));
                var k = new D(D.Type.Menu, P);
                (k.setCaption(i.GLocale.get(new i.GLocaleKey("GContextMenu", "text.transform"))),
                    k.getMenu().createAddItem(gDesigner.getAction(T.ID + "." + T.Type.Rotate90Left)),
                    k.getMenu().createAddItem(gDesigner.getAction(T.ID + "." + T.Type.Rotate90Right)),
                    k.getMenu().createAddItem(gDesigner.getAction(T.ID + "." + T.Type.FlipHorizontal)),
                    k.getMenu().createAddItem(gDesigner.getAction(T.ID + "." + T.Type.FlipVertical)),
                    e.addItem(k),
                    e.createAddDivider(),
                ...
                (O.setCaption(i.GLocale.get(new i.GLocaleKey("GContextMenu", "text.select-same"))),
                ...
                return (
                    B.setCaption(i.GLocale.get(new i.GLocaleKey("GContextMenu", "text.select"))),
                    ...
                    B.addEventListener(
                        ...
                        function () {
                            ...
                            if (!(e && e.length > 0 && e[0] instanceof i.GPage) && e && e.length > 0) {
                                B.setEnabled(!0);
                                for (var o = 0; o < t.length; o++) {
                                    var r = t[o].element,
                                        s = r instanceof i.GBlock ? r.getLabel() : r.getNodeNameTranslated(),
                                            ...
                                            c.addEventListener(D.UpdateEvent, function () {
                                                ...
                                                for (var t = 0; t < e.length; t++)
                                                    this.getMenu().createAddItem(
                                                        (t + 1).toString() +
                                                            ". " +
                                                            (e[t] instanceof i.GBlock ? e[t].getLabel() : e[t].getNodeNameTranslated()),
                                                        function () {
            ...
            (V.prototype._getHitsElments = function (e) {
                ...
                var t = gDesigner.getWindows().getActiveWindow().getView()._convertClientPositionFromMousePosition(e),
                    ...
                    l = n.hitTest(t, r, s, !0, -1, o.GEditorOptions.pickDistance, !0, null, !0, !1, a.getViewConfiguration().multiPageView);
                if (
                    (l &&
                        l.length > 0 &&
                ...
                if (l && l.length > 0)
                    for (var u = 0; u < l.length; ++u) {
                        for (var p = l[u].element.getParent(), g = !1, h = 0; h < l.length; ++h)
                            if (l[h].element === p) {
                                ((g = !0), d["temp-" + h] ? d["temp-" + h].push(l[u].element) : (d["temp-" + h] = [l[u].element]));
                                break;
                            }
                        g || c.push(l[u]);
                    }
            ...
            (V.prototype._createPageMenu = function () {
                var e = new P(null, "g-page-option-menu"),
                    t = {
                        DUPLICATE: i.GLocale.get(new i.GLocaleKey("GContextMenu", "page-panel.text.duplicate")),
                        DELETE: i.GLocale.get(new i.GLocaleKey("GContextMenu", "page-panel.text.delete")),
                        COPY: i.GLocale.get(new i.GLocaleKey("GContextMenu", "page-panel.text.copy")),
                        EXPORT: i.GLocale.get(new i.GLocaleKey("GContextMenu", "page-panel.text.export")),
                    },
                    n = e.createAddItem(t.DUPLICATE, function () {
                        ...
                        (o.GEditor.tryRunTransaction(
                            ...
                            function () {
                                ...
                                n.setProperty("off", new i.GTransform(1, 0, 0, 1, a.getX(), a.getY()));
                            },
                            t.DUPLICATE
                        ),
                    ...
                    a = e.createAddItem(t.DELETE, function () {
                        ...
                        n.getProperty("plkt") & i.GBlock.ProgramLck.NoDelete ||
                            (a
                                ? j.confirm(
                                      i.GLocale.get(new i.GLocaleKey("GOutlineSidebar", "text.confirm-delete-masterpage")),
                                      function (t) {
                                          t &&
                                              o.GEditor.tryRunTransaction(
                                                  e,
                                                  ...
                                                  i.GLocale.get(new i.GLocaleKey("GOutlineSidebar", "action.delete-page"))
                                              );
                                      },
                                      null,
                                      null,
                    ...
                    s = e.createAddItem(t.EXPORT, function () {
                        ...
                        (gDesigner.executeAction(B.ID, [{ element: e }], null, !0), gDesigner.stats("contextmenu_pages_export"));
                    });
                return (
            ...
            (V.prototype._createFillPropertyMenu = function () {
                var e = new P(null, "fill-context-menu"),
                    t = null,
                    n = {
                        DELETE: i.GLocale.get(new i.GLocaleKey("GContextMenu", "fill-properties-panel.text.delete-fill")),
                        COPY: i.GLocale.get(new i.GLocaleKey("GContextMenu", "fill-properties-panel.text.copy-fill")),
                    },
                    ...
                    s = e.createAddItem(n.COPY, function () {
                        if (t) {
                            var e = i.GNode.serialize([t], {
                                ...
                                n = '<gravit mimeType="' + i.GNode.MIME_TYPE + '">' + $("<div/>").text(e).html() + "</gravit>";
            ...
            (V.prototype._createBorderPropertyMenu = function () {
                var e = new P(null, "border-context-menu"),
                    t = null,
                    n = {
                        ADVANCED: i.GLocale.get(new i.GLocaleKey("GContextMenu", "border-properties-panel.text.advanced-settings")),
                        DELETE: i.GLocale.get(new i.GLocaleKey("GContextMenu", "border-properties-panel.text.delete-border")),
                        COPY: i.GLocale.get(new i.GLocaleKey("GContextMenu", "border-properties-panel.text.copy-border")),
                    },
                    r = e.createAddItem(
                        n.ADVANCED,
                        function () {
            ...
            (V.prototype._createEffectPropertyMenu = function () {
                var e = new P(null, "effect-context-menu"),
                    t = null,
                    n = {
                        COPY: i.GLocale.get(new i.GLocaleKey("GContextMenu", "effect-properties-panel.text.copy-effect")),
                        APPLY_TO_ELEMENT: i.GLocale.get(new i.GLocaleKey("GContextMenu", "effect-properties-panel.text.apply-to-element")),
                        APPLY_TO_FILL: i.GLocale.get(new i.GLocaleKey("GContextMenu", "effect-properties-panel.text.apply-to-fill")),
                        APPLY_TO_BORDER: i.GLocale.get(new i.GLocaleKey("GContextMenu", "effect-properties-panel.text.apply-to-border")),
                    },
