module.exports = function (e, t, n) {
        ...
        ((p.Error = {
            ...
            (p.prototype.isAuthenticated = function () {
                ...
                return !(!e || !this.isTokenValid(e)) || ((this._authenticated = !1), !1);
            }),
            (p.prototype._authenticateCommand = async function (e) {
                ...
                return 0 === i.length ? (await t.setTokens(o, !1), o) : this._processAuthenticationCommands(e, o);
            }),
                                ...
                                failureCallback: function (t) {
                                    t === p.FAIL_REASONS.POPUP_WINDOW_BLOCKED
                                        ? n._handleError(
                                              ...
                                              i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.authenticate")),
                                              (t) => {
                                        ...
                                        : t === p.FAIL_REASONS.CANCELLED_BY_USER
                                          ? (n._handleError(
                                                ...
                                                i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.try-again")),
            ...
            (p.prototype.setTokens = async function (e) {
                ...
                ((this._tokens = Object.assign({ userId: n }, o, e)),
                    t && localStorage.setItem(p.CACHED_TOKENS_PROPERTY_NAME, (0, c.stringToBase64String)(JSON.stringify(this._tokens))));
            }),
            (p.prototype.getOrFetchMSTeamsAccessToken = async function () {
                const e = (this._tokens && this._tokens[l.MS_TEAMS_COMMAND]) || null;
                return (
                    (e && this.isTokenValid(e)) || ((this._authenticated = !1), await this.authenticate()),
            ...
            (p.prototype._handleError = function (e, t, n) {
                ...
                switch (e) {
                    case p.Error.OFFLINE:
                        o = i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.offline"));
                        break;
                    case p.Error.ONEDRIVE_BUSINESS_ERROR:
                        o = i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.onedrive-business-error"));
                        break;
                    case p.Error.SHAREPOINT_ERROR:
                        o = i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.sharepoint-error"));
                        break;
                    case p.Error.SHAREPOINT_ONEDRIVE_BUSINESS_ERROR:
                        o = i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.sharepoint-onedrive-business-error"));
                        break;
                    case p.Error.NOT_REGISTERED:
                        o = i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.not_registered"));
                        break;
                    case p.Error.FAILED_TO_OPEN_WINDOW:
                        o = i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.failed-to-open-window"));
                        break;
                    case p.Error.CANCELLED_BY_USER:
                        o = i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.cancelled-by-user"));
                        break;
                    default:
                        o = e && e.message ? e.message : i.GLocale.get(new i.GLocaleKey("GMSTeamsAuthenticator", "text.unknown"));
                }
                ...
                return !e || e.reload || e.deactivated
                    ...
                    : e && e.microsoft_corporate_config
                      ? e.microsoft_corporate_config.client_id
                          ? !!e.microsoft_corporate_config.odb_client_id || (this._handleError(p.Error.ONEDRIVE_BUSINESS_ERROR), !1)
            ...
            (p.prototype._authWithCorelCloud = async function (e) {
                ...
                if (!t || !t.ok) return (this._handleError(p.Error.NOT_REGISTERED), (this._loading = !1), !1);
                return (await t.json().catch(() => null))
                    ? ((this._loaded = !0), (this._loading = !1), this._validateAuthenticatedUser())
