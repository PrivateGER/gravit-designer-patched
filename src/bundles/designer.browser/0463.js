module.exports = function (e, t, n) {
        ...
        function m(e, t) {
            ...
            do {
                if (c[(n = t) + r] === h && c[n + r - 1] === g && c[n] === c[a] && c[++n] === c[a + 1]) {
                    ((a += 2), n++);
                    do {} while (
                        c[++a] === c[++n] &&
                        c[++a] === c[++n] &&
                    ...
                    (n =
                        0 === g
                            ...
                            : ((c.avail_in -= g),
                              ...
                              1 === c.state.wrap ? (c.adler = r(c.adler, d, g, u)) : 2 === c.state.wrap && (c.adler = s(c.adler, d, g, u)),
                              (c.next_in += g),
                              (c.total_in += g),
                              g)),
                    (e.lookahead += n),
        ...
        function v(e, t) {
            for (var n, o; ; ) {
                ...
                if (
                    ...
                    if (
                        ((o = a._tr_tally(e, e.strstart - e.match_start, e.match_length - 3)),
            ...
            for (var n, o, i; ; ) {
                ...
                if (
                    ...
                    ((i = e.strstart + e.lookahead - 3),
                        (o = a._tr_tally(e, e.strstart - 1 - e.prev_match, e.prev_length - 3)),
        ...
        function S(e, t, n, o, a, r) {
            ...
            if (
                ...
                a < 1 || a > 9 || 8 !== n || o < 8 || o > 15 || t < 0 || t > 9 || r < 0 || r > 4)
            )
                return c(e, -2);
            8 === o && (o = 9);
            var l = new w();
                    ...
                    if (i.gzhead.extra) {
                        for (
                            ...
                            (i.pending !== i.pending_buf_size ||
                                (i.gzhead.hcrc && i.pending > r && (e.adler = s(e.adler, i.pending_buf, i.pending - r, r)),
                                p(e),
                                (r = i.pending),
                                i.pending !== i.pending_buf_size));
                ...
                if (91 === i.status)
                    if (i.gzhead.comment) {
                        ...
                        do {
                            ...
                            ((l = i.gzindex < i.gzhead.comment.length ? 255 & i.gzhead.comment.charCodeAt(i.gzindex++) : 0), h(i, l));
                        } while (0 !== l);
                        (i.gzhead.hcrc && i.pending > r && (e.adler = s(e.adler, i.pending_buf, i.pending - r, r)),
                            0 === l && (i.status = 103));
                    } else i.status = 103;
