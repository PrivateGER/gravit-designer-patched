module.exports = function (e, t, n) {
        ...
        let c = !1,
            ...
            v = 0,
            _ = 0,
            b = i.GPaintCanvas.getScreenDPI() * a.GSceneWidget.options.pinchToZoomFactor,
        ...
        class C extends s.default {
            ...
            start(e) {
                ...
                ((p = v = a.clientX), (g = _ = a.clientY), o.startTouchMode(), (this._moved = !1));
            }
            move(e) {
                if (!this._twoFingersState) return !1;
                const t = e.getOriginalEvent();
                (this._twoFingersState.update(t), (this._moved = !0), t.cancelable && (t.preventDefault(), t.stopPropagation()));
                ...
                if (
                    ...
                    if (i.GMath.isEqualEps(e, t, r.MIN_TWO_FINGERS_TOUCH_MOVE_DISTANCE)) {
                        ...
                        l = l < a.GSceneWidget.options.minZoomFactor ? a.GSceneWidget.options.minZoomFactor : l;
