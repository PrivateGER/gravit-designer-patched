module.exports = function (e, t, n) {
        ...
        (o.GObject.inherit(u, o.GEventTarget),
            ...
            (u.prototype.removeItem = function (e) {
                e >= 0 &&
                    e < this.getItemCount() &&
                    ((this._items[e]._parent = null), this._items[e]._htmlElement.detach(), this._items.splice(e, 1));
            }),
            ...
            (u.prototype.open = function (e, t, n, o) {
                ((t = "number" == typeof t ? t : r.Position.Center), (n = "number" == typeof n ? n : r.Position.Center));
                ...
                if (
                    ...
                    if ((v + u >= _ && (v = _ - u), this._htmlElement.find(".g-menu-arrow").remove(), a && s)) {
                        const e = $("<div/>").addClass("g-menu-arrow").prependTo(this._htmlElement);
                        let t = h.width / 2 - 14;
                        (t < 0 && (y - 14 > 0 ? ((y -= 14), (t += 14)) : e.remove()), e.css("left", "".concat(t, "px")));
                    }
            ...
            (u.prototype.closeMenus = function () {
                ...
                for (var t = 0; t < this.getItemCount(); ++t) {
                    var n = this.getItem(t);
                    n instanceof s && n.getType() === s.Type.Menu && (!n.isForcedAsOpened() || e) && n.getMenu().close();
                }
            }),
