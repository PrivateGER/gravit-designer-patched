module.exports = function (e, t, n) {
        ...
        (o.GObject.inherit(l, s),
            ...
            (l.prototype.getShortcut = function () {
                return [i.GKey.Constant.SHIFT, i.GKey.Constant.CONTROL, i.GKey.Constant.OPTION, "N"];
            }),
            ...
            (l.prototype.execute = function () {
                ...
                if (e && e.length > 0) {
                    ...
                    if (t.length > 0) {
                        ...
                        (n.getActivePage().setProperties(["bck", "w", "h"], [o.GRGBColor.WHITE, 0, 0]), gDesigner.addDocument(new r(n)));
                        var i = gDesigner.getActiveDocument().getEditor();
                        i.beginTransaction();
                        try {
                            i.insertElements(t, !0, !0, !0);
                        } finally {
                            (i.commitTransaction("Paste"), gDesigner.setClipboardContent(o.GNode.MIME_TYPE, null));
                        }
                ...
                return (
                    o.GUtil.each(e, function (e, n) {
                        ...
                        i &&
                            ...
                            (t = t ? t.united(i) : new o.GRect(i.getX(), i.getY(), i.getWidth(), i.getHeight()));
                    }),
                    t
                );
            }),
