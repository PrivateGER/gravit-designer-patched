        ...
        function l(e) {
            const t = (e) => {
                if (a.GKey.translateKey(e.keyCode) === a.GKey.Constant.ESC)
                    return (e.preventDefault(), e.stopPropagation(), $(document).off("keydown", t), this._dialog.gDialog("close"), !1);
            };
            ...
            (l.prototype._getMainContent = function () {
                return $("<div />")
                    ...
                    .append(
                        $("<div />")
                            .addClass("title")
                            .text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "text.title")))
                    )
                    .append(
                        $("<div />")
                            .addClass("description")
                            .append($("<span />").text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "text.description-text"))))
                            .append(
                                $("<a />")
                                    .attr("href", "https://www.gravit.linusrath.de/pro")
                                    .attr("target", "_blank")
                                    .text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "text.description-pro-link")))
                            )
                            .append($("<span />").text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "text.end-sentence-dot"))))
                    )
                ...
                return $("<div />")
                    ...
                    .append(
                        $("<button />")
                            .addClass("primary")
                            .addClass("g-button")
                            .text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "action.install-button")))
                            .on("click", function (t) {
                                try {
                    ...
                    .append(
                        $("<button />")
                            .addClass("g-button")
                            .text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "action.not-now-button")))
                            .on("click", () => {
                ...
                return $("<div />")
                    ...
                    .append(
                        $("<div/>")
                            ...
                            .html(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "text.pwa-requires")))
                    );
            }),
            (l.prototype._getFooter = function () {
                return $("<div />")
                    .addClass("footer")
                    .append($("<span />").text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "text.footer-main-text"))))
                    .append($("<span />").text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "action.footer-link-text"))))
                    .append($("<span />").text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "text.end-sentence-dot"))))
                    .append($("<span> </span>"))
                    .append(
                        $("<a />")
                            ...
                            .attr("target", "_blank")
                            .text(i.GLocale.get(new i.GLocaleKey("GInstallPwaDialog", "action.footer-more-information")))
                    );
            }),
