module.exports = function (e, t, n) {
        ...
        (o.GObject.inherit(i, o.GObject),
            ...
            (i.CATEGORY_FILE_OPEN_RECENT = a(["GCategory", "category.file.open-recent"], i.CATEGORY_FILE)),
            (i.CATEGORY_FILE_SAVE_AS = a(["GCategory", "category.file.save-as"], i.CATEGORY_FILE)),
            (i.CATEGORY_FILE_GRAVIT_CLOUD = a(["GCategory", "category.file.gravit-cloud"], i.CATEGORY_FILE)),
            (i.CATEGORY_FILE_IMPORT = a(["GCategory", "category.file.import"], i.CATEGORY_FILE)),
            (i.CATEGORY_FILE_IMPORT_IMAGE = a(["GCategory", "category.file.import.image"], i.CATEGORY_FILE_IMPORT)),
            ...
            (i.CATEGORY_MODIFY_COMBINE = a(["GCategory", "category.modify.combine"], i.CATEGORY_MODIFY)),
            ...
            (i.CATEGORY_HELP_SUPPORT = a(["GCategory", "category.help.support"], i.CATEGORY_HELP)),
            (i.CATEGORY_HELP_BETA_FEEDBACK = a(["GCategory", "category.help.beta_feedback"], i.CATEGORY_HELP)),
            (i.CATEGORY_HELP_LEARN = a(["GCategory", "category.help.learn"], i.CATEGORY_HELP)),
            (i.CATEGORY_HELP_LANGUAGE = a(["GCategory", "category.help.language"], i.CATEGORY_HELP)),
            (i.CATEGORY_HELP_SWITCHWEBCDR = a(["GCategory", "category.help.switchwebcdr"], i.CATEGORY_HELP)),
                ...
                () => {
                    ...
                    if (e) {
                        if (e.hasOwnPictureAvatar())
                            return $("<div/>").addClass("avatar").css("background-image", 'url("'.concat(e.avatar, '")'));
