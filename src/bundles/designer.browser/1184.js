module.exports = function (e, t, n) {
        ...
        (o.GObject.inherit(s, r),
            ...
            (s.prototype.getShortcut = function () {
                return [i.GKey.Constant.OPTION, i.GKey.Constant.SHIFT, i.GKey.Constant.META, "V"];
            }),
                ...
                if (e) {
                    ...
                    if (t) {
                        ...
                        if (n && n.indexOf(o.GNode.MIME_TYPE) >= 0)
                            for (var i = 0; i < t.length; ++i) if (t[i].hasMixin(o.GNode.Container)) return !0;
                    }
                }
                return !1;
            }),
            ...
            (s.prototype._paste = function (e, t) {
                if (e && e.length > 0) {
                    for (var n = [], i = 0; i < e.length; ++i) e[i] instanceof o.GElement && n.push(e[i]);
                    if ((n = gDesigner.getActiveDocument().filterUnrestrictedCommercialFileElements(n)).length > 0) {
                        ...
                        (n.forEach((e) => {
                            e instanceof o.GText &&
                                ...
                                (a.insertElements([e], !1, !0, !0), e.getParent().removeChild(e));
                        }),
                            a.beginTransaction());
                        try {
                                ...
                                if (s.hasMixin(o.GNode.Container) && !s.isLocked()) {
                                    ...
                                    if (d) {
                                        ...
                                        if (
                                            (null === u ||
                                                null === h ||
                                                (o.GMath.isEqualEps(u, h) && o.GMath.isEqualEps(p, f)) ||
