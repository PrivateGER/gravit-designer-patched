                ...
                return (
                    ...
                    (e.prototype._touchstart = function (t) {
                        ...
                        if (this._shouldHandle(t)) {
                            ...
                            o &&
                                ((e._ISPRESSHOLDMODE = parseInt(o.dataset.dragMode) === s.default.PRESS_AND_HOLD),
                                (this._dragSource = o),
                        ...
                        if (this._shouldCancelPressHoldMove(t)) this._reset();
                            ...
                            if (
                                ...
                                (t.cancelable && t.preventDefault(),
                                    ...
                                    this._dragSource.parentElement && this._dragSource.parentElement.classList.remove("g-draggable-parent"),
                    ...
                    (e.prototype._copyStyle = function (t, n) {
                        ...
                        for (r = 0; r < t.children.length; r++) this._copyStyle(t.children[r], n.children[r]);
                    }),
