module.exports = function (e, t, n) {
        "use strict";
        (n(58), n(19), n(96), n(8), n(20), n(3), n(4), n(13), n(26), n(125), n(126), n(114));
        var o = n(0),
            i = n(9),
            a = n(47),
            r = n(85),
                                ...
                                if (u === r.OpenFileRequest.Type.DocumentOrToken) {
                                    ...
                                    u === r.OpenFileRequest.Type.Document
                                        ...
                                        : u === r.OpenFileRequest.Type.Token &&
                                          ((t = p), (d = await gApi.getShare(t, !0).catch(() => null)));
                                if (d)
                                    ...
                                    (gDesigner.getShareManager().isPermissionRequestEnabled() &&
                                        c.push({
                                            label: i.get(new a("GShareManager", "text.file-request-access")),
                                            onclick: (e) => {
                                                (gDesigner.stats("permission-dialog_no-access_request-access"),
                                                    gApi
                                                        ...
                                                        .then(() => {
                                                            (e.gDialog("close"),
                                                                w.alert(i.get(new a("GShareManager", "text.sent-request-email"))));
                                                        })
                                                        .catch(() => {
                                                            w.error(i.get(new a("GShareManager", "text.cannot-request-access")));
                                                        }));
                                            },
                                        }),
                                        c.push({
                                        ...
                                        w.custom({
                                            ...
                                            closeable: !1,
                                            closeCallback: () => gDesigner.removeDocument(e, null, !0),
                                            title: i.get(new a("GShareManager", "text.file-can-not-be-accessed-title")),
                                            subtitle: i.get(new a("GShareManager", "text.file-can-not-be-accessed-info")),
                                            buttons: c,
                                        }));
                                }
                            }
