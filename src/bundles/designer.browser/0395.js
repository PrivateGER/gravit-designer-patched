        ...
        (GObject.GObject.inherit(d, GObject.GEventTarget),
            ...
            (d.prototype.setActiveSidebar = function (e) {
                if ((e || this.setActiveTouchTool(null), e !== this._activeSidebar)) {
                    ...
                    for (var n = this._activeSidebar, o = 0; o < this._sidebars.length; ++o) {
                        ...
                        if (a === e) {
                            ((this._activeSidebar = a),
                                ...
                                this.hasEventListeners(d.SidebarEvent) &&
                                    this.trigger(new d.SidebarEvent(d.SidebarEvent.Type.Activated, i.sidebar)));
                            ...
                            (i.container.css("display", "none"),
                                a === n &&
                                    ...
                                    this.hasEventListeners(d.SidebarEvent) &&
                                        this.trigger(new d.SidebarEvent(d.SidebarEvent.Type.Deactivated, i.sidebar))));
                ...
                if (this.getActiveSidebar() === e) {
                    for (var t = null, n = 0; n < this._sidebars.length && !t; ++n)
                        if (this._sidebars[n].sidebar.getId() !== e) {
                            ...
                            this._htmlElement.find(".sidebar-option.sidebar-" + o).is(":visible") && (t = o);
                        }
            ...
            (d.prototype.setSidebarEnabled = function (e, t) {
                ...
                if (n)
                    if (t) (n.container.find(".g-disabled-overlay").remove(), n.container.removeClass("g-disabled"));
                    else {
                        var o = n.container.find(".g-disabled-overlay");
                        (0 === o.length && (o = $("<div></div>").addClass("g-disabled-overlay").appendTo(n.container)),
            ...
            (d.prototype.init = function () {
                ...
                var e = function (e, t) {
                        ...
                        var n = $("<div></div>")
                            .addClass("sidebar-container sidebar-" + e.getId() + (this._sidebarsSelector ? " multiple" : ""))
                            .css("display", "none")
                            .appendTo(this._htmlElement);
                        (e.init(n),
                        ...
                        (e.addEventListener(
                            a.UpdateEvent,
                            function () {
                                (this.setSidebarEnabled(e.getId(), e.isEnabled() && i.canAccessFreemium()),
                            ...
                            e.getId() === SidebarsIds.GInspectorSidebar &&
                                e.addEventListener(
                                    d.SidebarEvent,
                                    function (e) {
                                        [d.SidebarEvent.Type.ChildAdded, d.SidebarEvent.Type.ChildRemoved].includes(e.type) &&
                                            this._updateTouchToolbar();
                                    }.bind(this)
                                ),
                    ...
                    if (this._isResizing) {
                        ...
                        (a || this._canResize) &&
                            (a && !this._canResize
                                ...
                                : this._canResize && !a && (this._frame.removeClass("resize"), (this._canResize = a)));
                    }
            }),
            ...
            (d.prototype._getSidebarInfo = function (e) {
                if (e && this._sidebars)
                    for (var t = 0; t < this._sidebars.length; ++t) {
                        if (this._sidebars[t].sidebar.getId() === e) return this._sidebars[t];
                    }
                return null;
            }),
            (d.prototype._settingChanged = function (e) {
                if (e.key === "sidebars_" + this._orientation + "_active") {
                    ...
                    (this.setActiveSidebar(e.newValue ? e.newValue : null), gDesigner.setPartVisible(this.getSidebarsPart(), !!e.newValue));
                } else if (0 === e.key.indexOf("sidebars_width_") && this._orientation !== d.Orientation.Right) {
                    var t = e.key.substr("sidebars_width_".length);
                    ((this._sidebarWidths[t] = e.newValue),
                        t === this._activeSidebar && (this._htmlElement.css("width", e.newValue + "px"), gDesigner.relayout()));
                } else
                    "touch" === e.key &&
            ...
            (d.prototype._updateBadge = function (e) {
                if (this._sidebarsSelector) {
                    var t = this._sidebarsSelector.find(".sidebar-option.sidebar-" + e.getId()),
                        n = t.find(".g-badge");
                    e.updateBadge(n) ? (t.addClass("content-width"), n.show()) : (t.removeClass("content-width"), n.hide());
                }
            }),
