            ...
            ((this._dialog = $("<div></div>")),
                $("<div/>")
                    ...
                    .append(
                        $("<span/>")
                            .css("display", "block")
                            .html(i.GLocale.get(new i.GLocaleKey("GNewFilePrompt", "text.name-document")))
                    )
                    .append(
                        $("<input/>")
                            .attr("type", "text")
                    ...
                    buttons: [
                        $(
                            "<button"
                                ...
                                .concat(i.GLocale.get(new i.GLocaleKey("GNewFilePrompt", "action.create")), "</button>")
                        ).on("click", function () {
                            (gDesigner.stats("newfile_click_save"), c());
                        }),
                        $("<button>" + i.GLocale.get(new i.GLocaleKey("GLocale", "cancel")) + "</button>").on("click", function () {
