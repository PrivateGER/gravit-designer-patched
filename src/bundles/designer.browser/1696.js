        ...
        var i = {
            init: function (e) {
                ...
                const t = [
                    ...
                    {
                        group: o.GLocale.getValue("GAppearanceProperties", "text.darken-image"),
                        options: [
                            {
                    ...
                    {
                        group: o.GLocale.getValue("GAppearanceProperties", "text.lighten-image"),
                        options: [
                            {
                    ...
                    {
                        group: o.GLocale.getValue("GAppearanceProperties", "text.boost-contrast"),
                        options: [
                            {
                    ...
                    {
                        group: o.GLocale.getValue("GAppearanceProperties", "text.adjust-colors"),
                        options: [
                            {
                    ...
                    {
                        group: o.GLocale.getValue("GAppearanceProperties", "text.invert-colors"),
                        options: [
                            {
