        ...
        (GObject.GObject.inherit(x, m),
            ...
            (x.prototype.init = function (e) {
                ...
                var r = false,
                    ...
                    c = function (e) {
                        var i;
                        r &&
                            ((i = n - t + e.clientY) < this._pageContainerMinHeight && (i = this._pageContainerMinHeight),
                            i > this._pageContainerMaxHeight && (i = this._pageContainerMaxHeight),
                            o.css("height", i + "px"));
                    }.bind(this),
                    u = function () {
            ...
            (x.prototype._changePageMode = function (e) {
                ...
                (this._document.getScene().setProperty(c.default.MULTIPAGE_VIEW_ENABLED, e),
                    ...
                    t && this._pageModeSwitch.find("input[data-property=multipage-switch]").prop("checked", e));
            }),
                ...
                e.type === d.Type.Activated
                    ? ((this._document = e.document),
                      ...
                      this._document.getStatus() === p.Ready || this._document.getStatus() === p.Loaded
                          ...
                          : this._document.addEventListener(u, this._documentStatusEvent, this),
            ...
            (x.prototype._documentStatusEvent = function (e) {
                (e.status !== p.Ready && e.status !== p.Loaded) ||
                    (this._updateMultiPageMode(), this._document.removeEventListener(u, this._documentStatusEvent, this));
            }),
            (x.prototype._windowsEvent = function (e) {
                e.type === g.WindowEvent.Type.Activated &&
                    (this._updateMultiPageMode(), gDesigner.getWindows().removeEventListener(g.WindowEvent, this._windowsEvent, this));
            }),
            (x.prototype._isMultiPageModeEnabled = function () {
                const e = this._document.getScene().getProperty(c.default.MULTIPAGE_VIEW_ENABLED);
                return "boolean" == typeof e ? e : gContainer.getProperty(x.MULTIPAGE_MODE_ENABLED_OPTION_NAME);
            }),
            ...
            (x.prototype._activeTool = function (e) {
                e && e instanceof i.GSelectTool && e.addEventListener(i.GSelectTool.Event, this._selectToolEvent, this);
            }),
            (x.prototype._selectToolEvent = function (e) {
                e.type === i.GSelectTool.Event.Type.EditModeChanged &&
                    this._updateTransformMode(e.args.mode === i.GSelectTool.EditMode.Transform);
            }),
            ...
            (x.prototype._movePageTreeNodeCallback = function (e, t, n) {
                if (n && e && n.length) {
                    ...
                    (i.GEditor.tryRunTransaction(
                        ...
                        function () {
                            (this._document.getEditor().clearSelection(), o.startBlockReferenceChanges(), n.length > 1 && e.beginUpdate());
                    ...
                    if ((e instanceof GObject.GItem ? (n = GObject.GItem) : e instanceof GObject.GLayer && (n = GObject.GLayer), n)) {
                        if (
                            ...
                            var i = t.getSelection(),
                                s = null;
                            if (i && i.length) {
                                for (var l = i.length - 1; l >= 0 && !s; --l) i[l] instanceof n && (s = i[l]);
                                if (s && s !== e) {
                                    var c = [];
                                    if (
