module.exports = function (e, t, n) {
        ...
        var o = function (e, t) {
                ...
                (o.removeClass(t ? "gravit-icon-down" : "gravit-icon-right"), o.addClass(t ? "gravit-icon-right" : "gravit-icon-down"));
            },
            i = {
                init: function (e, t, n, i) {
                    return this.each(function () {
                        ...
                        if (!$(this).hasClass("accordion")) {
                            var r = $("<span></span>").addClass($(this).hasClass("collapsed") ? "gravit-icon-right" : "gravit-icon-down"),
                                s = $("<button></button>")
