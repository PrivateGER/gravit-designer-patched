        ...
        function l() {
            l.TOOLTIP_CONFIG = {
                [a.TOOLTIP_AREA.TOOLBAR]: a.GRichTooltipConfig.from({
                    title: o.GLocale.get(new o.GLocaleKey("GUndoAction", "tooltip-title")),
                    description: o.GLocale.get(new o.GLocaleKey("GUndoAction", "tooltip-description")),
                    shortcut: l.SHORTCUT,
                }),
            };
        }
        (o.GObject.inherit(l, s),
            ...
            (l.prototype.getTitle = function () {
                ...
                return e && e.getEditor() && e.getEditor().hasUndoState()
                    ? o.GLocale.get(new o.GLocaleKey("GUndoAction", "undo-action")).replace("%action", e.getEditor().getUndoStateName())
