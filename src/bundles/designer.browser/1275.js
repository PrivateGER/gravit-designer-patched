module.exports = function (e, t, n) {
            ...
            return (
                d ||
                    (d = [
                        {
                            name:
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "text.light-theme")) +
                                " (" +
                                i.GLocale.get(new i.GLocaleKey("GCommonNames", "text.default")).toLowerCase() +
                                ")",
                            localeClass: new i.GLocaleKey("GSettingsDialog", "text.light-theme"),
                            key: "light",
                        },
                        {
                            name: i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "text.dark-theme")),
                            localeClass: new i.GLocaleKey("GSettingsDialog", "text.dark-theme"),
                            key: "dark",
                        },
                    ]),
                new Promise((e, t) => {
        ...
        (i.GObject.inherit(u, i.GObject),
            (u.prototype._buildDialog = async function () {
                let e = (await r.gApi.getUserSettings().catch(() => ({ notifications_disabled: !1 }))).notifications_disabled;
                ((this._dialog = $("<div></div>")
                    .append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.highlight-on-hover")),
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.highlight-on-hover-description")),
                            $("<label></label>")
                                .addClass("g-switch")
                                .append(
                                    $("<input>")
                    ...
                    .append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.auto-expand-layers")),
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.auto-expand-layers-description")),
                            $("<label></label>")
                                .addClass("g-switch")
                                .append(
                                    $("<input>")
                    ...
                    r.AUTO_SAVE_ENABLED &&
                        (this._dialog.append(
                            this._createSetting(
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.auto-save")),
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.auto-save-description")),
                                this._createAutoSaveSetting()
                            )
                        ),
                        this._dialog.append(
                            this._createSetting(
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.auto-save-warning")),
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.auto-save-warning-description")),
                                $("<label/>")
                                    .addClass("g-switch")
                                    .append(
                                        $("<input>")
                                            ...
                                            .prop("checked", !gDesigner.getSetting(s.DISABLE_WARNING_SETTING_NAME, !1))
                                    )
                                    .append($("<div/>"))
                            )
                        )),
                    "production" === gDesigner.getEnv() ||
                        ...
                        (this._dialog.append(
                            this._createSetting(
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.enable_steps_debug")),
                                null,
                                $("<label></label>")
                                    .addClass("g-switch")
                                    .append(
                                ...
                                $("<label></label>")
                                    ...
                                    .append(
                                        $("<input>")
                                            ...
                                            .prop("checked", gDesigner.getSetting("enable_cache", i.GRendererConfig.ENABLE_CACHE))
                                    )
                                    .append($("<div></div>"))
                            )
                        )),
                    this._dialog.append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.change-theme")),
                            null,
                            this._createThemeSelector()
                        ).append(
                            this._createSetting(
                                null,
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.ui-toolbar-alignment")),
                                $("<label></label>")
                                    .addClass("g-switch")
                                    .append(
                                        $("<input>")
                                            ...
                                            .prop("checked", gDesigner.getSetting("ui_toolbar_alignment", !1))
                                    )
                                    .append($("<div></div>"))
                    ...
                    this._dialog.append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.store-textpath")),
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.store-textpath-description")),
                            $("<label></label>")
                                .addClass("g-switch")
                                .append(
                                    $("<input>")
                                        ...
                                        .prop("checked", !gDesigner.getSetting("dont_store_textpath", i.GText.dontStorePaths))
                                )
                                .append($("<div></div>"))
                        )
                    ),
                    this._dialog.append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.decimals-num")),
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.decimals-num-description")),
                            this._createDecimalsNum()
                        )
                    ),
                    this._dialog.append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.disable-warning-unsupported-features")),
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.disable-warning-unsupported-features-description")),
                            $("<label></label>")
                                .addClass("g-switch")
                                .append(
                                    $("<input>")
                                        ...
                                        .prop("checked", gDesigner.getSetting("disable_warning_unsupported_features", !1))
                                )
                                .append($("<div></div>"))
                        )
                    ),
                    this._dialog.append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.eps-outline-fonts")),
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.eps-outline-fonts-description")),
                            $("<label></label>")
                                .addClass("g-switch")
                                .append(
                                    $("<input>")
                                        ...
                                        .prop("checked", gDesigner.getSetting("eps_outline_fonts", !0))
                                )
                                .append($("<div></div>"))
                        )
                    ),
                    this._dialog.append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.disable-notifications")),
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.disable-notifications-description")),
                            $("<label></label>")
                    ...
                    this._dialog.append(
                        this._createSetting(
                            i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.disable-scrubbing")),
                            null,
                            $("<label></label>")
                                .addClass("g-switch")
                                .append(
                    ...
                    gContainer.getRuntime() === c.Runtime.Electron &&
                        this._dialog.append(
                            this._createSetting(
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.create-backup-copy-of-file")),
                                i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "setting.create-backup-copy-of-file-description")),
                                $("<label></label>")
                                    .addClass("g-switch")
                                    .append(
                                        $("<input>")
                                            ...
                                            .prop("checked", gDesigner.getSetting("create_backup_copy", !1))
                                    )
                                    .append($("<div></div>"))
                            )
                        ),
                    this._dialog.gDialog({
                        ...
                        buttons: [
                            $('<button class="settings-button">' + i.GLocale.get(new i.GLocaleKey("GLocale", "cancel")) + "</button>").on(
                                "click",
                                () => {
                            ...
                            $(
                                '<button class="settings-button">' +
                                    i.GLocale.get(new i.GLocaleKey("GSettingsDialog", "action.save-changes")) +
                                    "</button>"
                            ).on("click", () => {
            ...
            (u.prototype._saveNotificationSetting = async function () {
                ...
                t && t.notifications_disabled !== e && (await r.gApi.updateUserSettings({ notifications_disabled: e }, !0));
            }),
            (u.prototype._saveBasicSettings = function () {
                var e =
                        r.AUTOSAVE_INTERVALS[
                            parseInt(this._dialog.find('[data-setting="'.concat(s.AUTO_SAVE_INTERVAL_SETTING, '"]')).val())
                        ],
                    t = null;
                ...
                gDesigner.setSetting(
                    ...
                    [
                        ...
                        this._dialog.find('[data-setting="'.concat(s.AUTO_SAVE_SETTING, '"]')).prop("checked"),
                        !this._dialog.find('[data-setting="'.concat(s.DISABLE_WARNING_SETTING_NAME, '"]')).prop("checked"),
                            ...
                            return $("<div/>")
                                ...
                                .on("click", function () {
                                    (gDesigner.stats(
                                        ...
                                        i.GLocale.get(e.localeClass, null, i.GLocaleLanguage.English)
                                    ),
                ...
                var e = gDesigner.getSetting("decimals_num", i.GScene.decimalsNum),
                    t = $("<div/>").append(
                        $("<input>")
                            .attr("type", "text")
                            .css("width", "60px")
                            .css("display", null !== gDesigner.getSetting("decimals_num", i.GScene.decimalsNum) ? "" : "none")
                            ...
                            .on(
                                ...
                                function (e) {
                                    ...
                                    ((t = i.GUtil.parseNumber(t)) < 0 && (t = 0),
                                        t > 6 && (t = 6),
                                        $(e.target).gInputBox("value", null !== t ? i.GUtil.formatNumber(t, 0) : "2"));
                                }.bind(this)
                            )
                        ...
                        $("<label></label>")
                            ...
                            .append(
                                $("<input>")
                                    ...
                                    .prop("checked", null !== gDesigner.getSetting("decimals_num", i.GScene.decimalsNum))
                            )
                            .on(
                                "change",
                                function (e) {
                                    gDesigner.stats("settings_change_decimals-num");
                                    var t = gDesigner.getSetting("decimals_num", i.GScene.decimalsNum),
                                        n = "2";
            ...
            (u.prototype._createAutoSaveSetting = function () {
                ...
                return (
                    ...
                    t.val(r.AUTOSAVE_INTERVALS.indexOf(gDesigner.getSetting(s.AUTO_SAVE_INTERVAL_SETTING, r.AUTOSAVE_INTERVAL_DEFAULT))),
                    [e, t]
                );
            }),
            (e.exports = u));
