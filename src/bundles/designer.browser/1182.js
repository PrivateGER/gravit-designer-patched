                        ...
                        try {
                            ...
                            if (
                                (!this._targetPosition ||
                                    ...
                                    (c = new o.GTransform(1, 0, 0, 1, this._targetPosition.getX() - s, this._targetPosition.getY() - l)),
                                c)
                            )
                            ...
                            a.commitTransaction(o.GLocale.get(new o.GLocaleKey("GPaste", "action.paste")));
                        }
                    }
                }
            }),
