module.exports = function (module, exports, __webpack_require__) {
        "use strict";
        ...
        (_core.GObject.inherit(GToolbar, _core.GObject),
            ...
            (GToolbar.prototype.init = function () {
                ($("<div></div>")
                    ...
                    (this._toolsDiv = $("<div></div>")
                                ...
                                click: function (e) {
                                    (gDesigner.stats("toolbar_click_menu", "shape"),
                                        $(e.target).closest(".toolbar-button").data("tool") && this._initShapeMenu
                                            ? this._activateOrResetTool($(e.target).closest(".toolbar-button").data("tool"))
                                            : $(e.target).closest(".toolbar-button").find("button.dropdown-button").trigger("mousedown"));
                                }.bind(this),
                            })
                        ...
                        .append(
                            this._createLabelButton({
                                ...
                                split: !0,
                                click: () => gDesigner.executeAction(GPlaceImportAction.ID, void 0, "toolbar"),
                                tooltipConfig: GPlaceImportAction.TOOLTIP_CONFIG[_richtooltipconfig.TOOLTIP_AREA.TOOLBAR],
                            ...
                            this._createLabelButton({
                                ...
                                click: () => {
                                    let e = $("<div/>")
                                        ...
                                        .append(
                                            this._textEdit(
                                                $('<textarea rows="30" cols="100" wrap="off" class="custom_button_code">').text(
                                        ...
                                        .append(
                                            $("<div/>")
                                                ...
                                                .append($('<input type="text" class="custom_button_name" value="New custom action">'))
                                        );
                                    (e.gDialog({
                                        releaseOnClose: !0,
                                        ...
                                        ($(".custom_button_code")[0].selectionStart = $(".custom_button_code")[0].selectionEnd =
                    ...
                    $("<div></div>")
                        ...
                        .append(
                            this._createLabelButton({
                                action: gDesigner.getAction(GArrangeAction.ID + "." + _editor.GEditor.ArrangeOrderType.BringForward),
                            })
                        )
                        .append(
                            this._createLabelButton({
                                action: gDesigner.getAction(GArrangeAction.ID + "." + _editor.GEditor.ArrangeOrderType.SendBackward),
                            })
                        )
                        .appendTo(this._htmlElement),
                    $("<div></div>")
                    ...
                    $("<div></div>")
                        ...
                        .append($("<div/>").addClass("share-section").append(this._collaboratorsDiv).append(this._shareButton))
                        .appendTo(this._htmlElement),
                    ...
                    this._updateActions(),
                    gDesigner.getToolManager().addEventListener(_editor.GToolManager.ToolChangedEvent, this._toolChangedEvent, this),
            ...
            (GToolbar.prototype._updateUI = function () {
                ...
                if ((this._htmlElement.toggleClass("g-simple-ui", e), e)) {
                    ...
                    (this._selectSection && (this._selectSection.remove(), (this._selectSection = null)),
                        ...
                        this._commentToggleSection && (this._commentToggleSection.remove(), (this._commentToggleSection = null)));
            }),
            (GToolbar.prototype._networkAvailabilityChangedEvent = function (e) {
                (this._collaboratorsDiv.gCollaborators(e.connected ? GCollaborators.Mode.Online : GCollaborators.Mode.Offline),
                    e.connected
                        ? this._updateShareSection()
                        : gDesigner.getApplicationManager().isSharing() && this._collaboratorsDiv.css("display", ""));
            }),
            (GToolbar.prototype._updatePageButton = function () {
                if (this._pageButton) {
                    const e = gDesigner.getActiveDocument(),
                        t = e && e.getScene();
                    (this._pageButton.gPageButton("scene", t), this._pageButton.css("display", t ? "" : "none"));
                }
            }),
            (GToolbar.prototype._updateShareSection = function () {
                const e = this._isShareButtonVisible(),
                    t = this._isRealtimeCollaboratorsVisible();
                if ((this._shareButton.css("display", e ? "" : "none"), this._collaboratorsDiv.css("display", t ? "" : "none"), e)) {
            ...
            (GToolbar.prototype._isRealtimeCollaboratorsVisible = function () {
                ...
                if (!e.hasPermission(t, _config.SharePermissions.EDIT) && !e.hasPermission(t, _config.SharePermissions.COMMENT)) return !1;
            ...
            (GToolbar.prototype._getRealtimeCollaborators = function () {
                ...
                return _core.GUtil.bubbleSort(
                    (gDesigner.getApplicationManager().getRealtimeCollaborators() || []).filter(
                        (t) => t.getRole().hasPermission(_config.SharePermissions.COMMENT) && !(e && e.getUID() === t.getUID())
                    ),
                    function (e, t) {
                        const n = e.getRole(),
                            o = t.getRole();
                        return n.equals(o) || (!n.is(_config.ShareRoles.CoAuthor) && !o.is(_config.ShareRoles.CoAuthor))
            ...
            (GToolbar.prototype._createOpenMenu = function () {
                ...
                (e.createAddItem(gDesigner.getAction(GOpenAction.ID)),
                    e.createAddItem(gDesigner.getAction("".concat(GGravitCloudAction.ID, ".").concat(GGravitCloudAction.Actions.Open))));
                const t = gContainer.getRecentDocuments();
                if (t && t.length) {
                    e.createAddDivider();
                    const n = e.createAddItem(
                        "".concat(_core.GLocale.get(new _core.GLocaleKey("GFilesPanel", "text.title-recent-files")), ":")
                    );
                    (n.setEnabled(!1),
                        n.addClass("title"),
                        t.forEach((t) => {
            ...
            (GToolbar.prototype._buildAndIncludeItemForState = function (e, t, n, o, i, a, r) {
                const s = o === e.id,
                ...
                return e
                    ...
                    .on("keydown", function (e) {
                        if (9 === e.keyCode) {
                            ...
                            return (
                                (this.value = this.value.substring(0, n) + "\t" + this.value.substring(t, this.value.length)),
                    ...
                    .on("keyup", function (e) {
                        if (13 === e.keyCode) {
                            for (var t, n = "", o = this.selectionStart, i = this.selectionEnd, a = o - 1; a > 0; ) {
                                if ("\n" === this.value.charAt(a)) {
                                    var r = 0;
                                    for (t = a; --a >= 0; )
                                        if ("\n" === this.value.charAt(a)) {
                            ...
                            ((this.value = this.value.substring(0, o) + n + this.value.substring(i, this.value.length)),
                            ...
                            t.createAddItem(
                                ...
                                function () {
                                    ...
                                    let t = $("<div/>")
                                        ...
                                        .append(
                                            myself._textEdit(
                                                $('<textarea rows="30" cols="100" class="custom_button_code_edit">').text(e.code)
                                            )
                                        )
                                        .append(
                                            $("<div/>")
                                                .append("<label>Name:</label>")
                                                .append($('<input type="text" class="custom_button_name_edit" value="' + e.name + '">'))
                                        );
                                    (t.gDialog({
                                        releaseOnClose: !0,
                                        className: "context-pane",
            ...
            (GToolbar.prototype._initZoomButton = function () {
                ...
                (e.createAddItem(gDesigner.getAction(GOriginalViewAction.ID)),
                    ...
                    $("<span></span>").addClass("gravit-icon-zoom-in icon").insertBefore(this._zoomButton.find(".caption")),
                    this._zoomButton
                        .find(".action-button")
                        .gRichTooltip(
                            _richtooltipconfig.GRichTooltipConfig.from({
                                title: _core.GLocale.get(new _core.GLocaleKey("GToolbar", "text.zoom-button-tooltip-title")),
                            })
                        )
                    ...
                    $("<div />")
                        ...
                        .html([
                            $("<input />")
                                ...
                                .attr("max", GMagnificationAction.ZOOM_LEVELS[GMagnificationAction.ZOOM_LEVELS.length - 1])
                                .on("blur", () => {
                                    $(this).data("keydown") ||
            ...
            (GToolbar.prototype._activateOrResetTool = function (e, t) {
                ...
                (!a || a.isToolAllowed(o) || a.isDeactivatable()) &&
                    (e && gDesigner.stats("toolbar_activate_tool", GToolbar.getToolName(e)), n.activateTool(o, null, !0));
            }),
                ...
                this._htmlElement.find(".toolbar-button").each(
                    function (e, t) {
                        var o = $(t),
                            i = o.data("tool"),
                            a = o.data("tool-group");
                        if (("shape" === a && n && "shape" === n.group && (this._initShapeMenu = !0), i)) {
                            if (a && n && n.group === a) {
                                i = n.tool;
            ...
            (GToolbar.prototype._updateIcon = function (e, t) {
                t && "<svg" === t.substr(0, 4)
                    ? (e.empty(),
                      e.attr("class", "icon"),
                      e.append($(t).attr({ width: "16px", height: "16px" }).css("stroke", "transparent").css("vertical-align", "middle")))
            ...
            (GToolbar.prototype._settingChangedEvent = function (e) {
                "snap_disabled" === e.key
                    ? this._htmlElement.find(".snap-button > .action-button").toggleClass("g-active", !1 === e.newValue)
                    : "touch" === e.key && (gDesigner.isTouchEnabled() ? this._updateTouchUI() : this._updateDesktopUI());
            }),
            (GToolbar.prototype._updateDesktopUI = function () {
                const e = this._htmlElement.find(".view-section > .zoom-button");
                (e.is(this._zoomButton) ||
                    ((this._zoomButton = null), this._initZoomButton(), e.replaceWith(this._zoomButton), this._updateZoomFromWindow(!0)),
                    this._pageButton &&
            ...
            (GToolbar.prototype._documentEvent = function (e) {
                ...
                switch (e.type) {
                    case GDocumentEvent.Type.Activated:
                        (t &&
                            t.getEditor() &&
                            t.getEditor().addEventListener(_editor.GEditor.SelectionChangedEvent, this._selectionChangedEvent, this),
                            this._updatePageButton(),
                            this._updateActions(),
                            this._updateContextTools());
                        break;
                    case GDocumentEvent.Type.Deactivated: {
                        (t &&
                            t.getEditor() &&
                            t.getEditor().removeEventListener(_editor.GEditor.SelectionChangedEvent, this._selectionChangedEvent, this),
                            this._updatePageButton(),
                            this._updateActions(),
                            this._updateContextTools());
                        const e = gDesigner.getToolManager();
            ...
            (GToolbar.prototype._windowEvent = function (e) {
                ...
                switch (e.type) {
                    case GWindows.WindowEvent.Type.Activated:
                        (t && t.addEventListener(_client.GSceneWidget.TransformEvent, this._updateZoomFromWindow, this),
                            this._updateZoomFromWindow(),
                            this._updateContextTools());
                        break;
                    case GWindows.WindowEvent.Type.Deactivated:
                        (t && t.removeEventListener(_client.GSceneWidget.TransformEvent, this._updateZoomFromWindow, this),
                            this._updateZoomFromWindow(),
                            this._updateContextTools());
                }
            ...
            (GToolbar.prototype._updateZoomFromWindow = function () {
                ...
                if (t && t.getView()) {
                    ...
                    (this._currentZoomLevel !== n || e) &&
                        (this._htmlElement.find(".zoom-button > .action-button .caption").text(n.toString() + "%"),
            ...
            (GToolbar.prototype._createToolItems = function (e, t) {
                ...
                return (
                    gravit.tools.forEach((o, i) => {
                        if (o.group === e)
                            if ((n !== o.category && (i > 0 && t.createAddDivider(), (n = o.category)), "simpleshape" === n))
                                ...
                                (a.setCaption(o.title),
                                    ...
                                    a.addEventListener(GMenuItem.ActivateEvent, () => {
                                        (o && o.title && gDesigner.stats("toolbar_activate_tool", GToolbar.getToolName(o.tool)),
            ...
            (GToolbar.prototype._createLabelButton = function (e) {
                ...
                (n && c.addClass(n), e.action && c.attr("data-action", e.action.getId()).data("action", e.action));
                var d = $("<button></button>")
                ...
                if (
                    ...
                    if (
                        (e.split
                            ...
                            : (u = d.addClass("menu").append($("<span></span>").addClass("gravit-icon-down dropdown-icon"))),
                        e.menu
                            ? u.gMenuButton({
                                  menu: e.menu,
                                  dblclick: a,
                        ...
                        (_config.IS_COREL
                            ? u.attr(
                                  "data-title",
                                  _core.GLocale.get(new _core.GLocaleKey("GToolbar", "text.undoList-button-tooltip-title"))
                              )
                            : u.gRichTooltip(
                                  _richtooltipconfig.GRichTooltipConfig.from({
                                      title: _core.GLocale.get(new _core.GLocaleKey("GToolbar", "text.undoList-button-tooltip-title")),
            ...
            (GToolbar.prototype.createSimpleShapesMenu = function (e) {
                var t = function (e) {
                        ...
                        if (n) {
                            ...
                            var l = (s = new _core.GVertexTransformer(s, new _core.GTransform(1, 0, 0, 1, 1, 1))).toSVGPath();
                            l &&
                                (t =
                        ...
                        return (
                            ...
                            $("<button></button>")
                                ...
                                .on(
                                    ...
                                    function (n) {
                                        (n.preventDefault(),
                                            gDesigner.getToolManager().activateTool(_editor.GSimpleShapeTool, t, !0),
            ...
            (GToolbar.prototype._createSnapMenu = function () {
                ...
                return (
                    ...
                    e.createAddItem(gDesigner.getAction(GToggleGuideAction.ID + "." + _editor.GGuideLinesGuide.ID)),
                    e.createAddItem(gDesigner.getAction(GToggleGuideAction.ID + "." + _editor.GFullPixelsGuide.ID)),
            ...
            (GToolbar.prototype.setEnabled = function (e) {
                $(".toolbar-button > button")[e ? "removeClass" : "addClass"]("g-disabled").prop("disabled", !e);
            }),
