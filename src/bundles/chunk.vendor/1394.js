            ...
            ((H.prototype.gfx = null),
                ...
                (H.prototype.clip = function () {
                    if (this._consumePath()) {
                        var e = this._clipping.getLastChild(),
                            t = e.getPrevious(),
                            i = e;
                        (t && H.VertexSource.equals(e, t) && (this._clipping.removeChild(e), (i = t)),
                            (this._clipping = i),
                            (this._currentClip = i));
                    }
                }),
                ...
                (H.prototype._putChar = function (e, t, i, n, r) {
                    if (this._isDisplayedCharacter(e)) {
                            ...
                            for (var A, c, p = this.gfx.current.font.fontMatrix[0] * s, d = 0; d < " -1iI".length && !h; d++)
                                ((c = this.gfx.current.font.toFontChar[" -1iI".charCodeAt(d)]),
                                    (h = (A = this.gfx.current.font.widths[c])
                                        ? A * p + this.gfx.current.charSpacing * this.gfx.current.fontDirection
                        ...
                        ((f.text = x.deCRLFify(e)),
                            ...
                            (f.spaceWidth = h),
                            Math.round(1e5 * this._transform.getScaleFactor()) / 1e5 !== f.fontSizeScale &&
                                (f.width *= 1 / f.fontSizeScale),
                            (f.startPoint = this._transform.preMultiplied(new E().translated(t, i)).getTranslation()),
                        ...
                        ((f.fontFamily = m.otf.getFamily()),
                            ...
                            r === U
                                ...
                                : (delete f.fontColor,
                                  (f.borderColor = this._getPattern(this.strokeStyle || "rgb(0,0,0)")),
                ...
                (H.prototype.drawImage = function (e, t, i, n, r, o, a, s, l) {
                    ...
                    if (e instanceof HTMLCanvasElement) {
                        var h,
                            A = this._transform.preMultiplied(new E().scaled(n / s, r / l)).preMultiplied(new E().translated(o, a)),
                            c = 1e8 / (e.width * e.height);
                        if (c < 1)
                            ((c = Math.sqrt(c)),
                                ((h = document.createElement("canvas")).width = e.width * c),
                                (h.height = e.height * c),
                                h.getContext("2d").drawImage(e, 0, 0, e.width, e.height, 0, 0, h.width, h.height),
                                (e = h),
                        ...
                        if (
                            ...
                            this._clipping === this._currentClip && 0 === this._clipping.getChildren().length)
                        ) {
                            var p = s || n,
                                u = l || r,
                            ...
                            for (var y = e.context._root.getFirstChild(); y; ) {
                                ...
                                (e.context._root.removeChild(y),
                                    y instanceof T &&
                                        n &&
                                        r &&
                                        y.transform(new E().multiplied(new E().scaled(n / s, r / l)).multiplied(new E().translated(o, a))),
                ...
                (H.prototype.stroke = function (e) {
                    if (this._consumePath() || e) {
                        ...
                        (o instanceof Z && (o = o.createGPattern(this._transform, t.getGeometryBBox())),
                            ...
                            try {
                                ...
                                if (r) {
                                    ((t = r._openTypeFont.names.fontFamily
                                        ...
                                        (n = I.Font.getStyle(r._openTypeFont.names.fontSubfamily.en)),
                                        (i = I.Font.getWeight(r._openTypeFont.names.fontSubfamily.en)));
                                    var a = y.contains(t);
                                    if (!a) {
                                    ...
                                    if (a) ((e.otf = this._fontManager.getFont(t, n, i)), (e.supported = true));
                                        ...
                                        (r && (this._embeddedFonts.push(r), this._fontManager.getFonts().push(r)),
                                            this._missingFonts.push(l));
                                    }
                                } else console.log("WARN: Unsupported font: " + this.gfx.current.font.name);
                            } catch (e) {
                ...
                (H.VertexSource = {
                    ...
                    readVertices: function (e) {
                        var t = [];
                        if (e.rewindVertices(0)) for (var i = new S(); e.readVertex(i); ) t.push(i);
                        return t;
                    },
                }),
                ...
                (Z.prototype.createGPattern = function (e, t) {
                    ...
                    if (!s) return this instanceof z ? new n(this._stops) : this instanceof j ? new p(this._stops) : null;
