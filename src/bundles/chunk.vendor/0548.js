module.exports = function (e, t, i) {
            ...
            (o.inherit(A, n),
                ...
                (A.prototype.deactivate = function (e, t) {
                    (t || (this.setEditMode(n.EditMode.Select), this._styleEdManager && this._styleEdManager.deactivate()),
                        ...
                        t ||
                            ...
                            (a.selectDoubleClickBehavior == n._DblClick.EditModeSwitch
                                ? (((this._clickedElement && this._clickedElement.hasFlag(r.Flag.Selected)) ||
                                      ...
                                      this.setEditMode(this._editMode === n.EditMode.Edit ? n.EditMode.Select : n.EditMode.Edit),
                                  (t = !0))
                                : a.selectDoubleClickBehavior == n._DblClick.SubSelectSwitch && ((t = !0), this._manager.activateTool(l))),
                        t
                    );
                }),
