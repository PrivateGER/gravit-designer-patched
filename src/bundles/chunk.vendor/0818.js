            ...
            ((r.ColorMap = function () {}),
                ...
                (r.ColorMap.prototype.getFirstOfColor = function (e) {
                    if (e >= r.ColorMap.Colors.White && e <= r.ColorMap.Colors.Black)
                        for (var t = this._colorMap[e], i = 0; i < t.length; ++i) if (t[i]) return t[i];
                    return null;
                }),
                (r.ColorMap.prototype.getItemsOfColor = function (e) {
                    var t = [];
                    if (e >= r.ColorMap.Colors.White && e <= r.ColorMap.Colors.Black)
                        for (var i = this._colorMap[e], n = 0; n < i.length; ++n) i[n] && t.push(i[n]);
                    return t;
                }),
                (r.ColorMap.prototype.getIdxItemsOfColor = function (e) {
                    var t = [];
                    if (e >= r.ColorMap.Colors.White && e <= r.ColorMap.Colors.Black)
                        for (var i = this._colorMap[e], n = 0; n < i.length; ++n) i[n] && t.push(n);
                    return t;
                }),
                (r.ColorMap.prototype.clearItemsOfColor = function (e) {
                    if (e >= r.ColorMap.Colors.White && e <= r.ColorMap.Colors.Black)
                        for (var t = this._colorMap[e], i = 0; i < t.length; ++i) t[i] && (t[i] = null);
                }),
                (r.prototype._edges = {}),
                ...
                (r.prototype.dfsPartitioner = function (e, t, i, n) {
                    ...
                    if (a && s) {
                        ...
                        for (var h = n || o.getFirstOfColor(r.ColorMap.Colors.White); h; ) {
                            ...
                            i && i(u, p);
                            for (var d = 0; d < u.length; ++d) o.setColor(u[d], r.ColorMap.Colors.Black);
                            for (d = 0; d < p.length; ++d) l.setColor(p[d], r.ColorMap.Colors.Black);
                ...
                (r.prototype._getInternalMapAsArray = function (e) {
                    for (var t = Object.keys(e), i = new Array(t.length), n = 0; n < t.length; ++n) i[n] = e[t[n]];
                    return i;
                }),
