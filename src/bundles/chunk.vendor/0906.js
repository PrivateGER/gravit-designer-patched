            ...
            e.exports = function (e) {
                ((e.Effect = function () {
                    ...
                    (e.Effect.prototype._handleChange = function (t, i) {
                        if (t === n._Change.Store) this.storeProperties(i.blob, e.Effect.GeometryProperties);
                        else if (t === n._Change.Restore) this.restoreProperties(i.blob, e.Effect.GeometryProperties);
                        ...
                        (this._handleGeometryChangeForProperties(t, i, e.Effect.GeometryProperties),
