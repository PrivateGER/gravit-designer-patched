module.exports = function (e, t, i) {
            ...
            (n.inherit("compoundpath", g, o),
                ...
                (g.Paths.prototype.serialize = function () {
                    ...
                    for (var t = this.getFirstChild(); null !== t; t = t.getNext()) e.push(n.serialize(t));
                    return e;
                }),
                ...
                (g.prototype.readVertex = function (e) {
                    return (
                        ...
                        (!!this._currentPath.readVertex(e) ||
                            ((this._currentPath = this._currentPath.getNext()), this._currentPath && this._currentPath.readVertex(e)))
                    );
                }),
                ...
                (g.prototype.getSubnodeIds = function (e) {
                    (o.prototype.getSubnodeIds.call(this, e),
                        this._paths &&
                            (e[this._paths.getMultireferenceId()] && this._paths.resetMultireference(),
                ...
                (g.prototype._referenceEvent = function (e) {
                    if (e.target === this) {
                        ...
                        e.reference instanceof c.AnchorPoint &&
                            ...
                            (e.reference.getPath().attachPath(e.reference, t ? this : null), o.prototype._referenceEvent.call(this, e));
                    }
                }),
                ...
                (g.prototype._handleChange = function (e, t) {
                    if ((this._handleVisualChangeForProperties(e, t, g.VisualProperties), e === n._Change.Store)) {
                        ...
                        (this.restoreProperties(t.blob, g.MetaProperties),
                            ...
                            t.blob.hasOwnProperty("paths") && this._paths.deserialize(t.blob.paths),
                        ...
                        if (t.properties.indexOf("refs") >= 0) this._scene || (this._delayedRefresh = !0);
                            ...
                            for (r = this._paths.getFirstChild(); null != r; r = r.getNext())
                                (r._beginBlockChanges([n._Change.BeforePropertiesChange, n._Change.AfterPropertiesChange]),
                                    r.setProperty("csc", this.getProperty("csc"), t.custom, t.forceEvent, t.temporary),
                                    r._endBlockChanges([n._Change.BeforePropertiesChange, n._Change.AfterPropertiesChange]));
                    if (
                        ...
                        for (r = this._currentPath; null != r; r = r.getNext()) r.setFlag(a.flag);
                    } else if (e == n._Change.BeforeFlagChange && !t.set) {
                        a = t;
                        this._currentPath = this._paths.getFirstChild();
                        for (r = this._currentPath; null != r; r = r.getNext()) r.removeFlag(a.flag);
                    }
                }),
                ...
                (g.prototype.setTransform = function (e) {
                    ...
                    for (var t = this._paths.getFirstChild(); null != t; t = t.getNext()) t.setTransform(e);
                }),
                ...
                (g.prototype.transform = function (e, t, i) {
                    ...
                    try {
                        if ((o.prototype.transform.call(this, e, t, i), e && !e.isIdentity()))
                            for (var r = this._paths.getFirstChild(); null != r; r = r.getNext()) r.transform(e);
                        this._scene &&
                            this._scene.visitReferences(
                                this,
                                function (e) {
                ...
                (g.prototype._checkPartialCollision = function (e, t, i, n, r, a) {
                    ...
                    if (s && h) return o.prototype._checkPartialCollision.call(this, e, t, i, n, r, a);
                    if (e.intersectsRect(t, n)) {
                        var A = 0 != (r & l.CollisionFlag.PaintBBox),
                            c = h ? u.RETRIEVE_MODE_FULLYCONTAINED : u.RETRIEVE_MODE_INTERSECT,
                            p = A ? this._paths.retrieveChildrenInPaintBBox(e, c) : this._paths.retrieveChildrenInGeometryBBox(e, c);
                        if (p) {
                            var d = 0;
                            if (s);
                                ...
                                for (m = 0; m < g.length; m++) if (!g[m].containsArea) return void a(this);
                            } else {
                ...
                (g.prototype._beginBlockEvents = function (e) {
                    ...
                    for (var t = this._paths.getFirstChild(); null != t; t = t.getNext()) t._beginBlockEvents(e);
                }),
                (g.prototype._endBlockEvents = function (e) {
                    n.prototype._endBlockEvents.call(this, e);
                    for (var t = this._paths.getFirstChild(); null != t; t = t.getNext()) t._endBlockEvents(e);
                }),
