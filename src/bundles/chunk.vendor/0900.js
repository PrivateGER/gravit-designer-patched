            ...
            e.exports = function (e) {
                ((e.PaintLayer = function (t, i, n, r) {
                    (this._setDefaultProperties(e.PaintLayer.GeometryProperties, e.PaintLayer.VisualProperties),
                        this.setProperties(
                            ["_pt", "_vs", "_op", "_bl"],
                            [t, void 0 === n || n, void 0 === i ? 1 : i, void 0 === r ? o.BlendMode.Normal : r]
                        ));
                }),
                    n.inheritAndMix("paintLayer", e.PaintLayer, r, [n.Properties, n.Store]),
                    ...
                    (e.PaintLayer.prototype.assignFrom = function (t) {
                        (t instanceof e.PaintLayer &&
                            this.transferProperties(t, [e.PaintLayer.VisualProperties, e.PaintLayer.GeometryProperties]),
                    ...
                    (e.PaintLayer.prototype._handleChange = function (t, i) {
                        if (t === n._Change.Store)
                            ...
                            (this.restoreProperties(i.blob, e.PaintLayer.GeometryProperties, o),
                                this.restoreProperties(i.blob, e.PaintLayer.VisualProperties, o));
                        ...
                        } else t === r._Change.SceneAttached && this.$_pt instanceof s && this.$_pt.setScene(this._scene);
                        (this._handleVisualChangeForProperties(t, i, e.PaintLayer.VisualProperties),
                            this._handleGeometryChangeForProperties(t, i, e.PaintLayer.GeometryProperties),
                    ...
                    (e.PaintLayer.prototype.getBlendingForContext = function (e) {
                        return this.$_bl === o.BlendMode.Normal || (e.configuration.noWebGL && this.$_bl in o.WebGLBlendMode)
                            ? null
                            : this.$_bl;
                    }));
            };
