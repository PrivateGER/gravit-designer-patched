module.exports = function (e, t, i) {
            ...
            (n.inheritAndMix("image", x, p, [B]),
                ...
                (x.prototype._calculateGeometryBBox = function (e) {
                    var t = null;
                    if (this._status === x.ImageStatus.Loaded) t = p.prototype._calculateGeometryBBox.call(this, e);
                    else {
                ...
                (x.prototype.transform = function (e, t, i) {
                    this.$dblMode
                        ...
                        : e &&
                          ...
                          this.setProperties(
                              ["trf", "itrf"],
                              [this.$trf ? this.$trf.multiplied(e) : e, this.$itrf ? this.$itrf.multiplied(e) : e]
                          ),
                ...
                (x.prototype.assignPreTransformFrom = function (e, t) {
                    if (t instanceof x) {
                        ...
                        this.setProperties(["trf", "itrf"], [e.multiplied(i), e.multiplied(n)]);
                ...
                (x.prototype.setBounds = function (e, t, i, n) {
                    if (!this.$dblMode) {
                        var r = i > d.Transform.MinimalDimention ? i : d.Transform.MinimalDimention,
                            o = n > d.Transform.MinimalDimention ? n : d.Transform.MinimalDimention,
                            a = this.getGeometryBBox(),
                            s = a.getWidth(),
                            l = a.getHeight(),
                            h = s > 0 ? r / s : 0,
                            A = l > 0 ? o / l : 0,
                            c = new g().translated(-a.getX(), -a.getY()).scaled(h, A).translated(e, t);
                        c.isIdentity() ||
                            this.setProperties(
                                ["trf", "itrf"],
                                [this.$trf ? this.$trf.multiplied(c) : c, this.$itrf ? this.$itrf.multiplied(c) : c]
                            );
                    }
                }),
                    ...
                    if (this._imageCanvas) {
                        ...
                        for (
                            var h,
                                ...
                                d = this._imageCanvas.getContext("2d").getImageData(s - i, l - i, u, u),
                                f = d ? d.data : [0, 0, 0],
                                y = Number.MAX_VALUE,
                                _ = NaN,
                                v = 3;
                            ...
                            0 !== f[v] &&
                                (h = (i - (A = (v >> 2) % u)) * (i - A) + (i - (c = (v >> 2) / u)) * (i - c)) < y &&
                                ((y = h), (_ = v));
                        if (Math.sqrt(y) > i) return null;
                        r = f.slice(_ - 3, _ + 1);
                    } else this._status === x.ImageStatus.Loaded && this._image && (r = [0, 0, 0, 255]);
                ...
                (x.prototype._handleChange = function (e, t) {
                    (e === n._Change.Store
                        ? (this.storeProperties(t.blob, x.VisualProperties, function (e, t) {
                        ...
                        e === n._Change.Restore &&
                            ...
                            this.restoreProperties(t.blob, x.GeometryProperties, function (e, t) {
                ...
                (x.prototype._updateUrl = function () {
                    if (this._scene) {
                        ...
                        if (
                            (this.$storedUrl
                                ? e
                                    ? e !== this.$storedUrl && (b.isDictionary(e) ? (this.$storedUrl = e) : (e = this.$storedUrl))
                            ...
                            i &&
                                (null === e &&
                                    (this._status !== x.ImageStatus.Loaded || this._imageCanvas
                                        ? ((this._imageCanvas = null), (this._imageCanvasOffscreen = null))
                                        : ((this._image = null), (this._imageCanvasOffscreen = null))),
                                this.setProperty("url", i.getUrl()));
                        }
                    }
                }),
                (x.prototype._paintFillLayers = function (e, t, i) {
                    (this.$ipfc && !e.configuration.isOutline(e) && this._paintImageCanvas(e, e.canvas, null, null),
                        y.each(
                            i,
                            function (i, n) {
                ...
                (x.prototype._getProperImageCanvas = function (e) {
                    if (E.isMultiThreaded(e.canvas.parent)) {
                        ...
                        this._imageCanvas
                            ...
                            : ((t = this._image.naturalWidth), (i = this._image.naturalHeight));
                        ...
                        (this.$itrf && e.canvas.setTransform(s.preMultiplied(this.$itrf)),
                            ...
                            r
                                ...
                                : (void 0 !== e.canvas.putVertices(this) &&
                                      (e.canvas.fillVertices(a.BLACK, 1, u.CompositeOperator.DestinationIn), o.drawCanvas(e.canvas)),
                                  e.canvas.finish(),
                                  e.popCanvas()),
                            this.$dblMode &&
                                ((s = t.getTransform(!0)),
                ...
                (x.prototype.getWidth = function () {
                    return this._status === x.ImageStatus.Loaded && (this._image || this._imageCanvas)
                        ? this._imageCanvas
                    ...
                    ((this._sourceBBox = null),
                        this._workspace && this._scene && this.$url
                            ? (this._setStatus(x.ImageStatus.Resolving),
                              this._workspace.resolveUrl(this.$url, this._resolvedImage.bind(this), this.getScene()))
                            : this._setStatus(x.ImageStatus.Delayed));
                }),
                (x.prototype.forceImageUpdate = function () {
                    this.$url &&
                        0 === this.$url.indexOf("data:") &&
                        (this._setStatus(x.ImageStatus.Resolving), this._resolvedImage(this.$url));
                }),
                ...
                (x.prototype._resolvedImage = function (e) {
                    ...
                    if (t && t.cachedCanvas) this._updatedImage(t.cachedCanvas);
                        ...
                        if (this._image && this._image.url === e) this._updatedImage();
                            ...
                            if (n && e.length > w.maxImgDataUrlLength) this._setStatus(x.ImageStatus.Error);
                                ...
                                try {
                                    ...
                                    for (var A = 0, c = r.length; A < c; A++) o[A] = r.charCodeAt(A);
                                } catch (e) {
                                    return void this._setStatus(x.ImageStatus.Error);
                                }
                ...
                (x.prototype._updatedImage = function (e) {
                    ...
                    if (!n || (n !== this._imageCanvas && n !== this._image)) {
                        if (
                            ...
                            if (
                                (this.setProperties(["ih", "iw", "pw", "ph"], [i, t, this.$pw ? this.$pw : t, this.$ph ? this.$ph : i]),
                                ...
                                var o = this.$pw > d.Transform.MinimalDimention ? this.$pw : d.Transform.MinimalDimention,
                                    a = this.$ph > d.Transform.MinimalDimention ? this.$ph : d.Transform.MinimalDimention,
                                    s = t > 0 ? o / t : 0,
                                    l = i > 0 ? a / i : 0,
                    ...
                    if (this._type === x.Type.JPEG && this._imageCanvas) {
                        var n = function (e) {
                            var t = this._imageCanvas.getContext("2d"),
                                i = t.createImageData(this._imageCanvas.width, this._imageCanvas.height);
                ...
                (x.prototype._setStatus = function (e) {
                    e !== this._status &&
                        ((this._status = e), this._canEventBeSent(x.StatusEvent) && this._sendEvent(new x.StatusEvent(this, this._status)));
                }),
                (x.prototype._setConvertStatus = function (e) {
                    e !== this._convertStatus &&
                        ((this._convertStatus = e),
                        this._canEventBeSent(x.ConvertStatusEvent) && this._sendEvent(new x.ConvertStatusEvent(this, this._convertStatus)));
                }),
                ...
                (x.prototype._initImageCanvas = function (e) {
                    if ("undefined" != typeof HTMLCanvasElement && e instanceof HTMLCanvasElement) {
                        ...
                        (this._imageCanvas || (this._imageCanvas = document.createElement("canvas")),
                ...
                (x.prototype.toFit = function (e) {
                    ...
                    if (
                        t &&
                        i &&
                        ((i *= n = this.getTransform() ? this.getTransform().getScaleFactor() : 1),
                ...
                (x.prototype.assignFrom = function (e) {
                    (e instanceof x && this.transferProperties(e, [x.GeometryProperties, x.VisualProperties, x.MetaProperties]),
