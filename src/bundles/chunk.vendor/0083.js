module.exports = function (module, exports, require) {
            ...
            (r.inheritAndMix("page", E, l, [r.Container, p.Transform, p.Layout, p.Accelerated, r.Reference, l.LabelHolder]),
                        ...
                        (i || !this.$off || m.pagesPerRow) &&
                            this._scene.iteratePages(
                                function (e) {
                                    ...
                                    g++ % d == 0
                                        ? ((h = 0), (c += Math.min(f, e.$h + Math.min(0, v.getY())) + r), (f = Number.MAX_VALUE))
                                        : ((h += e.$w + o + Math.min(0, v.getX())), (f = Math.min(f, e.$h + Math.min(0, v.getY()) + r)));
                                }.bind(this)
                            ),
                        (p = h),
                        (u = c),
                        this.$off && ((_ = this.$off.getTranslation()), (p += _.getX()), (u += _.getY())));
                            ...
                            C(
                                function (e, t) {
                                    ...
                                    if (i.getWidth() > i.getHeight())
                                        return new A(
                                            p,
                                            t.getY() + e.$h + r + r + this._scene.$lbp * this.getScaleLabelFactor(),
                                            this.$w,
                                            this.$h
                                        );
                                }.bind(this)
                ...
                (E.prototype.getPaintBBox = function (e, t, i, n) {
                    return i || this.isVisible()
                        ? t || i
                            ...
                            : (null == this._paintBBox && (this._paintBBox = this._calculatePaintBBox(null, i, n)), this._paintBBox)
                        : null;
                }),
                (E.prototype._calculateGeometryBBox = function (e) {
                    if (this.isFixedSized()) return new A(this.$x, this.$y, this.$w, this.$h);
                ...
                (E.prototype._calculatePaintBBox = function (e, t, i) {
                    ...
                    return (
                        e && e instanceof A
                            ? (this._screen = e)
                            : e && !this._screen && this._scene && (this._screen = this._scene.getScreenBox()),
                    ...
                    if ((this.hasAnnotations() && this._getAnnotations().paint(e), p.Accelerated.PAINT_QTREES)) {
                        ...
                        this.acceptChildren(function (t) {
                            if (t.hasMixin(p.Accelerated)) {
                                for (var i = 1, n = t; n.getParent() !== r; ) ((n = n.getParent()), i++);
                    ...
                    if (
                        (this._scene.isLinked(this, i)
                            ...
                            : ((i = this._scene.getProperty("empg")),
                              this._scene.isLinked(this, i)
                                  ? (t = i)
                                  : ((i = this._scene.getProperty("ompg")), this._scene.isLinked(this, i) && (t = i))),
                        t)
                    ) {
                ...
                (E.prototype._referenceEvent = function (e) {
                    e.target === this &&
                        ...
                        (this._requestInvalidation(), l.prototype._referenceEvent.call(this, e));
                }),
                (E.prototype.isPaintable = function (e, t) {
                    ...
                    if (
                        null ==
                            (i =
                                !e.configuration.multiPageView && e.configuration.isClipToPage() && this.isFixedSized()
                ...
                (E.prototype._getMasterPageClipRectForPage = function (e, t) {
                    var i = null;
                    return (
                        (i = this.isFixedSized() ? new A(this.$x, this.$y, this.$w, this.$h) : this.getPaintBBox(null, e, t)),
                        this._scene &&
                                    ...
                                    if (e.configuration.multiPageView && m.pagesCanOverlap)
                                        if (
                                            ...
                                            var B = e.configuration.pageDecoration,
                                                ...
                                                P = B.shadowOffsetY || 0;
                                            ((i._canvasContext.shadowColor = B.shadowBackground || "rgba(0,0,0,0.5)"),
                ...
                (E.prototype._handleChange = function (e, t) {
                    if (e === r._Change.Store)
                        ...
                        e == r._Change.AfterChildInsert
                            ? t instanceof w &&
                              (this._notifyChange(p._Change.ChildGeometryUpdate, [t, 1]), t._handleChange(p._Change.InvalidationRequest))
                    ...
                    if (
                        (this._handleGeometryChangeForProperties(e, t, E.GeometryProperties),
                ...
                (E.prototype.doCollisionlessTransform = function (e, t, i) {
                    ...
                    if (!h) return e;
                    if (this.isScaleLabel()) a = s = (7 + n.$lbs + n.$lbp) * y.getScreenDPI();
                    else {
                ...
                (E.prototype.assignFrom = function (e) {
                    (e instanceof E && this.transferProperties(e, [E.GeometryProperties, E.VisualProperties]),
