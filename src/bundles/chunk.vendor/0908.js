            ...
            module.exports = function (e) {
                ((e.Transform = function () {}),
                    ...
                    (e.Transform.prototype.setBounds = function (t, i, n, o) {
                        var a = n > e.Transform.MinimalDimention ? n : e.Transform.MinimalDimention,
                            s = o > e.Transform.MinimalDimention ? o : e.Transform.MinimalDimention,
                            l = this.getGeometryBBox(),
                            h = l.getWidth(),
                            A = l.getHeight(),
                            c = h > 0 ? a / h : 0,
                            p = A > 0 ? s / A : 0,
                            u = new r().translated(-l.getX(), -l.getY()).scaled(c, p).translated(t, i),
                            d = this.getTransform();
                    ...
                    (e.Transform.prototype.preTransform = function (e, t, i) {
                        if (this.isTransformChildren(e, t)) {
                            var n = this.getProperty("trf"),
                                r = n && n.invertible() ? n.inverted().multiplied(e).multiplied(n) : e;
