module.exports = function (module, exports, require) {
            ...
            ((o.Side = {
                ...
                (o.prototype.scaledAt = function (e, t, i) {
                    return i
                        ? new o((this._x - i.getX()) * e + i.getX(), (this._y - i.getY()) * t + i.getY(), this._width * e, this._height * t)
                        : this.scaled(e, t);
                }),
                (o.prototype.united = function (e, t) {
                    var i = this._x,
                        n = this._x;
                    if ((this._width < 0 ? (i += this._width) : (n += this._width), t && i == n)) return e;
                    var r = e._x,
                        a = e._x;
                    if ((e._width < 0 ? (r += e._width) : (a += e._width), t && r == a)) return this;
                    var s = this._y,
                        l = this._y;
                    if ((this._height < 0 ? (s += this._height) : (l += this._height), t && s == l)) return e;
                    var h = e._y,
                        A = e._y;
                    if ((e._height < 0 ? (h += e._height) : (A += e._height), t && h == A)) return this;
                    var c = new o();
                    return (
                        (c._x = Math.min(i, r)),
                        (c._y = Math.min(s, h)),
                ...
                (o.prototype.subtracted = function (e, t) {
                    var i = this._x,
                        n = this._x;
                    if ((this._width < 0 ? (i += this._width) : (n += this._width), i == n)) return new o(0, 0, 0, 0);
                    var r = e._x,
                        a = e._x;
                    if ((e._width < 0 ? (r += e._width) : (a += e._width), r == a))
                        return new o(this._x, this._y, this._width, this._height);
                    if (i >= a || r >= n) return new o(this._x, this._y, this._width, this._height);
                    var s = this._y,
                        l = this._y;
                    if ((this._height < 0 ? (s += this._height) : (l += this._height), s == l)) return new o(0, 0, 0, 0);
                    var h = e._y,
                        A = e._y;
                    return (
                        e._height < 0 ? (h += e._height) : (A += e._height),
                        h == A || s >= A || h >= l || (s >= h && l <= A && i < r && n > a) || (i >= r && n <= a && s < h && l > A)
                              ...
                              ? l <= A
                                  ? i >= r
                                      ...
                                      : n <= a
                                        ? new o(i, s, r - i, l - s)
                                        : t
                                          ? [new o(i, s, r - i, this._height), new o(i, s, n - a, this._height)]
                                          : new o(i, s, this._width, this._height)
                                  : i >= r
                                    ? n <= a
                                        ? new o(i, A, this._width, l - A)
                                        : t
                                          ? [new o(i, A, a - i, l - A), new o(a, s, n - a, this._height)]
                                          : new o(i, s, this._width, this._height)
                                    : n <= a
                                      ? t
                                          ? [new o(i, s, r - i, this._height), new o(r, A, n - r, l - A)]
                                          : new o(i, s, this._width, this._height)
                                      : t
                                        ? [new o(i, s, r - i, this._height), new o(r, A, a - r, l - A), new o(a, s, n - a, this._height)]
                                        : new o(i, s, this._width, this._height)
                              : l <= A
                                ? i >= r
                                    ? n <= a
                                        ? new o(i, s, n - i, h - s)
                                        : t
                                          ? [new o(i, s, a - i, h - s), new o(a, s, n - a, this._height)]
                                          : new o(i, s, this._width, this._height)
                                    : n <= a
                                      ? t
                                          ? [new o(i, s, r - i, this._height), new o(r, s, n - r, h - s)]
                                          : new o(i, s, this._width, this._height)
                                      : t
                                        ? [new o(i, s, r - i, this._height), new o(r, s, a - r, h - s), new o(a, s, n - a, this._height)]
                                        : new o(i, s, this._width, this._height)
                                : t
                                  ? i >= r
                                      ? n <= a
                                          ? [new o(i, s, n - i, h - s), new o(i, A, n - i, l - A)]
                                          : [new o(i, s, this._width, h - s), new o(a, h, n - a, A - h), new o(i, A, this._width, l - A)]
                                      : n <= a
                                        ? [new o(i, s, this._width, h - s), new o(i, h, r - i, A - h), new o(i, A, this._width, l - A)]
                                        : [
                ...
                (o.prototype.intersected = function (e) {
                    var t = this._x,
                        i = this._x;
                    if ((this._width < 0 ? (t += this._width) : (i += this._width), t == i)) return new o(0, 0, 0, 0);
                    var n = e._x,
                        r = e._x;
                    if ((e._width < 0 ? (n += e._width) : (r += e._width), n == r)) return new o(0, 0, 0, 0);
                    if (t >= r || n >= i) return new o(0, 0, 0, 0);
                    var a = this._y,
                        s = this._y;
                    if ((this._height < 0 ? (a += this._height) : (s += this._height), a == s)) return new o(0, 0, 0, 0);
                    var l = e._y,
                        h = e._y;
                    if ((e._height < 0 ? (l += e._height) : (h += e._height), l == h)) return new o(0, 0, 0, 0);
                ...
                (o.prototype.getClosestSideName = function (e) {
                    var t = [
                        ...
                        n = 1;
                    return (
                        e.getX() <= this._x + this._width / 3 ? (i = 0) : e.getX() >= this._x + (2 * this._width) / 3 && (i = 2),
                        e.getY() <= this._y + this._height / 3 ? (n = 0) : e.getY() >= this._y + (2 * this._height) / 3 && (n = 2),
                        t[3 * n + i]
                    );
                }),
                (o.prototype.getXYOffset = function (e, t, i, n) {
                    ...
                    if (t) {
                        for (
                            var o, a = null, s = null, l = [this._x, this._x + this._width], h = [e._x, e._x + e._width], A = 0;
                            A < l.length;
                            ++A
                        )
                            for (var c = 0; c < h.length; ++c)
                                ((o = h[c] - l[A]), (null === a || o < a) && (a = o), (null === s || o > s) && (s = o));
                        (a >= 0 && s >= 0 ? (r.x = Math.min(a, s)) : a <= 0 && s <= 0 && (r.x = Math.max(a, s)),
                            n && !r.x && ((r.leftDist = h[0] - l[0]), (r.rightDist = h[1] - l[1])));
                    }
                    if (i) {
                        var p = null,
                            u = null;
                        for (l = [this._y, this._y + this._height], h = [e._y, e._y + e._height], A = 0; A < l.length; ++A)
                            for (c = 0; c < h.length; ++c)
                                ((o = h[c] - l[A]), (null === p || o < p) && (p = o), (null === u || o > u) && (u = o));
                        (p >= 0 && u >= 0 ? (r.y = Math.min(p, u)) : p <= 0 && u <= 0 && (r.y = Math.max(p, u)),
                            n && !r.y && ((r.topDist = h[0] - l[0]), (r.bottomDist = h[1] - l[1])));
                    }
                    return r;
                }),
