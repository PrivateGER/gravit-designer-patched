            ...
            ((d.PolyLineExtended = function () {
                ...
                (d.PolyLineExtended.prototype._connect = function (e, t) {
                    (e.currCurve && (e.currCurve.prevCurve = this),
                        t
                            ...
                            : (e.currCurve && (e.currCurve.prevCurve = this), (this.next = e), (e.prev = this)));
                }),
                ...
                (d.PolyLineExtended.prototype._stitch = function () {
                    ...
                    var e,
                        ...
                        o = r;
                    do {
                        ((e = o._lastInLoop()).x === o.x && e.y === o.y ? i.push([o, e]) : t.push([o, e]), (o = e.next));
                    } while (o !== r);
                    var a,
                        s,
                        l = t.length;
                    ...
                    if (t.length !== n.length) return (console.log("ERROR WHILE STITCHING"), this._firstInLoop());
                        ...
                        do {
                            if (
                                ...
                                void 0 !== t && void 0 !== i
                                    ...
                                    : ((u.cx1 = t), (u.cx2 = void 0), (u.cy1 = n), (u.cy2 = void 0)),
                                (t = o),
                                (i = a),
                                (n = s),
                                (r = l),
                                ...
                                (b.currCurve
                                    ? void 0 === b.currCurve.cx2
                                        ...
                                        : ((c = 0.5),
                                          ...
                                          (p.y = u(m[3])))
                                    : ((c = 0.5), (p.x = u(k.x + c * (b.x - k.x))), (p.y = u(k.y + c * (b.y - k.y))))),
                                C &&
                                    (w.currCurve
                                        ? ((c = 0.5),
                                          void 0 === w.currCurve.cx2
                                              ? ((y = new Float64Array(3)),
                                                ...
                                                l.getCtrlPtsQuadratic(w.currCurve.x, C.x, w.currCurve.cx1, 0, c, y),
                                                (g.x = u(y[2])),
                                                l.getCtrlPtsQuadratic(w.currCurve.y, C.y, w.currCurve.cy1, 0, c, _),
                                                (g.y = u(_[2])))
                                              : ((y = new Float64Array(4)),
                                                (_ = new Float64Array(4)),
                                                l.getCtrlPts(w.currCurve.x, C.x, w.currCurve.cx1, w.currCurve.cx2, 0, c, y),
                                                (g.x = u(y[3])),
                                                l.getCtrlPts(w.currCurve.y, C.y, w.currCurve.cy1, w.currCurve.cy2, 0, c, _),
                                                (g.y = u(_[3]))))
                                        : ((c = 0.5), (g.x = u(w.x + c * (C.x - w.x))), (g.y = u(w.y + c * (C.y - w.y))))));
                        ...
                        if (t < 0)
                            for (var N = 0; N < M.length; N++) {
                                ...
                                if (
                                    (H.nextInside < 0 &&
                                        ((o = 0),
                                        ((H = U[0]).nextInside = t === d.AUTO ? d.OUTSIDE : d.INSIDE),
                                    ...
                                    if (t === d.AUTO)
                                        for (P = 1; P < V; P++) {
                                            ((H = U[(P + o) % V]).prevInside < 0 ? (H.prevInside = O) : (O = H.prevInside),
                                                H.nextInside < 0 ? (H.nextInside = O) : (O = H.nextInside));
                                        }
                                    else {
                                        var L = 0;
                                        for (P = 1; P < V; P++) {
                                            if (
                                                (((H = U[(P + o) % V]).prevInside >= 0 || H.nextInside >= 0) && (L = 0),
                                                H.prevInside >= 0 && H.nextInside >= 0)
                                            )
                                                if (h > 0) {
                                                    var Y =
                                                        H.corresponding.prevInside >= 0 &&
                                                        H.corresponding.prevInside === H.corresponding.nextInside;
                                                ...
                                                h > 0 && H.corresponding.prevInside === H.corresponding.nextInside
                                                    ? ((H.prevInside = O), (H.nextInside = O))
                                                    : ((H.prevInside = O), (O ^= 1), (H.nextInside = O));
                                            else if (H.prevInside < 0 && H.nextInside >= 0)
                                                h > 0 && H.corresponding.prevInside === H.corresponding.nextInside
                                                ...
                                                if (h > 0)
                                                    ...
                                                    var X = U[(P + o + 1) % V];
                                                    (X !== H && X.prevInside < 0 && X.nextInside < 0 && 0 === L
                                                        ? ((H.prevInside = O), (O ^= 1), (H.nextInside = O))
                                                        : X !== H && (X.prevInside >= 0 || X.nextInside >= 0) && L > 0
                                                          ? ((H.prevInside = O),
                                                            X.prevInside >= 0
                                                                ? ((H.nextInside = X.prevInside), (O = H.nextInside))
                                                                : ((O ^= 1), (H.nextInside = O)))
                                                          : X !== H && X.nextInside >= 0 && X.prevInside < 0
                                                            ? ((H.prevInside = O), O === X.nextInside && (O ^= 1), (H.nextInside = O))
                                                            : (H.prevInside = H.nextInside = O),
                                                        (L += 1));
                                                }
                                        }
                    ...
                    if (r) {
                        ...
                        do {
                            if (i.nextCurve) {
                                ...
                                do {
                                    if (((i.currCurve = a), (i = i.next) === t && i !== n)) return null;
                                } while (i !== n);
                            } else i = i.next;
                        } while (i !== t);
                        if (!o) return t;
                ...
                (d.PolyLineExtended.removeDuplicates = function (e, t) {
                    ...
                    if (l.isEqualEps(i.x, r.x, 1e-10) && l.isEqualEps(i.y, r.y, 1e-10)) {
                        if (
                            (o && o.nextCurve === r && ((o.nextCurve = null), (o.cx1 = o.cx2 = o.cy1 = o.cy2 = void 0)),
                            r.nextCurve &&
                                r.nextCurve !== i &&
                                ...
                                : void 0 !== i.cx1
                                  ...
                                  : void 0 !== i.cx2
                                    ? (t.addVertex(a.Command.Curve, i.next.x, i.next.y),
                                      ...
                                      (i = i.next))
                                    : (i = i.next) &&
                                      (i.prev.isLast ? t.addVertex(a.Command.Move, i.x, i.y) : t.addVertex(a.Command.Line, i.x, i.y));
                        } while (i && i !== this);
                ...
                (d.PolyLineExtended.prototype.isInsideBezier = function (e, t, i) {
                    ...
                    do {
                        (r.y <= s ? a.y > s && this.isLeft(r, a, e) > 0 && ++n : a.y <= s && this.isLeft(r, a, e) < 0 && --n,
                            (r = r.next),
                ...
                (d.PolyLineExtended.prototype._isInsideBezier = function (e, t, i) {
                    ...
                    do {
                        var s, l, h, A;
                        if (
                            (void 0 === n.cx1 ? ((s = 0.5 * (n.x + o.x)), (l = 0.5 * (n.y + o.y))) : ((s = n.cx1), (l = n.cy1)),
                            void 0 === n.cx2)
                        ) {
                            var c = s,
                                p = l;
                ...
                (d.PolyLineExtended.prototype._windingAngle = function (e, t, i, n, r, a, s, h, A) {
                    ...
                    if (((c = Math.sqrt(c)), (p = Math.sqrt(p)), u + d + g > Math.max(c, p))) {
                        ...
                        return (
                            ...
                            this._windingAngle(e, f[0], m[0], f[1], m[1], f[2], m[2], f[3], m[3]) +
                                this._windingAngle(e, y[0], _[0], y[1], _[1], y[2], _[2], y[3], _[3])
                        );
                    }
                    var v = new o(e.x, e.y);
                ...
                (d.PolyLineExtended.prototype.getWinding = function (e) {
                    ...
                    n.isLast && (r = n._firstInLoop());
                    do {
                        (i.y <= o ? r.y > o && this.isLeft(i, r, e) > 0 && ++t : r.y <= o && this.isLeft(i, r, e) < 0 && --t,
                    ...
                    for (n = 0; n < e.length; n++) {
                        ...
                        for (h.rewindVertices(0); h.readVertex(t); )
                            switch (t.command) {
                                case a.Command.Move:
                                    o
                                        ? i > 0 && (((o = new a()).x = t.x), (o.y = t.y), r.addVertex(-1, t.x, t.y))
                                        : (((o = new a()).x = t.x), (o.y = t.y), (r = new s()).addVertex(a.Command.Move, t.x, t.y));
                                    break;
                                case a.Command.Line:
                ...
                (d.prototype.xor = function () {
                    ...
                    if (!t) return null;
                    var i = new d(this.pip_check_policy, this.common_segments_policy, this._useIntersector, this._blockIntersector),
                ...
                (d.prototype.determineInside = function (e, t, i, n, r) {
                    var o = e;
                    do {
                        if (!e.corresponding && !t.hasPoint(e)) return ((i[0] = e), t.isInside(e, this.pip_check_policy) > 0 ? 1 : 0);
                ...
                (d.prototype.clip = function (e, t) {
                    ...
                    for (var g, f, m, y, _, v, b, C = [], w = [], E = true; this.hasUnprocessed(i); ) {
                        ...
                        do {
                            if (
                                (B.visit(),
                                B.isIsect && (b = E ? (e ? !B.prevInside : !B.nextInside) : t ? !B.prevInside : !B.nextInside),
                                b)
                            )
                                do {
                                    if (
                                        (B.nextCurve ? ((g = B.cx1), (m = B.cx2), (f = B.cy1), (y = B.cy2)) : (g = m = f = y = void 0),
                                        c.indexOf(B.index) < 0 && x.appendPoint(B.x, B.y, g, f, m, y),
                    ...
                    (d.forEach(function (e) {
                        ...
                        g.forEach(function (e) {
                            var t = (function (e) {
                                ...
                                var o = [];
                                for (n = 0; n < l.length; n++) t.indexOf(l[n].tmpIdx) >= 0 && o.push(l[n]);
                                return o;
                            })(e.item);
                            (t = t.map(function (e) {
                                var t;
                ...
                (d.prototype._getContainment = function (e, t) {
                                ...
                                a = function (e, t) {
                                    return (
                                        !!(
                                            ...
                                            ((void 0 === e.cx1 && void 0 === e.cy1) || o(e, "x", "cx1", "y", "cy1")) &&
                                            ((void 0 === e.cx2 && void 0 === e.cy2) || o(e, "x", "cx2", "y", "cy2"))
                                        ) &&
                                        (!t.corresponding || t)
                                    );
                                },
                    ...
                    for (var n = Array(e.length), r = 0; r < e.length; r++) ((n[r] = []), (e[r].tmpIdx = r));
                    if (t)
                        for (r = 0; r < e.length; r++)
                            for (var o = e[r], a = 0; a < r; a++) {
                                ...
                                if ((A = this._intersectsArray[o.index]) && A.indexOf(h.index) >= 0);
                                    ...
                                    (((void 0 === (s = t[a][r]) && i(o, h)) || (void 0 !== s && s)) && n[r].push(h),
                                        ((void 0 === (s = t[r][a]) && i(h, o)) || (void 0 !== s && s)) && n[a].push(o));
                            }
                    else
                        for (r = 0; r < e.length; r++)
                            for (o = e[r], a = 0; a < r; a++) {
                                var A;
                                h = e[a];
                                ((A = this._intersectsArray[o.index]) && A.indexOf(h.index) >= 0) ||
