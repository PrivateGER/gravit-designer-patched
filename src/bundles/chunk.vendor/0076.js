            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(l, r, [r.Identity, r.Multireference, a]),
                ...
                (l.prototype._setScene = function (e) {
                    e !== this._scene &&
                        ...
                        e ? (this._scene = e) : (this._scene && this._scene._unsetSceneNode(this), (this._scene = null)),
                                ...
                                if (n)
                                    if (n._scene) this._scene.link(n, this);
                                        ...
                                        this._scene._isRestoring ||
                                            (n.getParent() || this.getParent().appendChild(n), this._scene.link(n, this));
                            }
                ...
                (l.prototype._referenceEvent = function (e) {
                    if (e.target === this && this.hasMixin(r.Properties)) {
                        ...
                        if (t) {
                            ...
                            ((n = this.$refs.slice()).splice(this.$refs.indexOf(i.getReferenceId()), 1),
                ...
                (l.prototype._handleChange = function (e, t) {
                    if (e === l._Change.SceneAttached && this._scene)
                        ...
                        if (this.$refs) for (var i = this.$refs.slice(), n = i.length - 1; n >= 0; n--) this._scene.unlink(i[n], this);
