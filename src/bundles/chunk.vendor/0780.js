module.exports = function (e, t, i) {
            ...
            (r.inherit(v, c),
                ...
                (v.prototype.paint = function (e, t) {
                    ...
                    if (i && n && 4 == n.length) {
                        ...
                        ((d.length && 0 == d[0].position) || this._paintCross(l, t),
                            (d.length && 1 == d[d.length - 1].position) || this._paintCross(u, t),
                            m.paintAnnotation(
                                t,
                                null,
                    ...
                    if (o && 4 == o.length) {
                        ...
                        if (
                            ...
                            if (
                                ...
                                d.sqrSegmentDist(o[3].getX(), o[3].getY(), s.getX(), s.getY(), p.getX(), p.getY(), A) <= u * u
                                    ? (r = new f.PartInfo(
                                          this,
                                          {
                ...
                (v.prototype.movePart = function (e, t, i, n, r, o, a) {
                    ...
                    if (
                        (e && e.type === c.STOP_HANDLE_PART_ID && 0 == e.idx && h.length && 0 == h[0].position) ||
                        ...
                        if (((s = n.mapPoint(s)), (G = this._getCompositeTransform(!0).inverted()))) {
                            if (
                                ...
                                var g = d.ptSqrDist(s.getX(), s.getY(), this._gradient._cx, this._gradient._cy),
                        ...
                        !this._xLeading &&
                        e &&
                        ((e.type === c.STOP_HANDLE_PART_ID && h.length && e.idx == h.length - 1 && 1 == h[h.length - 1].position) ||
                        ...
                        if (
                            ...
                            var I = new l(this._gradient._fx, this._gradient._fy),
                                F = this._xLeading
                                    ? new l(this._gradient._cx + this._gradient._scale, this._gradient._cy)
                                    : new l(this._gradient._cx, this._gradient._cy - this._gradient._scale),
