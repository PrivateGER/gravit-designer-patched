module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(f, d),
                ...
                (f.prototype.layout = function () {
                    ...
                    try {
                        ...
                        ((this.frame = p.create(this.words).per(e.frame, e).first()),
                            (this._lastSpacingPadding = this.frame && this.frame.getBBoxSpacing()));
                    } catch (e) {
                        console.error(e);
                    }
                    if (this.frame) {
                    ...
                    } else (console.error("A bug somewhere has produced an invalid state - rolling back"), this.performUndo());
                }),
                        ...
                        function (e) {
                            ...
                            if (r && 0 === r.$.indexOf("List")) {
                                ...
                                ((t = i[i.length - 1]) ||
                                    ...
                                    (t && t.code) || (y(e) && !m(e) && ((t = i.pop()), n.push(this.range(t.start, a + e.length)))));
                            a += e.length;
                        }.bind(this)
                    );
                    var s = function (e) {
                ...
                (f.prototype.insert = function (e, t) {
                    (("string" == typeof e || e instanceof String) && (e = n.deCRLFify(e)),
                        this.select(this.selection.end + this.selectedRange().setText(e), null, t));
                }),
                ...
                (f.prototype.applyInsertFormatting = function (e) {
                    ...
                    if (this.frame && this.frame.length <= 1 && this.emptyFormatting) {
                        ...
                        if (((t = this.emptyFormatting), this.nextInsertFormatting))
                            for (var i in this.nextInsertFormatting) t[i] = this.nextInsertFormatting[i];
                ...
                (f.prototype.runs = function (e, t) {
                    var i = this.wordContainingOrdinal(Math.max(0, t.start)),
                        n = this.wordContainingOrdinal(Math.min(t.end, this.frame ? this.frame.length - 1 : 0));
                    if (i.index === n.index)
                        i.word.runs(e, {
                            start: i.offset,
                            end: n.offset,
                            ...
                            if (
                                (n.endOfList && e === this.frame.length - 1
                                    ...
                                    : "document" === n.type && i.block && 0 === e
                                      ...
                                      : i.endOfList && 1 === i.length && "inline" === n.type && (h = n.h),
                                h)
                            )
                                t = new a(s, l, 1, h);
                            else {
