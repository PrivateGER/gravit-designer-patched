module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(f, a),
                ...
                (f.openEditor = function (e, t, i) {
                    if (!e._scene && !t) throw new Error("Node is not attached to create an editor for.");
                ...
                (f.prototype.getPEGeometryBBox = function () {
                    ...
                    if (this.hasFlag(n.Flag.Selected) || this.hasFlag(n.Flag.Highlighted) || this.hasFlag(n.Flag.Outline)) {
                        ...
                        if (i && i != r) t = i;
                            ...
                            (this._preTransform && a && a.invertible() && (o = a.inverted().multiplied(this._preTransform).multiplied(a)),
                                this._transform && (o = o ? o.multiplied(this._transform) : this._transform));
                        }
                        if (t.hasMixin(p)) {
                            var s = o ? new u(t, o) : t;
                ...
                (f.prototype.getBBox = function (e) {
                    ...
                    var i = this.getPaintElement().getGeometryBBox(),
                        n = !this._preTransform && this.getElement() instanceof A && this.getElement().getTransform();
                    if (n) {
                ...
                (f.prototype._finishApplyPartMove = function (e, t) {
                    ...
                    if (!i && this._element.hasMixin(r.Layout) && this._element._relayout) {
                        if (this._element._layoutTransform)
                            (this._element._layoutAnchorContents(null, null, this._element._layoutTransform),
                                (this._element._layoutTransform = null));
                        else {
                ...
                (f.prototype._finishApplyTransform = function (e) {
                    ...
                    if (t.hasMixin(r.Layout) && t._relayout) {
                        if (t._layoutTransform) (t._layoutAnchorContents(null, null, t._layoutTransform), (t._layoutTransform = null));
                        else {
                            ...
                            (l.equals(this._oldBBox, i) ||
                                ...
                                (h.isEqualEps(this._oldBBox.getWidth(), i.getWidth(), 1e-10) &&
                                    h.isEqualEps(this._oldBBox.getHeight(), i.getHeight(), 1e-10)) ||
                ...
                (f.prototype._setElementPreview = function (e) {
                    (this._elementPreview && (this._elementPreview._baseElement = null),
                        ...
                        this._elementPreview && (this._elementPreview._baseElement = this._element));
                }),
