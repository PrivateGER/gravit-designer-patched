            ...
            (r.inherit("dropShadowEffect", p, GStylable.Effect),
                ...
                (p.equals = function (e, t) {
                    return (
                        e instanceof p &&
                        t instanceof p &&
                        e.arePropertiesEqual(t, Object.keys(p.GeometryProperties).concat(Object.keys(p.VisualProperties)))
                    );
                }),
                    ...
                    if (this.$pat && this.$opc > 0)
                        if (this.canApplyNativeEffect())
                            ...
                            (t.drawCanvas(e, a, s, 1, l.CompositeOperator.DestinationIn),
                                A > 0 && ((this._blur.$r = this.$r), this._blur.render(t, null, null, n, r, o)),
                ...
                (p.prototype._handleChange = function (e, t) {
                    (e === r._Change.Store
                        ...
                        : e === r._Change.Restore &&
                          ...
                          this.restoreProperties(t.blob, p.VisualProperties, function (e, t) {
