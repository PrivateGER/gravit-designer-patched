module.exports = function (module, exports, require) {
            ...
            ((b.hasFilters = function () {
                ...
                (b.prototype.resize = function (e, t) {
                    (e == this._canvasContext.canvas.width && t == this._canvasContext.canvas.height) ||
                        ((this._canvasContext.canvas.width = e), (this._canvasContext.canvas.height = t));
                }),
                    ...
                    if (
                        ...
                        for (var i = 0; i < e.length; ++i) {
                            ...
                            ((r = Math.max(0, r)),
                                ...
                                t && ((this._canvasContext.fillStyle = "#0f0"), this._canvasContext.fill()));
                        }
                        this._canvasContext.clip();
                    } else this._canvasContext.clearRect(0, 0, this.getWidth(), this.getHeight());
                }),
                ...
                (b.prototype.getPaintExtents = function (e, t, i) {
                    ...
                    return (
                        t ||
                            (i ? "number" == typeof i && (i = [i, i, i, i]) : (i = [0, 0, 0, 0]),
                            o < -i[1] && ((s += o + i[1]), (o = -i[1])),
                            r < -i[0] && ((a += r + i[0]), (r = -i[0])),
                            r + a > this.getWidth() + i[2] + i[0] && (a = this.getWidth() - r + i[2] + i[0]),
                            o + s > this.getHeight() + i[1] + i[3] && (s = this.getHeight() - o + i[1] + i[3])),
                        new p(r, o, a, s)
                    );
                }),
                ...
                (b.prototype.getScaleBoxCorrection = function (e, t, i, n, r, o) {
                    var a = function (e) {
                        ...
                        h = e * r,
                        A = t * r;
                    if (o) ((i = a(i) || 0), (n = a(n) || 0), (e = s(e) || 0), (t = s(t) || 0));
                    else {
                        var c = Math.round(h);
                        ((i = c < h ? a(i) || 0 : s(i) || 0),
                ...
                (b.prototype.drawCanvas = function (e, t, i, n, r, o, a, s) {
                    ...
                    (o && this._canvasContext.clearRect(d, g, f, m),
                        ...
                        (this._blender.globalCompositeOperation = r || b.CompositeOperator.SourceOver),
                        this._blender.drawImage(e._canvasContext.canvas, -_, -_, e.getWidth() + 2 * _, e.getHeight() + 2 * _, d, g, f, m),
                        this.setTransform(c),
                        this.setScale(h),
                ...
                (b.prototype.createTexture = function (e, t) {
                    ...
                    if (((t = t || g.RepeatMode.Both), (e = this._convertImage(e)) instanceof HTMLImageElement || e instanceof Image)) {
                        if (e.complete && e.naturalWidth && 0 !== e.naturalWidth) return this._canvasContext.createPattern(e, t);
                ...
                (b.prototype.createPatternPaint = function (e, t, i) {
                    ...
                    if (e instanceof r) o = e;
                        ...
                        ((a = i || (!t || (0 == t.getX() && 0 == t.getY()) ? null : new u(1, 0, 0, 1, t.getX(), t.getY()))),
                        ...
                        if (e instanceof n) {
                            var p = e.getAngle();
                            ((o = this._canvasContext.createLinearGradient(e._fx, e._fy, e._fx + Math.cos(p) * c, e._fy + Math.sin(p) * c)),
                                (l = e.getTransform()));
                ...
                (b.prototype.strokeVertices = function (e, t, i, n, r, o, a, s) {
                    ((this._canvasContext.strokeStyle = this._convertStyle(e)),
                        ...
                        (this._blender.globalCompositeOperation = s || b.CompositeOperator.SourceOver));
                ...
                (b.prototype.fillVertices = function (e, t, i, n) {
                    ((this._canvasContext.fillStyle = this._convertStyle(e)),
                        ...
                        (this._blender.globalCompositeOperation = i || b.CompositeOperator.SourceOver),
                ...
                (b.prototype.strokeRect = function (e, t, i, n, r, o, s, l) {
                    ((o = this._convertStyle(o || a.BLACK)),
                        (r = r || 1),
                        (this._blender.globalCompositeOperation = l || b.CompositeOperator.SourceOver),
                ...
                (b.prototype.strokeLine = function (e, t, i, n, r, o, s, l) {
                    ((o = this._convertStyle(o || a.BLACK)),
                        (r = r || 1),
                        (this._blender.globalCompositeOperation = b.CompositeOperator.SourceOver),
                ...
                (b.prototype.drawImage = function (e, t, i, n, r, o, a, s, l) {
                    ...
                    ((this._canvasContext.globalAlpha = "number" == typeof r ? r : 1),
                        (this._blender.globalCompositeOperation = o || b.CompositeOperator.SourceOver));
                ...
                (b.prototype.drawImageFragment = function (e, t, i, n, r, o, a, s, l, h, A, c) {
                    ...
                    ((A = A || o), (c = c || a));
                    ((this._canvasContext.globalAlpha = "number" == typeof l ? l : 1),
                        (this._blender.globalCompositeOperation = h || b.CompositeOperator.SourceOver));
                ...
                (b.prototype.hitTest = function (e, t) {
                    for (
                        ...
                        0 !== d[m] &&
                            (i = (t - (n = (m >> 2) % p)) * (t - n) + (t - (r = (m >> 2) / p)) * (t - r)) < g &&
                            ((g = i), (f = m));
                ...
                (b.prototype.setFilter = function (e, t) {
                    if (b.hasFilters()) {
                        if ((this._filters || (this._filters = {}), null === t)) delete this._filters[e];
                        else {
                            ...
                            switch (e) {
                                ...
                                case b.Filter.DropShadow:
                                    if (t.length < 4) throw new Error("GPaintCanvas.setFilter: Invalid parameter");
                                    if (!(t[3] instanceof r)) throw new Error("GPaintCanvas.setFilter: Invalid color provided");
                        ...
                        var n = "";
                        for (var o in this._filters) n = n.concat(o, "(", this._filters[o], ") ");
                ...
                (b.prototype.clone = function (e, t) {
                    ...
                    if (DUMP_IMAGES.isRenderPhase() && !n) {
                        ...
                        ((o._blender.globalCompositeOperation = this._blender.globalCompositeOperation),
                            (o._offset = this._offset ? new A(this._offset.getX(), this._offset.getY()) : null),
                            (o._origin = this._origin ? new A(this._origin.getX(), this._origin.getY()) : null),
                            (o._transform = this._transform ? u.deserialize(u.serialize(this._transform)) : null),
                        ...
                        (((i = o._canvasContext).globalAlpha = a.globalAlpha),
                            ...
                            (c = a instanceof y || a instanceof _ ? a.imageRendering : a.canvas.style.imageRendering),
                            i instanceof y || a instanceof _ ? (i.imageRendering = c) : (i.canvas.style.imageRendering = c));
                        s = null;
                        if (this._areas) {
                            s = [];
                        ...
                        for (var C = 0; C < p - 1; C++) {
                            ...
                            (d >> 1 >= f && (w = d >> 1),
                                ...
                                0 === C
                                    ...
                                    : C % 2 == 0
                                      ? (_.clearRect(0, 0, d, g), _.drawImage(v, 0, 0, d, g, 0, 0, w, E))
                                      : (b.clearRect(0, 0, d, g), b.drawImage(y, 0, 0, d, g, 0, 0, w, E)),
                                (d = w),
                                (g = E));
                        }
                        var B = s.getMatrix();
                        (this._canvasContext.setTransform(B[0], B[1], B[2], B[3], B[4], B[5]),
                            this._blender.drawImage(C % 2 == 0 ? v : y, t || 0, i || 0, d, g, 0, 0, f, m));
                ...
                (b.prototype._convertImage = function (e) {
                    if (
                        ...
                        return e;
                    if (e instanceof b)
                        return !(this._canvasContext instanceof y) && e._canvasContext instanceof y
                            ? e._canvasContext.canvas.__realCanvas
                            : !(this._canvasContext instanceof _) && e._canvasContext instanceof _
            ...
            var x = ["imageSmoothingEnabled", "webkitImageSmoothingEnabled", "mozImageSmoothingEnabled"];
