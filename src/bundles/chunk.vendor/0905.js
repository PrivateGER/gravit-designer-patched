                ...
                ((e.Effects = function () {}),
                    ...
                    (e.Effects.prototype._handleChange = function (t, i) {
                        ...
                        (r &&
                            ...
                            (t == n._Change.AfterChildInsert || t === n._Change.AfterChildRemove) &&
                                i instanceof e.Effect &&
                    ...
                    (e.Effects.prototype.getEffectsPadding = function (t, i, n) {
                        ...
                        if (
                            ...
                            return null;
                        for (var a = [0, 0, 0, 0], s = [0, 0, 0, 0], l = null, h = 0; h < r.length; ++h) {
                            var A,
                                c = r[h];
                            if (n && !n(c)) break;
                            if ((A = h >= o ? c.getAbsoluteEffectPadding(t) : c.getEffectPadding(t))) {
                                switch ((A instanceof Array || (A = [A, A, A, A]), c.getEffectType())) {
                                    case e.Effect.Type.PreEffect:
                                    case e.Effect.Type.PostEffect:
                                        s = [Math.max(s[0], A[0]), Math.max(s[1], A[1]), Math.max(s[2], A[2]), Math.max(s[3], A[3])];
                                        break;
                                    case e.Effect.Type.Multi:
                                    case e.Effect.Type.Filter:
                                        (l &&
                                            ...
                                            ((a = [a[0] + s[0], a[1] + s[1], a[2] + s[2], a[3] + s[3]]), (s = [0, 0, 0, 0])),
                    ...
                    (e.Effects.prototype.resetMultireference = function () {
                        (n.Multireference.prototype.resetMultireference.call(this),
                            this.getParent() && (this.getParent()._effId = this.getMultireferenceId()));
                    }));
            };
        };
