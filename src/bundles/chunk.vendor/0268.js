                ...
                (p.prototype.relayout = function () {
                    if (this._anchorPoints && this._anchorPoints.getFirstChild() && this._anchorPoints.getLastChild()) {
                        ...
                        var i,
                            ...
                            r,
                            o = function (e) {
                                return [l.Side.LEFT_CENTER, l.Side.RIGHT_CENTER, l.Side.TOP_CENTER, l.Side.BOTTOM_CENTER].map(function (t) {
                                    return {
                                        side: t,
                                        pt: e.getSide(t),
                                    };
                        ...
                        (this._anchorPoints.getFirstChild().setProperties(["x", "y"], [A.getX(), A.getY()]),
                            this._anchorPoints.getLastChild().setProperties(["x", "y"], [c.getX(), c.getY()]));
                    }
                }),
