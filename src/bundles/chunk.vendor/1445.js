module.exports = function (e, t, i) {
            ...
            (o.inherit(d, h),
                ...
                (d.prototype.fillVertices = function (e, t, i, n) {
                    if (
                        (i || h.CompositeOperator.SourceOver) === h.CompositeOperator.DestinationIn &&
                ...
                (d.prototype.createCanvas = function (e, t) {
                    ...
                    if (t && this._areas) {
                        s = [];
                        for (var h = 0; h < this._areas.length; ++h) s.push(this._areas[h].translated(-r, -o));
                    }
                ...
                (d.prototype._toScreenCSS = function (e, t) {
                    return this._canvasContext._doc.getColorSpace() === p.CMYK && e instanceof a
