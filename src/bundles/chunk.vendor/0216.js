module.exports = function (e, t, i) {
            ...
            function D() {
                (n.call(this),
                    ...
                    this.addEventListener(o.BeforeRemoveEvent, this._beforeNodeRemove, this),
                    this.addEventListener(o.AfterPropertiesChangeEvent, this._afterPropertiesChange, this),
                    this.addEventListener(o.AfterFlagChangeEvent, this._afterFlagChange, this),
                    this._setDefaultProperties(D.GeometryProperties, D.MetaProperties));
            }
            o.inheritAndMix("symbol", D, n, [o.Container, s.Transform, s.Stylable, s.Layout, o.Reference, f.LabelHolder]);
            ...
            ((D.BLOCK_EDITED = !1),
                ...
                (D._getChangedText = function (e, t) {
                    for (var i, n = e.length, r = t.length, o = Math.min(n, r), a = 0; a < o && e.charAt(a) == t.charAt(a); ) a++;
                    for (i = a, a = 0; i + a < o && e.charAt(n - a - 1) == t.charAt(r - a - 1); ) a++;
                    var s = n - a - i;
                ...
                (D._getChangedTextContentProperties = function (e, t) {
                    ...
                    for (var n in t[0])
                        for (var r = t[0][n], o = 0, a = 0, s = 0; ; ) {
                            ...
                            for (r = t[o][n], s = o; o < t.length && (t[o][n] === r || !t[o].hasOwnProperty(n)); ) o++;
                            for (; a < e.length && (e[a][n] === r || !e[a].hasOwnProperty(n)); ) a++;
                        }
                    ...
                    if (!this.isMaster()) {
                        ...
                        if (!((e && e !== this) || t || i)) {
                            ...
                            var _ = this.getProperty("trf") || new h(),
                                ...
                                b = _.decomposed(),
                                C = _.inverted();
                            if (!h.equals(b.scale, v.scale, 1e-4) || !h.equals(b.skew, v.skew, 1e-4)) {
                                var w = this.getFrame(),
                                ...
                                ((_ = _.translated(x.getWidth() / 2, x.getHeight() / 2)
                                    ...
                                    .multiplied(v.scale)),
                                    (x = y.fromPoints.apply(null, C.multiplied(_).mapQuadrilateral(w))),
                                    (_ = _.translated(-x.getWidth() / 2, -x.getHeight() / 2)
                                        .multiplied(v.skew)
                                        .multiplied(b.rotate)),
                                    (x = y.fromPoints.apply(null, C.multiplied(_).mapQuadrilateral(w))),
                                    (_ = _.translated(x.getWidth() / 2, x.getHeight() / 2).translated(B.getX(), B.getY())),
                                    ...
                                    do {
                                        if ((r = n._symbolParent(r)))
                                            if ((i = (t = r === this ? n : r.getMasterSymbol())._siblingMap[o])) {
                                                ...
                                                if (
                                                    (e.hasProperty("trf") &&
                                                        (a = D._swapBaseTransforms(i.getTransform(), t.getTransform(), r.getTransform())),
                                                    e instanceof d &&
                                    ...
                                    function (e) {
                                        ...
                                        (this.appendChild(t),
                                            e.hasMixin(o.Properties) &&
                                                ...
                                                e.setProperty(
                                                    "trf",
                                                    D._swapBaseTransforms(e.getTransform(), n.getTransform(), this.getTransform())
                                                ));
                                    }.bind(this)
                                ));
                        }
                ...
                (D.prototype._translationSwapped = function (e, t) {
                    ...
                    if (a && o % 2 == 1 && (n = a._siblingMap[e.$swpori[o - 1]])) {
                        var s = D._swapBaseTransforms(n.getTransform(), a.getTransform(), i.getTransform()),
                ...
                (D.prototype.getDisabledSiblings = function () {
                    var e = {};
                    for (var t in this._disabledSiblingMap) e[t] = this._disabledSiblingMap[t];
                    return (
                        (e.SYMBOL_FRAME = y.deserialize(y.serialize(this.getProperty("frame")))),
                        (e.SYMBOL_TRF = this.getTransform() ? this.getTransform().translated(0, 0) : null),
                        e
                    );
                }),
                (D.prototype.desynchronize = function (e) {
                    if (!this.isMaster()) {
                        if (!this.getMasterSymbol()) return (k("gsymbol: No master symbol found."), null);
                        var t = {},
                            i = [];
                        for (var n in e) {
                            var r = e[n];
                        ...
                        var c = e.SYMBOL_TRF,
                            ...
                            g = u.decomposed(),
                            f = u.inverted();
                        if (!h.equals(g.scale, d.scale, 1e-4) || !h.equals(g.skew, d.skew, 1e-4)) {
                            var m = this.getFrame(),
                            ...
                            ((u = u
                                ...
                                .multiplied(d.scale)),
                                (b = y.fromPoints.apply(null, f.multiplied(u).mapQuadrilateral(m))),
                                (u = u
                                    .translated(-b.getWidth() / 2, -b.getHeight() / 2)
                                    .multiplied(d.skew)
                                    .multiplied(g.rotate)),
                                (b = y.fromPoints.apply(null, f.multiplied(u).mapQuadrilateral(m))),
                                (u = u.translated(b.getWidth() / 2, b.getHeight() / 2).translated(v.getX(), v.getY())),
                        ...
                        i.length &&
                            (i = this._sortByDepth(i)).forEach(
                                function (i) {
                                    ...
                                    if (r) {
                                        var o;
                                        (i.hasProperty("trf") && (o = D._swapBaseTransforms(r.getTransform(), c, this.getTransform())),
                                            i.assignFrom(r));
                ...
                (D.prototype.assignFrom = function (e) {
                    (e instanceof D && this.transferProperties(e, [D.GeometryProperties, D.MetaProperties]),
                ...
                (D.prototype._getMasterSibling = function (e, t, i) {
                    if (this.isMaster()) return t && this._siblingMap.hasOwnProperty(e) ? this._siblingMap[e] : null;
                    var n = this.getMasterSymbol();
                    ...
                    for (var r = [this], o = this; o; )
                        if ((o = o._symbolParent())) {
                            ...
                            if (a) {
                                ...
                                if (a && a._siblingMap.hasOwnProperty(e)) return a._siblingMap[e];
                            }
                            r.push(o);
                        }
                    return null;
                ...
                (D.prototype.swapWith = function (e) {
                    if (e !== this && e instanceof D && this.getScene()) {
                        ...
                        if (i) {
                            ...
                            (this.$swpori || this.setProperty("swpori", [r, this.$masterMultiRef]), i.removeChild(this));
                            var a = e.clone();
                            if (
                                (a.setProperty("swpori", this.$swpori.slice()),
                                a.$masterMultiRef === this.$swpori[1] && ((a._multiReferenceId = this.$swpori[0]), (r = this.$swpori[0])),
                                i.insertChild(a, t),
                                o)
                            ) {
                                e._symbolParent();
                                    ...
                                    if (g !== f) {
                                        for (var m = [d - 1, d], _ = 0; _ < u.length; )
                                            if (m.indexOf(_) >= 0) _ += 2;
                                                ...
                                                if (((g = u[_ + 1]), m.push(_, _ + 1), (_ = 0), g === f)) break;
                                            } else _ += 2;
                                        if (g === f) {
                                            m.sort(function (e, t) {
                                                return t - e;
                ...
                (D.prototype.swapWithNew = function (e) {
                    if (e !== this && e instanceof D && this.getScene() && this.getParent() && !this.isMaster()) {
                        for (var t = this.getFirstChild(); t; t = t.getNext()) this.removeChild(t);
                        var i = e.clone();
                        if (e === this.getMasterSymbol())
                            for (t = i.getFirstChild(); t; t = t.getNext()) (i.removeChild(t), this.appendChild(t));
                ...
                (D.prototype.getMasterSymbol = function () {
                    ...
                    return (e = this._workspace.getReference(this.$masterRef)) &&
                        (e.isMaster() || k("GSymbol.getMasterSymbol: returning slave as master"), this.getScene() !== e.getScene())
                        ? null
                        : e;
                }),
                ...
                (D.prototype.getAngle = function () {
                    ...
                    if (t && !t.isEmpty()) {
                        ...
                        (this.$trf && ((i = this.$trf.mapPoint(i)), (n = this.$trf.mapPoint(n))),
                            (e = m.normalizeAngleRadians(-Math.atan2(n.getY() - i.getY(), n.getX() - i.getX()))) > Math.PI && (e -= m.PI2));
                    }
                    return e;
                }),
                ...
                (D.prototype._calculatePaintBBox = function (e, t) {
                    ...
                    if (n && this.getScene()) {
                        ...
                        ((r = new y(n.getX(), n.getY() - r.getHeight(), n.getWidth(), r.getHeight())),
                        ...
                        t &&
                            (e && e.symbolMasterReplicate && this.isMaster()
                                ? ((t._master = this._master),
                                  ...
                                  t.setProperties(["masterRef", "masterMultiRef"], [t.getReferenceId(), t.getMultireferenceId()]))
                ...
                (D.prototype._afterNodeInsert = function (e) {
                    if (!(this._blockEvents > 0)) {
                        ...
                        if (!this.isMaster() && !this._isRestoring) {
                            t = e.node.getMultireferenceId();
                            if (((this._siblingMap[t] = e.node), e.node.hasMixin(o.Container))) e.node.getSubnodeIds(this._siblingMap);
                            else if (e.node.hasMixin(s.Stylable))
                                throw new Error("GSymbol: stylable without Container mixin. This corrupts some symbol principles.");
                        }
                        if (this.isMaster() && !this._isRestoring && e.node !== this) {
                            ...
                            this._iterateSiblings(a, function (t, a, A) {
                                ...
                                if (e.node instanceof D && e.node.isRecordedTransaction()) {
                                    ...
                                    if (u) for (var d = 0; d < u.length; d += 2) if (u[d] === e.node.$masterMultiRef) return;
                                }
                                if (
                                    (n && (c = a._siblingMap[n.getMultireferenceId()]), "function" == typeof i.clone && (p = i.clone()), p)
                                ) {
                                    var g = a;
                                    if (
                                        A === l ||
                                        ...
                                        if (
                                            ...
                                            var f = A.getTransform(),
                                                m = D._swapBaseTransforms(i.getTransform(), f, a.getTransform()),
                                        ...
                                        if (t instanceof s)
                                            (_ = t.getScene()) &&
                                                _._beginBlockEvents([o.AfterPropertiesChangeEvent, o.BeforePropertiesChangeEvent]);
                                        (t._beginBlockEvents([
                                            o.BeforeInsertEvent,
                                            o.AfterInsertEvent,
                                            ...
                                            _ && _._endBlockEvents([o.AfterPropertiesChangeEvent, o.BeforePropertiesChangeEvent]),
                                            p.hasMixin(o.Container) && g._getDeadSiblingsFromNode(p),
                                            a._canEventBeSent(D.AfterSiblingUpdate) &&
                                                a._sendEvent(new D.AfterSiblingUpdate(p, t, D.AfterSiblingUpdate.INSERT)));
                                    } else k("symbol insert: couldn't find right symbol with map");
                            ...
                            if (!i || i === t)
                                for (var n = e.getFirstChild(); n; n = n.getNext())
                                    e._getMasterSibling(n.getMultireferenceId()) ||
                                        ((t._siblingMap[n.getMultireferenceId()] = n), n.getSubnodeIds(t._siblingMap));
                        }
                    });
                }),
                (D.prototype._beforeNodeRemove = function (e) {
                    if (!(this._blockEvents > 0)) {
                                    ...
                                    if (
                                        ...
                                        if (!a)
                                            return (
                                                ...
                                                void delete r._disabledSiblingMap[e.getMultireferenceId()]
                                            );
                                        var l = a instanceof s && a.getScene();
                                        (l && l._beginBlockEvents([o.AfterPropertiesChangeEvent, o.BeforePropertiesChangeEvent]),
                                            a._beginBlockEvents([
                                                o.BeforeRemoveEvent,
                                                o.AfterRemoveEvent,
                                                o.AfterPropertiesChangeEvent,
                                            ...
                                            l && l._endBlockEvents([o.AfterPropertiesChangeEvent, o.BeforePropertiesChangeEvent]),
                        ...
                        this.isMaster() &&
                            (delete this._siblingMap[t.getMultireferenceId()], delete this._disabledSiblingMap[t.getMultireferenceId()]);
                        ...
                        if (this.isMaster() && t !== this && (!(t instanceof s) || (t instanceof s && !t.isRecordedTransaction()))) {
                            ...
                            this._iterateSiblings(t, function (r, a, l) {
                                var A = e.properties.slice(),
                                    c = t.getProperties(e.properties, e.custom, null, e.temporary),
                                    p = A.indexOf("trf"),
                                    d = e.values.slice(),
                                    g = [],
                                    f = [],
                                ...
                                } else p >= 0 && (A.splice(p, 1), c.splice(p, 1), d.splice(p, 1));
                                                ...
                                                if ((he = O ? O.plainText() : "") === j && X && X.length > 0) {
                                                    ...
                                                    if (J) {
                                                        ...
                                                        for (var q = 0; q < J.length; q++) {
                                                            for (
                                                                var K, $, ee = J[q], te = ee.range[0], ie = ee.range[1], ne = 0, re = 0;
                                                                re < X.length;
                                                                re++
                                                            )
                                                    ...
                                                    ((j = N.getDocumentRange().plainText()),
                                                        ...
                                                        (ce = D._getChangedText(j, he))[1] < 0 && (ce[1] = 0),
                                                        (Y = N.getRange(ce[0], ce[0] + ce[1])));
                                                    var ae = new w(),
                                                        se = r.getProperty("content") || "[]";
                                                    (ae.load(JSON.parse(se)),
                                                        (ce = D._getChangedText(he, j)),
                                                        (pe = ae.range(ce[0], ce[0] + ce[1])).setText(Y.save()),
                                                        (ue = JSON.stringify(ae.save())) !== se && (g.push("content"), f.push(ue)));
                                                } else
                                                    X && X.length
                                                ...
                                                if (X && X.length > 0) {
                                                    ...
                                                    if ((he = R(M)) === j)
                                                        (Ae = D._assignChangedTextContentProperties(M, X, le, function (e) {
                                                            return (
                                                                "text" === e &&
                                                                    k("cannot handle simultaneous change of text and other properties"),
                                                                "text" !== e
                                                            );
                                                        ...
                                                        ((de = (ce = D._getChangedText(he, j))[0]),
                                                            ...
                                                            (ue = JSON.stringify(ae.save())) !== (se = JSON.stringify(le)) &&
                                ...
                                (a._blockEvents++,
                                    ...
                                    e.temporary ||
                                        (r instanceof D && !r.isMaster() && r !== a
                                            ...
                                            : a.isMaster() || a.getMasterSymbol() === i || a._updateDisabledSiblings(r, A.concat(g))));
                            });
                        } else
                            e.temporary ||
                                (this._hasMasterParent() && t !== this._siblingMap[t.getMultireferenceId()]) ||
                    ...
                    if (!this._isRestoring && !this.isMaster() && e !== this) {
                        ...
                        e: if (this._disabledSiblingMap.hasOwnProperty(i))
                            this._comparePropertiesWithMaster(e) &&
                                (D.BLOCK_EDITED
                                    ? (this._siblingMap.hasOwnProperty([i]) || (this._siblingMap[i] = this._disabledSiblingMap[i]),
                            ...
                            (n && A && c && e.arePropertiesEqual(n, p)) ||
                                (D.BLOCK_EDITED
                                    ? ((this._disabledSiblingMap[i] = this._siblingMap[i]),
                                      (n && A && e instanceof u && !c && e.arePropertiesEqual(n, p)) || delete this._siblingMap[i])
                                    : (this._disabledSiblingMap[i] = this._siblingMap[i]));
                        }
                ...
                (D.prototype._iterateSiblings = function (e, t, i, n) {
                    if (e)
                            ...
                            if (this.isMaster()) {
                                ...
                                if (h) {
                                    ...
                                    if (h !== this && h.isMaster()) A = h;
                                        ...
                                        if (h._getMasterSibling(e.getMultireferenceId())) A = h.getMasterSymbol();
                                        else {
                                            for (var p = this._symbolParent(h); p && !A; )
                                                (p.isMaster() && p._siblingMap[e.getMultireferenceId()] && ((A = p), (h = p)),
                                    ...
                                    var u = function (t, i) {
                                            ...
                                            do {
                                                if (
                                                    (n !== i && (n = n.getParent()),
                                                    r !== h && (r = r.getParent()),
                                                    n || (k("some propagation errors might have occurred"), (n = i)),
                                            ...
                                            if (n instanceof D && n !== h && !n.isMaster()) {
                                                if (A !== c) {
                                                    if (
                                                        ...
                                                        return;
                                                    if (h.getMultireferenceId() !== n.getMultireferenceId()) return;
                                                }
                                                if (D.BLOCK_EDITED && !i) {
                                                    var r = n._symbolParent();
                                                    if (r && r._disabledSiblingMap.hasOwnProperty(n.getMultireferenceId())) return;
                                                }
                                                var s = null;
                                                if (
                                                    (s = a
                                                    ...
                                                    i && u(p, n) && p instanceof o
                                                        ? t(p, n, h)
                                                        : p || k("GSymbol._iterateSiblings: Updating non existing sibling");
                                                }
                                            }
                                        };
                        ...
                        } else k("GSymbol._iterateSiblings: Error: node is not a multireference");
                ...
                (D.prototype._handleChange = function (e, t) {
                    ...
                    if (e == s._Change.ChildGeometryUpdate)
                                    ...
                                    if ("sbl" === e && t) {
                                        var s = function (e, t) {
                                            ...
                                            e._cachedSymbolSiblings ||
                                                (e._cachedSymbolSiblings = Object.values(e._siblingMap).filter(function (e) {
                                                    return e instanceof D;
                                                }));
                                            ...
                                            if (l) {
                                                ...
                                                (delete l._siblingMap[n],
                                                    l._cachedSymbolSiblings &&
                                                        l._cachedSymbolSiblings.splice(l._cachedSymbolSiblings.indexOf(h), 1),
                        ...
                        e == o._Change.AfterPropertiesChange &&
                            (this._blockEvents--,
                            this._blockEvents < 0 && ((this._blockEvents = 0), k("too many afterpropertieschange events")));
                ...
                (D.prototype._referenceEvent = function (e) {
                    e.target === this &&
                        ...
                        (e.linked && (this.$masterRef = e.reference.getReferenceId()), n.prototype._referenceEvent.call(this, e));
                }),
