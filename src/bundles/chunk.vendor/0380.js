            ...
            ((s.prototype.polys = null),
                        ...
                        return (
                            ...
                            (h[1] = r.equals(m, n)
                                ? h[0]
                                      ...
                                      .scale(1 / 3)
                                : h[0].add(n.scale(y))),
                            (h[2] = r.equals(m, a) ? h[0].add(h[3].scale(2)).scale(1 / 3) : h[3].add(a.scale(y))),
                            s.push(h),
                            1
                        );
                    }
                ...
                (s.prototype._darray_left_tangent = function (e, t, n, r) {
                    ...
                    for (i = 1; ; ) {
                        ...
                        if ((++i, i == o)) return 0 == s ? this._computeLeftTangent(e, t) : a.scale(1 / Math.sqrt(s));
                    }
                }),
                (s.prototype._darray_right_tangent = function (e, t, i, n) {
                    for (var r = i - 1; ; r--) {
                        ...
                        if (r == t) return 0 == a ? this._computeRightTangent(e, i) : o.scale(1 / Math.sqrt(a));
                    }
                }),
                ...
                (s.prototype._generateBezier = function (e, t, i, n, r, a) {
                    ...
                    for (_ = new Array(4), l = i - t + 1, v[0] = [0, 0], v[1] = [0, 0], b[0] = 0, b[1] = 0, s = 0; s < l; s++) {
                        var C = r.scale(A(n[s])),
                            w = a.scale(c(n[s]));
                        ((v[0][0] += C.dot(C)),
                            (v[0][1] += C.dot(w)),
                            ...
                            (v[1][1] += w.dot(w)),
                            (y = e[t + s].subtract(
                                e[t].scale(h(n[s])).add(e[t].scale(A(n[s])).add(e[i].scale(c(n[s])).add(e[i].scale(p(n[s])))))
                            )),
                            (b[0] += C.dot(y)),
                            (b[1] += w.dot(y)));
                    }
                ...
                (s.prototype._newtonRaphsonRootFind = function (e, t, i) {
                    ...
                    var c = o.subtract(t);
                    ((n = c.dot(a)),
                        (l = (r = a.dot(a) + c.dot(s)) > 0 ? i - n / r : n > 0 ? 0.98 * i - 0.01 : n < 0 ? 0.031 + 0.98 * i : i),
                ...
                (s.prototype._evalBezier = function (e, t, i) {
                    ...
                    for (n = 1; n <= e; n++) for (r = 0; r <= e - n; r++) o[r] = o[r].scale(1 - i).add(o[r + 1].scale(i));
                    return o[0];
                }),
                ...
                (s.prototype._computeMaxError = function (e, t, i, n, r, o) {
                    ...
                    var d = n[0];
                    for (a = t + 1; a < i; a++)
                        ((l = (A = (h = this._evalBezier(3, n, r[a - t])).subtract(e[a])).dot(A)) >= s && ((s = l), (o[0] = a)),
                            u < (p = this._computeHook(d, h, 0.5 * (r[a - t - 1] + r[a - t]), n)) && ((u = p), (c = a)),
                            (d = h));
                    var g,
