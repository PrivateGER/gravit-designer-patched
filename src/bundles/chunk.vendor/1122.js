module.exports = function (module, exports, require) {
            ...
            ((f.Inflater = g),
                ...
                (m.prototype._getEntry = function (e) {
                    for (var t = 0; t < this._entries.length; t++) if (0 === this._entries[t].filename.indexOf(e)) return this._entries[t];
                    return null;
                }),
                (m.prototype.load = function (e) {
                    return (
                        ...
                        (this._fontSearch = new A(e.fontProvider, this._workspace.getFontManager())),
                        new Promise(
                            function (e, t) {
                                f.createReader(
                                    ...
                                    function (i) {
                                        ((this._reader = i),
                                            i.getEntries(
                                                function (i) {
                                                    ((this._entries = i),
                                                        this.getReference("meta.json", new f.TextWriter()).then(
                                                            function (n) {
                                                                if (
                ...
                (m.prototype._preProcess = function (e) {
                    e.forEach(
                        function (e) {
                            ("symbolMaster" === e._class && (this._symbolsMaster[e.symbolID] = e),
                                "symbolInstance" === e._class && (this._symbolsInstance[e.do_objectID] = e),
