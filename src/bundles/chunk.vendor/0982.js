module.exports = function (module, exports, require) {
            ...
            function f(e) {
                ((e = e || {}).empty ||
                    (h.checkArgument(e.familyName, "When creating a new Font object, familyName is required."),
                    h.checkArgument(e.styleName, "When creating a new Font object, styleName is required."),
                    h.checkArgument(e.unitsPerEm, "When creating a new Font object, unitsPerEm is required."),
                    h.checkArgument(e.ascender, "When creating a new Font object, ascender is required."),
                    h.checkArgument(e.descender, "When creating a new Font object, descender is required."),
                    h.checkArgument(e.descender < 0, "Descender should be negative (e.g. -512)."),
                    (this.names = {
                        fontFamily: {
                            en: e.familyName || " ",
                        },
            ...
            ((f.prototype.hasChar = function (e) {
                ...
                (f.prototype.stringToGlyphs = function (e, t, i) {
                    ...
                    if (t.features) {
                        var A = t.script || this.substitution.getDefaultScriptName(),
                            f = [];
                        (t.features.liga && (f = f.concat(this.substitution.getFeature("liga", A, t.language))),
                            t.features.rlig && (f = f.concat(this.substitution.getFeature("rlig", A, t.language))));
                        for (h = 0; h < l; h += 1)
                            for (var m = 0; m < f.length; m++) {
                                for (var y = f[m], _ = y.sub, v = _.length, b = 0; b < v && _[b] === s[h + b]; ) b++;
                                b === v &&
                                    (s.splice(h, v, y.by),
                                    i &&
                                        i.splice(h, v, {
                        ...
                        (t.language && this._applyLocalizedForm(s, A, t.language),
                            t.features.stylisticSet && this._applyStylisticSet(s, t.features.stylisticSet, A, t.language));
                    }
                ...
                (f.prototype.forEachGlyph = function (e, t, i, n, r, o) {
                    ...
                    for (var c = 0; c < h.length; c += 1) {
                        ...
                        (r.kerning &&
                            c < h.length - 1 &&
                            (p = l ? this.position.getKerningValue(l, u.index, h[c + 1].index) : this.getKerningValue(u, h[c + 1])),
                            o.call(this, u, t, i, n, r, a && a[c], p),
                            u.advanceWidth && (t += u.advanceWidth * s),
                            r.kerning && p && (t += p * s),
                            r.letterSpacing ? (t += r.letterSpacing * n) : r.tracking && (t += (r.tracking / 1e3) * n));
                    }
                    return t;
                }),
