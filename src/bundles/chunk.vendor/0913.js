            ...
            !(function (r) {
                ...
                function c(e, t) {
                    ...
                    for (
                        e.s = "-" == t.charAt(0) ? ((t = t.slice(1)), -1) : 1,
                            ...
                            (n = t.search(/e/i)) > 0
                                ? (i < 0 && (i = n), (i += +t.slice(n + 1)), (t = t.substring(0, n)))
                                : i < 0 && (i = t.length),
                            r = t.length,
                            n = 0;
                        n < r && "0" == t.charAt(n);
                ...
                function p(e, t, i, n) {
                    ...
                    if (t < 1)
                        ((n =
                            (3 === i && (n || !!r[0])) ||
                            (0 === t && ((1 === i && r[0] >= 5) || (2 === i && (r[0] > 5 || (5 === r[0] && (n || void 0 !== r[1]))))))),
                            (r.length = 1),
                        ...
                        if (
                            ((n =
                                (1 === i && r[t] >= 5) ||
                                (2 === i && (r[t] > 5 || (5 === r[t] && (n || void 0 !== r[t + 1] || 1 & r[t - 1])))) ||
                                (3 === i && (n || !!r[0]))),
                            (r.length = t),
                            n)
                        )
                ...
                function u(e, t, i) {
                    var n = e.e,
                        r = e.c.join(""),
                        o = r.length;
                    if (t) r = r.charAt(0) + (o > 1 ? "." + r.slice(1) : "") + (n < 0 ? "e" : "e+") + n;
                    else if (n < 0) {
                        for (; ++n; ) r = "0" + r;
                        r = "0." + r;
                    } else if (n > 0)
                ...
                ((h.abs = function () {
                    ...
                    (h.minus = h.sub =
                        function (e) {
                            ...
                            var h = o.c.slice(),
                                ...
                                c = e.c,
                                p = e.e;
                            if (!h[0] || !c[0]) return (c[0] ? (e.s = -l) : h[0] ? (e = new a(o)) : (e.s = 1), e);
                            if ((s = A - p)) {
                                for ((r = s < 0) ? ((s = -s), (n = h)) : ((p = A), (n = c)), n.reverse(), l = s; l--; ) n.push(0);
                                n.reverse();
                            } else
                    ...
                    (h.plus = h.add =
                        function (e) {
                            var t,
                                ...
                                r = this,
                                o = r.constructor;
                            if (((e = new o(e)), r.s != e.s)) return ((e.s = -e.s), r.minus(e));
                            var a = r.e,
                                s = r.c,
                                l = e.e,
                                h = e.c;
                            if (!s[0] || !h[0]) return (h[0] || (s[0] ? (e = new o(r)) : (e.s = r.s)), e);
                            if (((s = s.slice()), (t = a - l))) {
                                for (t > 0 ? ((l = a), (n = h)) : ((t = -t), (n = s)), n.reverse(); t--; ) n.push(0);
                                n.reverse();
                            }
                            for (s.length - h.length < 0 && ((n = h), (h = s), (s = n)), t = h.length, i = 0; t; s[t] %= 10)
                                i = ((s[--t] = s[t] + h[t] + i) / 10) | 0;
                            for (i && (s.unshift(i), ++l), t = s.length; 0 === s[--t]; ) s.pop();
                    ...
                    (h.times = h.mul =
                        function (e) {
                            var t,
                                ...
                                l = i.e,
                                h = e.e;
                            if (((e.s = i.s == e.s ? 1 : -1), !r[0] || !o[0])) return ((e.c = [(e.e = 0)]), e);
                            for (
                                e.e = l + h, a < s && ((t = r), (r = o), (o = t), (h = a), (a = s), (s = h)), t = new Array((h = a + s));
                                h--;
                    ...
                    ((o = (function e() {
                        function t(i) {
                            var n = this;
                            if (!(n instanceof t)) return void 0 === i && 0 === arguments.length ? e() : new t(i);
