module.exports = function (module, exports, require) {
            ...
            (r.inheritAndMix(d, r),
                ...
                (d.prototype.setProject = function (e) {
                    if (!l.hasOwnProperty(e)) throw Error("Project '" + e + "' doesn't exist!");
                    this._project = e;
                }),
                ...
                (d.prototype._getClassIdentifier = function (e) {
                    return (
                        ((e instanceof h && "string" != typeof e.getReference()) || (!(e instanceof h) && "string" != typeof e)) &&
                            this._sendNotification(
                                c.Type.Warning,
                                "Using class instead of string for:" + (e instanceof h ? e.getReference() : e),
                                {
                                    clazz: e,
                                }
                            ),
                ...
                (d.prototype.lookupLanguage = function (e) {
                    ...
                    if (e) {
                        if (this._project) {
                            if (
                                (t = this._translationInstance.getByProject(this._project).find(function (t) {
                                    return t.abbreviation.toLowerCase() == e.toLowerCase();
                                }))
                            )
                                return t.keyValue;
                            if (
                                (i = this._translationInstance.getByProject(this._project).find(function (t) {
                                    return t.abbreviation.toLowerCase().slice(0, 2) == e.toLowerCase().slice(0, 2);
                                }))
                            )
                                return i.keyValue;
                            if (
                                (r = this._translationInstance.getByProject(this._project).find(function (t) {
                                    return t.abbreviation.toLowerCase().slice(0, 2) === e.toLowerCase().slice(0, 2);
                                }))
                            )
                                return r.keyValue;
