            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(m, r, [r.Map]),
                    ...
                    var P = function (e) {
                        ...
                        if (i && !i.isEmpty()) {
                            ...
                            for (t = 0; t < _.length; ++t) {
                                var E = _[t];
                                ((!C || (C.getX() <= E.getX() && C.getX() + C.getWidth() >= E.getX())) &&
                                    ((l = Math.abs(B.getX() - E.getX())),
                                    (null === p && l <= n) || (null !== p && l < Math.abs(B.getX() - p))
                                        ? ((p = E.getX()),
                                          (f = l),
                                          (d = {
                                          ...
                                          B.getY() <= r.getY()
                                              ? (d.line = [new o(p, B.getY() - v), new o(p, s.getY() + v)])
                                              : r.getY() < B.getY() && B.getY() < s.getY()
                                                ? (d.line = [new o(p, r.getY() - v), new o(p, s.getY() + v)])
                                                : (d.line = [new o(p, r.getY() - v), new o(p, B.getY() + v)]))
                                        : null !== p &&
                                          ...
                                          B.getY() <= r.getY()
                                              ? d.line[1].getY() < s.getY() + v && (d.line[1] = new o(p, s.getY() + v))
                                              : r.getY() < B.getY() && B.getY() < s.getY()
                                                ? (d.line[1].getY() < s.getY() + v && (d.line[1] = new o(p, s.getY() + v)),
                                                  d.line[0].getY() > r.getY() - v && (d.line[0] = new o(p, r.getY() - v)))
                                                : d.line[0].getY() > r.getY() - v && (d.line[0] = new o(p, r.getY() - v)))),
                                    (!C || (C.getY() <= E.getY() && C.getY() + C.getHeight() >= E.getY())) &&
                                        ((l = Math.abs(B.getY() - E.getY())),
                                        (null === u && l <= n) || (null !== u && l < Math.abs(B.getY() - u))
                                            ? ((u = E.getY()),
                                              (y = l),
                                              (g = {
                                              ...
                                              B.getX() <= r.getX()
                                                  ? (g.line = [new o(B.getX() - v, u), new o(s.getX() + v, u)])
                                                  : r.getX() < B.getX() && B.getX() < s.getX()
                                                    ? (g.line = [new o(r.getX() - v, u), new o(s.getX() + v, u)])
                                                    : (g.line = [new o(r.getX() - v, u), new o(B.getX() + v, u)]))
                                            : null !== u &&
                                              ...
                                              B.getX() <= r.getX()
                                                  ? g.line[1].getX() < s.getX() + v && (g.line[1] = new o(s.getX() + v, u))
                                                  : r.getX() < B.getX() && B.getX() < s.getX()
                                                    ? (g.line[1].getX() < s.getX() + v && (g.line[1] = new o(s.getX() + v, u)),
                                                      g.line[0].getX() > r.getX() - v && (g.line[0] = new o(r.getX() - v, u)))
                                                    : g.line[0].getX() > r.getX() - v && (g.line[0] = new o(r.getX() - v, u)))));
                            }
                        }
                    }.bind(this);
                ...
                (m.prototype.useExclusions = function (e) {
                    if (e && e.length) {
                        var t;
                        this._exclusions = [];
                        for (var i = 0; i < e.length; ++i) ((t = e[i]) instanceof s || t instanceof d) && this._exclusions.push(t);
                    }
                }),
                ...
                (m.prototype.checkDistanceGuidesMapping = function (e, t, i, n, r, o, s) {
                    var l,
                        ...
                        u = null,
                        d = null,
                        g = ((t = i ? t / i : t), [e.getSide(a.Side.TOP_LEFT), e.getSide(a.Side.BOTTOM_RIGHT), e.getSide(a.Side.CENTER)]),
                        f = e,
                        m = null,
                    ...
                    var b = function (e, i, n) {
                        if (this._exclusions && this._exclusions.length)
                            for (var r = 0; r < this._exclusions.length; ++r) if (this._exclusions[r] == e) return;
                        var o = e.getGeometryBBox();
                        if (o && !o.isEmpty()) {
                            var s,
                                l,
                                c = [o.getSide(a.Side.TOP_LEFT), o.getSide(a.Side.BOTTOM_RIGHT), o.getSide(a.Side.CENTER)],
                                p = null,
                                u = null;
                            ...
                            for (var t, i = false, n = [], r = [], o = null, a = 0; a < e.length && !i; ++a) {
                                ((t = e[a]),
                                    !(i = !f.intersected(t.bBox).isEmpty()) &&
                                        (null === o || t.absDelta <= o) &&
                                        (null === o || t.absDelta < o
                                            ? (t.delta >= 0 ? ((n = [t]), (r = [])) : ((r = [t]), (n = [])), (o = t.absDelta))
                                            : t.delta >= 0
                                              ? n.push(t)
                                              : r.push(t)));
                            }
                ...
                (m.prototype.getDistGuides = function (e, t, i, n) {
                    var r,
                        ...
                        u = [];
                    n
                        ? ((o = (r = e.getY()) + e.getHeight()), (l = (s = t.getY()) + t.getHeight()), (p = i.getY()), i.getHeight())
                        : ((o = (r = e.getX()) + e.getWidth()), (l = (s = t.getX()) + t.getWidth()), (p = i.getX()), i.getWidth());
                    var d = [];
                    o < s && o < p
                        ? (d.push(e), l < p ? (d.push(t), d.push(i)) : (d.push(i), d.push(t)))
                        : l < r && l < p
                          ? (d.push(t), o < p ? (d.push(e), d.push(i)) : (d.push(i), d.push(e)))
                          : (d.push(i), o < s ? (d.push(e), d.push(t)) : (d.push(t), d.push(e)));
                                ...
                                if ((n && c.isEqualEps(C.getX(), E.getX())) || (!n && c.isEqualEps(C.getY(), E.getY()))) {
                                    ...
                                    (v
                                        ...
                                        : ((B.freeSegments = B.freeSegments ? B.freeSegments : []),
                                          ...
                                          n
                                              ? ((B.orient = h.Orientation.V), B.freeSegments.push([C.getY(), E.getY()]))
                                              : ((B.orient = h.Orientation.H), B.freeSegments.push([C.getX(), E.getX()]))),
                                        u.push(B));
                                }
                            }
                    }
                ...
                (m.prototype._setEffectiveScope = function (e) {
                    if (((this._eSnapElems = []), e.hasMixin(p.Container)))
                        for (var t = e.getFirstChild(); null != t; t = t.getNext()) t instanceof u && this._eSnapElems.push(t);
                }),
                ...
                (m.prototype._getAllChildrenInBBox = function (e, t) {
                    ...
                    if (e.hasMixin(l.Accelerated)) i = e.retrieveChildrenInGeometryBBox(t, f.RETRIEVE_MODE_INTERSECT) || [];
                    else
                    ...
                    for (var o = [], a = 0; a < i.length; a++) o = o.concat(this._getAllChildrenInBBox(i[a], t));
                    return i.concat(o);
                }),
                        ...
                        for (h = 0; h < o.length; h++) {
                            ...
                            if ((g instanceof s || g instanceof d) && !g.hasFlag(l.Flag.Hidden)) {
                                ...
                                if (m || g.getParent() instanceof s) {
                                    if (m) for (var y = 0; y < m.length && !f; ++y) g == m[y] && (f = g);
                                } else f = g;
                                f && n(f);
                            }
                        }
