            ...
            (a.inherit(h, a),
                ...
                (h.store = function (e, t) {
                    if (((t = t || {}), e.hasMixin(h.Store) && !(t.exceptions && t.exceptions.indexOf(e) >= 0))) {
                        ...
                        return (
                            e.hasMixin(h.Reference) && e._referenceId && (i["#"] = e._referenceId),
                            e.hasMixin(h.Multireference) && e._multiReferenceId && (i["&"] = e._multiReferenceId),
                ...
                (h._restoreInstance = function (e, t, i, n, r, o, a) {
                    ...
                    (t._notifyChange(h._Change.PrepareRestore, s),
                        t.hasMixin(h.Identity) && e.hasOwnProperty("@id") && (t.__id = e["@id"]));
                    var l = function () {
                        if (t.hasMixin(h.Properties))
                            for (var i in e) "@" === i.charAt(0) && e.hasOwnProperty(i) && i.length > 1 && (t[i] = e[i]);
                        (t.hasMixin(h.Reference) && e.hasOwnProperty("#") && (t._referenceId = e["#"]),
                            t.hasMixin(h.Multireference) && e.hasOwnProperty("&") && (t._multiReferenceId = e["&"]),
                ...
                (h.serialize = function (e, t) {
                    ...
                    if (e instanceof Array) {
                        for (var r = [], o = 0; o < e.length; ++o) {
                            if (!(t && t.exceptions && t.exceptions.indexOf(e[o]) >= 0)) (a = h.store(e[o], n)) && r.push(a);
                        }
                        if (r.length > 0) {
                            try {
                ...
                (h.countBlobChildren = function (e, t) {
                    ...
                    if (e.hasOwnProperty("$")) {
                        var i = e.$;
                        if (i.length > 0) for (var n = 0; n < i.length; ++n) t = h.countBlobChildren(i[n], t);
                    }
                    return t;
                }),
                ...
                (h.Container.prototype.getChildren = function () {
                    for (var e = [], t = this.getFirstChild(); null !== t; t = t.getNext()) e.push(t);
                    return e;
                }),
                ...
                (h.Container.prototype.insertChild = function (e, t) {
                    if (null != e._parent) throw new Error("Child is already appended somewhere else");
                    if (null != t && t.getParent() != this) throw new Error("Reference is not a child of this node");
                    if (!e.validateInsertion(this, t)) throw new Error("Child insertion validation failed.");
                    (this._notifyChange(h._Change.BeforeChildInsert, e),
                        null != t
                            ? (e._setNext(t),
                              e._setPrevious(t._previous),
                              t._setPrevious(e),
                              null == e._previous ? (this._firstChild = e) : e._previous._setNext(e))
                            : (null != this._lastChild &&
                                  (e._setPrevious(this._lastChild), this._lastChild._setNext(e), (this._lastChild = e)),
                              e._setNext(null)),
                        null == this._firstChild && ((this._firstChild = e), e._setPrevious(null), e._setNext(null)),
                ...
                (h.Container.prototype.removeChild = function (e) {
                    if (e._parent != this) throw new Error("Child is not a child of this node");
                    if (!e.validateRemoval()) throw new Error("Child removal validation failed.");
                ...
                (h.Container.prototype.getSubnodeIds = function (e) {
                    for (var t = this.getLastChild(); null !== t; t = t.getPrevious())
                        (t.hasMixin(h.Multireference) &&
                            (e[t.getMultireferenceId()] && t.resetMultireference(), (e[t.getMultireferenceId()] = t)),
                ...
                h.inheritAndMix("MapContainer", h.MapContainer, h, [h.Store, h.Container]),
                ...
                (h.MapContainer.prototype.removeChild = function (e) {
                    ...
                    (this._notifyChange(h._Change.BeforeChildRemove, e),
                        this._children[e.getId()] &&
                            (delete this._children[e.getId()], this._children || (this._children = Object.create(null))),
                        this._firstChild == e && (this._firstChild = e._next),
                        this._lastChild == e && (this._lastChild = e._previous),
                        null != e._previous && e._previous._setNext(e._next),
                        null != e._next && e._next._setPrevious(e._previous),
                ...
                (h.MapContainer.prototype.getAsArray = function () {
                    ...
                    if (!e) return null;
                    for (var t = new Array(e), i = 0, n = this.getFirstChild(); i < e && n; ++i, n = n.getNext()) t[i] = n;
                    return t;
                }),
                ...
                (h.prototype._beginBlockChanges = function (e, t) {
                    ...
                    for (var i = 0; i < e.length; ++i) {
                        var n = e[i];
                        (n in this._blockedChanges ? this._blockedChanges[n]++ : (this._blockedChanges[n] = 1),
                ...
                (h.prototype._getCompositeEvents = function (e, t, i) {
                    var n = [];
                    return (
                        e && (n = n.concat([h.BeforeInsertEvent, h.AfterInsertEvent, h.BeforeRemoveEvent, h.AfterRemoveEvent])),
                        t && (n = n.concat([h.AfterPropertiesChangeEvent])),
                        i && (n = n.concat([h.BeforeFlagChangeEvent, h.AfterFlagChangeEvent])),
                        n
                    );
                }),
                ...
                (h.prototype._sendEvent = function (e) {
                    ...
                    if (e.temporary)
                        for (
                            (t instanceof r || t.hasMixin(r)) && t.hasEventListeners(e.constructor) && t.trigger(e), t = t.getParent();
                            t;
                            t = t.getParent()
                        )
                ...
                (h.prototype._setWorkspace = function (e) {
                    e !== this._workspace &&
                        (this._workspace &&
                            ...
                            this.hasMixin(h.Reference) && this._workspace.removeReference(this),
                ...
                (h.prototype._setParent = function (e) {
                    this._parent !== e &&
                        (this._parent && (this._notifyChange(h._Change.ParentDetach), this._detachFromParent(this._parent)),
                        (this._parent = e),
                        this._parent && (this._attachToParent(this._parent), this._notifyChange(h._Change.ParentAttached)));
                }),
                ...
                (h.prototype._handleChange = function (e, t) {
                    if (e === h._Change.PrepareRestore) this._isRestoring = !0;
                        ...
                        (n = t).forceEvent && this._canEventBeSent(h.BeforePropertiesChangeEvent)
                            ? this._sendEvent(new h.BeforePropertiesChangeEvent(this, n.properties, n.values, n.custom, n.temporary))
                            : !n.temporary &&
                              this._canEventBeSent(h.BeforePropertiesChangeEvent) &&
                              this._sendEvent(new h.BeforePropertiesChangeEvent(this, n.properties, n.values, n.custom));
                    } else if (e == h._Change.AfterPropertiesChange) {
                        var n = t;
                        this._canEventBeSent(h.AfterPropertiesChangeEvent) &&
                            (n.forceEvent,
                            this._sendEvent(new h.AfterPropertiesChangeEvent(this, n.properties, n.values, n.custom, n.temporary)));
