                            ...
                            if (this._mode != o.Mode.Edit)
                                if ((this._renewPreviewLink(), this._newPoint && this._pathEditor)) {
                                    ...
                                    (this._editor.getGuides().beginMap(this._editor.getMappingScopes()),
                                        (h = this._editor.getGuides().mapPoint(h, n.DetailMap.Mode.DetailOnFilterOn)),
                        ...
                        if (
                            ...
                            t &&
                                this._pathEditor.hitAnchorPoint(
                                    t,
                                    this._view.getWorldTransform(this._view.getScene().getActivePage()).mapPoint(n),
                    ...
                    if (!(new Date().getTime() - this._mDownTime < o.DBLCLICKTM))
                        if (A.leaveWhenClosePath && this._pathRef && this._pathRef.getProperty("closed")) this._manager.notifyJobDone(this);
                            ...
                            if (this._released)
                                if (
                                    (this.isPanning()
                                        ? this.panView(e.client, new h(A.autoPanStep, A.autoPanStep), new h(40, 40))
                                        : this.beginPan(),
                                    (this._lastMouseEvent = e),
                                    this._checkMode(),
                                        ...
                                        (this._mode == o.Mode.Append
                                            ...
                                            this._pathEditor.hitAnchorPoint(
                                                ...
                                                : this._pathEditor.hitAnchorPoint(
                                                  ...
                                                  : this._hitSideConnectPoints(this._view.getViewTransform().mapPoint(r))
                                                    ? this._setCursorForPosition(s.PenEnd)
                    ...
                    if (
                        ...
                        this._mode != o.Mode.Edit
                            ? this._mode == o.Mode.Append
                                ...
                                : null !== this._editPt.getProperty("hrx") && null !== this._editPt.getProperty("hry")
                                  ? this._editPt.setProperties(["tp", "hlx", "hly"], [u.AnchorPoint.Type.Symmetric, null, null])
                                  : this._editPt.setProperties(["tp", "hlx", "hly"], [u.AnchorPoint.Type.Asymmetric, null, null])
                            : d.modifiers.optionKey
                              ? this._editPt.setProperties(["tp", "hrx", "hry"], [u.AnchorPoint.Type.Asymmetric, null, null])
                ...
                (y.prototype._mouseDrag = function (e) {
                    (this.isPanning() && this.panView(e.client, e.clientDelta),
                        !this._refPt ||
                            ...
                            e.button == l.BUTTON_LEFT && this._editPt.setProperty("tp", u.AnchorPoint.Type.Symmetric),
                            this._pathEditor.requestInvalidation()),
                        !this._released &&
                            this._editPt &&
                            ((this._lastMouseEvent = e),
                    ...
                    if ((this._pathEditor.requestInvalidation(), this._editPt && this._editPt.getProperty("tp") == u.CornerType.Rounded))
                        ...
                        if (this._lastMouseEvent && this._lastMouseEvent.clientDelta && this._editPt) {
                            var i = this._editPt.getProperty("x"),
                                ...
                                r = new h(i + this._lastMouseEvent.clientDelta._x, n + this._lastMouseEvent.clientDelta._y);
