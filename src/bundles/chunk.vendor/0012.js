            ...
            ((r.PI2 = 2 * Math.PI),
                ...
                (r.getIntersectionPoint = function (e, t, i, o, a, s, l, h, A) {
                    ...
                    return (!A && 0 <= d && d <= 1 && 0 <= g && g <= 1) || A
                        ? (A && ((A[0] = d), (A[1] = g)), new n(e + d * (i - e), t + d * (o - t)))
                        : null;
                }),
                (r.circleLineIntersection = function (e, t, i, n, o, a, s, l) {
                    ...
                    if (!r.isEqualEps(A, 0)) {
                        ...
                        r.isEqualEps(p, 0)
                            ? (l[0] = (i * (o - e) + n * (a - t)) / A)
                            : p > 0 && ((c = i * (o - e) + n * (a - t)), (l[0] = (c - Math.sqrt(p)) / A), (l[1] = (c + Math.sqrt(p)) / A));
                    }
                }),
                (r.circleCircleIntersection = function (e, t, i, o, a, s, l) {
                    ...
                    if (!r.isEqualEps(h, 0)) {
                        var d = (i * i - s * s) / (2 * h),
                            g = (e + o) / 2 + (o - e) * d,
                            f = (t + a) / 2 + (a - t) * d;
                        if (r.isEqualEps(h, u) || (!r.isEqualEps(h, 0) && r.isEqualEps(h, c))) l[0] = new n(g, f);
                        else if (c < h && h < u) {
                ...
                (r.getPointAtLength = function (e, t, i, o, a, s) {
                    ...
                    return a <= 0
                        ...
                        : ((l = Math.sqrt((i - e) * (i - e) + (o - t) * (o - t))),
                          !s && a >= l ? new n(i, o) : ((h = a / l), r.getPointAtSegment(e, t, i, o, h)));
                }),
                ...
                (r.sqrSegmentDist = function (e, t, i, n, o, a, s, l) {
                    if (r.isEqualEps(e, i) && r.isEqualEps(t, n)) return r.ptSqrDist(e, t, o, a);
                    var h,
                        A,
                        c,
                        p,
                              ...
                              : s && l && r.ptSqrDist(o, a, i, n) <= l
                                ...
                                : ((c = i - e),
                                  ...
                                  (g = r.vDotProduct(h, A, c, p) / r.vDotProduct(c, p, c, p)) <= 0
                                      ? ((f = r.vDotProduct(h, A, h, A)), s && (s[0] = 0))
                                      : g >= 1
                                        ? ((f = r.vDotProduct(o - i, a - n, o - i, a - n)), s && (s[0] = 1))
                                        : ((u = h - c * g), (d = A - p * g), (f = r.vDotProduct(u, d, u, d)), s && (s[0] = g))),
                        f
                    );
                }),
                (r.getSegmToSegmSqrDist = function (e, t, i, n) {
                    var o = r.sqrSegmentDist(e.getX(), e.getY(), t.getX(), t.getY(), i.getX(), i.getY()),
                        a = o;
                    return (
                        a > 0 &&
                            ((o = r.sqrSegmentDist(e.getX(), e.getY(), t.getX(), t.getY(), n.getX(), n.getY())) < a && (a = o),
                            a > 0 &&
                                ((o = r.sqrSegmentDist(i.getX(), i.getY(), n.getX(), n.getY(), e.getX(), e.getY())) < a && (a = o),
                                a > 0 &&
                                    (o = r.sqrSegmentDist(i.getX(), i.getY(), n.getX(), n.getY(), t.getX(), t.getY())) < a &&
                                    (a = o))),
                        a
                    );
                }),
                ...
                (r.solveLinear2Pseudo = function (e, t, i, o, a, s) {
                    ...
                    null == A &&
                        (r.isEqualEps(e + t, 0) || (r.isEqualEps(i, 0) && !r.isEqualEps(s, 0))
                            ? r.isEqualEps(o + a, 0) || (r.isEqualEps(s, 0) && !r.isEqualEps(i, 0))
                                ...
                                : (h = l = s / (o + a))
                            : (h = l = i / (e + t)),
                        r.isEqualEps(e * l + t * h, i) && r.isEqualEps(o * l + a * h, s) && (A = new n(l, h)));
                    return A;
                }),
                ...
                (r.uSortSegment = function (e, t, i, n) {
                    ...
                    if (
                        ...
                        return r;
                    for (var o = 1; o < i.length; o++) i[o] != i[o - 1] && i[o] >= e && i[o] <= t && (n.push(i[o]), ++r);
                    return r;
                }),
                ...
                (r.getCubicRoots = function (e, t, i, n, o, a) {
                    ...
                    return (
                        ...
                        (d = w[2]),
                        (g = w[3]),
                        0 == t && 1 == i ? r.inversePolyUnaryInterval(w, 3, E) : r.inversePolyInterval(w, 3, t, i, E),
                        0 == r.estimPositiveRootsDescartes(E, 3)
                            ...
                            : (r.getCoeffPolyDeriv(w, 3, B),
                              ...
                              0 == (h = u * u - B[0] * d)
                                  ? ((c = 1), (l = s = -u / B[0]))
                                  : h > 0 && ((c = 2), (s = (-u - (A = Math.sqrt(h))) / B[0]), (l = (-u + A) / B[0])),
                ...
                (r.locateByNewton = function (e, t, i, n, o, a, s, l, h, A, c) {
                    ...
                    if (((g = e), (f = t), 3 == a))
                        ...
                        if (
                            ...
                            for (
                                ...
                                P < R.length ? ((f = R[P]), (F[1] = null), b && (I[1] = null)) : ((f = t), (F[1] = n), b && (I[1] = c[1])),
                                !(
                                    C &&
                    ...
                    for (P = 1; null != w && (S < B || h < S) && P < r._maxIter; )
                        (x < (p = r.evalPoly(s, E, w)) && p < r.defaultEps
                            ...
                            : ((v = w),
                              ((w -= p = (S = r.evalPoly(o, a, w)) / p) <= g || w >= f) && (w = null),
                              p > 0 ? (f = v) : p < 0 && (g = v)),
                            ++P);
                ...
                (r.getQuadraticRoots = function (e, t, i, n) {
                    ...
                    0 == e
                        ...
                        : 0 == (r = t * t - 4 * e * i)
                          ? n.push(-t / (2 * e))
                          : r > 0 && ((o = Math.sqrt(r)), n.push((-t + o) / (2 * e)), n.push((-t - o) / (2 * e)));
                }),
                ...
                (r.getSturmPRS = function (e, t, i, n) {
                    ...
                    for (
                        u[0] = null,
                            ...
                            m[1] = 1,
                            o = 1;
                        o < t && ((f = []), (c = r._pseudoRem(n[o - 1], n[o], f)), 0 != f.length);
                        ++o
                    ) {
                        for (n[o + 1] = [], a = 0; a < f.length; ++a) n[o + 1][a] = f[a] / u[o];
                        for (
                            d[o] = n[o + 1].length - n[o].length, p[o + 1] = n[o + 1][0], l = 1, h = 1, A = p[o + 1], s = 2;
                            s <= d[o];
                            ++s
                        )
                            ((l *= g[o]), (h = -h), (A *= p[o + 1]));
                        ((u[o + 1] = h * l * g[o] * p[o]),
                            (g[o + 1] = A / l),
                            (u[o] > 0 && c > 0) || (u[o] < 0 && c < 0) ? (m[o + 1] = -m[o - 1]) : (m[o + 1] = m[o - 1]));
                    }
                    for (o = 2; o < n.length; ++o) if (m[o] < 0) for (a = 0; a < n[o].length; ++a) n[o][a] = -n[o][a];
                }),
                ...
                (r.locRootsSturm = function (e, t, i, n, o, a, s, l, h, A, c) {
                    ...
                    if (!(s <= 1))
                        if (
                            ...
                            1 == g || c > 31
                                ? A.push([n, p, d[0], d[1]])
                                : g > 1 && (++c, r.locRootsSturm(e, t, i, n, p, a, g, u, d, A, c)),
                            1 == f || c > 31)
                        )
                            A.push([p, o, d[1], h[1]]);
                        else if (f > 1) {
                ...
                (r.shiftPoly = function (e, t, i, n) {
                    ...
                    for (n[0] = e[0], o = 1; o <= t; ++o)
                        for (n[o] = e[o], a = 0; a < o; ++a) n[o] += r.combNK(t - a, o - a) * e[a] * s[o - a];
                }),
                ...
                (r.combNK = function (e, t) {
                    if (!(e <= 5 && t <= e)) throw new Error("Combinations calculation not implemented");
                    return 5 == e
                        ? r._numComb5[t]
                        : 4 == e
                          ? r._numComb4[t]
                ...
                (r.shiftPolyOne = function (e, t, i) {
                    var n, o;
                    for (i[0] = e[0], n = 1; n <= t; ++n) for (i[n] = e[n], o = 0; o < n; ++o) i[n] += r.combNK(t - o, n - o) * e[o];
                }),
                (r.inversePolyInterval = function (e, t, i, n, o) {
                    ...
                    if ((r.shiftPoly(e, t, i, h), 0 != (s = n - i))) for (l = 1, a = 1; a <= t; ++a) ((l /= s), (h[t - a] *= l));
                ...
                (r.estimPositiveRootsDescartes = function (e, t) {
                    ...
                    for (i = 0; i < r - 1; ++i) ((n[i] > 0 && n[i + 1] < 0) || (n[i] < 0 && n[i + 1] > 0)) && (o += 1);
                    return o;
                }),
