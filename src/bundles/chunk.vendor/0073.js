module.exports = function (module, exports, require) {
            ...
            (o.inherit("rectangle", h, a),
                ...
                (h.SIDES = [r.Side.TOP_LEFT, r.Side.TOP_RIGHT, r.Side.BOTTOM_RIGHT, r.Side.BOTTOM_LEFT]),
                (h.prototype._x = -1),
                (h.prototype._y = -1),
                (h.prototype._w = 2),
                (h.prototype._h = 2),
                ...
                (h.prototype.getPointsMinDistance = function () {
                    ...
                    return (
                        this.$trf && ((e = this.$trf.mapPoint(e)), (t = this.$trf.mapPoint(t)), (i = this.$trf.mapPoint(i))),
                        Math.min(s.ptDist(e.getX(), e.getY(), t.getX(), t.getY()), s.ptDist(e.getX(), e.getY(), i.getX(), i.getY()))
                    );
                }),
                    ...
                    if (e === o._Change.Store)
                        if (this.$uf) ((t.blob.uf = true), (t.blob.ct = this.$tl_ct), (t.blob.sl = this.$tl_sx));
                            ...
                            for (var i = 0; i < h.SIDES.length; ++i) {
                                ...
                                ((t.blob[r + "uf"] = this["$" + r + "_uf"]),
                                    ...
                                    (t.blob[r + "sl"] = [this["$" + r + "_sx"], this["$" + r + "_sy"]]));
                            }
                        }
                        ...
                        if (true !== t.blob.uf && false !== t.blob.uf) this._setDefaultProperties(h.GeometryProperties);
                            ...
                            for (i = 0; i < h.SIDES.length; ++i) {
                                n = h.SIDES[i];
                                ((this["$" + (r = h.getGeometryPropertiesSidePrefix(n)) + "_uf"] = t.blob.uf
                                    ? t.blob.uf
                                    : t.blob[r + "uf"]),
                                    (this["$" + r + "_ct"] = t.blob.uf ? t.blob.ct : t.blob[r + "ct"]),
                                    (this["$" + r + "_sx"] = t.blob.uf ? t.blob.sl : t.blob[r + "sl"][0]),
                                    (this["$" + r + "_sy"] = t.blob.uf ? t.blob.sl : t.blob[r + "sl"][1]));
                            }
                        }
                        this._invalidatePath();
                    }
                    if (
                        this._canHandleGeometryChangeForProperties(e, t, h.GeometryProperties) &&
                ...
                (h.prototype.calculateMitterLimit = function (e) {
                    var t = function (e, t, i) {
                            if (e && t && i) {
                                var n = Math.sqrt(Math.pow(i.getX() - e.getX(), 2) + Math.pow(i.getY() - e.getY(), 2)),
                                    r = Math.sqrt(Math.pow(i.getX() - t.getX(), 2) + Math.pow(i.getY() - t.getY(), 2)),
                                    o = Math.sqrt(Math.pow(t.getX() - e.getX(), 2) + Math.pow(t.getY() - e.getY(), 2));
