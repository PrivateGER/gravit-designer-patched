            ...
            module.exports = function (e) {
                ...
                ((e.prototype.arc = function (t, i, n, r, o, a) {
                    ...
                    (e.LinearGradient = function (i, n, r, o, a) {
                        var s = void 0;
                        ((this.ctx = new e(t, s, s, s, s, s, s, i.__multiThreaded, i.__persistent)),
                    ...
                    (e.LinearGradient.prototype._render = function () {
                        ...
                        for (
                            var t = e.getFlt(this.ctx),
                                ...
                                n = e.getFlt(this.ctx),
                                r = e.getFlt(this.ctx),
                                o = e.getPtr(this.ctx).$realCtx.createLinearGradient(t, i, n, r);
                    ...
                    (e.LinearGradient.prototype._dumpCode = function (t, i) {
                        e.resetExec(this.ctx);
                        for (
                            var n = [e.getFlt(this.ctx), e.getFlt(this.ctx), e.getFlt(this.ctx), e.getFlt(this.ctx)],
                    ...
                    (e.RadialGradient = function (i, n, r, o, a, s, l) {
                        var h = void 0;
                        ((this.ctx = new e(t, h, h, h, h, h, h, i.__multiThreaded, i.__persistent)),
                            this.ctx.__pushFltT(n),
                            this.ctx.__pushFltT(r),
                            this.ctx.__pushFltT(o),
                            this.ctx.__pushFltT(a),
                    ...
                    (e.RadialGradient.prototype._render = function () {
                        ...
                        for (
                            var t = e.getFlt(this.ctx),
                                ...
                                o = e.getFlt(this.ctx),
                                a = e.getFlt(this.ctx),
                                s = e.getPtr(this.ctx).$realCtx.createRadialGradient(t, i, n, r, o, a);
                            this.ctx.__execPtr < this.ctx.__len;
                    ...
                    (e.ImageData = function (t, i, n, r, o) {
                        if ((e.Renderable.call(this, t), r < 1)) throw new Error("GRendererCtx: Empty imagedata");
                    ...
                    (e.ImageData.prototype._dumpCode = function (t, i) {
                        var n =
                            "var " + i + " = " + t + ".getImageData(" + this.sx + "," + this.sy + "," + this.sw + "," + this.sh + ");\n";
                        return (
                            this.imgCtx &&
                                (e.resetExec(this.ctx),
                                this.imgCtx.__execPtr < this.imgCtx.__len && (n += "// some modifier executed on data.\n")),
                            n
                        );
                    }),
                    ...
                    (e.prototype.createPattern = function (t, i) {
                        ...
                        return (
                            t.$type === e.INSTANCE_RENDERERCANVAS && t.parent !== this && (t.parent._flush(this), t.parent.__finish(this)),
                            n
                        );
                    }),
                    ...
                    (e.prototype.drawImage = function (t, i, n, r, o, a, s, l, h) {
                        (this.__pushByte(e.drawImage),
                            ...
                            void 0 !== a && (this.__pushPtr(a), this.__pushPtr(s), this.__pushPtr(l), this.__pushPtr(h)),
                            this.__call(),
                            t.$type === e.INSTANCE_RENDERERCANVAS && t.parent !== this && (t.parent._flush(this), t.parent.__finish(this)));
                    }),
                    ...
                    (e.prototype.moveTo = function (t, i) {
                        (this.__pathStart ||
                            ((this.__pathStart = this.__pathStartArr), (this.__pathStart[0] = t), (this.__pathStart[1] = i)),
                    ...
                    (e.prototype.restore = function () {
                        ...
                        if (t) for (var i = e.propertiesToSync["2d"], n = 0; n < i.length; n++) this["$" + i[n]] = t[n];
                    ...
                    (e.prototype.save = function () {
                        ...
                        for (var i = 0; i < t.length; i++) this.$savedProperties[i] = this[t[i]];
