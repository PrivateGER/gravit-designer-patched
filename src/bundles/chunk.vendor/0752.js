            ...
            (r.inherit(b, r),
                ...
                (b.prototype.activate = function (e) {
                    ...
                    (t && t.setInlineEdit(!0),
                        ...
                        this._view.startCaptureInput(this._boxInput.bind(this), this._compStart.bind(this), this._compEnd.bind(this)),
                        this._view.isCapturingInput() || e.addEventListener(c.Press, this._keyPress, this));
                }),
                (b.prototype.deactivate = function () {
                    ...
                    (e && e.setInlineEdit(!1),
                        ...
                        this._view.removeEventListener(s.DblClick, this._mouseDblClick, this),
                ...
                (b.prototype.hideCaretAndSelection = function () {
                    if (0 !== this._caretInterval) {
                        var e = this._editor.getElement().getTLCore();
                        (e && ((this._lastSelect = g.extend({}, e.getSelection())), e.select(0, 0)),
                ...
                (b.prototype._changeLine = function (e, t) {
                    ...
                    if (i) {
                        ...
                        for (this._nextKeyboardX = null !== this._keyboardX ? this._keyboardX : r.l; !this._exhausted(e, t); ) {
                            ...
                            if (((e += t), (n = i.getCaretCoords(e)), this._differentLine(n, r))) break;
                        }
                        for (
                            r = n;
                            !this._exhausted(e, t) && !((t > 0 && n.l >= this._nextKeyboardX) || (t < 0 && n.l <= this._nextKeyboardX));
                                ...
                                case u.Constant.LEFT:
                                    if (this._compositionOn)
                                        r > 0 &&
                                            ...
                                            this._lastCompositedTextLength > this._compositionSelectionDelta &&
                                                d > 0 &&
                        ...
                        return (
                            ...
                            n && r && r.length
                                ...
                                : !i &&
                                  r &&
                                  (t
                                      ? ((a = s.indexOf(o)) >= 0 && (r = ')!@#$%^&*(:+<_>?~{|}"~{|}"'.charAt(a)), (l = r && r.length))
                                      : (l =
                                            (r = (a = s.indexOf(o)) >= 0 ? "0123456789;=,-./`[\\]'`[\\]'".charAt(a) : r.toLowerCase()) &&
                                            r.length)),
                            l
                        );
                    }
                        ...
                        if (this.hasFocus()) {
                            if (!b.IS_NON_PRINTABLE_REG.test(i) && !this._keyDownHandled) {
                                if ((this._editor.requestInvalidation(), this._editor.contentSetEnabled(0), t && this._compositionOn)) {
                                    ...
                                    if (
                                        (r === o && ((r += this._compositionSelectionDelta), (o += this._compositionSelectionDelta)),
                                        r === o)
                                    ) {
                                        var a = n.getRange(r - this._lastCompositedTextLength, r);
                                        (a.plainText() != i && a.setText(i),
                                            (this._focusChar =
                                                r - this._compositionSelectionDelta + i.length - this._lastCompositedTextLength),
                ...
                (b.prototype._convertToObjectSpace = function (e) {
                    var t = this._editor.getElement().getTransform(),
                        i = this._view.getWorldTransform(this._view.getScene().getActivePage());
                ...
                (b.prototype.selectWordAtPosition = function (e) {
                    ...
                    if (t) {
                        var i = this._convertToObjectSpace(e),
                            n = t.byCoordinate(i.getX(), i.getY() - this._editor._getVerticalOffset());
                    ...
                    if (e.button === s.BUTTON_LEFT && this._textUnderMouse) {
                        if (this._shiftKeyDown) {
                            ...
                            if ((this._view.setCursor(a.Text), t)) {
                                ...
                                return (
                                    r && ((this._focusChar = r.ordinal), i > r.ordinal ? t.select(r.ordinal, i) : t.select(i, r.ordinal)),
                    ...
                    if ((this._textUnderMouse && this._view.setCursor(a.Text), null !== this._selectDragStart)) {
                        ...
                        if (n) {
                            var r = this._convertToObjectSpace(e.client),
                                o = n.byCoordinate(r.getX(), r.getY() - this._editor._getVerticalOffset());
                            o &&
