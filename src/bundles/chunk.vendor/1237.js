module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(c, s),
                ...
                (c.prototype.getSvgStyle = function (e, t) {
                    ...
                    switch (
                        ("butt" !== i ? r.set("stroke-linecap", i) : r.remove("stroke-linecap"),
                    ...
                    return (
                        "miter" !== i ? r.set("stroke-linejoin", i) : r.remove("stroke-linejoin"),
                        ...
                        1 != o.globalAlpha && "1" !== o.globalAlpha ? r.set("opacity", o.globalAlpha) : r.remove("opacity"),
                ...
                (c.patternToRGBA = function (e) {
                    if (e) return ((ret = "rgba(" + e._value.join(",")), 3 == e._value.length && (ret += ",1"), (ret += ")"), ret);
                }),
                (c.toFill = function (e) {
                    var t;
