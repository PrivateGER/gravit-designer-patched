module.exports = function (module, exports, require) {
            ...
            ((s.CoordType = {
                ...
                (s.SUPPORTED_MATH_FUNCS = "abs|acos|asin|atan|atan2|ceil|cos|exp|floor|log|round|sign|sin|sqrt|tan|trunc"),
                (s.SUPPORTED_MATH_FUNCS2 = "min|max"),
                (s.serialize = function (e) {
                    var t = [e._annotationsName, e._initVerticesList];
                    return (
                        e._initAnnotationsList && e._initParametersList && t.push(e._initAnnotationsList, e._initParametersList),
                ...
                (s.prototype.getVertices = function (e) {
                    if ((this._parametersFuncs && (!e || e.length != this._annotationsFuncs.length)) || !this._vertices) return null;
                    var t = new r();
                    try {
                        var i = null;
                ...
                (s.prototype.isSecure = function (e, t) {
                    ...
                    if (((i = (i = i.replace(/\.Y/g, "")).replace(/\[[0-9]+\]/g, "")), t))
                        for (var n = 0; n < t.length; ++n) i = i.replace(new RegExp(t[n], "g"), "0");
                    i = i.replace(/\d+\.*\d*/g, "0");
                    var r = "(?:" + s.SUPPORTED_MATH_FUNCS + ")\\(";
                    i = i.replace(new RegExp(r, "g"), "a(");
                    for (n = 0; n < 3; ++n)
                        ((r = "(?:" + s.SUPPORTED_MATH_FUNCS2 + ")\\(0, *0"),
                            (i = (i = (i = i.replace(new RegExp(r, "g"), "a(0")).replace(/(?:0 *[\+\-\/\*]+ *)*0/g, "0")).replace(
                                /a?\( *\-? *0 *\)/g,
                                "0"
                            )));
                    return "0" == i || "-0" == i;
                ...
                (s.prototype._initParametersFuncs = function (e) {
                    if (((this._parametersFuncs = null), e && e.length && this._annotationsFuncs && this._annotationsFuncs.length))
                        for (var t = [this._annotationsName], i = 0; i < e.length; ++i) {
                            var n = e[i];
                            if (!/^[a-z]*$/i.test(n.name)) return void (this._parametersFuncs = null);
                ...
                (s.prototype._getCoordVal = function (e, t) {
                    ...
                    if (t == s.CoordType.Direct && "number" == typeof e) i = e;
                        ...
                        for (var n = [], r = 0; r < this._parametersFuncs.length; ++r) n.push(this._parametersFuncs[r].name);
                ...
                (s.prototype._getExprFunction = function (e, t, i, n) {
                    ...
                    if (e && t && t.length && this.isSecure(e, t)) {
                        ...
                        var o = "",
                            ...
                            s = "",
                            l = "";
                        (null !== i && "number" == typeof i && ((o = "Math.max(" + i + ", ( "), (a = " ))")),
                            null !== n && "number" == typeof n && ((s = "Math.min(" + n + ", ( "), (l = " ))")));
