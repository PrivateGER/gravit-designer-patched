module.exports = function (module, exports, require) {
            ...
            function C(e, t, i, n, r) {
                ...
                ((this.blx = l.getX()),
                    ...
                    (this._tBoxFlags = n || C.TBoxFlag.Rotate | C.TBoxFlag.Skew | C.TBoxFlag.Move | C.TBoxFlag.Resize),
                    (this._scene = r));
            }
            ((C.TRANSFORM_MARGIN = 0),
                ...
                (C.prototype._calculateGeometryBBox = function () {
                    var e = this._getPoint(C.Handles.ROTATION_CENTER),
                        ...
                        n = e.getY(),
                        r = n,
                        o = [C.Handles.TOP_LEFT, C.Handles.TOP_RIGHT, C.Handles.BOTTOM_RIGHT, C.Handles.BOTTOM_LEFT];
                    (l.annotationHandles.tranformBox.skew && (o = o.concat([C.Handles.SKEW_HORIZONTAL, C.Handles.SKEW_VERTICAL])),
                ...
                (C.prototype.paint = function (e, t, i) {
                    ...
                    if (!this._centerOnly) {
                        ...
                        if (
                            ...
                            t.canvas.strokeVertices(t.transformBoxOutlineColor, l.outlineWidth),
                            this._isSkewAnnotationEnabled() &&
                                this._tBoxFlags & C.TBoxFlag.Skew &&
                                (_.paintAnnotation(t, null, this._getPoint(C.Handles.SKEW_HORIZONTAL), 0, t.transformBoxOutlineColor),
                                v.paintAnnotation(t, null, this._getPoint(C.Handles.SKEW_VERTICAL), 0, t.transformBoxOutlineColor)),
                            this._isRotateAnnotationEnabled() && this._tBoxFlags & C.TBoxFlag.Rotate)
                        ) {
                            var A = this._getPoint(C.Handles.BOTTOM_CENTER).subtract(new s(l.outlineWidth / 2, l.outlineWidth / 2)),
                                c = this._getPoint(C.Handles.ROTATE);
                            (t.canvas.strokeLine(A.getX(), A.getY(), c.getX(), c.getY(), l.outlineWidth, t.transformBoxOutlineColor),
                                y.paintAnnotation(t, null, this._getPoint(C.Handles.ROTATE), 0, t.transformBoxOutlineColor));
                        }
                        if (this._tBoxFlags & C.TBoxFlag.Resize)
                ...
                (C.prototype.getPartInfoAt = function (e, t, i, r) {
                    ...
                    (this._tBoxFlags & C.TBoxFlag.Rotate && s.push(C.Handles.ROTATION_CENTER),
                        this._isSkewAnnotationEnabled() &&
                            this._tBoxFlags & C.TBoxFlag.Skew &&
                            (s.push(C.Handles.SKEW_HORIZONTAL), s.push(C.Handles.SKEW_VERTICAL)));
                    ...
                    if (
                        ...
                        } else this._tBoxFlags & C.TBoxFlag.Move && (o = new d.PartInfo(r, C.INSIDE, null));
                    var u = function () {
                ...
                (C.prototype.calculateTransformation = function (e, t, i, n, r, o, a, h) {
                    ...
                    if (e.id < 8) {
                        var f = [
                            ...
                            m = new A(this.tlx, this.tly, this.brx - this.tlx, this.bry - this.tly),
                            y = f[e.id],
                            _ = m.getSide(y);
                        return (
                ...
                (C.prototype._getPoint = function (e, t) {
                    ...
                    switch (e) {
                        ...
                        case C.Handles.TOP_CENTER:
                            ((i = n(new s((this.tlx + this.trx) / 2, (this.tly + this.try) / 2))),
                        ...
                        case C.Handles.RIGHT_CENTER:
                            ((i = n(new s((this.trx + this.brx) / 2, (this.try + this.bry) / 2))),
                        ...
                        case C.Handles.BOTTOM_CENTER:
                            ((i = n(new s((this.blx + this.brx) / 2, (this.bly + this.bry) / 2))),
                                (i = new s(i.getX(), i.getY() + C.TRANSFORM_MARGIN)));
                            break;
                        ...
                        case C.Handles.LEFT_CENTER:
                            ((i = n(new s((this.tlx + this.blx) / 2, (this.tly + this.bly) / 2))),
                                (i = new s(i.getX() - C.TRANSFORM_MARGIN, i.getY())));
                            break;
                ...
                (C.prototype._collectResizeHandles = function (e) {
                    ...
                    if (this._tBoxFlags & C.TBoxFlag.Resize) {
                        ...
                        (n.getHeight() > 2 * o &&
                            n.getWidth() > 2 * o &&
                            (t = t.concat([C.Handles.TOP_LEFT, C.Handles.TOP_RIGHT, C.Handles.BOTTOM_LEFT, C.Handles.BOTTOM_RIGHT])),
                            n.getHeight() > 3 * o && (t = t.concat([C.Handles.RIGHT_CENTER, C.Handles.LEFT_CENTER])),
                            n.getWidth() > 3 * o && (t = t.concat([C.Handles.TOP_CENTER, C.Handles.BOTTOM_CENTER])));
                    }
                    return t;
                }),
