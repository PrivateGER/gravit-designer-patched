module.exports = function (module, exports, require) {
            ...
            (n.inherit("path", g, s),
                ...
                (g.prototype.insertHitPoint = function (e) {
                    ...
                    if (r && o) {
                        ...
                        l =
                            ...
                            (h == s.AnchorPoint.Type.Asymmetric && A == s.AnchorPoint.Type.Asymmetric)
                        ...
                        ((c = r.getProperty("x")),
                            ...
                            (u = o.getProperty("hlx")),
                            (y = o.getProperty("hly")));
                        var b = null == p || null == m || (a.isEqualEps(p, c) && a.isEqualEps(m, f)),
                            C = null == u || null == y || (a.isEqualEps(u, d) && a.isEqualEps(y, _));
                        if (b && C)
                            ((v = new g.AnchorPoint()).setProperties(["x", "y", "tp"], [c + t * (d - c), f + t * (_ - f), l]),
                            ...
                            (a.divideQuadraticCurve(c, w, d, t, B, P),
                                ...
                                (v = new g.AnchorPoint()).setProperties(["x", "y", "tp"], [B[2], x[2], l]),
                                this.getAnchorPoints().insertChild(v, o),
                                b
                            ...
                            (a.getCtrlPtsCasteljau(c, p, u, d, t, 1, B),
                                ...
                                (v = new g.AnchorPoint()).setProperties(["x", "y", "tp"], [B[3], x[3], l]),
                                this.getAnchorPoints().insertChild(v, o),
                ...
                (g.prototype.getAngle = function () {
                    if (!this.isMultiPointsLine()) return s.prototype.getAngle.apply(this, arguments);
                    var e = 0,
                    ...
                    if (t) {
                        ...
                        (this.$trf && ((r = this.$trf.mapPoint(r)), (o = this.$trf.mapPoint(o))),
                            (e = a.normalizeAngleRadians(-Math.atan2(o.getY() - r.getY(), o.getX() - r.getX()))) > Math.PI && (e -= a.PI2));
                    }
                    return e;
                }),
                (g.prototype._handleChange = function (e, t) {
                    (e === n._Change.PrepareRestore
                        ? t.blob.hasOwnProperty("rtxt") && (t.blob.hasOwnProperty("refs") || (t.blob.refs = t.blob.rtxt))
                        : e === n._Change.Store
                          ...
                          : e === n._Change.Restore &&
                            ...
                            t.blob.hasOwnProperty("pts") && this.getAnchorPoints().deserialize(t.blob.pts)),
                        ...
                        if (c) {
                            ...
                            for (_ = 0; _ < y.length; _++) {
                                ...
                                if ((b = c.insertHitPoint(w)))
                                    ...
                                    } else (b.setProperty("x", C.pt.getX()), b.setProperty("y", C.pt.getY()));
                                else {
                                    if (n) {
                                        var B,
                                        ...
                                        if (this.isLine()) {
                                            ...
                                            if (t.$_blc === l.LineCap.Butt || t.$_blc === l.LineCap.Square) {
                                                var f = this.getAnchorPoints().getFirstChild(),
                                                    m = ((g = f.getNext()), new c(f.getProperty("x"), f.getProperty("y"))),
