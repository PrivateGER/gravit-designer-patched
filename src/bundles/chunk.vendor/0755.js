            ...
            (o.inherit(p, A),
                ...
                (p.prototype.paint = function (e) {
                    if (this._hasDragArea()) {
                        ...
                        (c.outlineWidth % 2 != 0 && ((t += 0.5), (i += 0.5), (n -= 1), (r -= 1)),
                ...
                (p.prototype._mouseDragEnd = function (e) {
                    if (0 !== this._zoomMode)
                        ...
                        } else this._hasDragArea() && this.invalidateArea(this._dragArea.expanded(2, 2, 2, 2));
                }),
                ...
                (p.prototype._updateMode = function () {
                    var e = 0;
                    ((((e = n.modifiers.optionKey ? -1 : 1) < 0 && this._view.getZoom() <= h.options.minZoomFactor) ||
