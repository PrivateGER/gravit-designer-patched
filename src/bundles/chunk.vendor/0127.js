            ...
            (IsFiniteNonNegativeNumber.inherit(P, d),
                    ...
                    if (this._partSelection && this._partSelection.length)
                        for (var t = 0; t < this._partSelection.length; ++t) {
                            ...
                            if (i.type == P.PartType.Point) {
                                ...
                                var r;
                                ((r = this.getPointCoord(i.apLeft)) && ((n = new E(r.getX(), r.getY(), 0, 0)), (e = e ? e.united(n) : n)),
                                    (r = this.getPointCoord(i.apRight)) && ((n = new E(r.getX(), r.getY(), 0, 0)), (e = e.united(n))));
                            }
                        }
                ...
                (P.prototype.removeFlag = function (e, t) {
                    (d.prototype.removeFlag.call(this, e, t),
                        e !== h.Flag.Selected || this._element.hasFlag(o.Flag.Selected) || this._handleFinishDrawing());
                }),
                ...
                (P.prototype.movePart = function (e, t, i, n, r, o, a) {
                    ...
                    if (e === u.RESIZE_HANDLE_PART_ID || e === u.ROTATION_HANDLE_PART_ID)
                        ...
                        switch (
                            (this.requestInvalidation(), this._createPathPreviewIfNecessary(e.point), this.extendPreviewToFull(), e.type)
                        ) {
                ...
                (P.prototype._applyPartMove = function (e, t, i, r) {
                    if (e === u.RESIZE_HANDLE_PART_ID || e === u.ROTATION_HANDLE_PART_ID) d.prototype._applyPartMove.call(this, e, t, i, r);
                    else
                        switch (e.type) {
                            case P.PartType.LeftHandle:
                                this._assignPreviewPointPropertiesToSourcePoint(e.point, ["hlx", "hly", "ah", "tp"]);
                                break;
                            case P.PartType.RightHandle:
                                this._assignPreviewPointPropertiesToSourcePoint(e.point, ["hrx", "hry", "ah", "tp"]);
                                break;
                            case P.PartType.LeftShoulder:
                            case P.PartType.RightShoulder:
                                this._assignPreviewPointPropertiesToSourcePoint(e.point, ["cl", "cr"]);
                                break;
                            case P.PartType.Segment:
                ...
                (P.prototype.canApplyTransform = function () {
                    return (
                        (this._partSelection && this._partSelection.length > 0 && !this.hasFlag(u.Flag.ResizeAll)) ||
                        (this._transform && !this._transform.isIdentity() && this._transform.invertible()) ||
                    ...
                    if (e.isolated || e.id.type != P.PartType.Point)
                        if (e.id.type != P.PartType.Segment || t)
                            e.id.type == P.PartType.Segment &&
                                ((i.isolated = e.data.rightButton.isolated), (i.selectable = e.data.rightButton.selectable));
                        else {
                            var a = e.data.hitRes,
                                s = e.id.apLeft,
                                l = e.id.apRight;
                                ...
                                if (A && u)
                                    if (y.isEqualEps(a.slope, 0, 0.001))
                                        ...
                                        var d,
                                            ...
                                            w = a;
                                        if (
                                            (null !== s.getProperty("hrx") && null !== s.getProperty("hry")) ||
                                            (null !== l.getProperty("hlx") && null !== l.getProperty("hly"))
                                        )
                ...
                (P.prototype._attach = function () {
                    ...
                    (null != e && e.addEventListener(n.GeometryChangeEvent, this._geometryChange, this),
                        this._element.addEventListener(o.AfterInsertEvent, this._afterInsert, this));
                }),
                (P.prototype._detach = function () {
                    ...
                    (null != t && t.removeEventListener(n.GeometryChangeEvent, this._geometryChange, this),
                        this._element.removeEventListener(o.AfterInsertEvent, this._afterInsert, this),
                ...
                (P.prototype.hitAnchorPoint = function (e, t, i, n) {
                    if (e) {
                        ...
                        return (
                            ...
                            _.getAnnotationBBox(r, new c(e.getProperty("x"), e.getProperty("y")), p.annotationHandles.path.node.size)
                                .expanded(n, n, n, n)
                                .containsPoint(t)
                        );
                    }
                ...
                (P.prototype._getPartInfoAt = function (e, t, i) {
                                        ...
                                        (n(e.position, p.annotationHandles.path.node.size)
                                            ...
                                            : n(e.rightHandlePosition, p.annotationHandles.path.control.size)
                                              ...
                                              : n(e.leftHandlePosition, p.annotationHandles.path.control.size)
                                                ...
                                                : n(e.rightShoulderPosition, p.annotationHandles.path.corner.size)
                                                  ? (t = P.PartType.RightShoulder)
                                                  : n(e.leftShoulderPosition, p.annotationHandles.path.corner.size) &&
                    ...
                    return c && ((c.id !== u.RESIZE_HANDLE_PART_ID && c.id !== u.ROTATION_HANDLE_PART_ID) || this.hasFlag(u.Flag.ResizeAll))
                        ? c
                        : null;
                }),
                ...
                (P.prototype._partIdAreEqual = function (e, t) {
                    ...
                    return (
                        i && e.type == P.PartType.Point
                            ? (i = e.point === t.point)
                            : i && e.type == P.PartType.Segment && (i = e.apLeft === t.apLeft && e.apRight == t.apRight),
                        i
                    );
                }),
                            ...
                            for (var n = 0; n < i.length; ++n) {
                                ...
                                a ||
                                    (r.point
                                        ...
                                        : r.type == P.PartType.Segment &&
                                          (r.apLeft.removeFlag(o.Flag.Selected), r.apRight.removeFlag(o.Flag.Selected)));
                            }
                        if (t)
                            for (n = 0; n < t.length; ++n) {
                                (r = t[n]).point
                                    ...
                                    : r.type == P.PartType.Segment &&
                                      (r.apLeft.setFlag(o.Flag.Selected), r.apRight.setFlag(o.Flag.Selected));
                            }
                        this.requestInvalidation();
                    }
                }),
                ...
                (P.prototype._iteratePoints = function (e, t) {
                    for (
                        ...
                        if (a.hasFlag(o.Flag.Selected) || (l && l.hasFlag(o.Flag.Selected)))
                            null !== (d = new c(a.getProperty("hrx"), a.getProperty("hry"))).getX() &&
                                null !== d.getY() &&
                ...
                (P.prototype.getPointsSelectionType = function () {
                    ...
                    if (this._partSelection && !this.hasFlag(u.Flag.ResizeAll))
                        if (this._partSelection.length > 1) e = P.PointsSelectionType.Several;
                ...
                (P.prototype.updatePartSelectionUnderCollision = function (e, t, i) {
                    ...
                    if (
                        ((!a.length && !s.length) ||
                            ...
                            (i
                                ? this._element.hasFlag(o.Flag.Highlighted) || this._element.setFlag(o.Flag.Highlighted)
                        ...
                        (this._element.hasFlag(o.Flag.Highlighted) && this._element.removeFlag(o.Flag.Highlighted),
                ...
                (P.prototype.deletePartsSelected = function () {
                    if (this._partSelection && !this.hasFlag(u.Flag.ResizeAll)) {
                        for (
                            var e = this._element.getAnchorPoints(), t = this._element.getParent();
                ...
                (P.prototype.extendPreviewToFull = function () {
                    ...
                    t._beginBlockChanges([o._Change.BeforeChildInsert, o._Change.AfterChildInsert]);
                    try {
                        for (; !a && n; ) {
                            ((c = new m.AnchorPoint()).transferProperties(n, [m.AnchorPoint.GeometryProperties]),
                        ...
                        t._endBlockChanges([o._Change.BeforeChildInsert, o._Change.AfterChildInsert]);
                    }
                    this._elementPreview.transferProperties(this._element, [l.GeometryProperties, s.GeometryProperties]);
                }),
                ...
                (P.prototype.getPathPointPreview = function (e) {
                    if (!e) return null;
                    var t = e.getParent();
                    if (!t) return (console.warn("GPathEditor.getPathPointPreview: requested preview for non bound point"), null);
                    var i = t.getIndexOfChild(e);
                    ((this._sourceIndexToPreviewIndex && null != this._sourceIndexToPreviewIndex[i]) || this.extendPreviewToFull(),
                        this.requestInvalidation());
                ...
                (P.prototype.movePoint = function (e, t, i, n) {
                    var r = this.getTransformFromNative(i),
                        o = r.inverted(),
                        a = o.mapPoint(t);
                    if (e.getProperty("ah")) e.setProperties(["x", "y"], [a.getX(), a.getY()]);
                    else {
                        var s = n || e,
                            l = s.getProperty("hlx"),
                            h = s.getProperty("hly"),
                        ...
                        e.setProperties(["x", "y", "hlx", "hly", "hrx", "hry"], [a.getX(), a.getY(), l, h, A, p]);
                    }
                }),
                    ...
                    if (i) {
                        if (this.hasFlag(h.Flag.Detail) && 1 != l.getProperty("cu")) {
                            ...
                            if (((p = null != p ? A : 0), e.type == P.PartType.LeftShoulder)) {
                                var u = p - (d = s - A);
                                return ((u = u > 0 ? u : 0), l.setProperties(["cl", "cr"], [s, u]), new f(1, 0, 0, 1, -d, p - u));
                            }
                            var d,
                                g = A - (d = s - p);
                            return ((g = g > 0 ? g : 0), l.setProperties(["cl", "cr"], [g, s]), new f(1, 0, 0, 1, A - g, -d));
                        }
                        return (l.setProperties(["cl", "cr"], [s, s]), new f(1, 0, 0, 1, A - s, p - s));
                    }
                    return e.type == P.PartType.LeftShoulder
                        ? (l.setProperty("cl", s), new f(1, 0, 0, 1, e.point.getProperty("cl") - s, 0))
                        : (l.setProperty("cr", s), new f(1, 0, 0, 1, 0, e.point.getProperty("cr") - s));
                }),
