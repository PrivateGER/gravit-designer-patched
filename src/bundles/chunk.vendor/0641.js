            ...
            ((o.HEADER_LENGTH = 128),
                ...
                (o.prototype.readLuts = function (e, t, i, n, r) {
                    ...
                    if (a == o.MFTType.Mft2) {
                        ...
                        var h = 2 * (f = l.numInputChannels * l.numInputTEntries),
                            A = 2 * (m = Math.pow(l.numCLUTGridPts, l.numInputChannels) * l.numOutputChannels),
                        ...
                        var f = 256 * l.numInputChannels,
                            m = Math.pow(l.numCLUTGridPts, l.numInputChannels) * l.numOutputChannels,
                ...
                (o.prototype.readMFTHeaderData = function (e, t, i) {
                    ((i.numInputChannels = e.getUint8(8)),
                        ...
                        t == o.MFTType.Mft2 && ((i.numInputTEntries = e.getUint16(48)), (i.numOutputTEntries = e.getUint16(50))));
                }),
