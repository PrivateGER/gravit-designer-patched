module.exports = function (e, t, i) {
            ...
            function y(e) {
                ...
                for (var t = 0, i = 0; i < e.length; i += 4) t += (e[i] << 24) + (e[i + 1] << 16) + (e[i + 2] << 8) + e[i + 3];
                ...
                for (var l = 0; l < e.length; l += 1) {
                    ...
                    for (
                        o.push({
                            ...
                            s += A,
                            n.argument(!isNaN(s), "Something went wrong calculating the offset.");
                        s % 4 != 0;
                ...
                (t.fontToTable = function (e) {
                    for (
                        ...
                        var F = e.glyphs.get(I),
                            R = 0 | F.unicode;
                        if (isNaN(F.advanceWidth)) throw new Error("Glyph " + F.name + " (" + I + "): advanceWidth is not a number.");
                    ...
                    var z = [],
                        ...
                        $ = e.metas && Object.keys(e.metas).length > 0 ? f.make(e.metas) : void 0,
