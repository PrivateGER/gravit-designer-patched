            ...
            e.exports = function (e) {
                ((e.PaintLayers = function () {}),
                    ...
                    (e.PaintLayers.prototype._handleChange = function (t, i) {
                        ...
                        if (
                            (r &&
                                ((t != n._Change.BeforeChildInsert && t !== n._Change.BeforeChildRemove) ||
                                    r._stylePrepareGeometryChange(i),
                                (t != n._Change.AfterChildInsert && t !== n._Change.AfterChildRemove) || r._styleFinishGeometryChange(i)),
                            t == n._Change.Restore)
                        ) {
                                ...
                                function (r, o) {
                                    ...
                                    for (var s in a)
                                        if (i.blob.hasOwnProperty(s)) {
                                            this._beginBlockChanges([n._Change.BeforeChildInsert, n._Change.AfterChildInsert]);
                                            try {
                                                ...
                                                try {
                                                    ...
                                                    l._endBlockChanges([n._Change.BeforePropertiesChange, n._Change.AfterPropertiesChange]);
                                                }
                                            } finally {
                                                this._endBlockChanges([n._Change.BeforeChildInsert, n._Change.AfterChildInsert]);
                                            }
                                            break;
                                        }
                                }.bind(this)
                    ...
                    (e.PaintLayers.prototype.resetMultireference = function () {
                        (n.Multireference.prototype.resetMultireference.call(this),
                            this.getParent() && (this.getParent()._layId = this.getMultireferenceId()));
                    }));
            };
        };
