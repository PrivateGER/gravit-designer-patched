            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(f, r, [r.Map, r.DetailMap]),
                    ...
                    var R = function (e, t, i) {
                            ...
                            return (
                                (t !== c.AnchorPoint.Type.Asymmetric &&
                                    ...
                                    ((n = A.annotationHandles.path.node.smoothType), i && (n = A.annotationHandles.path.node.autoType)),
                                {
                                    pt: e,
                                    annot: n,
                                ...
                                for (t = 0; t < i.length; ++t) {
                                    ...
                                    if (r || h.containsPoint(A)) {
                                        ...
                                        if (
                                            ...
                                            (null === y && f <= n) || (null !== y && f < Math.abs(S.getX() - y)))
                                        ) {
                                            ((y = A.getX()), (C = f));
                                            var d = c ? R(A, c, u) : A;
                                            v = S.getY() <= A.getY() ? [new o(y, S.getY()), d] : [d, new o(y, S.getY())];
                                        } else
                                            null !== y &&
                                                f === Math.abs(S.getX() - y) &&
                                                ((y = A.getX()),
                                                (C = f),
                                                S.getY() <= A.getY()
                                                    ? (v[1].pt ? v[1].pt.getY() : v[1].getY()) < A.getY() && (v[1] = c ? R(A, c, u) : A)
                                                    : (v[0].pt ? v[0].pt.getY() : v[0].getY()) > A.getY() && (v[0] = c ? R(A, c, u) : A));
                                    }
                                }
                                ...
                                for (t = 0; t < i.length; ++t) {
                                    ...
                                    if (r || E.containsPoint(A)) {
                                        ...
                                        if (
                                            ...
                                            (null === _ && f <= n) || (null !== _ && f < Math.abs(S.getY() - _)))
                                        ) {
                                            ((_ = A.getY()), (w = f));
                                            d = c ? R(A, c, u) : A;
                                            b = S.getX() <= A.getX() ? [new o(S.getX(), _), d] : [d, new o(S.getX(), _)];
                                        } else
                                            null !== _ &&
                                                f === Math.abs(S.getY() - _) &&
                                                ((_ = A.getY()),
                                                (w = f),
                                                S.getX() <= A.getX()
                                                    ? (b[1].pt ? b[1].pt.getX() : b[1].getX()) < A.getX() && (b[1] = c ? R(A, c, u) : A)
                                                    : (b[0].pt ? b[0].pt.getX() : b[0].getX()) > A.getX() && (b[0] = c ? R(A, c, u) : A));
                                    }
                                }
                        }.bind(this),
                        k = function (e, t) {
                            ...
                            if (e.hasMixin(s.Accelerated)) i = e.retrieveChildrenInGeometryBBox(t, d.RETRIEVE_MODE_INTERSECT) || [];
                            else
                            ...
                            for (var o = [], a = 0; a < i.length; a++) o = o.concat(k(i[a], t));
                            return i.concat(o);
                        }.bind(this);
                    if (B && (this._scoped && B != this._snapMainPage && this._setEffectiveScope(B), x)) {
                        var G = new p(F.getX() - n, x.getY() - n, 2 * n, x.getHeight() + 2 * n),
                            Q = new p(x.getX() - n, F.getY() - n, x.getWidth() + 2 * n, 2 * n),
                            M = k(B, G);
                        M = M.concat(
                        ...
                        for (var N = 0; N < M.length; N++) {
                            ...
                            if (U instanceof a && !U.hasFlag(s.Flag.Hidden)) {
                                ...
                                if (O) for (var L = 0; L < O.length && !V; ++L) U == O[L] && (V = U);
                                else V = U;
                                V && D(V);
                            }
                        }
                ...
                (f.prototype.useExclusions = function (e) {
                    if (e && e.length) {
                        var t;
                        this._exclusions = [];
                        for (var i = 0; i < e.length; ++i) (t = e[i]) instanceof a && this._exclusions.push(t);
                    }
                }),
                ...
                (f.prototype._setEffectiveScope = function (e) {
                    if (((this._eSnapElems = []), e.hasMixin(h.Container)))
                        for (var t = e.getFirstChild(); null != t; t = t.getNext()) t instanceof a && this._eSnapElems.push(t);
                }),
