module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(d, a),
                ...
                (g.prototype._parse = function (e, t, i, n, r) {
                    ...
                    if ((this._sizeTrf && (o = this._sizeTrf(o)), o > 256)) throw new Error("Something might be wrong");
                    for (
                        var a = [],
                            s = [0],
                            l = 0,
                ...
                (y.prototype._parse = function (e, t, i, n, r) {
                    ...
                    if (this._type && this._type.startsWith("parent")) {
                        for (var s = this._type.split(".").length, l = i, h = 0; h < s; h++) l = l.one_up;
                        if (!l || !l.parent) throw new Error("Invalid file structure");
                        t = l.parent._position + o;
                    } else "absolute" === this._type ? (t = o) : "immediate" === this._type ? (t += o) : (t = i.parent._position + o);
                    return "string" == typeof this._snode ? t : this._snode._parse(e, t, i, n, [0]);
                }),
                (o.Parser = function (e) {
                    if (e) {
                        if (!(e instanceof ArrayBuffer)) {
                            if (!(e.buffer instanceof ArrayBuffer)) return void console.warn("Invalid font buffer given");
                            e = e.buffer;
                        }
                    ...
                    switch (((i = parseInt(i) || 400), (t = t || GFont.Style.Normal), this._type)) {
                        case _:
                            ...
                            for (var h = 0; h < l.length; h++) {
                                var A = l[h];
                                if (
                                    ((m = a ? new DataView(this._buffer.buffer, A) : this._buffer.buffer.slice(A)),
                                    (w = o.getOpenTypeInfo(m, A)),
                                    a || o.patchOffsets(m, A),
                                    w &&
                                        (n || (w.name === e && parseInt(w.weight) === parseInt(i) && w.style === t)) &&
                                        (s.push({
                                            buffer: a ? null : m,
                                            family: w.name,
                                            weight: w.weight,
                        ...
                        case v:
                            ...
                            if (p) {
                                var f = [];
                                for (u = p.refList, h = 0; h < u.length; h++) f.push(u[h].dataOffset);
                                f.sort(function (e, t) {
                                    return e - t;
                                });
            ...
            ((o.Parser.prototype._checkType = function () {
                if (o._getOpenTypeInfo(this._buffer, 0, true)) this._type = b;
                    ...
                    if (e && "ttcf" === e.name) return ((this._type = _), void (this._parsedStruct = e));
                    try {
                        if ((e = this._parse(P)))
                            for (var t = e.map.typeList.types, i = 0; i < t.length; i++)
                                if ("sfnt" === t[i].name) return ((this._type = v), void (this._parsedStruct = e));
                    } catch (e) {}
                    this._type = -1;
                }
            }),
                                        ...
                                        : h.indexOf("black") >= 0 || h.indexOf("heavy") >= 0
                                          ...
                                          : h.indexOf("medium") >= 0
                                            ...
                                            : h.indexOf("regular") >= 0 || h.indexOf("normal") >= 0
                                              ? (s = 400)
                                              : h.indexOf("light") >= 0
                                                ? (s = h.indexOf("extra") >= 0 || h.indexOf("ultra") >= 0 ? 200 : 300)
            ...
            var T = [
                    ...
                    1066, 1067, 1068, 1069, 1070, 1071, 1074, 1076, 1077, 1078, 1079, 1080, 1081, 1082, 1083, 1086, 1087, 1088, 1089, 1090,
                    1091, 1092, 1093, 1094, 1095, 1096, 1097, 1098, 1099, 1100, 1101, 1102, 1103, 1104, 1105, 1106, 1107, 1108, 1110, 1111,
                    1114, 1115, 1117, 1118, 1121, 1122, 1123, 1124, 1125, 1128, 1130, 1131, 1132, 1133, 1134, 1135, 1136, 1144, 1146, 1148,
                    1150, 1152, 1153, 1154, 1155, 1156, 1157, 1158, 1159, 1160, 1164, 2049, 2052, 2055, 2057, 2058, 2060, 2064, 2067, 2068,
                    2070, 2074, 2077, 2092, 2094, 2107, 2108, 2110, 2115, 2117, 2128, 2141, 2143, 2155, 3073, 3076, 3079, 3081, 3082, 3084,
                    3098, 3131, 3179, 4097, 4100, 4103, 4105, 4106, 4108, 4122, 4155, 5121, 5124, 5127, 5129, 5130, 5132, 5146, 5179, 6145,
                    6153, 6154, 6156, 6170, 6203, 7169, 7177, 7178, 7194, 7227, 8193, 8201, 8202, 8218, 8251, 9217, 9225, 9226, 9275, 10241,
                    10249, 10250, 11265, 11273, 11274, 12289, 12297, 12298, 13313, 13321, 13322, 14337, 14346, 15361, 15370, 16385, 16393,
                    16394, 17417, 17418, 18441, 18442, 19466, 20490, 21514,
                ],
                I = [1033, 2057, 3081, 4105, 5129, 6153, 7177, 8201, 9225, 10249, 11273, 12297, 13321, 16393, 17417, 18441],
                F = {
                    "x-mac-croatian":
            ...
            ((o._getOpenTypeInfo = function (e, t, i) {
                ...
                try {
                    ...
                    for (n = 0; n < c && A - h >= 16; n++) {
                        if (((m = o._readTag(r, h)), (h += 4), (h += 4), "name" === m)) p = r.getUint32(h) - t;
                    ...
                    if (d > 0) {
                        ...
                        if (((h += 8), 1 === C)) {
                            ...
                            for (h += 8, b = [], n = 0; n < w; n++) {
                                ...
                                A = r.getUint16(h);
                                h += 2;
                                for (var B = E; B < E + A; B++) m += String.fromCharCode(r.getUint8(B));
                                tags.push(m);
                            }
                        }
                    }
                    if (u > 0) {
                        ...
                        for (h = u + S, n = 0; n < P; n++)
                            ((m = o._readTag(r, h)),
                                (h += 4),
                                "wght" == m ? (s = String(D[n])) : "ital" == m && (l = String(D[n])),
                                (h = u + S + n * x));
                    }
                    if (p > 0) {
