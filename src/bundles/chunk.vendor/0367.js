module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(E, IsFiniteNonNegativeNumber, [w]),
                ...
                (E.prototype.initialize = function (e, t, i, n) {
                    ...
                    if (
                        ...
                        (l.hasOwnProperty(text) && this.setText(l.text),
                            ...
                            l.hasOwnProperty(select) && this.select(l.select.start, l.select, end),
                            l.hasOwnProperty(selectAll) && this.selectAll(),
                            l.hasOwnProperty(wrap) && this.setWrap(l.wrap),
                            l.hasOwnProperty(path) &&
                                this.setPath(l.path.path, l.path.direction, l.path.side, l.path.offset, l.path.distance),
                            l.hasOwnProperty(direction) && this.setDirection(l.direction.direction));
                    }
                }),
                ...
                (E.prototype.getPadding = function () {
                    return [this.getLeftPadding(), this._padding || 0, this.getRightPadding(), this._padding || 0];
                }),
                (E.prototype.setWidth = function (e) {
                    this.isInitialized()
                        ? ((this._width = e), e == E.AUTO ? this._doc.width(this.getActualWidth() || this._maxWidth) : this._doc.width(e))
                                    ...
                                    if (this._textTransformer) {
                                        var r = function (e) {
                                            var n = e.bounds(false, true),
                                                ...
                                                s = this._textTransformer.getMatrix(n.l, isNaN(e.baseline) ? 0 : e.baseline, o) || new y(),
                ...
                (E.prototype.selectAll = function () {
                    return this.isInitialized()
                        ...
                        : (this._setDeferred("select", null), void this._setDeferred("selectAll"));
                }),
                ...
                (E.prototype.render = function (e, t, i, n) {
                    ...
                    (w.width !== _ && ((w.width = _ <= 0 ? 1 : _), DUMP_IMAGES.isRenderPhase() || (this._canvas.width = w.width), (C = true)),
                        ...
                        i.shapePaint
                            ? (n & p.RENDERFLAG_STROKE &&
                                  ...
                                  (this._ctx.strokeStyle = s.prototype._convertStyle.call(this, i.shapePaint))),
                              n & p.RENDERFLAG_FILL && (this._ctx.defaultFill = s.prototype._convertStyle.call(this, i.shapePaint)))
                            : n & p.RENDERFLAG_FILL && (this._ctx.defaultFill = "transparent"),
                        (this._ctx.globalAlpha = "number" == typeof i.opacity ? i.opacity : 1),
                        (this._ctx.globalCompositeOperation = s.CompositeOperator.SourceOver),
                        n & p.RENDERFLAG_STROKE &&
                            ("number" == typeof i.strokeWidth ? (this._ctx.lineWidth = i.strokeWidth) : (this._ctx.lineWidth = 1),
                    ...
                    (i.valign &&
                        !this.hasPathTransformer() &&
                        ("m" == i.valign
                            ? (B = (A - (this._doc.frame ? this._doc.frame.bounds().h : 0)) / 2)
                            : "b" == i.valign && (B = A - (this._doc.frame ? this._doc.frame.bounds().h : 0))),
                        (this._verticalShift = -B),
                        this._ctx.setTranslate(c * g + this.getLeftPadding() * t, g * (B + u) + o * t),
                    ...
                    (i.paintTransform && this._ctx.appendFillTransform(i.paintTransform),
                        n & p.RENDERFLAG_NODRAW && n & p.RENDERFLAG_STROKE && this._ctx._canvasContext.beginPath(),
                        this._doc.draw(this._ctx, new h(0, Math.max(0, this._verticalShift), l, A + Math.max(0, this._verticalShift))),
                        n & p.RENDERFLAG_NODRAW &&
                            n & p.RENDERFLAG_STROKE &&
                            (this._ctx.strokeVertices(),
                            n & p.RENDERFLAG_INSIDEBRD
                                ? this._ctx.fillVertices("#000", 1, s.CompositeOperator.DestinationIn)
                                : n & p.RENDERFLAG_OUTSIDEBRD && this._ctx.fillVertices("#000", 1, s.CompositeOperator.DestinationOut)),
                ...
                (E.prototype.renderVerticesWithStyle = function (e) {
                    if (!this.isInitialized()) throw new Error(E.INITIALIZATION_ERROR);
                    (this._ctx.renderMode(p.RENDERFLAG_VERTEX | p.RENDERFLAG_RENDERSTYLES),
                        this._ctx.clearVertices(),
                        this.hasPathTransformer()
                            ? this._doc.draw(
                                  this._ctx,
