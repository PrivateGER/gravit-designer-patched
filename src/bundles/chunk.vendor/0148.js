module.exports = function (module, exports, require) {
            ...
            ((o.formattingKeys = [
                ...
                (o.merge = function (e, t) {
                    if (1 === arguments.length) return Array.isArray(e) ? e.reduce(o.merge) : e;
                    if (arguments.length > 2) return o.merge(Array.prototype.slice.call(arguments, 0));
                ...
                (o.consolidate = function () {
                    var e;
                    return function (t, i) {
                        e && o.sameFormatting(e, i) && "string" == typeof e.text && "string" == typeof i.text
                            ? (e.text += i.text)
                            : t((e = o.clone(i)));
                    };
                }),
