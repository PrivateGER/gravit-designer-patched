module.exports = function (e, t, i) {
            ...
            ((a.Flag = {
                ...
                (a.prototype.initializeAnnotation = function () {
                    (this.addEventListener(r.BeforePropertiesChangeEvent, this.handleBeforePropertiesChangeEvent, this),
                ...
                (a.prototype.handleBeforePropertiesChangeEvent = function (e) {
                    e.node !== this &&
                        (e.custom ||
                            ...
                            this.isRestoring() ||
                            e.node.isRestoring() ||
                            ((e.properties.indexOf("mtime") < 0 || this.recordedTransaction || e.node.recordedTransaction) &&
                ...
                (a.prototype.updateReadUnreadStatus = function (e) {
                    ...
                    i >= 0 &&
                        e.values[i] &&
                        (t = n >= 0 ? e.values[n] : (this.getProperty("read") || []).slice()) &&
                        t.indexOf(e.values[i]) < 0 &&
                        (t.push(e.values[i]), n < 0 && ((n = e.properties.length), e.properties.push("read"), e.values.push(t)));
                    return e;
                }),
