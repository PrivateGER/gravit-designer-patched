            ...
            ((l.LARGE_EPS = 1e-4),
                ...
                (l._checkDegree = function (e) {
                    ...
                    if (e.currCurve.cp2 && !r.equals(e.currCurve.cp2, e.currCurve.cp1))
                        return r.equals(e.currCurve.cp2, e.currCurve.nextCurve.point) || r.equals(e.currCurve.cp1, e.currCurve.point)
                            ? 2
                            : 3;
                    var t = e.currCurve.cp1.getX(),
                        ...
                        s = (i - n.getY()) * (o.getX() - n.getX()) - (t - n.getX()) * (o.getY() - n.getY()),
                ...
                (l.intersect = function (e, t, i) {
                    ...
                    function r(e, t) {
                        if (e.currCurve) {
                            for (var i = e.currCurve, n = e.currCurve.nextCurve; i !== n && !(t <= i.next.m || i.next === n); ) i = i.next;
                            return i;
                        }
                        return e;
                    }
                    ...
                    if (1 === g && 1 === f) {
                        ...
                        var m = [],
                            y = a.getIntersectionPoint(u.getX(), u.getY(), d.getX(), d.getY(), c.getX(), c.getY(), p.getX(), p.getY(), m);
                        return (
                            (h = m[0]),
                            (A = m[1]),
                            y && h >= 0 && h <= 1 && A >= 0 && A <= 1 ? [new o(y, h, A, r(e, h), r(t, A))] : null
                        );
                    }
                    return 1 === g && 2 === f
                        ? ((u = e.currCurve ? e.currCurve.point : e.point),
                          (d = e.currCurve ? e.currCurve.nextCurve.point : e.next.point),
                          s(
                              (y = l.intersectBezier2Line(t.currCurve.point, t.currCurve.cp1, t.currCurve.nextCurve.point, u, d)),
                              e,
                              t,
                              !0,
                              !1,
                        ...
                        : 2 === g && 1 === f
                          ? ((c = t.currCurve ? t.currCurve.point : t.point),
                            (p = t.currCurve ? t.currCurve.nextCurve.point : t.next.point),
                            s(
                                (y = l.intersectBezier2Line(e.currCurve.point, e.currCurve.cp1, e.currCurve.nextCurve.point, c, p)),
                                e,
                                t,
                                !1,
                                !0,
                ...
                (l.intersectBezier2Line = function (e, t, i, n, o) {
                    ...
                    var m = new l.Polynomial([c.dot(a), c.dot(s), c.dot(h) + A]).getRoots();
                    if (!m) return [];
                ...
                (l.intersectBezier2Bezier3 = function (e, t, i, n, o, a, s) {
                    ...
                    ((c = (f = l._calcQuadraticCoefficients(e.subtract(y), t.subtract(y), i.subtract(y)))[0]),
                        (A = f[1]),
                        (h = f[2]),
                        (g = (f = l._calcCubicCoefficients(n.subtract(y), o.subtract(y), a.subtract(y), s.subtract(y)))[0]),
                        (d = f[1]),
                        (u = f[2]),
                        (p = f[3]));
                    var v = c.getX(),
                        ...
                        z = new l.Polynomial([
                            ...
                            (2 * E * B * T - 2 * S * U) * v +
                                ...
                                2 * x * S * U,
                            k * U +
                                (-C * w * B - 2 * x * U + M * E + 2 * E * P * B - 2 * b * E * B) * v +
                                G * N +
                    ...
                    for (var j = 0; j < z.length; j++) {
                        var J = z[j],
                            q = new l.Polynomial([E, C, v - x - J * S - J * J * I - J * J * J * R]).getRoots(),
                            K = new l.Polynomial([B, w, b - P - J * T - J * J * F - J * J * J * D]).getRoots();
                        if (q) K || (K = q);
                        else {
                            if (!K) return [];
                            q = K;
                ...
                (l.intersectBezier3Line = function (e, t, i, n, o, a) {
                    ...
                    var _ = new l.Polynomial([u.dot(s), u.dot(h), u.dot(A), u.dot(c) + p]).getRoots();
                    if (!_) return [];
                ...
                (l.intersectBezier3Bezier3 = function (e, t, i, n, o, a, s, h, A) {
                    ...
                    var b = l._calcCubicCoefficients(o, a, s, h),
                        C = l._calcCubicCoefficients(e.subtract(v), t.subtract(v), i.subtract(v), n.subtract(v));
                    ((d = C[0]),
                        (u = C[1]),
                        (p = C[2]),
                        (c = C[3]),
                        (y = (C = l._calcCubicCoefficients(o.subtract(v), a.subtract(v), s.subtract(v), h.subtract(v)))[0]),
                        (m = C[1]),
                        (f = C[2]),
                        (g = C[3]));
                    var w = d.getX(),
                        ...
                        M = g.getX(),
                        N = g.getY(),
                        U = l.bezoutResultant(w, E, B, x, P, S, T, I, F, R, D, k, G, Q, M, N),
                        V = new l.Polynomial(U),
                        O = V.getRootsInInterval(0, 1);
                    l.removeMultipleRoots(O);
                    for (var L = [], Y = 0; Y < O.length; Y++) {
                        var X = O[Y],
                            H = new l.Polynomial([T, P, B, w - F - X * D - X * X * G - X * X * X * M]).getRoots(),
                            W = new l.Polynomial([I, S, x, E - R - X * k - X * X * Q - X * X * X * N]).getRoots();
                        if (H) W || (W = H);
                        else {
                            if (!W) return [];
                            H = W;
                    ...
                    if (A) {
                        ((U = l.bezoutResultant(F, R, D, k, G, Q, M, N, w, E, B, x, P, S, T, I)),
                        ...
                        for (Y = 0; Y < O.length; Y++) {
                            ...
                            if (!K) {
                                ((H = new l.Polynomial([M, G, D, F - w - q * B - q * q * P - q * q * q * T]).getRoots()),
                                    (W = new l.Polynomial([N, Q, k, R - E - q * x - q * q * S - q * q * q * I]).getRoots()));
                                if (H) W || (W = H);
                                else {
                                    if (!W) return [];
                                    H = W;
                ...
                (l._lerpPrecise = function (e, t, i) {
                    var n, r, o, a;
                    return (
                        e instanceof Array ? ((n = e[0]), (r = e[1])) : ((n = s(n)), (r = s(r))),
                        t instanceof Array ? ((o = t[0]), (a = t[1])) : ((o = s(o)), (a = s(a))),
                ...
                (l.bezoutResultant = function (e, t, i, n, r, o, a, s, l, h, A, c, p, u, d, g) {
                    ...
                    return [
                        ...
                        (6 * a * S * d * g - 3 * x * s * M - 3 * T * Q) * e +
                            ...
                            ((-3 * S * d * g + 3 * a * s * M) * r + (S * Q - 2 * x * M + a * s * d * g) * o) * i +
                            ((-x * M + 2 * S * Q - a * s * d * g) * r + (3 * x * d * g - 3 * a * s * Q) * o) * n -
                            w * s * M +
                            (a * M + 2 * s * d * g) * o * C +
                            (-s * Q - 2 * a * d * g) * E * r +
                            B * a * Q +
                            (-3 * h * M - 6 * c * u * g - u * u * u) * P +
                            (3 * l * M + 6 * d * h * g + 6 * A * u * g + (6 * u * d + 6 * p * g) * c + 3 * p * G) * s * x +
                            (-6 * l * d * g - 3 * h * Q + (-6 * p * g - 6 * u * d) * A - 6 * c * p * d - 3 * k * u) * S * a +
                            (3 * l * Q + p * p * p + 6 * A * p * d) * T,
                        (-6 * x * s * u * g + (6 * u * d + 6 * p * g) * S * a - 6 * p * T * d) * e +
                            (6 * P * u * g + (-6 * p * g - 6 * u * d) * s * x + 6 * a * p * S * d) * t +
                            ((6 * a * s * u * g + (-3 * p * g - 3 * u * d) * S) * r +
                                (-4 * x * u * g + (p * g + u * d) * s * a + 2 * p * S * d) * o) *
                                i +
                            ...
                            (6 * l * u * g + (6 * u * d + 6 * p * g) * h + (6 * c * g + 3 * G) * A + 6 * p * c * u + 3 * d * D) * s * x +
                            ((-6 * p * g - 6 * u * d) * l - 6 * h * p * d - 3 * R * g + (-6 * p * u - 6 * c * d) * A - 3 * c * k) * S * a +
                            (3 * A * k + 3 * R * d + 6 * l * p * d) * T,
                        ((-6 * c * g - 3 * G) * s * x + (6 * c * d + 6 * A * g + 6 * p * u) * S * a + (-6 * A * d - 3 * k) * T) * e +
                            ((6 * c * g + 3 * G) * P + (-6 * p * u - 6 * c * d - 6 * A * g) * s * x + (3 * k + 6 * A * d) * S * a) * t +
                            (((6 * c * g + 3 * G) * s * a + (-3 * c * d - 3 * A * g - 3 * p * u) * S) * r +
                                ((-4 * c * g - 2 * G) * x + (p * u + A * g + c * d) * s * a + (2 * A * d + k) * S) * o) *
                                i +
                            (((-2 * c * g - G) * x + (-c * d - p * u - A * g) * s * a + (2 * k + 4 * A * d) * S) * r +
                                ((3 * p * u + 3 * c * d + 3 * A * g) * x + (-6 * A * d - 3 * k) * s * a) * o) *
                                n +
                            w * s * (-2 * c * g - G) +
                            ((2 * c * g + G) * a + (2 * A * g + 2 * c * d + 2 * p * u) * s) * o * C +
                            ((-2 * A * g - 2 * c * d - 2 * p * u) * a + (-k - 2 * A * d) * s) * E * r +
                            (2 * A * d + k) * a * B +
                            ((-6 * c * g - 3 * G) * h - 3 * u * D) * P +
                            ((6 * c * g + 3 * G) * l + (6 * c * d + 6 * A * g + 6 * p * u) * h + 3 * p * D + 6 * A * c * u) * s * x +
                            ((-6 * p * u - 6 * c * d - 6 * A * g) * l + (-6 * A * d - 3 * k) * h - 3 * R * u - 6 * A * c * p) * S * a +
                            ((3 * k + 6 * A * d) * l + 3 * R * p) * T,
                        (-3 * a * S * g + 3 * T * d) * f +
                            ((6 * x * s * g - 6 * a * S * d) * t +
                                (3 * r * S * g + (-2 * S * d - a * s * g) * o) * i +
                                ((-4 * S * d + a * s * g) * r + (6 * a * s * d - 3 * x * g) * o) * n -
                                2 * C * o * s * g +
                                (2 * a * g + 2 * s * d) * E * r -
                                2 * B * a * d +
                                (-6 * h * g - 6 * c * u) * s * x +
                                ...
                                e +
                            (-3 * P * g + 3 * x * s * d) * m +
                            (((3 * S * d - 6 * a * s * g) * r + (4 * x * g - a * s * d) * o) * i +
                            ...
                            ((-x * g - 2 * a * s * d) * v +
                                ...
                                ((6 * h * g + 6 * c * u) * s * a + (-3 * c * p - 3 * A * u - 3 * h * d - 3 * l * g) * S) * r +
                                ((-4 * h * g - 4 * c * u) * x + (l * g + c * p + A * u + h * d) * s * a + (2 * A * p + 2 * l * d) * S) *
                                    o) *
                                i +
                            b * x * d +
                            (-r * o * a * d + C * s * d) * v +
                            (((-2 * h * g - 2 * c * u) * x + (-A * u - l * g - h * d - c * p) * s * a + (4 * A * p + 4 * l * d) * S) * r +
                                ((3 * c * p + 3 * A * u + 3 * l * g + 3 * h * d) * x + (-6 * l * d - 6 * A * p) * s * a) * o) *
                                n +
                            w * s * (-2 * h * g - 2 * c * u) +
                            ((2 * h * g + 2 * c * u) * a + (2 * l * g + 2 * A * u + 2 * c * p + 2 * h * d) * s) * o * C +
                            ((-2 * l * g - 2 * c * p - 2 * A * u - 2 * h * d) * a + (-2 * A * p - 2 * l * d) * s) * E * r +
                            (2 * A * p + 2 * l * d) * a * B +
                            (-3 * F * g - c * c * c - 6 * h * c * u) * P +
                            ((6 * h * g + 6 * c * u) * l + 3 * F * d + (6 * c * p + 6 * A * u) * h + 3 * A * D) * s * x +
                            (-3 * I * g + (-6 * A * u - 6 * c * p - 6 * h * d) * l - 6 * h * A * p - 3 * R * c) * S * a +
                            (3 * I * d + A * A * A + 6 * l * A * p) * T,
                        (3 * p * T - 3 * a * S * u) * f +
                            ((-6 * a * p * S + 6 * x * s * u) * t +
                                (3 * r * S * u + (-2 * p * S - a * s * u) * o) * i +
                                ((-4 * p * S + a * s * u) * r + (6 * a * p * s - 3 * x * u) * o) * n -
                                2 * C * o * s * u +
                                (2 * a * u + 2 * p * s) * E * r -
                                2 * B * a * p +
                                (-6 * h * u - 3 * D) * s * x +
                                ...
                                e +
                            (-3 * P * u + 3 * x * p * s) * m +
                            (((-6 * a * s * u + 3 * p * S) * r + (4 * x * u - a * p * s) * o) * i +
                            ...
                            ((-2 * a * p * s - x * u) * v +
                                ...
                                ((6 * h * u + 3 * D) * s * a + (-3 * A * c - 3 * h * p - 3 * l * u) * S) * r +
                                ((-4 * h * u - 2 * D) * x + (l * u + h * p + A * c) * s * a + (2 * l * p + R) * S) * o) *
                                i +
                            b * x * p +
                            (-r * o * a * p + C * p * s) * v +
                            (((-2 * h * u - D) * x + (-l * u - A * c - h * p) * s * a + (2 * R + 4 * l * p) * S) * r +
                                ((3 * A * c + 3 * h * p + 3 * l * u) * x + (-3 * R - 6 * l * p) * s * a) * o) *
                                n +
                            w * s * (-2 * h * u - D) +
                            ((2 * h * u + D) * a + (2 * l * u + 2 * A * c + 2 * h * p) * s) * o * C +
                            ((-2 * A * c - 2 * h * p - 2 * l * u) * a + (-R - 2 * l * p) * s) * E * r +
                            (2 * l * p + R) * a * B +
                            (-3 * h * D - 3 * F * u) * P +
                        ...
                        (-3 * a * c * S + 3 * A * T) * f +
                            ((-6 * A * a * S + 6 * x * c * s) * t +
                                ...
                                ((a * c * s - 4 * A * S) * r + (-3 * x * c + 6 * A * a * s) * o) * n -
                                2 * C * o * c * s +
                                (2 * a * c + 2 * A * s) * E * r -
                                2 * A * B * a -
                                6 * h * x * c * s +
                                ...
                                e +
                            (-3 * P * c + 3 * A * x * s) * m +
                            (((3 * A * S - 6 * a * c * s) * r + (4 * x * c - A * a * s) * o) * i +
                            ...
                            3 * I * A * T,
                        -(e * e * e) * T +
                            (3 * t * a * S + i * o * S + (2 * r * S - 3 * o * a * s) * n - r * E * s + 3 * l * T + B * a - 3 * h * a * S) *
                                f +
                            (-3 * m * x * s +
                                ((o * a * s - 3 * r * S) * i +
                                    (-r * a * s + 3 * o * x) * n -
                                    ...
                                    t -
                                y * n * S +
                                (2 * v * a * s + (r * o * s - E * a) * n + 3 * r * h * S + (-h * a * s - 2 * l * S) * o) * i -
                                b * x +
                                (-C * s + r * o * a) * v +
                                ((h * a * s - 4 * l * S) * r + (6 * l * a * s - 3 * h * x) * o) * n -
                                2 * C * h * o * s +
                                (2 * l * s + 2 * h * a) * E * r -
                                3 * F * x * s +
                                6 * l * h * a * S -
                                ...
                                e +
                            t * t * t * P +
                            ((-2 * o * x + 3 * r * a * s) * i - 3 * P * h + C * o * a - w * s + 3 * l * x * s - n * r * x) * m +
                            (_ * S +
                                (E * a - r * o * s - 2 * n * a * s) * y +
                                (v * x + (-r * o * a + C * s) * n + (3 * l * S - 6 * h * a * s) * r + (4 * h * x - l * a * s) * o) * i +
                            ...
                            l * b * x +
                            (l * C * s - l * r * o * a) * v +
                            ((-F * x - l * h * a * s + 2 * I * S) * r + (-3 * I * a * s + 3 * l * h * x) * o) * n -
                            w * F * s +
                            (2 * l * s * h + F * a) * o * C +
                            (-I * s - 2 * l * h * a) * E * r +
                            l * l * l * T +
                            ...
                            try {
                                for (; --a >= 0; ) {
                                    ((this.coefs[a] = this.coefs[a].div(r)),
                                        (s = Math.pow(this.coefs[a].abs(), 1 / (i - a))) > o && ((o = s), a));
                                }
                                for (a = 1, t = o; a <= i; a++, t *= o) this.coefs[n - a] = this.coefs[n - a].div(t);
                            } catch (e) {}
                        else {
                            for (; --a >= 0; ) {
                                var s;
                                ((this.coefs[a] = this.coefs[a] / r),
                                    (s = Math.pow(Math.abs(this.coefs[a]), 1 / (i - a))) > o && ((o = s), a));
                            }
                            for (a = 1, t = o; a <= i; a++, t *= o) this.coefs[n - a] /= t;
                        }
                }),
                (l.Polynomial.prototype.simplify = function (e) {
                    if (e) for (var t = this.getDegree(); t >= 0 && this.coefs[t].abs().lte(0); t--) this.coefs.pop();
                    else for (t = this.getDegree(); t >= 0 && Math.abs(this.coefs[t]) <= l.Polynomial.TOLERANCE; t--) this.coefs.pop();
                }),
                ...
                (l.Polynomial.prototype.getCubicRootsAnal = function () {
                    var e,
                        ...
                        o = (3 * t * n - i * i) / (3 * t * t),
                        a = (2 * i * i * i - 9 * t * i * n + 27 * t * t * this.coefs[0]) / (27 * t * t * t);
                    if (Math.abs(o) < l.SMALL_EPS) e = [r(-a)];
                    else if (Math.abs(a) < l.SMALL_EPS) e = [0].concat(o < 0 ? [Math.sqrt(-o), -Math.sqrt(-o)] : []);
                    else {
                        ...
                        if (Math.abs(s) < l.SMALL_EPS) e = [(-1.5 * a) / o, (3 * a) / o];
                            ...
                            var h = 2 * Math.sqrt(-o / 3),
                                ...
                                c = (2 * Math.PI) / 3;
                            e = [h * Math.cos(A), h * Math.cos(A - c), h * Math.cos(A - 2 * c)];
                        }
                    }
                ...
                (l.Polynomial.prototype.getCubicRootsAnalPrecise = function () {
                    ...
                    try {
                        var o = e.times(i).times(3).minus(t.times(t)).div(e.times(e).times(3)),
                            a = t
                                .times(t)
                                .times(t)
                                .times(2)
                        ...
                        if (o.abs().lte(l.TINY_EPS)) s = [r(Number(a.times(-1)))];
                            ...
                            s = [0].concat(o.lte(0) ? [Number(o.times(-1).sqrt()), Number(o.times(-1).sqrt().times(-1))] : []);
                        else {
                            var h = a.times(a).div(4).plus(o.times(o).times(o).div(27));
                            if (h.abs().lte(l.TINY_EPS))
                                (s = [Number(a.div(o).times(-1.5)), Number(a.div(o).times(3))])[0] === s[1] && (s = s.pop());
                            else if (h.gt(0)) {
                                ...
                                var A = Number(o.times(-1).div(3).sqrt().times(2)),
                                    ...
                                    p = (2 * Math.PI) / 3;
                                (s = [A * Math.cos(c), A * Math.cos(c - p), A * Math.cos(c - 2 * p)])[0] == s[1]
                                    ? (s.shift(), s[0] == s[1] && s.pop())
                                    : (s[1] == s[2] || s[0] == s[2]) && (s.pop(), s[0] == s[1] && s.pop());
                            }
                        }
                        for (var u = Number(t.div(e.times(3))), d = 0; d < s.length; d++) s[d] -= u;
                    } catch (e) {}
                    return s;
                }),
                        ...
                        if (e) {
                            ...
                            if (i < 3) {
                                ...
                                for (n = 0; n < o.length; n++) {
                                    ...
                                    if (s === t.length && (console.log("putting some unfound!"), t.push(o[n]), 3 === t.length)) break;
                                }
                            }
                        } else
                            a.getCubicRoots(
                ...
                (l.Polynomial.prototype.getQuarticRoots = function () {
                    ...
                    if (4 == this.getDegree()) {
                        var t = this.coefs[4],
                            ...
                            r = this.coefs[1] / t,
                            o = this.coefs[0] / t,
                            a = new l.Polynomial([1, -n, i * r - 4 * o, -i * i * o + 4 * n * o - r * r]).getCubicRootsAnal()[0],
                            s = (i * i) / 4 - n + a;
                        if ((Math.abs(s) <= l.Polynomial.TOLERANCE && (s = 0), s > 0)) {
                            var h = Math.sqrt(s),
                                ...
                                u = A - c;
                            if (
                                (Math.abs(p) <= l.Polynomial.TOLERANCE && (p = 0), Math.abs(u) <= l.Polynomial.TOLERANCE && (u = 0), p >= 0)
                            ) {
                                var d = Math.sqrt(p);
                ...
                (l.Polynomial.prototype.getRootsInIntervalBisection = function (e, t) {
                    var i = [],
                        n = NaN;
                    if (1 == this.getDegree()) ((n = this.bisection(e, t)), isNaN(n) || i.push(n));
                    else {
                        var r = this.getDerivative().getRootsInInterval(e, t);
                        if (r.length > 0) {
                            ((n = this.bisection(e, r[0])), isNaN(n) || i.push(n));
                            for (var o = 0; o <= r.length - 2; o++) ((n = this.bisection(r[o], r[o + 1])), isNaN(n) || i.push(n));
                ...
                (l.Polynomial.prototype.bisection = function (e, t) {
                    ...
                    if (Math.abs(i) <= l.Polynomial.TOLERANCE) r = e;
                        ...
                        for (
                            var o = Math.log(t - e), a = Math.LN10 * l.Polynomial.ACCURACY, s = Math.ceil((o + a) / Math.LN2), h = 0;
                            h < s;
                            h++
                        ) {
                            r = 0.5 * (e + t);
                ...
                (l.Polynomial.prototype.eval = function (e) {
                    if (isNaN(e)) throw new Error("Polynomial.eval: parameter must be a number");
                    for (var t = 0, i = this.coefs.length - 1; i >= 0; i--) t = t * e + this.coefs[i];
                    return t;
                }),
                (l.Polynomial.prototype.getDerivative = function () {
                    for (var e = new l.Polynomial(), t = 1; t < this.coefs.length; t++) e.coefs.push(t * this.coefs[t]);
                    return e;
                }),
                (l.removeMultipleRoots = function (e) {
                    ...
                    for (var t = 1; t < e.length; ) Math.abs(e[t] - e[t - 1]) < l.TINY_EPS ? e.splice(t, 1) : t++;
                }),
                (l.JenkinsTraub = function () {}),
                (l.JenkinsTraub.prototype.quadSD = function (e, t, i, n, r, o) {
                    ((r[0] = o.b = n[0]), (r[1] = o.a = -t * o.b + n[1]));
                    for (var a = 2; a < e; a++) ((r[a] = -(t * o.a + i * o.b) + n[a]), (o.b = o.a), (o.a = r[a]));
                }),
                (l.JenkinsTraub.prototype.calcSC = function (e, t, i, n, r, o, a, s, l) {
                    ...
                    return (
                        ...
                        (r.c = h.a),
                        (r.d = h.b),
                        (Math.abs(r.c) <= 100 * e * Math.abs(o[t - 1]) && Math.abs(r.d) <= 100 * e * Math.abs(o[t - 2])) ||
                            ((r.h = s * n),
                ...
                (l.JenkinsTraub.prototype.nextK = function (e, t, i, n, r, o, a, s, l) {
                    ...
                    if (3 != i)
                        if (((h = 1 == i ? r : n), Math.abs(o.a1) > 10 * e * Math.abs(h))) {
                            ...
                            for (A = 2; A < t; A++) a[A] = -l[A - 1] * o.a7 + s[A - 2] * o.a3 + l[A];
                        } else {
                            ((a[0] = 0), (a[1] = -l[0] * o.a7));
                        ...
                        3 != e &&
                            ...
                            0 !=
                                (E =
                                    ...
                                    y +
                                    _ * m) && ((t.a = -(p * (C + b) + u * (_ * n + v * o)) / E + p), (t.b = u * (1 + w / E)))));
                }),
                            ...
                            ? 0 != i
                                ? ((r = t / 2),
                                  Math.abs(r) < Math.abs(i)
                                      ...
                                      : ((a = (-e / r) * (i / r) + 1), (o = Math.sqrt(Math.abs(a)) * Math.abs(r))),
                                  a >= 0
                                      ? ((o = r >= 0 ? -o : o), (n.lr = (-r + o) / e), (n.sr = 0 != n.lr ? i / n.lr / e : n.sr))
                                      : ((n.lr = n.sr = -r / e), (n.si = Math.abs(o / e)), (n.li = -n.si)))
                                : (n.lr = -t / e)
                            : (n.sr = 0 != t ? -i / t : n.sr));
                }),
                (l.JenkinsTraub.prototype.quadIT = function (e, t, i, n, r, o, a, s, l, h, A, c) {
                    ...
                    do {
                        if (
                            ...
                            (i.lzr = E.lr),
                            (i.lzi = E.li),
                            Math.abs(Math.abs(i.szr) - Math.abs(i.lzr)) > 0.01 * Math.abs(i.lzr))
                        )
                            break;
                        for (
                        ...
                        if (
                            ...
                            20 *
                                (p =
                                    (9 * (p = p * b + Math.abs(f + s.a)) + 2 * Math.abs(f) - 7 * (Math.abs(s.a + f) + b * Math.abs(s.b))) *
                                    e)
                        ) {
                            i.NZ = 2;
                            break;
                        ...
                        if (B >= 2 && g <= 0.01 && u >= d && !x) {
                            for (
                                m -= m * (g = g < e ? Math.sqrt(e) : Math.sqrt(g)), _ += _ * g, this.quadSD(a, m, _, l, o, s), C = 0;
                                C < 5;
                                C++
                            )
                        ...
                        ((d = u),
                            ...
                            (w = this.calcSC(e, t, s.a, s.b, A, c, m, _, h)),
                            this.newest(w, s, s.a, A.a1, A.a3, A.a7, s.b, A.c, A.d, A.f, A.g, A.h, m, _, c, t, l),
                            (y = s.a),
                            0 != (v = s.b) && ((g = Math.abs((-_ + v) / v)), (m = y), (_ = v)));
                    } while (0 != v);
                }),
                (l.JenkinsTraub.prototype.realIT = function (e, t, i, n, r, o, a, s, l) {
                    ...
                    for (t.NZ = _ = m = 0, g = i.a; ; ) {
                        ...
                        for (c = Math.abs(d), p = Math.abs(g), h = 0.5 * Math.abs(a[0]), y = 1; y < o; y++) h = h * p + Math.abs(a[y]);
                        if (c <= 20 * e * (2 * h - c)) {
                        ...
                        for (u = c, l[0] = A = s[0], y = 1; y < n; y++) l[y] = A = A * g + s[y];
                        if (Math.abs(A) > 10 * Math.abs(s[v]) * e)
                            for (f = -d / A, s[0] = a[0], y = 1; y < n; y++) s[y] = f * l[y - 1] + a[y];
                ...
                (l.JenkinsTraub.prototype.fxshfr = function (e, t, i, n, r, o, a, s, l, h, A) {
                    ...
                    for (
                        A.NZ = 0,
                            ...
                            g = n,
                            y = P = r,
                            V.h = V.g = V.f = V.e = V.d = V.c = V.a7 = V.a3 = V.a1 = U.b = U.a = 0,
                        ...
                        if (
                            ...
                            (Q = this.calcSC(e, a, c, p, V, o, B, P, O)),
                            this.newest(Q, U, c, V.a1, V.a3, V.a7, p, V.c, V.d, V.f, V.g, V.h, B, P, o, a, s),
                            (x = U.a),
                            (T = S = U.b),
                            ...
                            0 != D &&
                                3 != Q &&
                                ((M = (E = (w = 0 != T ? Math.abs((T - y) / T) : w) < m ? w * m : 1) < d ? 1 : 0),
                                (k = (C = (b = 0 != v ? Math.abs((v - g) / v) : b) < f ? b * f : 1) < u ? 1 : 0) || M))
                        ) {
                            for (F = 0; F < a; F++) L[F] = o[F];
                            ((_ = v), (G = N = 0), (I = 1));
                            do {
                                if (((R = 1), !I || 0 != (I = 0) || !k || (M && !(C < E)))) {
                                    if ((this.quadIT(e, a, A, x, S, h, l, U, s, O, V, o), (c = U.a), (p = U.b), A.NZ > 0)) return;
                                    if (((N = 1), (d *= 0.25), G || !k)) R = 0;
                                    else for (F = 0; F < a; F++) o[F] = L[F];
                                }
                                if (0 != R) {
                                    if (((U.a = _), (R = this.realIT(e, A, U, a, s, l, h, o, O)), (_ = U.a), A.NZ > 0)) return;
                                    if (((G = 1), (u *= 0.25), 0 != R)) {
                                        ((x = -(_ + _)), (S = _ * _));
                                        continue;
                                    }
                ...
                (l.JenkinsTraub.prototype.rpSolve = function (e, t, i) {
                    ...
                    for (v = E + 1; E >= 1; ) {
                        ...
                        if (
                            (((l = G / O) <= 1 && V >= 10) || (l > 1 && Number.MAX_VALUE / l >= V)) &&
                            ((l = 0 == l ? Number.MIN_VALUE : l), (y = Math.floor(Math.log(l) / B + 0.5)), 1 != (a = Math.pow(2, y)))
                        )
                            for (k = 0; k < v; k++) C[k] *= a;
                        ...
                        for (P[0] = C[0], c = C[E], p = C[_], b = 0 == P[_] ? 1 : 0, m = 0; m < 5; m++)
                            if (((u = P[_]), b)) {
                                ...
                                ((P[0] = C[0]), (b = Math.abs(P[_]) <= 2220446049250313e-31 * Math.abs(p) * 10 ? 1 : 0));
                            }
                        ...
                        for (m = 1; m <= 20; m++) {
                            if (
                                ...
                                (U = M * N + Q * U),
                                (d = n * (N = f)),
                                this.fxshfr(2220446049250313e-31, x, 20 * m, d, n, P, E, C, v, T, R),
                                0 != R.NZ)
                            ) {
