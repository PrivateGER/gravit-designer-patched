                ...
                (l.prototype.render = function (e, t) {
                    ...
                    if (!(l.BlendModes.indexOf(r) < 0)) {
                        ...
                        this.shaders.hasOwnProperty(r)
                            ? (h = this.shaders[r])
                            : ((this.shaders[r] = h = new n(this.glEffect, null, this.getShaderSource(r))),
                              h.textures({
                                  texture1: 1,
                              }));
                        var A,
                        ...
                        (h.glEffect.spareTexture.drawTo(
                            function () {
                                if (e.dimensions) {
                                    var t = e.dimensions;
                                    h.uniforms(e).drawRect(t.x, t.y, t.x + t.width, t.y + t.height, [0, 0, u, d]);
                                } else h.uniforms(e).drawRect(void 0, void 0, void 0, void 0, [0, 0, u, d]);
                            }.bind(h)
                        ),
