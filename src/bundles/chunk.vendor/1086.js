            ...
            (n.inheritAndMix(g, a, [s.LabelHolder]),
                ...
                (g.prototype.createElementPreview = function () {
                    if (!this._elementPreview) {
                        ...
                        (this._setElementPreview(new p(e.getX(), e.getY(), e.getWidth(), e.getHeight())),
                ...
                (g.prototype.canApplyTransform = function () {
                    return (
                        (this._elementPreview &&
                            (!this._elementPreview.getTransform() || this._elementPreview.getTransform().invertible())) ||
                ...
                (g.prototype.transformBox = function (e, t) {
                    ...
                    if (i && !i.isEmpty())
                        return (
                            this._elementPreview.setProperty("trf", this._element.getProperty("trf")),
                ...
                (g.prototype._setPreTransform = function (e) {
                    u.equals(this._preTransform, e) ||
                        (this.hasFlag(A.Flag.Outline) ? a.prototype.requestInvalidation.call(this) : this.setOutlineTmpFlag(),
                ...
                (g.prototype.getCustomBBox = function (e, t) {
                    ...
                    if (this.getElement().getScene())
                        ...
                        } else this.getElement().getGeometryBBox() && (i = this._getLabelBBox(e));
                    return i;
                }),
                    ...
                    if (((p = A && A.isMaster()), !r.isIdentity())) {
                        ...
                        if ((e.beginUpdate(), t))
                            ...
                            var d = e.getProperty("frame"),
                                ...
                                m = e.getTransform();
                            if (e.dependentUpdate) e.setTransform((m || new u()).multiplied(r));
                            else if (f) {
                                var y = u.getResizeTransform(g, f.side, f.dx, f.dy, f.shift, f.option);
                                (e.setProperty("frame", y.mapRect(d)),
                                    p ||
                                        (this._savedElementPreview && (e._layoutTransform = this._savedElementPreview._layoutTransform),
