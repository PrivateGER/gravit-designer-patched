module.exports = function (module, exports, require) {
            ...
            ((o._textures = []),
                ...
                (o.deleteTexture = function (e) {
                    e &&
                        e.id &&
                        (e.id instanceof n.WebGLTexture ? delete this._textures[e.id.__renderableId] : delete this._textures[e.id]);
                }),
                (o.flush = function () {
                    var e = this;
                    this._textures.slice().forEach(function (t, i) {
                        t.id
                            ? t.id && t.id instanceof n.WebGLTexture && !(t.id.$rendered instanceof r) && e.deleteTexture(t)
                ...
                (o.checkMemory = function () {
                    ...
                    return (
                        this._textures.forEach(function (o) {
                            if (o.id) {
                                if (o.id instanceof n.WebGLTexture && !(o.id.$rendered instanceof r)) return void (i += 1);
                                var a = o.width,
                                    s = o.height;
                                ((e += a * s * 8), (t += 1));
                            }
