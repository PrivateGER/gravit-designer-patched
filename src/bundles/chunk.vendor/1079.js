module.exports = function (e, t, i) {
            ...
            ((a.UNCHANGED = 1),
                ...
                (a.prototype.performCut = function (e, t, i, n, r, o, s) {
                    ...
                    if (
                        ...
                        (n && ((a.ALLOW_ODD_CLOSED && 0 === t.length) || (!a.ALLOW_ODD_CLOSED && t.length % 2 != 0))) ||
                            0 == i.length ||
                        ...
                        switch ((1 === t && (i = []), n.command)) {
                            ...
                            case r.Command.Curve2:
                                if (o) {
                                    ...
                                    e.readVertex(s) &&
                                        e.readVertex(l) &&
                                        (i.push(o.x, o.y), i.push(s.x, s.y), i.push(l.x, l.y), i.push(n.x, n.y));
                                }
                                ((o = n), (n = new r()));
                                break;
                            case r.Command.Close:
                ...
                (a.prototype._getSide = function (e, t, i, n, r) {
                    ...
                    return 0 == c.length || 0 == p.length
                        ...
                        : (1 == h
                              ...
                              : (a = [c[0], c[1], c[2], c[3]]),
                          0 == A
                              ? (4 == p.length || 6 == p.length || 8 == p.length) && (s = [p[2], p[3]])
                              : 4 == p.length
                                ? (s = [p[0], p[1]])
                                : 6 == p.length
                                  ? (s = [p[2], p[3]])
                          ...
                          0 ==
                          (l = r ? o.segmentSide(a[2], a[3], a[0], a[1], s[0], s[1]) : o.segmentSide(a[0], a[1], a[2], a[3], s[0], s[1]))
                              ? 2
                              : 1 == l
                                ? 0
                                : 1);
                ...
                (a.prototype._correctMoveTo = function (e) {
                    ...
                    for (var a = new n(); e.readVertex(t); )
                        ((t.command === r.Command.Move && i && o.isEqualEps(t.x, i.x) && o.isEqualEps(t.y, i.y)) ||
                ...
                l = function (e) {
                    ...
                    return (
                        ...
                        i.command === r.Command.Curve
                            ...
                            : i.command === r.Command.Curve2 && (e.rewindVertices(t - 3), e.readVertex(i)),
                        i
                    );
                },
                h = function (e) {
            ...
            ((a.prototype._distributeSides = function (e, t) {
                for (var i, r = [[], [], []], o = e.length, a = t.length, A = o - 1; A >= 0; A--) {
                    var c = e[A],
                        p = h(c),
                        u = l(c);
                    i = !1;
                    ...
                    for (y = 0; y < 3; y++) {
                        ...
                        for (b = 0; b < S; b++)
                            r[y][b] &&
                                ...
                                (r[y][b].path.getCount(), D.push(this._closePath(r[y][b].path)));
                        e.push(D);
                    }
