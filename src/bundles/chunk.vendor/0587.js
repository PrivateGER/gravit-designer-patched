module.exports = function (e, t, i) {
            ...
            (n.inherit(_, r),
                ...
                (_.prototype.getGlyphBoundingRect = function (e, t, i) {
                    var n,
                        r = "string" == typeof t ? this._openTypeFont.stringToGlyphs(t)[0] : t;
                    if (i) {
                ...
                (_.prototype.getGlyphOutline = function (e, t, i, n) {
                    ...
                    if (!r) {
                        var h = "string" == typeof n ? this._openTypeFont.stringToGlyphs(n)[0] : n,
                            c = h.getPath(
                                0,
                                0,
                            ...
                            "M" === u.type
                                ...
                                : "L" === u.type
                                  ...
                                  : "C" === u.type
                                    ...
                                    : "Q" === u.type
                                      ? (r.addVertex(a.Command.Curve, u.x, u.y), r.addVertex(a.Command.Curve, u.x1, u.y1))
                ...
                (_.prototype.getMaxFontHeight = function (e) {
                    return (
                        ((-this._openTypeFont.tables.head.yMin + this._openTypeFont.tables.head.yMax) / this._openTypeFont.unitsPerEm) * e
                    );
                }),
                (_.prototype.getStrikeoutPosition = function (e, t, i, n) {
                    ...
                    if (r) {
                        ...
                        if ("number" == typeof o) return e - (n / this._openTypeFont.unitsPerEm) * o - i / 2;
                    }
                    return e - t / 2 - i / 2;
                }),
