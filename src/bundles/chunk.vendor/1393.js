module.exports = function (module, exports, require) {
            ...
            ((d.FontManagerProxy = function (e) {
                ((this._fontManager = e),
                    this._fontManager.addEventListener(a.FontAvailableEvent, this._fontEvent, this),
                    this._fontManager.addEventListener(a.FontUnavailableEvent, this._fontEvent, this),
                ...
                (d.FontManagerProxy.prototype.release = function () {
                    (this._promiseCapability.resolve(),
                        this._fontManager.removeEventListener(a.FontAvailableEvent, this._fontEvent, this),
                        this._fontManager.removeEventListener(a.FontUnavailableEvent, this._fontEvent, this));
                }),
                            ...
                            !(function t() {
                                ...
                                (A.push(g),
                                    ...
                                    e.getPage(d).then(function (r) {
                                        ...
                                        g.setProperties(["w", "h", "bck"], [_.width, _.height, o.WHITE]);
                                        var b = new l(g, v, m),
                                            C = {
                                                canvasContext: b,
                                                viewport: _,
