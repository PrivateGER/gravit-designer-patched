module.exports = function (e, t, i) {
            ...
            (n.inherit(m, f),
                ...
                (m.prototype.getCursor = function (e, t) {
                    ...
                    return (
                        e === m.ROTATION_HANDLE_PART_ID
                            ? (i = t.handle ? a.SelectRotateRound : a.SelectRotate[t.rotSegment])
                              ...
                              (1 == t.resizeSegment || 5 == t.resizeSegment
                                  ...
                                  : 3 == t.resizeSegment || 7 == t.resizeSegment
                                    ...
                                    : 0 == t.resizeSegment || 4 == t.resizeSegment
                                      ...
                                      : (2 != t.resizeSegment && 6 != t.resizeSegment) || (i = a.SelectResizeUpRightDownLeft)),
                        i || null
                    );
                }),
                (m.prototype._getPartInfoAt = function (e, t, i) {
                    var n;
                    if (this._showResizeHandles() && (n = this._getResizePartInfoAt(e, t, i))) return n;
                    if (this._showRotationCorners() && (n = this._getRotationCornerPartInfoAt(e, t, i))) return n;
                    if (this._showRotationHandle() && (n = this._getRotationHandlePartInfoAt(e, t, i))) return n;
                    ...
                    this._iterateResizeHandles(
                        function (n, o, a) {
                            l.isPreserveAspectRatioEnabledForSide(o)
                                ? g.paintAnnotation(t, e, n, 0, this.getColor() || this._getOutlineColor(t, e))
                                : u.paintAnnotation(
                                      t,
                                      e,
                                      n,
                ...
                (m.prototype._showResizeHandles = function () {
                    return (
                        !(this.hasFlag(f.Flag.Detail) && !this._showResizeHandlesInDetailMode()) &&
                        this._showAnnotations() &&
                        l.resizeHandles &&
                        (this.hasFlag(m.Flag.ResizeEdges) || this.hasFlag(m.Flag.ResizeCenters))
                    );
                }),
                ...
                (m.prototype._iterateResizeHandles = function (e, t) {
                    ...
                    if (i && !i.isEmpty()) {
                        var n = this.getBoxTransform() || new c(),
                            ...
                            s = [],
                            h = r.mapRect(i),
                            d = l.adaptiveResizeHandles || (h.getHeight() > a && h.getWidth() > a);
                        (this.hasFlag(m.Flag.ResizeEdges) &&
                            d &&
                            (s = s.concat([A.Side.TOP_LEFT, A.Side.TOP_RIGHT, A.Side.BOTTOM_LEFT, A.Side.BOTTOM_RIGHT])),
                            this.hasFlag(m.Flag.ResizeCenters) &&
                                (s = s.concat([A.Side.TOP_CENTER, A.Side.BOTTOM_CENTER, A.Side.RIGHT_CENTER, A.Side.LEFT_CENTER])));
                        for (
                            var g = r.mapPoint(i.getSide(A.Side.CENTER)),
                                f = p.getRotationSegment(g, r.mapPoint(i.getSide(A.Side.TOP_CENTER))),
                                y = p.getRotationSegment(g, r.mapPoint(i.getSide(A.Side.RIGHT_CENTER))),
                                _ = (y >= 3 ? y : f - y >= 4 ? y + 8 : y) > (f >= 3 ? f : y - f >= 4 ? f + 8 : f),
                                v = 0;
                            v < s.length;
                            ++v
                        ) {
                ...
                (m.prototype._processRotationHandle = function (e, t) {
                    ...
                    if (i && !i.isEmpty()) {
                        ...
                        var o = (r = t ? r.multiplied(t) : r).mapPoint(
                                i.getSide("top" == l.rotateHandle ? A.Side.TOP_LEFT : A.Side.BOTTOM_RIGHT)
                            ),
                            a = r.mapPoint(i.getSide("top" == l.rotateHandle ? A.Side.TOP_CENTER : A.Side.BOTTOM_CENTER)),
                            h = r.mapPoint(i.getSide("top" == l.rotateHandle ? A.Side.TOP_RIGHT : A.Side.BOTTOM_LEFT)),
                            ...
                            y = a;
                        this._alignment < 0
                            ? (y = p.getPointAtLength(a.getX(), a.getY(), o.getX(), o.getY(), -this._alignment))
                            : this._alignment > 0 && (y = p.getPointAtLength(a.getX(), a.getY(), h.getX(), h.getY(), this._alignment));
                        var _ = y.add(m),
                            v = r.mapPoint(i.getSide(A.Side.CENTER));
                        p.segmentSide(o.getX(), o.getY(), h.getX(), h.getY(), _.getX(), _.getY()) ==
                            p.segmentSide(o.getX(), o.getY(), h.getX(), h.getY(), v.getX(), v.getY()) && (_ = y.subtract(m));
                ...
                (m.prototype.getRotationAngle = function () {
                    ...
                    return (
                        this._transform && (e = e ? e.multiplied(this._transform) : this._transform),
                ...
                (m.prototype._processRotationCorners = function (e, t, i) {
                    ...
                    if (n && !n.isEmpty()) {
                        ...
                        if (!i || !o || !n.containsPoint(o.mapPoint(i))) {
                            var a = [A.Side.TOP_LEFT, A.Side.TOP_RIGHT, A.Side.BOTTOM_LEFT, A.Side.BOTTOM_RIGHT],
                    ...
                    u) &&
                        ...
                        this._alignment &&
                            (this._alignment === m.OutlineAlignment.Outside
                                ? i.canvas.fillVertices(r.BLACK, 1, h.CompositeOperator.DestinationOut)
                                : this._alignment === m.OutlineAlignment.Inside &&
                                  i.canvas.fillVertices(r.BLACK, 1, h.CompositeOperator.DestinationIn),
