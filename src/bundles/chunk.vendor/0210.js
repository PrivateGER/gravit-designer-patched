module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(g, r),
                ...
                (g.prototype.beginMap = function (e) {
                    (0 == this._counter &&
                        ((this._visuals = []), this._area && !this._area.isEmpty() && this.invalidate(this._area), (this._area = null)),
                        ++this._counter);
                                        ...
                                        if (e && 2 == e.length)
                                            for (var a = 0; a < 2; ++a) {
                                                ...
                                                ((null === t || t > A.getX()) && (t = A.getX()),
                                                    ...
                                                    (null === r || r < A.getX() + A.getWidth()) && (r = A.getX() + A.getWidth()),
                                                    (null === o || o < A.getY() + A.getHeight()) && (o = A.getY() + A.getHeight()));
                                            }
                                    }.bind(this),
                                    l = function (e, t) {
                                        var i = e.line;
                                        if ((e.orient == g.Orientation.V || e.orient == g.Orientation.H) && !e.valueSegments) {
                                            ...
                                            if (!e.freeSegments && !e.valueSegments && r)
                                                if (o) {
                                                    for (var d = [], f = 0; f < r.length; ++f) d.push(r[f][0], r[f][1]);
                                                    d.sort(function (e, t) {
                                                        return e - t;
                                                    });
                                                    var m = false,
                                        ...
                                        if ((s(i, t), e.valueSegments && e.valueSegments.length))
                                            for (
                                                var _ = this._view.getEditor().getDistanceHelper(), v = null, b = null, C = 0;
                                                ...
                                                if (_) {
                                                    ...
                                                    (e.orient == g.Orientation.V
                                                        ? ((v = new n(i[0].getX(), w.bounds[0] + (w.bounds[1] - w.bounds[0]) / 2)),
                                                          (b = p.ValueDirection.Right))
                                                        : ((v = new n(w.bounds[0] + (w.bounds[1] - w.bounds[0]) / 2, i[0].getY())),
                                ...
                                (l.x &&
                                    ...
                                    this._visuals &&
                                        ...
                                        (l.x.guide instanceof n
                                            ? (h.push(l.x.guide), A.push(d ? (l.x.page ? l.x.page : c) : null))
                                            : this._visuals.push({
                                                  guide: l.x.guide,
                                ...
                                l.y &&
                                    ...
                                    this._visuals &&
                                        ...
                                        (l.y.guide instanceof n
                                            ? (h.push(l.y.guide), A.push(d ? (l.y.page ? l.y.page : c) : null))
                                            : this._visuals.push({
                                                  guide: l.y.guide,
                                                ...
                                                if (S.x && u.isEqualEps(S.x.delta, 0) && (!d.length || d[0].idx === T)) {
                                                    if (S.x.guide) {
                                                        ...
                                                        ((V = L.getY()),
                                                            (O = Y.getY()),
                                                            V <
                                                                ((X = S.x.guide.line ? S.x.guide.line : S.x.guide)[0].pt
                                                                    ? X[0].pt.getY()
                                                                    : X[0].getY()) &&
                                                                (X[0] = new n(X[0].pt ? X[0].pt.getX() : X[0].getX(), V)),
                                                            O > (X[1].pt ? X[1].pt.getY() : X[1].getY()) &&
                                                                (X[1] = new n(X[1].pt ? X[1].pt.getX() : X[1].getX(), O)),
                                                ...
                                                if (S.y && u.isEqualEps(S.y.delta, 0) && (!f.length || f[0].idx === T)) {
                                                    if (S.y.guide) {
                                                        ...
                                                        ((N = L.getX()),
                                                            (U = Y.getX()),
                                                            N <
                                                                ((X = S.y.guide.line ? S.y.guide.line : S.y.guide)[0].pt
                                                                    ? X[0].pt.getX()
                                                                    : X[0].getX()) &&
                                                                (X[0] = new n(N, X[0].pt ? X[0].pt.getY() : X[0].getY())),
                                                            U > (X[1].pt ? X[1].pt.getX() : X[1].getX()) &&
                                                                (X[1] = new n(U, X[1].pt ? X[1].pt.getY() : X[1].getY())),
                            ...
                            for (T = 0; T < d.length; ++T)
                                if (this._visuals && d[T].guide) {
                                    ...
                                    if (d[T].guide instanceof n) {
                                        ...
                                        (Math.abs(d[T].value - d[T].guide.getX()) >= 2 || Math.abs(k.getY() - d[T].guide.getY()) >= 2) &&
                                            this._visuals.push({
                            ...
                            for (T = 0; T < f.length; ++T)
                                if (this._visuals && f[T].guide) {
                                    ...
                                    if (f[T].guide instanceof n) {
                                        ...
                                        (Math.abs(f[T].value - f[T].guide.getY()) >= 2 || Math.abs(k.getX() - f[T].guide.getX()) >= 2) &&
                                            this._visuals.push({
                ...
                (g.prototype.paint = function (e, t) {
                    ...
                    var p = function (i, n, r, o) {
                            ...
                            } else ((a = e.mapPoint(i[0].pt ? i[0].pt : i[0])), (s = e.mapPoint(i[1].pt ? i[1].pt : i[1])));
                            (t.canvas.strokeLine(
                                Math.floor(a.getX()) + A,
                                Math.floor(a.getY()) + A,
                                Math.floor(s.getX()) + A,
                            ...
                            if (r.valueSegments && r.valueSegments.length) {
                                ...
                                for (y = 0; y < r.valueSegments.length; ++y) {
                                    ...
                                    (p(
                                        ...
                                        null != v.value &&
                                            u &&
                                            u.paintDistanceHint(v.value, v.valuePt, v.valueDir, _, t, l.distanceHelperColor));
                                }
                            }
                        }
                    this._visuals = [];
                ...
                (g.prototype.invalidate = function (e) {
                    this.hasEventListeners(g.InvalidationRequestEvent) &&
                        (e && !e.isEmpty()
                            ...
                            : this._area &&
                              !this._area.isEmpty() &&
                              ((this._visuals = []), this.trigger(new g.InvalidationRequestEvent(this._area)), (this._area = null)));
                }),
                (g.prototype.useExclusions = function (e) {
                    if (e && e.length) for (var t = 0; t < this._guides.length; ++t) this._guides[t].useExclusions(e);
                }),
                ...
                (g.prototype.getBBoxSnapZones = function (e, t) {
                    ...
                    if (r && e && !e.isEmpty() && e.expanded(s, s, s, s).containsPoint(t, true)) {
                        ...
                        switch (
                            ...
                            (b = m > 2 * g.options.visualsLength ? g.options.visualsLength : m > g.options.visualsLength ? m / 2 : m),
                            (C = v = p.getX()),
                            (y = u.getY()),
                            c)
                        ) {
