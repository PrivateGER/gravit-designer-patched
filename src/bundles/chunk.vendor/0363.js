module.exports = function (module, exports, require) {
            ...
            function P(e) {
                (d.apply(this, arguments.length > 1 ? Array.prototype.slice.call(arguments, 1) : null),
                    ...
                    (this._elementCanvas._canvasContext.canvas.style.position = "absolute"),
                    (this._elementCanvas._canvasContext.canvas.style.left = "0px"),
                    (this._elementCanvas._canvasContext.canvas.style.top = "0px"),
                    this._htmlElement.insertBefore(this._elementCanvas._canvasContext.canvas, this._htmlElement.firstChild),
                    w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None &&
                        ((this._debugCanvas = new f()),
                        (this._debugCanvas._canvasContext.canvas.style.position = "absolute"),
                    ...
                    (this._sceneCanvas = new m(w.CANVAS_GRID_HORIZONTAL, w.CANVAS_GRID_VERTICAL)),
                    ...
                    this._watermarkHelperCanvas.setRenderAlgorithm(f.RenderAlgorithm.Crisp),
                    this._watermarkHelperCanvas.setImageSmoothingQuality(f.SmoothingQuality.High),
            ...
            (DUMP_IMAGES.init(w.ENABLE_RENDERER, w.ENABLE_DEBUG),
                ...
                (P.prototype.setRulers = function (e) {
                    e && !this._horizontalRuler
                        ...
                        : !e &&
                          ...
                          (this._htmlElement.removeChild(this._horizontalRuler._htmlElement),
                          ...
                          this.removeEventListener(c.Move, this._rulerMouseMoveListener, this));
                }),
                (P.prototype.resize = function (e, t, i, n) {
                    if (((e = Math.round(e)), (t = Math.round(t)), e !== this._width || t !== this._height || i)) {
                        ...
                        var r = function () {
                            ((this._inputHtmlElement.style.width = this._htmlElement.style.width),
                                (this._inputHtmlElement.style.height = this._htmlElement.style.height));
                            var i = f.getScreenDPI();
                            (this._elementCanvas.resize(e * i, t * i),
                                (this._elementCanvas._canvasContext.canvas.style.width = e + "px"),
                                (this._elementCanvas._canvasContext.canvas.style.height = t + "px"),
                                w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None &&
                                    (this._debugCanvas.resize(e * i, t * i),
                                    (this._debugCanvas._canvasContext.canvas.style.width = e + "px"),
                                    (this._debugCanvas._canvasContext.canvas.style.height = t + "px")),
                ...
                (P.prototype._scheduleRendering = function (e, t, i) {
                    var n = this,
                        r = function () {
                            x
                                ? t
                                    ? null !== n._resizeRequestFrameId && (n._resizeRequestFrameId = g.scheduleFrame(r))
                                    : i
                                      ? null !== n._finishPanRequestFrameId && (n._finishPanRequestFrameId = g.scheduleFrame(r))
                                      : null !== n._repaintRequestFrameId && (n._repaintRequestFrameId = g.scheduleFrame(r))
                                : (w.DEBUG_AREAS !== w.DBG_AREAS_INFO.None &&
                ...
                (P.prototype.setViewOffset = function (e) {
                    if (((this._viewOffset = [0, 0, 0, 0]), e && e.length > 0)) {
                        for (var t = 0; t < Math.min(4, e.length); ++t) this._viewOffset[t] = e[t];
                        this._relayoutRulers();
                    }
                }),
                ...
                (P.prototype.setViewMargin = function (e) {
                    if (((this._viewMargin = [0, 0, 0, 0]), e && e.length > 0))
                        for (var t = 0; t < Math.min(4, e.length); ++t) ((this._viewMargin[t] = e[t]), this.invalidate());
                }),
                ...
                (P.prototype.getViewBox = function (e) {
                    ...
                    return new p(
                        t,
                        i,
                        this.getWidth() - (this._viewOffset[2] + (e ? 0 : this._viewMargin[2]) + t),
                        this.getHeight() - (this._viewOffset[3] + (e ? 0 : this._viewMargin[3]) + i)
                    );
                }),
                ...
                (P.prototype.zoomAtCenter = function (e, t) {
                    ...
                    var i = f.getScreenDPI(),
                        ...
                        o = Math.min(P.options.maxZoomFactor, Math.max(t, P.options.minZoomFactor));
                    if (o != this._zoom || !A.equals(r, n)) {
                        this._zoom = o;
                        var a = this.getLogicalZoom(),
                            s = new u().translated(-e.getX(), -e.getY()).scaled(a, a).translated(n.getX(), n.getY()).getMatrix(),
                            l = -s[4],
                            h = -s[5];
                ...
                (P.prototype.zoomAll = function (e, t, i) {
                    ...
                    if (t) {
                        var l = this.getWorldTransform().mapRect(new p(n.getX() - r / 2, n.getY() - o / 2, r, o)),
                            h = this._zoom * Math.min(1, Math.max(l.getWidth() / a.getWidth(), l.getHeight() / a.getHeight()));
                        this.zoomAtCenter(n, h);
                    } else this.zoomAtCenter(n, 1 / Math.max(r / a.getWidth(), o / a.getHeight()));
                }),
                (P.prototype.scrollBy = function (e, t) {
                    return (0 != e && Math.abs(e) > 0.5) || (0 != t && Math.abs(t) > 0.5)
                        ? (this._correctScrollPosition(this._scrollX + e, this._scrollY + t),
                    ...
                    return e && n.dirty(e.getX(), e.getY(), e.getWidth(), e.getHeight())
                        ? (t
                              ? (w.DEBUG_AREAS & w.DBG_AREAS_INFO.Scene &&
                                    this._debugCanvas.fillRect(e.getX(), e.getY(), e.getWidth(), e.getHeight(), "#f00", 0.2),
                                null === i
                                    ? (this._dirtyElementList.reset(), (i = this._dirtyElementList.getArea()))
                                    : void 0 === i && (i = e),
                                this._dirtyElementList.dirty(i.getX(), i.getY(), i.getWidth(), i.getHeight()))
                ...
                (P.prototype.release = function () {
                    (this.setRulers(false),
                        ...
                        this._finishPanRequestFrameId &&
                            (g.cancelFrame(this._finishPanRequestFrameId), (this._finishPanRequestFrameId = null)));
                }),
                    ...
                    if (e) {
                        ...
                        try {
                            (t &&
                                ...
                                (this._elementCanvas.clearRect(0, 0, this._elementCanvas.getWidth(), this._elementCanvas.getHeight()),
                                this._elementCanvas.drawImage(this._watermarkHelperCanvas, 0, 0)),
                                a
                                    ? (this._elementCanvas.prepare(a.getDirtyRectangles()), (this._elementPaintContext.dirtyMatcher = a))
                                    : (this._elementCanvas.prepare(e.getDirtyRectangles()), (this._elementPaintContext.dirtyMatcher = e)),
                ...
                (P.prototype._paintWatermark = function () {
                    if (this._viewConfiguration.watermark) {
                        ...
                        (this._watermarkHelperCanvas.clearRect(
                            ...
                            this._elementCanvas.fillRect(0, 0, this._elementCanvas.getWidth(), this._elementCanvas.getHeight(), e));
                    }
                }),
                        ...
                        if (this._panSubAreas) {
                            if (null !== e && null !== t) {
                                ...
                                var r = this._worldToViewTransform
                                        .mapRect(this._lastInvalidatedVtoWtransform.mapRect(this._dirtySceneList.getArea()))
                                        .intersected(this._dirtySceneList.getArea()),
                                    o = this._lastInvalidatedWtoVtransform.mapRect(this._viewToWorldTransform.mapRect(r));
                                ((r = new p(
                                    Math.round(r.getX()),
                                    Math.round(r.getY()),
                                ...
                                (l._cumulativeInvalidationArea
                                    ? (l._cumulativeInvalidationArea = l._cumulativeInvalidationArea
                                          .map(function (e) {
                ...
                (P.prototype._updateViewTransforms = function (e, t) {
                    ((this._scrollX = Math.round(this._scrollX)),
                        ...
                        this._isPanning &&
                            (this._dirtyElementList.translate(-this._scrollDX, -this._scrollDY),
                            this._dirtySceneList.translate(-this._scrollDX, -this._scrollDY)));
                    var i = this._lastInvalidatedVtoWtransform || this._viewToWorldTransform,
                ...
                (P.prototype._relayoutRulers = function () {
                    if (this._horizontalRuler && this._verticalRuler && this._unitRuler) {
                        ...
                        (this._horizontalRuler.resize(this.getWidth() - h - o - (p ? 0 : s), h),
                            this._verticalRuler.resize(h + (c ? o : 0), this.getHeight() - h - a - (p ? 0 : l)),
                            ...
                            this._horizontalRuler.updateView(-this._scrollX - o * e - h * e + t.getX(), this.getLogicalZoom()),
                            this._verticalRuler.updateView(-this._scrollY - a * e - h * e + t.getY(), this.getLogicalZoom()));
                    }
                }),
                ...
                (P.prototype._wheelListener = function (e) {
                    if (g.modifiers.metaKey || g.modifiers.ctrlKey || e.zoom) {
                        ...
                        ("number" == typeof this._wheelScrollingOrZooming &&
                            ...
                            this.beginPan(),
                            g.modifiers.shiftKey ? this.scrollBy(e.deltaY, e.deltaX) : this.scrollBy(e.deltaX, e.deltaY));
                }),
                (P.prototype._rulerMouseMoveListener = function (e) {
                    var t = this._horizontalRuler.getHeight(),
                        i = f.getScreenDPI();
                    (this._horizontalRuler.setMousePosition(e.client.getX() / i - t - this._viewOffset[0]),
                        this._verticalRuler.setMousePosition(e.client.getY() / i - t - this._viewOffset[1]));
                }),
                (P.prototype._leaveListener = function (e) {
                    (this._horizontalRuler && (this._horizontalRuler.setMousePosition(-999), this._verticalRuler.setMousePosition(-999)),
