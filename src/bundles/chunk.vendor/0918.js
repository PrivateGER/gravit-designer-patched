            ...
            ((r.prototype._lineBuffer = null),
                ...
                (r.prototype._store = function (e, t, i) {
                    if (
                        ...
                        e.eof
                            ? ((this._maxAscent = Math.max(this._maxAscent, this._tempLastAscent || e.ascent)),
                              (this._maxDescent = Math.max(this._maxDescent, this._tempLastDescent || e.descent)))
                        ...
                        (this._send(t, i),
                            "number" == typeof n
                                ? e.eof
                                    ? (this._lastNewLineHeight = (this._tempLastAscent + this._tempLastDescent) * n)
                            ...
                            r &&
                                ...
                                ("number" == typeof r
                                    ? e.eof
                                        ? (this._y += (this._tempLastAscent + this._tempLastDescent) * r)
                    ...
                    if (!this._quit && 0 !== this._lineBuffer.length) {
                        ...
                        ((this._ordinal += a.length),
                            ...
                            "number" == typeof a.lineSpacing
                                ? ((o = this._maxAscent + this._maxDescent), (o *= a.lineSpacing))
                ...
                (r.prototype.wrap = function (e, t, i) {
                    if (this._consumer) {
                        ...
                        if (o && o.block) {
                            ...
                            ((!o || (this._includeTerminator && this._includeTerminator(o))) && this._store(t, e, i),
