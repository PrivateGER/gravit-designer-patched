            ...
            ((T.Annots = {
                ...
                (T.ImageBoxEditor.prototype._applyPartMove = function (e, t, i, n) {
                    ((e !== b.RESIZE_HANDLE_PART_ID && e !== b.ROTATION_HANDLE_PART_ID) ||
                        (this._preTransform && !this._preTransform.isIdentity()
                            ? (this._image.preTransformImage(this._preTransform), (this._preTransform = null))
                            : this._transform && !this._transform.isIdentity() && this._image.transformImage(this._transform),
                        this.resetTransform()),
                ...
                (T.prototype.createElementPreview = function () {
                    if (!this._elementPreview) {
                        ...
                        (this._setElementPreview(new d(e.getX(), e.getY(), e.getWidth(), e.getHeight())),
                ...
                (T.prototype._applyTransform = function (e, t, i, n) {
                    this._preTransform && !this._preTransform.isIdentity()
                        ? (e.preTransform(this._preTransform, t, i), b.prototype._applyTransform.call(this))
                ...
                (T.prototype.setEditMode = function (e, t, i, n) {
                    if (this._editMode !== e || t)
                        if (
                            ...
                            this._elementPreview && this._elementPreview.setProperty("csc", !this._editMode),
                            ...
                            if (i && s.imageCropDistance && ((!r && !a) || m.equals(r, a, 1e-11))) {
                                ...
                                var _ = E.pointToLineDist(d.getX(), d.getY(), f.getX(), f.getY(), u.getX(), u.getY()),
                                    v = E.pointToLineDist(d.getX(), d.getY(), u.getX(), u.getY(), f.getX(), f.getY());
                                if (_ >= 3 * p && v >= 3 * p) {
                                    var b = (_ - 2 * p) / _,
                                        C = (v - 2 * p) / v,
                            ...
                            ((this._imgBoxEditor = new T.ImageBoxEditor(this._element)),
                                this.insertEditor(this._imgBoxEditor, this._editors && this._editors.length ? this._editors[0] : null),
                            ...
                            if (r) {
                                ...
                                if (f) {
                                    var _ = t.origTrf ? t.origTrf : u.getBoxTransform(),
                                        v = (d = _ ? _.mapRect(d) : d).translated(p.getX(), p.getY());
                ...
                (T.prototype._getResizePartInfoAt = function (e, t, i) {
                    if (!this._editMode) return c.prototype._getResizePartInfoAt.call(this, e, t, i);
                    var n = null;
                    return (
                ...
                (T.prototype._iterateCropHandles = function (e, t) {
                    ...
                    if (i && !i.isEmpty()) {
                        ...
                        var n = {
                            ...
                            r = E.getVectorProjection(n.bl.getX(), n.bl.getY(), n.br.getX(), n.br.getY(), n.tl.getX(), n.tl.getY()),
                        ...
                        if (o >= h && a >= h && s >= A && l >= A) {
                            ...
                            for (
                                var d = E.getRotationSegment(n.c, n.tc),
                                    ...
                                    v = (y >= 3 ? y : d - y >= 4 ? y + 8 : y) > (d >= 3 ? d : y - d >= 4 ? d + 8 : d),
                                    C = 0;
                                C < u.length;
                                ++C
                            ) {
                ...
                (T.prototype._constructAngleAnnot = function (e, t, i, n, o, a) {
                    ...
                    if (n > 0 && o > 0) {
                        var l = E.getPointAtLength(t.getX(), t.getY(), e.getX(), e.getY(), T.Annots.AngleLength),
                            ...
                            y = h.add(m),
                            _ = t.add(m),
                            v = E.getIntersectionPoint(u.getX(), u.getY(), d.getX(), d.getY(), y.getX(), y.getY(), _.getX(), _.getY());
                        v
                ...
                (T.prototype._constructMiddleAnnot = function (e, t, i, n, o) {
                    ...
                    if (n > 0) {
                        var s = i.getX() - e.getX(),
                            ...
                            A = E.getPointAtLength(t.getX(), t.getY(), e.getX(), e.getY(), T.Annots.MiddleLength / 2),
                            c = A.add(h),
                            p = E.getPointAtLength(t.getX(), t.getY(), i.getX(), i.getY(), T.Annots.MiddleLength / 2),
                            u = p.add(h);
