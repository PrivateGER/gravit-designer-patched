            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(C, p, [b]),
                ...
                (C.prototype._mouseRelease = function (e) {
                    if (!this._hasCreatedShape) {
                        ...
                        (this._editor.getGuides().beginMap(this._editor.getMappingScopes()),
                            (t = this._editor.getGuides().mapPoint(t, null, this._getExclusions())),
                ...
                (C.prototype._mouseDragStart = function (e) {
                    ((this._hasCreatedShape = false),
                        ...
                        this._editor.getGuides().beginMap(this._editor.getMappingScopes()),
                        (this._dragStart = this._editor.getGuides().mapPoint(this._dragStart, null, this._getExclusions())),
                        this._editor.getGuides().finishMap(),
                ...
                (C.prototype._mouseDrag = function (e) {
                    ((this._dragCurrent = this._view.getViewTransform(this._view.getScene().getActivePage()).mapPoint(e.client)),
                        ...
                        n.modifiers.spaceKey &&
                            this._dragStartOrig &&
                            (this._dragStart = this._dragStartOrig.add(this._dragCurrent.subtract(this._dragCurrentOrig))),
                        this._invalidateShape());
                }),
                ...
                (C.prototype._mouseMove = function (e) {
                    this._isDragging ||
                        ((this._movePosition = this._view.getViewTransform(this._view.getScene().getActivePage()).mapPoint(e.client)),
                        this._invalidateMovePosition());
                }),
                (C.prototype._modifiersChanged = function (e) {
                    ((this._keepRatio && e.changed.shiftKey) || (this._fromCenter && e.changed.optionKey) || e.changed.metaKey
                        ? this._invalidateShape()
                        : e.changed.spaceKey &&
                          (n.modifiers.spaceKey
                              ? ((this._dragStartOrig = this._dragStart), (this._dragCurrentOrig = this._dragCurrent))
                              : ((this._dragStartOrig = null), (this._dragCurrentOrig = null))),
                        e.changed.metaKey && !this._isDragging && this._invalidateMovePosition());
                }),
                ...
                (C.prototype._invalidateMovePosition = function () {
                    if (this._movePosition) {
                        ...
                        if (
                            (this._editor.getGuides().finishMap(),
                            c.showTooltips && c.coordinatesTooltip && this._showMousePositionInlineHint())
                        ) {
                            var t =
                        ...
                        if ((this._editor.getGuides().finishMap(), !A.equals(this._dragStart, e))) {
                            ...
                            if (
                                (this._fromCenter && n.modifiers.optionKey
                                    ? ((d = u.fromPoints(new A(t - (r - t), i - (o - i)), new A(t + (r - t), i + (o - i)))),
                                      (g = [new A(t - (s - t), i - (l - i)), new A(t + (s - t), i + (l - i))]))
                                ...
                                if (this._dragArea) {
                                    ...
                                    f =
                                        this._shape instanceof a && this._shape.isLine()
                                            ? this._scene.pointToString(Math.sqrt(m * m + y * y), c.tooltipDecimalPlaces)
