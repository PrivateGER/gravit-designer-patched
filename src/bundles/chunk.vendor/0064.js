module.exports = function (module, exports, require) {
                            ...
                            (document.activeElement &&
                                (function (e) {
                                    ...
                                    return (
                                        ...
                                        ("input" === t ||
                                            ("textarea" === t && "gravit-ime-textarea-608209" !== e.className) ||
                                            "button" === t ||
                                            "select" === t)
                                    );
                                })(document.activeElement)) ||
                            ...
                            : navigator.userAgent.match(/Firefox/i)
                              ...
                              : navigator.userAgent.match(/Chrome/i) || navigator.userAgent.match(/CriOS/i)
                                ...
                                : navigator.userAgent.match(/Safari/i)
                                  ? A.WebBrowser.Safari
                                  : navigator.userAgent.match(/Trident/i) || navigator.userAgent.match(/MSIE/)
                                    ? A.WebBrowser.MSIE
                        ...
                        ? o.operatingSystem === o.OperatingSystem.Unix
                            ...
                            : A.webBrowser === A.WebBrowser.Chrome ||
                              ...
                              : A.webBrowser === A.WebBrowser.Edge_OLD
                                ? (e = 16384)
                                : A.webBrowser === A.WebBrowser.MSIE || A.webBrowser === A.WebBrowser.Opera
                                  ? (e = 8192)
                                  : A.webBrowser === A.WebBrowser.Safari && (e = 4194304)
                        : A.webBrowser === A.WebBrowser.Chrome || A.webBrowser === A.WebBrowser.Firefox
                          ? (e = 32768)
                          : A.webBrowser === A.WebBrowser.Safari && (e = 4194304),
                    (e -= 1)
                );
                    ...
                    o.hardware === o.Hardware.Desktop
                        ? o.operatingSystem === o.OperatingSystem.Unix
                            ...
                            : A.webBrowser === A.WebBrowser.Chrome ||
                              ...
                              : A.webBrowser === A.WebBrowser.Firefox
                                ? (e = 124992400)
                                : (A.webBrowser !== A.WebBrowser.MSIE && A.webBrowser !== A.WebBrowser.Opera) || (e = 67108864)
            ...
            function d() {
                ...
                if (A.webBrowser === A.WebBrowser.Chrome || A.webBrowser === A.WebBrowser.Edge) {
                    ...
                    A.webBrowser === A.WebBrowser.Firefox
                        ...
                        : A.webBrowser === A.WebBrowser.Edge_OLD || A.webBrowser === A.WebBrowser.Opera
                          ? (e = 10485760)
            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(A, IsFiniteNonNegativeNumber, [n]),
                (A.prototype._updateProperties = function () {
                    ((this.webBrowser = A.webBrowser),
                        ...
                        (this.maxImgLinearDimension = A.absoluteMaxImgLinearDimension >>> 1),
                ...
                (A.isTouchDevice =
                    ...
                    ("undefined" != typeof navigator && (navigator.MaxTouchPoints > 0 || navigator.msMaxTouchPoints > 0))),
                ...
                (A.prototype.scheduleFrame = function (e) {
                    return "undefined" != typeof window && "function" == typeof window.requestAnimationFrame
            ...
            if ("undefined" != typeof window && !window.requestAnimationFrame)
                for (var y = 0; y < m.length; ++y)
                    ((window.requestAnimationFrame = window[m[y] + "RequestAnimationFrame"]),
                        (window.cancelAnimationFrame = window[m[y] + "CancelAnimationFrame"]));
