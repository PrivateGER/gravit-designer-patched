module.exports = function (module, exports, require) {
            ...
            ((r.options = {
                ...
                (r.Matcher.from = function (e) {
                    for (var t = new r.Matcher(), i = null, n = 0; n < e.length; n++) i = i ? i.united(e[n]) : e[n];
                ...
                (r.Matcher.prototype.transform = function (e) {
                    if ((this._unitedArea && (this._unitedArea = e.mapRect(this._unitedArea)), this._rects && this._rects.length > 0))
                        for (var t = 0; t < this._rects.length; ++t) this._rects[t] = e.mapRect(this._rects[t]);
                }),
                (r.Matcher.prototype.clip = function (e) {
                    if (this._rects && this._rects.length > 0) {
                        this._unitedArea && (this._unitedArea = e.intersected(this._unitedArea));
                        for (var t = 0; t < this._rects.length; ++t) this._rects[t] = e.intersected(this._rects[t]);
                            ...
                            for (var o = [], a = 0; a < i.length; a++) {
                                ...
                                s instanceof Array
                                    ? ((s = s.filter(function (e) {
                                      ...
                                      (o = o.concat(s)))
                                    : s instanceof n && s.getWidth() > 0 && s.getHeight() > 0 && o.push(s);
                            }
                            i = o;
                        }
                        e = e.concat(i);
                ...
                (r.prototype.dirty = function (e, t, i, n) {
                    ...
                    if (((i = Math.ceil(e + i) - o), (n = Math.ceil(t + n) - a), (e = o), (t = a), this._area)) {
                        ...
                        (e < this._area.getX() && (e = this._area.getX()),
                            ...
                            t + n > this._area.getY() + this._area.getHeight() && (n = this._area.getY() + this._area.getHeight() - t));
                    }
                    null == this._dirties
                        ? (this._dirties = new Array(r.options.bufferSize))
                        : this._numDirties == this._dirties.length && (this._dirties.length += r.options.bufferSize);
                    for (var s = 0; s < this._numDirties; s++) {
                        ...
                        if (e >= l) {
                            ...
                            if (t <= h && e + i >= l + A && t + n >= h + c) ((p[2] = 0), (p[3] = 0));
                            else {
                    ...
                    for (s = 0; s < this._numDirties; s++) {
                        ...
                        if (
                            ...
                            p[2] > 0 &&
                            p[3] > 0 &&
                            (Math.max(e + i, p[0] + p[2]) - Math.min(e, p[0])) * (Math.max(t + n, p[1] + p[3]) - Math.min(t, p[1])) <
                ...
                (r.prototype.translate = function (e, t) {
                    if (this._dirties && this._numDirties > 0)
                        for (var i = 0; i < this._numDirties; ++i) ((this._dirties[i][0] += e), (this._dirties[i][1] += t));
                }),
                    ...
                    if (this._numDirties > 0) {
                        ...
                        for (var t = 0, i = 0; i < this._numDirties; ++i) {
                            ...
                            if (o && o[2] > 0 && o[3] > 0) {
                                ...
                                ((e._rects[t++] = a),
                                    null == e._unitedArea ? (e._unitedArea = a) : (e._unitedArea = e._unitedArea.united(a)));
                            }
                        }
