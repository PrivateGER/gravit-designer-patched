module.exports = function (module, exports, require) {
            ...
            (l.inherit("colorAdjustMultiEffect", A, n),
                ...
                (A.prototype._handleChange = function (e, t) {
                    if (e === l._Change.Store) this.storeProperties(t.blob, A.GeometryProperties);
                    else if (e === l._Change.Restore) this.restoreProperties(t.blob, A.GeometryProperties);
                    else if (e == l._Change.BeforePropertiesChange) {
                        for (
                            var i = t.properties, n = t.values, h = this._colorAdjust.$shp || a.GeometryProperties, c = 0;
                            c < i.length;
                            c++
                        ) {
                            var p = i[c].split("&")[0];
                            l.getName(r) === p
                                ? (n[c]
                                      ? ((h.brightness = n[c].brightness), (h.contrast = n[c].contrast))
                                      : ((h.brightness = 0), (h.contrast = 0)),
                                  this._fx[0].setProperty("shp", n[c], t.custom, t.force, t.temporary))
                                : l.getName(o) === p &&
                                  (n[c] ? ((h.hue = n[c].hue), (h.saturation = n[c].saturation)) : ((h.hue = 0), (h.saturation = 0)),
                                  this._fx[1].setProperty("shp", n[c], t.custom, t.force, t.temporary));
                        }
