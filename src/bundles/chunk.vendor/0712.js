                    ...
                    for (var p = 0; p < a.length; p += 1) {
                        ...
                        "M" === u.type
                            ...
                            : "L" === u.type
                              ...
                              : "Q" === u.type
                                ? A.quadraticCurveTo(e + u.x1 * l, t + -u.y1 * h, e + u.x * l, t + -u.y * h)
                                : "C" === u.type
                                  ? A.curveTo(e + u.x1 * l, t + -u.y1 * h, e + u.x2 * l, t + -u.y2 * h, e + u.x * l, t + -u.y * h)
                ...
                (a.prototype.getMetrics = function () {
                    for (var e = this.path.commands, t = [], i = [], n = 0; n < e.length; n += 1) {
                        ...
                        ("Z" !== r.type && (t.push(r.x), i.push(r.y)),
                            ("Q" !== r.type && "C" !== r.type) || (t.push(r.x1), i.push(r.y1)),
