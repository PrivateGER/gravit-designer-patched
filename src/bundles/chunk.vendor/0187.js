module.exports = function (module, exports, require) {
            ...
            ((c.PolyLine = function () {}),
                ...
                (c.PolyLine.prototype.getOddEven = function (e) {
                    ...
                    do {
                        var s = t.point.getX(),
                            ...
                            h = r.point.getX(),
                            A = r.point.getY();
                        (((l < a && A >= a) || (A < a && l >= a)) && (s <= o || h <= o) && (i ^= s + ((a - l) / (A - l)) * (h - s) < o),
                ...
                (c.PolyLine.prototype.collinear = function (e) {
                    ...
                    if (
                        (t
                            ...
                            : (n.push(this.point.getX(), this.next.point.getX()), o.push(this.point.getY(), this.next.point.getY())),
                        i)
                    ) {
                        var s = e.m,
                            A = e.next.m || 1;
                        i.cp2
                            ? (h.getCtrlPts(i.point.getX(), i.nextCurve.point.getX(), i.cp1.getX(), i.cp2.getX(), s, A, r),
                              h.getCtrlPts(i.point.getY(), i.nextCurve.point.getY(), i.cp1.getY(), i.cp2.getY(), s, A, a))
                            : (h.getCtrlPtsQuadratic(i.point.getX(), i.nextCurve.point.getX(), i.cp1.getX(), s, A, r),
                              h.getCtrlPtsQuadratic(i.point.getY(), i.nextCurve.point.getY(), i.cp1.getY(), s, A, a));
                    } else (r.push(e.point.getX(), e.next.point.getX()), a.push(e.point.getY(), e.next.point.getY()));
                ...
                (c.PolyLine.prototype.generateAABB = function () {
                    ...
                    if ((e = this.point) && this.next && !this.isLastSegment && (t = this.next.point)) {
                        var i = e.getX(),
                            ...
                            r = e.getY(),
                            o = t.getY();
                        (i < n ? ((this.width = n - i), (this.x = i)) : ((this.width = i - n), (this.x = n)),
                            r < o ? ((this.height = o - r), (this.y = r)) : ((this.height = r - o), (this.y = o)));
                    }
                }),
                ...
                (c.redistributeVertexSource = function (e, t) {
                    ...
                    for (a = 0; a < r.length; a++)
                        if (r[a]) {
                            var u = [i[a]],
                                d = [n[a]];
                            for (l = 0; l < r[a].length; l++) (u.push(i[r[a][l]]), d.push(n[r[a][l]]));
                            (h.push(u), A.push(d));
                        }
                ...
                (c.quadTreeFromPolygon = function (e) {
                    ...
                    for (e = s; e.next.point; ) (e.isLastSegment || (e.generateAABB(), l.insert(e)), (e = e.next));
                    return l;
                }),
                ...
                (c.prototype._getPlacement = function (e, t) {
                    ...
                    if (!o.point) return e;
                    do {
                        if (!r.isLastSegment && n <= h.ptSqrDist(i.getX(), i.getY(), o.point.getX(), o.point.getY())) return r;
                        o = (r = r.next).next;
                    } while (o.point);
                    return e;
                }),
                        ...
                        for (var n = 0; n < 2; n++) {
                            ...
                            a.forEach(function (e) {
                                if (e) {
                                    ...
                                    if (a.cp1 && a.cp2) {
                                        for (
                                            var p = new Float64Array(4), u = new Float64Array(4), d = a.cp1, g = a.cp2, f = 0;
                                            f < e.length;
                                            f++
                                        ) {
                                            var m = (_ = e[f])["slope" + n];
                                            ...
                                            (((a = _[r] = a.appendPoint(i.getX(), i.getY(), true)).isIsect = true),
                                                t !== a &&
                                                    (h.isEqualEps(c, m, 1e-8)
                                                        ...
                                                        : (h.getCtrlPts(s.getX(), l.getX(), d.getX(), g.getX(), c, m, p),
                                                          h.getCtrlPts(s.getY(), l.getY(), d.getY(), g.getY(), c, m, u),
                                                          (t.cp1 = new o(p[1], u[1])),
                                                          (t.cp2 = new o(p[2], u[2])),
                                                          (t.nextCurve = a))));
                                            for (var y = t; y !== a; ) ((y.currCurve = t), (y = y.next));
                                            if (((c = m), a === A)) break;
                                        }
                                        A !== a
                                            ? h.isEqualEps(c, 1, 1e-8)
                                                ? a.nextCurve && (a.nextCurve = a.cp1 = a.cp2 = null)
                                                : (h.getCtrlPts(s.getX(), l.getX(), d.getX(), g.getX(), c, 1, p),
                                                  h.getCtrlPts(s.getY(), l.getY(), d.getY(), g.getY(), c, 1, u),
                                                  (a.cp1 = new o(p[1], u[1])),
                                                  (a.cp2 = new o(p[2], u[2])),
                                                  (a.nextCurve = A))
                                        ...
                                        for (p = new Float64Array(3), u = new Float64Array(3), d = a.cp1, f = 0; f < e.length; f++) {
                                            ...
                                            (((a = _[r] = a.appendPoint(i.getX(), i.getY(), true)).isIsect = true),
                                                t !== a &&
                                                    (h.isEqualEps(c, m, 1e-8)
                                                        ? t.nextCurve && (t.nextCurve = t.cp1 = t.cp2 = null)
                                                        : (h.getCtrlPtsQuadratic(s.getX(), l.getX(), d.getX(), c, m, p),
                                                          h.getCtrlPtsQuadratic(s.getY(), l.getY(), d.getY(), c, m, u),
                                                          (t.cp1 = new o(p[1], u[1])),
                                                          (t.cp2 = null),
                                                          (t.nextCurve = a))));
                                        ...
                                        A !== a
                                            ? h.isEqualEps(c, 1, 1e-8)
                                                ? a.nextCurve && (a.nextCurve = a.cp1 = a.cp2 = null)
                                                : (h.getCtrlPtsQuadratic(s.getX(), l.getX(), d.getX(), c, 1, p),
                                                  h.getCtrlPtsQuadratic(s.getY(), l.getY(), d.getY(), c, 1, u),
                                                  (a.cp1 = new o(p[1], u[1])),
                                                  (a.cp2 = null),
                                                  (a.nextCurve = A))
                            ...
                            case a.Command.Curve:
                                if (n) {
                                    ...
                                    ((n = r),
                                        ...
                                        e.readVertex(r) &&
                                            ((p = s),
                                            (s = this._subdivideBezier(s, u.getX(), u.getY(), r.x, r.y, n.x, n.y, void 0, void 0, ++l)),
                                            (r = new a())));
                                } else ((n = r), (r = new a()));
                                break;
                            case a.Command.Curve2:
                                if (n) {
                                    ...
                                    e.readVertex(r) &&
                                        e.readVertex(g) &&
                                        ((p = s),
                                        (s = this._subdivideBezier(s, u.getX(), u.getY(), r.x, r.y, g.x, g.y, d.getX(), d.getY(), ++l)),
                                        (r = new a()));
                                } else ((n = r), (r = new a()));
                                break;
                ...
                (c.prototype._addPoly = function (e) {
                    if (e.next) for (; e.next.point; ) (e.isLastSegment || (e.generateAABB(), this.qtree.insert(e)), (e = e.next));
                }),
                            ...
                            if (i)
                                for (var v = 0; v < _.length; v++) {
                                    if (
                                        ...
                                        (d = b.next.point.getX()),
                                        (g = b.next.point.getY()),
                                        !((s === p && l === u) || (s === d && l === g) || (A === p && c === u) || (A === d && c === g)) &&
                                ...
                                for (v = 0; v < _.length; v++) {
                                    ...
                                    if (
                                        ...
                                        if (!(w = m[(C = (o + 1) * e.seg + b.seg)] || 0)) {
                                            if (((a = r.intersect(e, b)), (m[C] = 1), !a || !a.length)) continue;
                                            for (var B = 0; B < a.length; B++) this._addIsect(f, a[B]);
                                        ...
                                        if (this._firstIntersect) return f;
                                        var x = 0;
                                        if (666 === (w = m[(C = (o + 1) * e.seg + b.seg)] || 0)) continue;
                                        ...
                                        (x &&
                                            ...
                                            x && (e.currCurve || b.currCurve) && (m[C] = w ? w + 1 : 1));
                                    } else if (
                                        ((p = b.point.getX()),
                                        (u = b.point.getY()),
                                        (d = b.next.point.getX()),
                ...
                (c.prototype._addIsect = function (e, t) {
                    ...
                    e.some(function (e) {
                        ...
                        var n = e.slope0,
                            ...
                            A = t.polySeg1.seg;
                        (h.isEqualEps(n, 1, i) &&
                            ((n = 0), (a = e.polySeg0.next.isLastSegment ? e.polySeg0.next.firstSegNum : e.polySeg0.next.seg)),
                            h.isEqualEps(r, 1, i) &&
                                ((r = 0), (l = t.polySeg0.next.isLastSegment ? t.polySeg0.next.firstSegNum : t.polySeg0.next.seg)));
                        var c = e.slope1,
                            p = t.slope1;
                        return (
                            h.isEqualEps(c, 1, i) &&
                                ((c = 0), (s = e.polySeg1.next.isLastSegment ? e.polySeg1.next.firstSegNum : e.polySeg1.next.seg)),
                            h.isEqualEps(p, 1, i) &&
                                ((p = 0), (A = t.polySeg1.next.isLastSegment ? t.polySeg1.next.firstSegNum : t.polySeg1.next.seg)),
                            a === l && s === A && h.isEqualEps(n, r, i) && h.isEqualEps(c, p, i)
                        );
                    }) || e.push(t);
                }),
                (c.prototype._subdivideBezier = function (e, t, i, n, r, a, s, l, A, c) {
                    ...
                    if (
                        ...
                        (e =
                            void 0 !== l && void 0 !== A
                                ? this._recursive_bezier4(e, t, i, n, r, a, s, l, A, 0, 1, c, p, 0)
                        ...
                        for (u.m = 0; u.next.point; )
                            ((d += h.ptSqrDist(u.point.getX(), u.point.getY(), u.next.point.getX(), u.next.point.getY())),
                                (u.next.m = d),
                                (u = u.next));
                    ...
                    return (
                        this._retainBezier &&
                            ((p.nextCurve = e), (p.cp1 = new o(n, r)), void 0 !== l && void 0 !== A && (p.cp2 = new o(a, s))),
                        e
                    );
                }),
                (c.prototype._recursive_bezier4 = function (e, t, i, n, r, o, a, s, l, A, c, p, u, d) {
                    ...
                    switch ((Number(I > 1e-8) << 1) + Number(F > 1e-8)) {
                        case 0:
                            if (0 == (g = S * S + T * T)) ((I = h.ptSqrDist(t, i, n, r)), (F = h.ptSqrDist(s, l, o, a)));
                            else {
                                if (
                                    ((I = (g = 1 / g) * ((n - t) * S + (r - i) * T)),
                                    (F = g * ((o - t) * S + (a - i) * T)),
                            ...
                            if (I > F) {
                                if (I < this.bezierToleranceSq) return (e = e.insertPoint(n, r, A, p, u));
                            } else if (F < this.bezierToleranceSq) return (c < 1 && (e = e.insertPoint(o, a, c, p, u)), e);
                            break;
                        case 1:
                            if (F * F <= this.bezierToleranceSq * (S * S + T * T)) return (e = e.insertPoint(y, _, A + (c - A) / 2, p, u));
                            break;
                        case 2:
                            if (I * I <= this.bezierToleranceSq * (S * S + T * T)) return (e = e.insertPoint(y, _, A + (c - A) / 2, p, u));
                            break;
                        case 3:
                    ...
                    return (
                        (e = this._recursive_bezier4(e, t, i, f, m, C, w, x, P, A, A + (c - A) / 2, p, u, d + 1)),
                        (e = this._recursive_bezier4(e, x, P, E, B, v, b, s, l, A + (c - A) / 2, c, p, u, d + 1))
                    );
                }),
                (c.prototype._recursive_bezier3 = function (e, t, i, n, r, o, a, s, l, A, c, p) {
                    ...
                    if (C > 1e-8) {
                        if (C * C <= this.bezierToleranceSq * (v * v + b * b)) return (e = e.insertPoint(y, _, s + (l - s) / 2, A, c));
                    } else {
                        ...
                        if (C < this.bezierToleranceSq) return (l < 1 && (e = e.insertPoint(n, r, l, A, c)), e);
                    }
                    return (
                        (e = this._recursive_bezier3(e, t, i, d, g, y, _, s, s + (l - s) / 2, A, c, p + 1)),
