module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(h, a),
                ...
                (h.prototype.strokeLine = function (e, t, i, n, s, l) {
                    ...
                    ((this._canvasContext.globalCompositeOperation = a.CompositeOperator.SourceOver),
                ...
                (h.prototype.createCanvas = function (e, t) {
                    ...
                    if (t && this._areas) {
                        l = [];
                        for (var A = 0; A < this._areas.length; ++A) l.push(this._areas[A].translated(-r, -o));
                    }
                    i.prepare(l);
                ...
                (h.prototype.drawCanvas = function (e, t, i, n, r) {
                    (this._canvasContext.save(),
                        (this._canvasContext._dc_globalAlpha = "number" == typeof n ? n : 1),
                        (this._canvasContext._dc_globalCompositeOperation = r || a.CompositeOperator.SourceOver),
