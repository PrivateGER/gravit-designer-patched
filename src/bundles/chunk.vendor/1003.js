            ...
            ((a.prototype.rand = function () {
                ...
                (a.prototype.colorquantization = function (e, t) {
                    var i,
                        ...
                        p = [],
                        u = e.width * e.height;
                    for (a = 0; a < e.height + 2; a++) for (A[a] = [], o = 0; o < e.width + 2; o++) A[a][o] = -1;
                    for (
                        h = t.pal
                            ? t.pal
                            : t.colorsampling
                        ...
                        for (o = 0; o < h.length; o++) ((p[o] = {}), (p[o].r = 0), (p[o].g = 0), (p[o].b = 0), (p[o].a = 0), (p[o].n = 0));
                            ...
                            for (o = 0; o < e.width; o++) {
                                for (c = 4 * (a * e.width + o), n = 1024, r = 0, s = 0; s < h.length; s++)
                                    (i =
                                        ...
                                        4 * Math.abs(h[s].a - e.data[c + 3])) < n && ((n = i), (r = s));
                                ((p[r].r += e.data[c]),
                                    (p[r].g += e.data[c + 1]),
                                    (p[r].b += e.data[c + 2]),
                                    (p[r].a += e.data[c + 3]),
                ...
                (a.prototype.layering = function (e) {
                    ...
                    for (c = 0; c < e.palette.length; c++)
                        for (p[c] = [], A = 0; A < d; A++) for (p[c][A] = [], h = 0; h < g; h++) p[c][A][h] = 0;
                    for (A = 1; A < d - 1; A++)
                        for (h = 1; h < g - 1; h++)
                            ((u = e.array[A][h]),
                                ...
                                (l = A < d - 1 && h < g - 1 && e.array[A + 1][h + 1] === u ? 1 : 0),
                ...
                (a.prototype.batchpathscan = function (e, t) {
                    var i = [];
                    for (var n in e) e.hasOwnProperty(n) && (i[n] = this.pathscan(e[n], t));
                    return i;
                }),
                ...
                (a.prototype.batchinternodes = function (e) {
                    var t = [];
                    for (var i in e) e.hasOwnProperty(i) && (t[i] = this.internodes(e[i]));
                    return t;
                }),
                (a.prototype.tracepath = function (e, t, i) {
                    for (var n, r, o, a = 0, s = []; a < e.length; ) {
                        for (
                            ...
                            (e[o].linesegment === n || e[o].linesegment === r || -1 === r) && o < e.length - 1;
                ...
                (a.prototype.tracepath2 = function (e) {
                    for (var t, i, o, a = 0, s = [], l = new n(0.5); a < e.length; ) {
                        for (
                            ...
                            (e[o].linesegment === t || e[o].linesegment === i || -1 === i) && o < e.length - 1;
                        ...
                        if (h.length > 1) {
                            var c, p;
                            (s.length && (c = new r(s[s.length - 1].cx2 - s[s.length - 1].x2, s[s.length - 1].cy2 - s[s.length - 1].y2)),
                ...
                (a.prototype.batchtracepaths = function (e, t, i) {
                    var n = [];
                    for (var r in e) e.hasOwnProperty(r) && n.push(this.tracepath(e[r], t, i));
                    return n;
                }),
                (a.prototype.batchtracelayers = function (e, t, i) {
                    var n = [];
                    for (var r in e) e.hasOwnProperty(r) && (n[r] = this.batchtracepaths(e[r], t, i));
                    return n;
                }),
                (a.prototype.gks = [
