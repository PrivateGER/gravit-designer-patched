module.exports = function (module, exports, require) {
            ...
            function f(e, t) {
                (t instanceof d.RendererCanvas
                    ? (t = t.parent)
                    : "undefined" != typeof HTMLCanvasElement && t instanceof HTMLCanvasElement && (t = t.getContext("2d")),
                    (this._canvasContext = t),
                    this._canvasContext.hasOwnProperty("imageSmoothingQuality") && (this._canvasContext.imageSmoothingQuality = "high"),
                    (this._core = e),
            ...
            ((f.FLAGS_DRAWING = s.RENDERFLAG_FILL | s.RENDERFLAG_STROKE),
                        ...
                        set: function (e) {
                            this._renderMode & s.RENDERFLAG_LOCKFILL ||
                                (e instanceof o
                                    ...
                                    : ((this._canvasContext.fillStyle = e), (this._textFillStyle = null)));
                        },
                    },
                    globalAlpha: {
                        get: function () {
                        ...
                        set: function (e) {
                            this._renderMode & s.RENDERFLAG_LOCKSTROKE ||
                                (e instanceof o
                                    ...
                                    : ((this._canvasContext.strokeStyle = e), (this._textStrokeStyle = null)));
                        },
                    },
                    font: {
                        get: function () {
                ...
                (f.prototype.fillRect = function (e, t, i, n, r) {
                    var o;
                    (r && ((o = this._canvasContext.fillStyle), (this._canvasContext.fillStyle = r)),
                        ...
                        this._canvasContext.setTransform.apply(this._canvasContext, this._transform.getMatrix()),
                ...
                (f.prototype.getCurrentFont = function () {
                    var e = this.font,
                        t = r.parseFont(e),
                        i = this._currentFont;
                    return null === i && null == (i = this._getFont(t.fontFamily, t.fontStyle, t.fontWeight))
                        ? ((this._currentFont = this._core._fontManager.getDefaultFont()), this._currentFont)
                        : t.fontFamily !== i.getFamily() || t.fontWeight !== i.getWeight() || t.fontStyle !== i.getStyle()
                ...
                (f.prototype._getFont = function (e, t, i) {
                    ...
                    return (
                        ...
                        r &&
                            !r.isResolved() &&
                            (this._core.requireFont(r), (o = null), (r = n.getDefaultFont()).isResolved() || this._core.requireFont(r)),
                        o
                    );
                }),
                ...
                (f.prototype.drawMarker = function (e, t, i) {
                    if (this._renderMode & s.RENDERFLAG_VERTEX) {
                        ...
                        (this._renderMode & s.RENDERFLAG_FILL &&
                            ...
                            this._canvasContext.fill(this._renderMode & s.RENDERFLAG_EVENODDFILL ? "evenodd" : "nonzero"),
                            this._canvasContext.setTransform.apply(this._canvasContext, this._transform.getMatrix())),
                            this._renderMode & s.RENDERFLAG_STROKE &&
                                ...
                                this._renderMode & s.RENDERFLAG_INSIDEBRD
                                    ? this.fillVertices("#000", 1, a.CompositeOperator.DestinationIn)
                                    : this._renderMode & s.RENDERFLAG_OUTSIDEBRD &&
                                      this.fillVertices("#000", 1, a.CompositeOperator.DestinationOut)),
                            this._renderMode & s.RENDERFLAG_RENDERSTYLES &&
                ...
                (f.prototype.drawText = function (e, t, i, n, o) {
                    if (this._renderMode & s.RENDERFLAG_VERTEX) {
                        ...
                        (this.textLocalizedForm && (d.language = this.textLocalizedForm),
                            this.langScript && "auto" !== this.langScript && (d.script = this.langScript),
                        ...
                        if (
                            ...
                            this.textUnderline && this._canvasContext.strokeRect(t, 1 + i, o, 1),
                            this.textStrikeout && this._canvasContext.strokeRect(t, 1 + i - n / 2, o, 1),
                            this._renderMode & (s.RENDERFLAG_INSIDEBRD | s.RENDERFLAG_INSIDEBRD))
                        ) {
                            ...
                            ((this.globalAlpha = 1),
                                ...
                                this._renderMode & s.RENDERFLAG_INSIDEBRD
                                    ? (this.globalCompositeOperation = a.CompositeOperator.DestinationIn)
                                    : this._renderMode & s.RENDERFLAG_OUTSIDEBRD &&
                                      (this.globalCompositeOperation = a.CompositeOperator.DestinationOut),
                                this._canvasContext.fillText(e, t, i),
                                this.textUnderline && this._canvasContext.fillRect(t, 1 + i, o, 1),
                                this.textStrikeout && this._canvasContext.fillRect(t, 1 + i - n / 2, o, 1),
