module.exports = function (e, t, i) {
            ...
            ((l.prototype.draw = function (e, t, i) {
                ((this.isInitialized() && e.width == this.width && e.height == this.height) ||
                ...
                return (
                    this.texture.drawTo(function () {
                        r.getDefaultShader().drawRect(void 0, void 0, void 0, void 0, [0, 0, n, o]);
                    }),
                    this
                );
            }),
                (l.prototype._destroy = function () {
                    (this.shaderInstance && this.shaderInstance.destroy(),
                        ...
                        (this.shaderInstance = this.texture = this.spareTexture = this.extraTexture = this.flippedShader = null));
                }),
                ...
                (l.prototype._initialize = function (e, t) {
                    ...
                    ((this.width = e),
                        ...
                        (this.extraTexture && this.extraTexture.isInitialized()) || (this.extraTexture = n.createTexture(0, 0, i.RGBA)),
                        (this.flippedShader =
                            this.flippedShader ||
                            new r(
                                this,
                ...
                (l.prototype.update = function () {
                    return (
                        this.texture.use(),
                        this.flippedShader.drawRect(void 0, void 0, void 0, void 0, [0, 0, this.width, this.height]),
                        this
                    );
                }),
                        ...
                        if (this.backupShaderData)
                            if (this.backupShaderData.currentGL === e)
                                ...
                                for (var t in (console.warn("third webgl type created"), this.backupShaderData))
                                    ("function" == typeof this.backupShaderData[t].destroy && this.backupShaderData[t].destroy(),
                            ...
                            ((this.backupShaderData = {
                                ...
                                (this.texture = this.spareTexture = this.extraTexture = this.flippedShader = null),
                                (this.shaderInstance = new (this.getShaderClass())(this)));
                        this.currentGL = e;
                    }
                    return !0;
