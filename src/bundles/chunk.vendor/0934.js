            ...
            (r.inheritAndMix(p, r, [a]),
                ...
                (p.prototype.getGimmick = function (e, t, i) {
                    ...
                    for (a = 0; a < f.length; a++) {
                        ...
                        (g.drawFragmentTo(A, v.getX(), v.getY(), b.getX(), b.getY(), v.getWidth(), v.getHeight()),
                            h.drawImageFragment(
                                A,
                                b.getX(),
                                b.getY(),
                ...
                (p.prototype.cachedRender = function (e, t, i, n, r, a) {
                    ...
                    return (
                        A.SHOW_CACHE_DEBUG_LOG && console.log("(render) matcher has " + h.cacheMatcher.getRects().length + " rects"),
                    ...
                    if ((p || (p = this._getNewItem(h)), t)) {
                        ...
                        for (d = 0; d < f.length; d++) {
                            ...
                            for (
                                p.cacheMatcher.merge(m),
                                    p.canvasGrid.drawFragmentFrom(e, C.getX(), C.getY(), m.getX(), m.getY(), m.getWidth(), m.getHeight());
                            ...
                            for (d = 0; d < p.canvasGrid._paintCanvases.length; d++) {
                                ...
                                for (var b = 0; b < _.length; b++) {
                                    var C = _[b],
                                        ...
                                        E = new c(w.x, w.y, w.canvas.getWidth(), w.canvas.getHeight());
                                    C.intersectsRect(E) &&
                                        w.canvas.strokeRect(C.getX() - w.x, C.getY() - w.y, C.getWidth(), C.getHeight(), 1, "#0f0");
                                }
                            }
                        }
                        ...
                        if (
                            (A.SHOW_CACHE_DEBUG_LOG &&
                                ...
                                console.log("Now cache has " + p.cacheMatcher.getRects().length + " rects")),
                            Math.floor(a) !== a)
                        )
                            throw new Error();
                ...
                (p.prototype.setDirty = function (e, t, i, n) {
                    if (
                        (A.SHOW_CACHE_DEBUG_LOG && (console.log("Subtracting:"), console.log(e ? e.translated(i, n).toString() : "all")), e)
                    )
                    ...
                    else for (var s = 0; s < this._cachedCanvases.length; s++) this._cachedCanvases[s].cacheMatcher.reset();
                }),
                ...
                (p.prototype._getNewItem = function (e) {
                    ...
                    return (
                        ...
                        this._cachedCanvases.length > A.MAX_CACHED_ZOOM_LEVELS && this._cachedCanvases.shift(),
                        t
                    );
                }),
