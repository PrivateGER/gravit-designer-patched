module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(u, o),
                ...
                (u.prototype.getMatrix = function (e, t, i, n, r) {
                    ...
                    if (!l || !l.next) return o.prototype.getMatrix.call(this, e, t, i, n, r);
                    s = new a(e + i.getWidth() / 2, t);
                    var h = this._getMtxAtDist(l, e, s, i),
                        A = new a(e, t);
                    return (
                        h ? ((A = h.mapPoint(A)), (i = h.mapRect(i)), r && (h = r.multiplied(h))) : (h = r),
                        ...
                        for (var P = h[g], S = 0; S < P.length; S++) {
                            ...
                            if (!T.isLastSegment && T.next.point) {
                                ...
                                I < B &&
                                    ...
                                    (b = this._totalDist[g]),
                                    (E = T),
                                    (_ = -p.segmentSide(T.point.getX(), T.point.getY(), T.next.point.getX(), T.next.point.getY(), s, l)));
                            }
                        }
                    if (null === E)
                ...
                (u.prototype._getMtxAtDist = function (e, t, i, n) {
                    ...
                    if (((t += n.getWidth() / 2), this._basePath.$closed || this._params.distance > 0)) {
                        ...
                        for (var s in this._polys) {
                            if ((o < 0 && (o = this._totalDist[s]), this._polys[s] === e)) {
                                ...
                                (this._params.distance > 0 && ((r = Math.max(0, Math.min(l - 10, r))), (t += r *= l / o)),
                    ...
                    for (
                        var h, A, u = this._getSegmentAtParam(e, t), d = u.next, g = u.point, f = d.point;
                        f && a.equals(g, f) && ((f = (d = d.next).point), !d.isLastSegment || d.next.point);
                    ...
                    if (
                        (a.equals(g, f)
                            ...
                            : ((A = (t - u.m) / (d.m - u.m)), (h = p.getPointAtSegment(g.getX(), g.getY(), f.getX(), f.getY(), A))),
                        A > 1)
                    )
                        return null;
                    ...
                    if (!f || p.isEqualEps(m.dot(m), 0)) return new c().translated(h.getX() - y.getX(), h.getY() - y.getY());
                ...
                (u.prototype._generateDistancesFilterSubpaths = function (e) {
                    ...
                    if (i && i.point) {
                        do {
                            (t.isLastSegment
                                ? (r < u.MIN_SPATH_LEN && (a ? (a.next = i) : (s = this._polys[e] = i), (n -= r)), (a = t), (r = 0))
                                : ((r += o = p.ptDist(t.point.getX(), t.point.getY(), i.point.getX(), i.point.getY())), (n += o)),
                                (i.m = n),
                                (i = (t = i).next));
                        } while (i.point);
                ...
                (u.prototype._getSegmentAtParam = function (e, t) {
                    ...
                    do {
                        if (((i = r.m), (r.isLastSegment && !r.next.point) || t < i)) return n.isLastSegment && !r.isLastSegment ? r : n;
                        r = (n = n.next).next;
                    } while (r.point);
                    return n;
                }),
