module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(p, IsFiniteNonNegativeNumber, [r, c]),
                ...
                (p.prototype._prepareBackground = function (e, t) {
                    var i, n, r, s, h, A, c, p;
                    (e
                        ? ((i = e.getX()), (n = e.getY()), (r = e.getWidth()), (s = e.getHeight()))
                        : ((i = 0), (n = 0), (r = this._paintCanvas.getWidth()), (s = this._paintCanvas.getHeight())),
                        t
                    ...
                    (t &&
                        ((this.isInitialized() && h === this.texture.width && A === this.texture.height) ||
                            this._initialize.call(this, h, A)),
                        m.use(),
                        t
                            ? this.texture.drawTo(function () {
                                  a.getDefaultShader().drawRect(i - c, n - p, i - c + r, n - p + s, [0, 0, h, A]);
                              })
                            : this.draw(m),
                        m.destroy(),
                ...
                (p.prototype._renderWithBlend = function (e, t, i) {
                    ...
                    if (
                        ...
                        ((n._canvasContext.globalCompositeOperation = h.CompositeOperator.Copy),
                            (n._canvasContext.globalAlpha = 1),
                            n._canvasContext.drawImage(p.canvas, e ? e.getX() : 0, e ? e.getY() : 0),
