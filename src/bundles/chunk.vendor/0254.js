module.exports = function (e, t, i) {
            ...
            ((t.isSharePointFileId = d),
                ...
                (t.sanitizeName = u),
                (t.sameDomain = (e, t) => e && t && e.email && t.email && e.email.split("@")[1] === t.email.split("@")[1]),
                (t.getExternalAppCodes = () => a.map((e) => e.code)),
                (t.getAppFromFileId = (e) => (d(e) ? s.SharePoint : g(e) ? s.GoogleDrive : null)),
                ...
                (t.getSubscriptionUrl = function () {
                    let e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return t.getUrlWithQueryParams("https://gravit.plasmatrap.com", e);
                }),
