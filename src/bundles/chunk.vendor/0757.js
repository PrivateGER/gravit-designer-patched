            ...
            (IsFiniteNonNegativeNumber.inherit(O, GPathTool),
                ...
                (O.prototype._mouseDown = function (e) {
                    ...
                    if (t - this._mDownTime < GPathTool.DBLCLICKTM) "edit" == u.selectDoubleClickBehavior && this._manager.notifyJobDone(this);
                        ...
                        if (
                            ...
                            (r && (r.removeFlag(n.Flag.Selected), this._editPt.setFlag(n.Flag.Selected)),
                                this._invalidate(),
                            ...
                            (this._editor.getGuides().beginMap(this._editor.getMappingScopes()),
                                (o = this._editor.getGuides().mapPoint(o, P.DetailMap.Mode.DetailOnFilterOn)),
                ...
                (O.prototype._mouseMove = function (e) {
                    ...
                    if (this._released || !this._firstAlt) {
                        ...
                        if (!this._newPoint && this._pathEditor) {
                            ...
                            (this._editor.getGuides().beginMap(this._editor.getMappingScopes()),
                                (n = this._editor.getGuides().mapPoint(n, P.DetailMap.Mode.DetailOnFilterOn)),
                                this._editor.getGuides().finishMap(),
                ...
                (O.prototype._updateHandles = function (e) {
                    ...
                    if (
                        ...
                        (null !== this._editPt.getProperty("hlx") && null !== this._editPt.getProperty("hly")
                            ? this._editPt.setProperties(["tp", "hrx", "hry"], [B.AnchorPoint.Type.Symmetric, null, null])
                            : this._editPt.setProperties(["tp", "hrx", "hry"], [B.AnchorPoint.Type.Asymmetric, null, null]),
                            (this._cursor = p.Knife));
                    else {
                        ...
                        if (
                            ...
                            if (n != B.AnchorPoint.Type.Connector) {
                                ...
                                (this._editPt.setProperties(["hlx", "hly", "hrx", "hry"], [null, null, t, i]), (this._cursor = p.Knife));
                            }
                        else {
                            var m = a.getX() - r,
                                y = a.getY() - o;
                ...
                (O.prototype._mouseDrag = function (e) {
                    (!this._refPt ||
                        ...
                        e.button == a.BUTTON_LEFT && this._editPt.setProperty("tp", B.AnchorPoint.Type.Symmetric),
                        this._invalidate()),
                        !this._released &&
                            this._editPt &&
                            ((this._lastMouseEvent = e),
                ...
                (O.prototype._addPoint = function (e, t, i, r) {
                    if ((r || e.setFlag(n.Flag.Selected), this._pathEditor && !i)) {
                        ...
                        if (o) {
                            ...
                            ((a = o.inverted().mapPoint(a)), e.setProperties(["x", "y"], [a.getX(), a.getY()]));
                        }
                    }
                    this._pathEditor
                        ? (this._invalidate(),
                    ...
                    if ((this._invalidate(), M.modifiers.spaceKey)) {
                        if (this._lastMouseEvent && this._lastMouseEvent.clientDelta && this._editPt) {
                            var i = this._editPt.getProperty("x"),
                                ...
                                r = new s(i + this._lastMouseEvent.clientDelta._x, n + this._lastMouseEvent.clientDelta._y);
                        ...
                        if (
                            (a.hasFlag(n.Flag.Selected) &&
                                (c === B.AnchorPoint.Type.Connector
                                    ...
                                    : (c !== B.AnchorPoint.Type.Symmetric && c !== B.AnchorPoint.Type.Mirror) ||
                                      (d.annotation = u.annotationHandles.path.node.smoothType)),
                            a.hasFlag(n.Flag.Selected) || (h && h.hasFlag(n.Flag.Selected)))
                        )
                            null !== (l = new s(a.getProperty("hlx"), a.getProperty("hly"))).getX() &&
                                null !== l.getY() &&
                                (d.leftHandlePosition = l);
                        if (a.hasFlag(n.Flag.Selected) || (A && A.hasFlag(n.Flag.Selected)))
                            null !== (l = new s(a.getProperty("hrx"), a.getProperty("hry"))).getX() &&
                                null !== l.getY() &&
                                (d.rightHandlePosition = l);
                        if (o) {
                            var g = o.mapPoint(d.position);
                            (d.leftHandlePosition && (d.leftHandlePosition = o.mapPoint(d.leftHandlePosition)),
                ...
                (O.prototype.getPathPreview = function () {
                    if (!this._elementPreview) {
                        ...
                        var e = this._knifePath.getAnchorPoints().getFirstChild(),
                            t = new c.AnchorPoint();
                        (t.setProperties(["x", "y"], [e.getProperty("x"), e.getProperty("y")]),
                ...
                (O.prototype.movePoint = function (e, t, i, n) {
                    ...
                    if (e.getProperty("ah")) e.setProperties(["x", "y"], [a.getX(), a.getY()]);
                        ...
                        e.setProperties(["x", "y", "hlx", "hly", "hrx", "hry"], [a.getX(), a.getY(), h, A, c, p]);
                    }
                }),
                ...
                (O.prototype._performCut = function () {
                    var e = false,
                        ...
                        n = [],
                        r = null;
                    if (this._editor.hasSelection()) r = this._getSelectableElements(this._editor.getSelection());
                    else {
                        ...
                        (s.addVertex(R.Command.Move, a.getX(), a.getY()),
                            ...
                            s.addVertex(R.Command.Line, a.getX() + a.getWidth(), a.getY() + a.getHeight()),
                    ...
                    for (var h, p, u = [], g = [], f = new k(this._dpathRef), _ = [], v = 0; v < r.length; v++) {
                        if ((ee = r[v]) instanceof y) for (var w = ee.getTextShapes(), B = 0; B < w.length; B++) (g.push(w[B]), _.push(ee));
                                    ...
                                    for (O = 0; O < ae; O++) {
                                        if ((ee = D[V][O])) {
                                            ...
                                            if (
                                                ...
                                                (x.$trf = se),
                                                1 == ae ? (h.insertChild(ee, p), u.push(ee)) : oe.appendChild(ee),
                                                !(x instanceof S))
                                            )
                                                for (var le = x.getFirstChild(); null != le; le = le.getNext()) ee.appendChild(le.clone());
                                        }
                                    }
                                }
                            }
                ...
                (O.prototype.elementHitTest = function (e, t) {
                    ...
                    if (
                        ...
                        if (n)
                            2 * G.ptDist(locationInvTransformed.getX(), locationInvTransformed.getY(), n.getX(), n.getY()) <= 2 &&
                                ((i.slope = 0.5), (i.x = n.getX()), (i.y = n.getY()));
                    }
                    return i;
                }),
                ...
                (O.prototype.convertToPath = function (e) {
                    ...
                    if (n) i.push(e.getParent() ? e.clone() : e);
                        ...
                        if ((t = A.createPathFromVertexSource(e))) {
                            ...
                            ((e.$trf = null),
                                t.assignFrom(e),
                                e instanceof B && ((t.$evenodd = e.getProperty("evenodd")), (t.$closed = e.getProperty("closed"))),
                                (e.$trf = p),
                                i.push(t));
                        }
                    }
                    ...
                    for (s = 0; s < i.length; s++) {
                        ...
                        if ((t = i[s]) instanceof d) {
                            var f = t.getPaths();
                            for (o = f.getFirstChild(); null !== o; o = o.getNext()) g.push(o);
                            f.clearChildren();
                        } else g.push(t);
                        u.push(g);
                    }
                    ...
                    return (
                        ...
                        !(
                            ...
                            (e.getProperty("plkt") & r.ProgramLck.NoSelect ||
                                ...
                                (e.getParent() && e.getParent().getProperty("plkt") & r.ProgramLck.NoEdit))
                        )
                    );
                }),
