            ...
            module.exports = function (e) {
                ...
                ((e.Accelerated.prototype._updateQTree = function () {
                    ...
                    for (var t = 0, i = this.getFirstChild(); null !== i; i = i.getNext())
                        i instanceof e &&
                            ((i._elementIndex = t++),
                            i._containingPaintQTreeElement || i._containingGeometryQTreeElement
                    ...
                    (e.Accelerated.prototype._removeAccelElement = function (e, t, i) {
                        (!i &&
                            ...
                            (this._childrenGeometryQTree.remove(e._containingGeometryQTreeElement),
                            (e._containingGeometryQTreeElement = null)),
                            !t &&
                                e._containingPaintQTreeElement &&
                                (this._childrenPaintQTree.remove(e._containingPaintQTreeElement), (e._containingPaintQTreeElement = null)));
                    }),
                    ...
                    (e.Accelerated.prototype._handleChildrenStructureChange = function (t, i) {
                        if (t === n._Change.Restore) {
                            ...
                            if (i[0] instanceof e && i[0].getParent() === this)
                                if (
                                    (this._createQTreeIfNotExists(),
                                    i[0]._containingPaintQTreeElement || i[0]._containingGeometryQTreeElement)
                                )
                    ...
                    (e.Accelerated.prototype._getIndexOfPrevious = function (t) {
                        if (!t) return -1;
                        for (var i = t.getPrevious(); null !== i; i = i.getPrevious()) if (i instanceof e) return i._elementIndex;
                        return -1;
                    }),
                    ...
                    (e.Accelerated.prototype.paintQTree = function (e, t, i, n) {
                        ...
                        if (r) {
                            ...
                            if (r.nodes) for (l = 0; l < r.nodes.length; l++) this.paintQTree(e, r.nodes[l], 0.6 * i);
                        }
                    }),
