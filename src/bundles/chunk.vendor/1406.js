                ...
                (V.export = function (e, t, i, n, r) {
                    if (i) {
                        ...
                        if (
                            ...
                            o = [];
                            var d = "undefined" != typeof navigator && navigator.hardwareConcurrency ? navigator.hardwareConcurrency : 4,
                                ...
                                if (!E.isAbort())
                                    if (i || (i = e._getBitmapPaintArea())) {
                                        ...
                                        ((h.configuration.sceneBackground =
                                            void 0 !== x.sceneBackground ? x.sceneBackground : h.configuration.sceneBackground),
                                            h.canvas.resize(a, l),
                                            h.canvas.prepare(),
                                        ...
                                        (E.setPageOrigin(d.mapPoint(new s(0, 0))),
                                            ...
                                            h.canvas.setScale(S),
                                            t.backgroundColor && h.canvas.fillCanvas(t.backgroundColor, t.backgroundOpacity));
                                                            ...
                                                            try {
                                                                ...
                                                                if (N.isAffectedByBackground(t)) {
                                                                    if (
                                                                        ...
                                                                        var i = A.getBitmapPaintArea(t.getPage(), "1x"),
                                                                            n = t.getPaintBBox();
                                                                        h.canvas
                                                                            .getContext()
                                                                            .replaceWithBitmap(_.getHTMLElement(), t, i, n);
                                                                    }
                                                                    w(++e);
                                                                } else
                                                                    new D()
                            ...
                            if (
                                ...
                                ((i._paint = function (e) {
                                    (e.beginNode(this.__source__),
                                        ...
                                        (this.__source__ instanceof v && this._needToRaster && !s) || this.__proto__._paint.call(this, e),
                                        this._needToRaster ||
                                            s ||
                                            (function (e, t) {
                                                if (t.hasMixin(GStylable)) {
                                ...
                                t._instanceof(i, B)
                                    ...
                                    : t._instanceof(i, x)
                                      ...
                                      : t._instanceof(i, C)
                                        ...
                                        : t._instanceof(i, b) && (i._workspace = t.proxy(i._workspace));
                        }
                        return i;
                    }
                    return null;
