module.exports = function (e, t, i) {
            ...
            ((A.import = function (e, t, i, c) {
                try {
                    if ("string" == typeof e) return A.import(new DOMParser().parseFromString(e, "text/xml"), t, i, c);
                    ...
                    if (!e || !e.documentElement || "svg" !== e.documentElement.nodeName) return c("Invalid svg document.");
                    t = r.extend(
                        {
                            baseWidth: 400,
                            baseHeight: 400,
                    ...
                    if (
                        ...
                        4 === y.length &&
                            ...
                            NaN !== d && NaN !== g && d >= 0 && g >= 0 && f.ViewPort.SetCurrent(d, g));
                    }
                    var _ = null;
