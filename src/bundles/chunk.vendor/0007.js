module.exports = function (module, exports, require) {
            ...
            ((a.serialize = function (e) {
                        ...
                        switch (t) {
                            ...
                            default:
                                Math.abs(h) > Math.abs(A)
                                    ? (A = o.isEqualEps(A, 0) ? h : (A * Math.abs(h)) / Math.abs(A))
                                    : (h = o.isEqualEps(h, 0) ? A : (h * Math.abs(A)) / Math.abs(h));
                        }
                ...
                (a.prototype.getScaleFactor = function () {
                    var e = 0.7071067811865476 * this._sx + 0.7071067811865476 * this._shx,
                ...
                (a.prototype.mapQuadrilateral = function (e) {
                    ...
                    return [this.mapPoint(t), this.mapPoint(i), this.mapPoint(n), this.mapPoint(o)];
                }),
