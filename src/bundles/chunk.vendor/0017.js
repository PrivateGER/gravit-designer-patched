            ...
            (require(50).inherit("C", a, n),
                    ...
                    if ("#" === l[0])
                        return l.length <= 4
                            ? (s = parseInt(l.substr(1), 16)) >= 0 && s <= 4095
                                ? [((3840 & s) >> 4) | ((3840 & s) >> 8), (240 & s) | ((240 & s) >> 4), (15 & s) | ((15 & s) << 4), 1]
                                : null
                            : l.length <= 7 && (s = parseInt(l.substr(1), 16)) >= 0 && s <= 16777215
                        ...
                        switch (c) {
                            ...
                            case "hsl":
                                ...
                                var d = (((parseFloat(p[0]) % 360) + 360) % 360) / 360,
                                    ...
                                    y = 2 * f - m;
                                return [o(255 * r(y, m, d + 1 / 3)), o(255 * r(y, m, d)), o(255 * r(y, m, d - 1 / 3)), u];
                            default:
                                return null;
                        }
                    }
                ...
                (a.blend = function (e, t, i) {
                    return void 0 === e && void 0 !== t
                        ...
                        : void 0 !== e && void 0 === t
                          ? e
                          : [e[0] + (t[0] - e[0]) * i, e[1] + (t[1] - e[1]) * i, e[2] + (t[2] - e[2]) * i];
                }),
