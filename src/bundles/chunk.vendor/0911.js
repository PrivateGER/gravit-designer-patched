                ...
                ((e.Stylable = function () {}),
                        ...
                        if (r >= 0 && this._fxCache[r]) {
                            ...
                            if (a && h) {
                                ...
                                return !i && (Math.abs(l.getWidth() - e.getWidth()) > 1 || Math.abs(l.getHeight() - e.getHeight()) > 1)
                                    ? (console.log("fx cache: size misfit"), this._resetFxCacheAndState(t, !0), !1)
                                    : (n ||
                    ...
                    (e.Stylable.prototype._reinvalidateRemovedFx = function (e) {
                        ...
                        this._fxCache = this._fxCache.filter(function (i) {
                            ...
                            for (var n = i.deps, r = 0; r < n.length; r++) {
                                var o = n[r];
                                if (o === e || !this._fxExists(o)) return (t.destroy([i.bmp]), !1);
                            }
                            return !0;
                        }, this);
                    }),
                    ...
                    (e.Stylable.prototype._paintWithEffects = function (e, t, i, n, r, l, h, A, c, p) {
                        ...
                        (h || (h = []),
                            ...
                            (e.getWidth() < c.getWidth() - 1 || e.getHeight() < c.getHeight() - 1) && (d = !0));
                        var f,
                            m = {};
                        for (
                            r.some(function (e) {
                            ...
                            if (((m[v] = !0), _ === a.Effect.Type.Filter))
                                ...
                                (_ === a.Effect.Type.PostEffect && "string" == typeof b && (w = b),
                    ...
                    (e.Stylable.prototype._styleFinishGeometryChange = function (t) {
                        if ((this._notifyChange(e._Change.FinishGeometryUpdate, 1), t)) {
                            if (
                                (t instanceof a.Effect ? this._resetFxCacheAndState(t) : this._resetFxCacheAndState(),
                    ...
                    (e.Stylable.prototype._styleRepaint = function (t) {
                        (t && t instanceof a.Effect ? this._resetFxCacheAndState(t) : this._resetFxCacheAndState(),
                                    ...
                                    switch (e) {
                                        ...
                                        case r._Change.SceneAttached:
                                            (this._scene.link(i, this),
                                                e === n._Change.AfterPropertiesChange && this.assignStyleFrom(i, !0));
                                    }
                            }
