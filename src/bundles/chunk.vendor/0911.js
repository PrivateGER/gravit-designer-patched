module.exports = function (module, exports, require) {
            ...
            module.exports = function (e) {
                ((e.Stylable = function () {}),
                    IsFiniteNonNegativeNumber.inherit(e.Stylable, GStylable),
                    (e.Stylable.GeometryProperties = {
                        sref: null,
                    }),
                    (e.Stylable._ENABLE_PARTIAL_RESET = true),
                    (e.Stylable.prototype._fxCache = []),
                    (e.Stylable.prototype.assignStyleFrom = function (e, t) {
                        this.beginUpdate();
                        try {
                            GStylable.prototype.assignStyleFrom.call(this, e, t);
                        } finally {
                            this.endUpdate();
                        }
                    }),
                    ...
                    (e.Stylable.prototype._paintStyle = function (e, t) {
                        ...
                        if (e.configuration.isOutline(e)) this._paintStyleFillLayer(e, t, i);
                            ...
                            n =
                                ...
                                (e.getRootCanvas().getScale() > 6 &&
                                    ...
                                    ? null
                                    : this._effects
                                      ? this._effects.getLayersEffects(i, true)
                                      : null;
                            var r = false,
                                o = function (e) {
                                    var t = e.getEffectType();
                                    return t === GStylable.Effect.Type.PreEffect || t === GStylable.Effect.Type.PostEffect || t === GStylable.Effect.Type.Multi;
                                },
                                l = null;
                            if (n) {
                    ...
                    (e.Stylable.prototype._paintCompositedWithBackground = function (e, t) {
                        if ("m" === this.$_sbl || "!m" === this.$_sbl) {
                            ...
                            n && e.hasClip() && (e.clipRect(n.getX(), n.getY(), n.getWidth(), n.getHeight()), (i = true));
                            try {
                                t(
                                    e,
                                    this.$_stop,
                                    "m" === this.$_sbl ? s.CompositeOperator.DestinationIn : s.CompositeOperator.DestinationOut
                                );
                            } finally {
                                i && e.resetClip();
                            }
                    ...
                    (e.Stylable.prototype._paintStyleFillLayer = function (e, t, i, n, r, o) {
                        if (e.configuration.isOutline(e)) this._paintStyleContent(e, t, i, n, r, o);
                        else {
                            var a = n ? n[i && i.length ? i.length : 0] : null;
                            if (1 !== this.$_sfop || a) {
                                var s = [null],
                                    l = [1],
                                    h = this._createStyleCanvas(e, t, this._fxPadding(a, null, e.canvas.getScale()), s, l),
                                    A = e.pushCanvas(h);
                                try {
                                    if ((this._paintStyleContent(e, t, i, n, r, o), a)) {
                                        var c = [];
                                        if (i) for (var p = 0; p < i.length; p++) n[p] && (c = c.concat(n[p]));
                            ...
                            } else this.$_sfop > 0 && this._paintStyleContent(e, t, i, n, r, o);
                        }
                    }),
                                ...
                                : ((e[0] = r),
                                  e
                                      .reduce(function (e, t) {
                                          ...
                                          return (
                                              "number" == typeof i ? (i = [i, i, i, i]) : i || (i = n),
                    ...
                    (e.Stylable.prototype._paintStyleContent = function (e, t, i, n, r, o) {
                        if (i && i.length) {
                            for (var a = e.configuration.isOutline(e), s = null, l = [null], h = 0; h < i.length; ++h) {
                                var A = i[h];
                                if (a) this._paintStyleLayer(e, A, false);
                                else {
                                    var c = n ? n[h] : null;
                                    if (c || this._isSeparateStylePaintLayer(e, A)) {
                                        var p = [1];
                                        s ? s.clear() : (s = this._createStyleCanvas(e, t, c ? [0, 0, 0, 0] : null, l, p));
                                        var u = e.pushCanvas(s);
                                        try {
                                            (this._paintStyleLayer(e, A, true),
                                                c
                                                    ? this._paintWithEffects(
                                                          s,
                                                          e.getRootCanvas(),
                                    ...
                                    } else this._paintStyleLayer(e, A, false);
                                }
                            }
                            s && s.finish();
                        }
                    ...
                    (e.Stylable.prototype._getFxCache = function (e, t, i, n) {
                        if (!t.isCacheable(e)) return false;
                            ...
                            if (a && h) {
                                ...
                                if (c !== p) {
                                    if (c > p || e.getWidth() * e.getHeight() > 16777216) {
                                        ...
                                        var d = e.getTransform(false),
                                            g = e.getTransform(true),
                                            f = d.inverted();
                                        ...
                                        return (
                                            x.isEmpty() ||
                                                ...
                                                (e._canvasContext.globalCompositeOperation = "source-over"),
                                ...
                                return !i && (Math.abs(l.getWidth() - e.getWidth()) > 1 || Math.abs(l.getHeight() - e.getHeight()) > 1)
                                    ? (console.log("fx cache: size misfit"), this._resetFxCacheAndState(t, true), false)
                                    : (n ||
                                          (i ? l.setOffset(i.getSide(A.Side.TOP_LEFT)) : l.setOffset(e.getOffset()),
                    ...
                    (e.Stylable.prototype._reinvalidateFxDeps = function (e, t) {
                        for (var i = e.length - 1; i >= 0; i--) {
                            var n = this._getFxIdx(e[i], true);
                            if (n >= 0 && this._fxCache[n]) {
                                var r = e.slice(0, i).concat(t),
                                    o = this._fxCache[n].deps;
                                c.equals(r, o) || this._resetFxCacheAndState(e[i], true);
                            }
                        }
                    }),
                    (e.Stylable.prototype._reinvalidateRemovedFx = function (e) {
                        ...
                        this._fxCache = this._fxCache.filter(function (i) {
                            ...
                            for (var n = i.deps, r = 0; r < n.length; r++) {
                                var o = n[r];
                                if (o === e || !this._fxExists(o)) return (t.destroy([i.bmp]), false);
                            }
                            return true;
                        }, this);
                    }),
                    (e.Stylable.prototype._resetFxCacheAndState = function (t, i) {
                        ...
                        if (e.Stylable._ENABLE_PARTIAL_RESET && t) {
                            ...
                            ((this._fxCache || []).forEach(function (e) {
                                ...
                                (n = true));
                        if (n) {
                            for (var s = this.getParent(); s && !(s instanceof e && s.hasMixin(e.Stylable)); ) s = s.getParent();
                    ...
                    (e.Stylable.prototype._getFxIdx = function (e, t) {
                        ...
                        if (n < 0) return -1;
                        for (var o = this._effects.getFirstChild(), a = 0; null !== o; o = o.getNext(), a++) if (o === e) return n;
                    ...
                    (e.Stylable.prototype._paintWithEffects = function (e, t, i, n, r, l, h, A, c, p) {
                        ...
                        (h || (h = []),
                            ...
                            (e.getWidth() < c.getWidth() - 1 || e.getHeight() < c.getHeight() - 1) && (d = true));
                        var f,
                            m = {};
                        for (
                            r.some(function (e) {
                            ...
                            var y = r[u],
                                _ = y.getEffectType();
                            if (y.isSingleton()) {
                                var v = IsFiniteNonNegativeNumber.getTypeId(y);
                                if (m[v]) continue;
                            }
                            if (((m[v] = true), _ === GStylable.Effect.Type.Filter))
                                (!A || (y instanceof GStylable.Effect && !y.isCacheable(e))
                            ...
                            else if (_ === GStylable.Effect.Type.PreEffect || _ === GStylable.Effect.Type.PostEffect || _ === GStylable.Effect.Type.Multi) {
                                (_ === GStylable.Effect.Type.PostEffect && !g && n > 0 && (i.drawCanvas(e, 0, 0, n), (g = true)), l.clear());
                                var b,
                                    C = e;
                                ...
                                (_ === GStylable.Effect.Type.PostEffect && "string" == typeof b && (w = b),
                    ...
                    (e.Stylable.prototype._createStyleCanvas = function (e, t, i, n, r) {
                        ...
                        if (e.configuration.paintMode === GScenePaintConfiguration.PaintMode.Fast) {
                            var a = new s();
                            if (o > 1) {
                        ...
                        var d = e.canvas.getPaintExtents(t, false, i),
                        ...
                        var b = y.getX() * _,
                            ...
                            E = e.canvas.createCanvas(w, "undefined" != typeof CLIPDIRTY ? CLIPDIRTY : e.configuration.clipDirty, i);
                        return (
                            n &&
                                ((d = e.canvas.getPaintExtents(t, true, i)),
                                (g = e.canvas.getFinalExtents(d)),
                                (m = new h(-g.getX(), -g.getY())),
                                (b = (y = e.canvas.getTranslateCorrection(f, m)).getX() * _),
                                (C = y.getY() * _),
                                (w = t.translated(b, C).expanded(_, _, _, _)),
                                (d = e.canvas.getPaintExtents(w, true, i)),
                                (g = e.canvas.getFinalExtents(d).toRoundedPrecision()),
                                (n[0] = new A(g.getX(), g.getY(), Math.ceil(g.getWidth()), Math.ceil(g.getHeight())))),
                            E
                        );
                    }),
                    ...
                    (e.Stylable.prototype._styleFinishGeometryChange = function (t) {
                        if ((this._notifyChange(e._Change.FinishGeometryUpdate, 1), t)) {
                            if (
                                (t instanceof GStylable.Effect ? this._resetFxCacheAndState(t) : this._resetFxCacheAndState(),
                    ...
                    (e.Stylable.prototype._styleRepaint = function (t) {
                        (t && t instanceof GStylable.Effect ? this._resetFxCacheAndState(t) : this._resetFxCacheAndState(),
                            this._notifyChange(e._Change.InvalidationRequest));
                    }),
                    (e.Stylable.prototype._handleStyleChange = function (e, t) {
                        if (this._workspace) {
                            if (
                                ((e === n._Change.BeforePropertiesChange || e === n._Change.AfterPropertiesChange) &&
                                    ...
                                    switch (e) {
                                        ...
                                        case r._Change.SceneAttached:
                                            (this._scene.link(i, this),
                                                e === n._Change.AfterPropertiesChange && this.assignStyleFrom(i, true));
                                    }
                            }
                            if (e === n._Change.AfterPropertiesChange) {
                                ...
                                if (o >= 0) {
                                    var s = t.values[o],
                                        l = this.$_sbl;
                                    ((o >= 0 && "m" === l) || "!m" === l || "m" === s || "!m" === s) &&
                                        this._requestInvalidationArea(this._getStyleMaskClipArea(s));
                                }
                            }
                            this._workspace &&
                                (e === n._Change.ParentAttached
                                    ? "m" === this.$_sbl && this._requestInvalidationArea(this._getStyleMaskClipArea())
                    ...
                    (e.Stylable.prototype.equalsStyle = function () {
                        return GStylable.prototype.equalsStyle.call(this, this.getReferencedStyle());
                    }),
