module.exports = function (e, t) {
            ...
            ((i.getCurve = function (e) {
                ...
                for (cubicSpline = new n(o, a), i = 0; i <= 256; i++) r[i] = Math.round(cubicSpline.interpolate(i)) || 0;
                return r;
            }),
                (i.getCurves = function (e) {
                    ...
                    for (a in ((o.a = r[0]), (o.r = r[1]), (o.g = r[2]), (o.b = r[3]), o))
                        for (t = o[a].getLowestAbove(0) - 1, n = 0; n <= o[a].length; n++) 0 == o[a][n] && (o[a][n] = t);
                    return o;
                }),
                (i.apply = function (e, t, n, r) {
                    ...
                    if (o) {
                        ...
                        for (s = 0; s < a; s += 4) ((e[s] = o.a[e[s]]), (e[s + 1] = o.a[e[s + 1]]), (e[s + 2] = o.a[e[s + 2]]));
                    }
                }));
            var n = (function () {
                function e(e, t) {
                    ...
                    for (
                        r = [], s = [], i = [], n = [], o = [], h = [], a = 0, g = (l = e.length) - 1;
                        0 <= g ? a < g : a > g;
                        0 <= g ? (a += 1) : (a -= 1)
                    )
                    ...
                    for (a = 0, m = l - 1; 0 <= m ? a < m : a > m; 0 <= m ? (a += 1) : (a -= 1))
                        ((i[a] = s[a] / r[a]),
                            ...
                            (h[a] = 3 / Math.sqrt(o[a])));
                    for (A = [], a = 0, y = l - 1; 0 <= y ? a < y : a > y; 0 <= y ? (a += 1) : (a -= 1)) o[a] > 9 && A.push(a);
                    for (p = 0, d = A.length; p < d; p++) ((s[(a = A[p])] = h[a] * i[a] * r[a]), (s[a + 1] = h[a] * n[a] * r[a]));
                ...
                return (
                    (e.prototype.interpolate = function (e) {
                        ...
                        return (
                            ...
                            (i = -2 * l + 3 * s),
                            (r = l - s),
                            (2 * l - 3 * s + 1) * this.y[o] + n * t * this.m[o] + i * this.y[o + 1] + r * t * this.m[o + 1]
                        );
                    }),
                    e
                );
