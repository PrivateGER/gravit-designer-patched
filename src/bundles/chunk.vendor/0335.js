module.exports = function (module, exports, require) {
            ...
            ((x._SmoothingManager.prototype.start = function (e) {
                    ...
                    if (this._currentPoints.length) {
                        if (this._lastSmoothed) {
                            ...
                            ((this._firstTangent = this._currentPoints[0].subtract(n)),
                                (this._lastTangent = this._currentPoints[this._currentPoints.length - 1].subtract(i)));
                        ...
                        if (
                            (0 !== s && (this._firstTangent = this._firstTangent.scale(1 / Math.sqrt(s))), this._currentPoints.length > 2)
                        ) {
                            for (
                                var l,
                                    h,
                                    ...
                                    p = this._lastSmoothed ? this._lastSmoothed.getNext() : c.getFirstChild();
                                p;

                            )
                                ((l = p.getNext()), c.removeChild(p), (p = l));
                            if (
                                ((a = this._fitter.fitCurve(this._currentPoints, P, this._firstTangent, this._lastTangent)),
                                t && a && a.length)
                            ) {
                                ((h = a[0]),
                                    (A = new f.AnchorPoint()).setProperties(["x", "y"], [h[0].getX(), h[0].getY()]),
                                    c.appendChild(A));
                ...
                (x.prototype._keyDown = function (e) {
                    if ((a.prototype._keyDown.call(this, e), e.key === d.Constant.ESC)) ((this._lastMouseEvent = null), this._escAction());
                    else if (e.key === d.Constant.ENTER) ((this._lastMouseEvent = null), this._enterAction());
                    else if (("string" == typeof e.key || e.key instanceof String) && e.key.match(/^[0-9]$/)) {
                        var t = parseInt(e.key),
                            i = this._newPath || this._createdPath;
                        if (i) {
                            var n = 0;
                            if (((n = 0 === t ? 1 : t / 10), this._transactionStarted)) i.setProperty("_bop", n);
                            else
                                try {
                ...
                (x.prototype._enterAction = function () {
                    this._released &&
                        (this._pathEditor && this._pathEditor instanceof y && this._pathEditor.setActiveExtendingMode(C.ExtendingMode.Off),
                    ...
                    if (e.button === r.BUTTON_LEFT)
                        if (h.modifiers.shiftKey) this._released = false;
                            ...
                            (this._pathEditor && this._pathEditor.blockRemoval(),
                                ...
                                this._startingSelection && (this._startingSelection = this._startingSelection.slice()));
                            ...
                            (this._mouseMove(e),
                                ...
                                this._newPath &&
                                    ...
                                    this._pathEditor.selectOnePoint(this._newPath.getAnchorPoints().getFirstChild()),
                                    this._pathEditor.requestInvalidation(),
                                    this._pathEditor.setActiveExtendingMode(C.ExtendingMode.End)));
                        }
                }),
                    ...
                    ((this._lastMouseEvent = e),
                        this._released
                            ? (this._lastReleasedPos || (this._lastReleasedPos = []),
                              ...
                              this._lastReleasedPos.length > 10 && this._lastReleasedPos.shift(),
                ...
                (x.prototype._mouseDrag = function (e) {
                    if (this._newPath) {
                        ...
                        if (((this._lastMouseEvent = e), h.modifiers.shiftKey))
                            this._newPath.getAnchorPoints().getLastChild().setProperties(["x", "y"], [t.getX(), t.getY()]);
                        ...
                        this._closeIfNeeded(1)
                            ...
                            : this._newPath && this._newPath.hasFlag(n.Flag.Highlighted) && this._newPath.removeFlag(n.Flag.Highlighted);
                    }
                }),
                        ...
                        if (((this._lastMouseEvent = e), !this._released))
                            try {
                                ...
                                if (i.getFirstChild() === i.getLastChild()) {
                                    ...
                                    (r.setProperties(["x", "y"], [i.getFirstChild().$x + 1, i.getFirstChild().$y]), i.appendChild(r));
                                }
                                (this._finalizeDrawing(),
                                    this._newPath.hasFlag(n.Flag.Highlighted) && this._newPath.removeFlag(n.Flag.Highlighted));
                            } finally {
                                this._finishTransaction();
                            }
