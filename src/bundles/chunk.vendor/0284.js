module.exports = function (module, exports, require) {
            ...
            (r.inherit("polygon", l, a),
                ...
                (l.prototype._transformStyledCorners = function (e, t) {
                    ...
                    o.isEqualEps(r, 1) || e.setProperties(["ocr", "icr"], [this.getProperty("ocr") * r, this.getProperty("icr") * r]);
                }),
                ...
                (l.prototype.iterateSegments = function (e, t) {
                    for (
                        var i = this.$oa + o.PI2, r = o.PI2 / this.$pts, a = this.$ia - this.$oa, s = t ? this.$trf : null, l = this.$oa;
                        l < i - 1e-6;
                        l += r
                    ) {
