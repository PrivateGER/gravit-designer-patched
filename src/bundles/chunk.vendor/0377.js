module.exports = function (e, t, i) {
            ...
            ((o.BYTE = function (e) {
                ...
                (o.TAG = function (e) {
                    return (
                        n.argument(4 === e.length, "Tag should be exactly 4 ASCII characters."),
                ...
                (o.REAL = function (e) {
                    ...
                    var l = [30];
                    for (r = 0, o = (a += 1 & a.length ? "f" : "ff").length; r < o; r += 2) l.push(parseInt(a.substr(r, 2), 16));
                    return l;
                }),
                (a.REAL = function (e) {
                ...
                (r.UTF8 = function (e, t, i) {
                    for (var n = [], r = i, o = 0; o < r; o++, t += 1) n[o] = e.getUint8(t);
                    return String.fromCharCode.apply(null, n);
                }),
                (r.UTF16 = function (e, t, i) {
                    for (var n = [], r = i / 2, o = 0; o < r; o++, t += 2) n[o] = e.getUint16(t);
                    return String.fromCharCode.apply(null, n);
                }),
                (o.UTF16 = function (e) {
            ...
            function p(e, t, i) {
                for (var n = 0, r = e.length; t < r && n < 64 && 0 === e[t]; ) (++t, ++n);
            ...
            ((o.MACSTRING = function (e, t) {
                var i = (function (e) {
                    ...
                    if (void 0 !== i) {
                        ...
                        var r = l[e];
                        if (void 0 !== r) {
                            for (var o = {}, a = 0; a < r.length; a++) o[r.charCodeAt(a)] = a + 128;
            ...
            ((o.CHARSTRING = function (e) {
                ...
                (o.TABLE = function (e) {
                    ...
                    for (t = 0; t < r; t += 1) {
                        ...
                        void 0 === A && (A = l.value);
                        var c = h(A);
                        "TABLE" === l.type ? (s.push(i.length), (i = i.concat([0, 0])), a.push(c)) : (i = i.concat(c));
                    }
