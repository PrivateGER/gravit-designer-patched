                            ...
                            for (; m && m.next && (i || void 0 !== m.cx1); ) {
                                if (
                                    ...
                                    if (o) {
                                        if (
                                            ((b = new r.PolyLine()),
                                            w._subdivideBezier(b, m.x, m.y, m.cx1, m.cy1, m.cx2, m.cy2, m.next.x, m.next.y),
                                            (b = b.next))
                                        ) {
                                            for (; b.point; ) (this._pushUnique(_, b.point.getX(), b.point.getY()), (b = b.next));
                                        ...
                                        for (var E = 1; E < d.length; E++)
                                            ((g = d[E]),
                                                (f = d[E - 1]),
                                                (A = h.getCubicCurveAtT(m.x, m.next.x, m.cx1, m.cx2, 0.5 * (g + f))),
                                                (c = h.getCubicCurveAtT(m.y, m.next.y, m.cy1, m.cy2, 0.5 * (g + f))),
                                                this._pushUnique(_, A, c),
                                                (p = h.getCubicCurveAtT(m.x, m.next.x, m.cx1, m.cx2, g)),
                                                (u = h.getCubicCurveAtT(m.y, m.next.y, m.cy1, m.cy2, g)),
                                    ...
                                    if (o) {
                                        if (
                                            ((b = new r.PolyLine()),
                                            w._subdivideBezier(b, m.x, m.y, m.cx1, m.cy1, m.next.x, m.next.y),
                                            (b = b.next))
                                        ) {
                                            for (; b.point; ) (this._pushUnique(_, b.point.getX(), b.point.getY()), (b = b.next));
                                            this._pushUnique(_, m.next.x, m.next.y);
                                        ...
                                        for (E = 1; E < d.length; E++)
                                            ((g = d[E]),
                                                (f = d[E - 1]),
                                                (A = h.getCurveAtT(m.x, m.next.x, m.cx1, 0.5 * (g + f))),
                                                (c = h.getCurveAtT(m.y, m.next.y, m.cy1, 0.5 * (g + f))),
                                                this._pushUnique(_, A, c),
                                ...
                                if (
                                    (m.next ||
                                        ...
                                        (void 0 !== m.cx2
                                            ...
                                            : void 0 !== m.cx1 && (l = new a(m.prev.cx1 - m.x, m.prev.cy1 - m.y))),
                                    v++,
                                    (m = m.next) === e)
                                )
                                    break;
                                ...
                                if (
                                    (_.length > 1
                                        ? (m &&
                                              ...
                                              (void 0 !== m.prev.cx2
                                                  ? (l = new a(m.prev.cx2 - m.x, m.prev.cy2 - m.y))
                                                  : void 0 !== m.prev.cx1 && (l = new a(m.prev.cx1 - m.x, m.prev.cy1 - m.y))),
                                          i || (s && (s = s.scale(1 / Math.sqrt(s.dot(s)))), l && (l = l.scale(1 / Math.sqrt(l.dot(l))))),
                                          (B = this.fitter.fitCurve(_, i ? Math.max(Math.min(v, 666), 200) : v, s, l)))
                                        : (B = []),
                                    this.force || B)
                                ) {
                                    var x = null,
