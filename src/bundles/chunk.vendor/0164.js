            ...
            (IsFiniteNonNegativeNumber.inherit(a, IsFiniteNonNegativeNumber),
                ...
                (a.transformKey = function (e) {
                    return e === a.Constant.META || e === a.Constant.COMMAND
                        ? r.operatingSystem === r.OperatingSystem.OSX_IOS && r.hardware === r.Hardware.Desktop
                            ? a.Constant.COMMAND
                            : a.Constant.CONTROL
                        : e === a.Constant.OPTION
                          ? a.Constant.ALT_LEFT
                ...
                (a.toLocalizedShort = function (e, t) {
                    if (!t && r.operatingSystem === r.OperatingSystem.OSX_IOS && r.hardware === r.Hardware.Desktop) {
                        ...
                        if (e === a.Constant.OPTION || e === a.Constant.ALT_LEFT || e === a.Constant.ALT_RIGHT) return "⌥";
                ...
                (a.shortcutToString = function (e, t = {}) {
                    for (var i = t.isWordMode, n = "", o = 0; o < e.length; ++o)
                        (o > 0 &&
                            (i
                                ? (n += r.operatingSystem === r.OperatingSystem.OSX_IOS ? " " : " + ")
                                : r.operatingSystem !== r.OperatingSystem.OSX_IOS && (n += "+")),
