            ...
            ((o.PIXEL_RATE_STDDEVIATION = 2.3290429691304455),
                ...
                (o.replaceFillAndStroke = function (e, t, i) {
                    if (e.getAttribute) {
                        ...
                        (r &&
                            ((r = (r = r.replace(/fill:[^;]+;/, "fill:" + t + ";")).replace(/stroke:[^;]+;/, "stroke:" + i + ";")),
                ...
                (o.replaceFill = function (e, t) {
                    ...
                    (i && ((i = i.replace(/fill:[^;]+;/, "fill:" + t + ";")), e.setAttribute("style", i)),
                ...
                (o.isElementShape = function (e) {
                    return (
                        e && e.nodeName && ["circle", "ellipse", "line", "mesh", "path", "polygon", "polyline", "rect"].includes(e.nodeName)
                    );
                }),
                (o.getDefaultFillForElement = function (e) {
                    var t = ["altGlyph", "circle", "ellipse", "path", "polygon", "polyline", "rect", "text", "textPath", "tref", "tspan"];
