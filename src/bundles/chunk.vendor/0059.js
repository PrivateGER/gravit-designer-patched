            ...
            ((s.prototype._hitTestSegment = function (e, t, i, n, r, o, s, l, h) {
                ...
                (s.prototype._hitTestCurve2 = function (e, t, i, n, r, o, s, l, h, A, c, p, u) {
                    ...
                    for (var se = 0; se < d - 1; ++se) {
                        ...
                        if (
                            ...
                            if (
                                (ie || ((ie = new Float64Array(5)), a.getCoeffPolyDeriv(K, 5, ie)),
                                ne || ((ne = new Float64Array(4)), a.getCoeffPolyDeriv(ie, 4, ne)),
                                1 == M &&
                                    (null == (U = a.locateByNewton(S, T, G, Q, K, 5, ie, ne, 0.005)) && (U = (S + T) / 2),
                            ...
                            if (M > 1) {
                                ...
                                if (
                                    1 == N &&
                                    (null == (U = a.locateByNewton(S, T, G, Q, K, 5, ie, ne, 0.005, ae, W)) && (U = (S + T) / 2),
                                    (V = a.evalCubic(g, v, C, e, U)),
                                    (O = a.evalCubic(f, b, w, t, U)),
                                    a.ptSqrDist(V, O, h, A) <= c)
                                )
                    ...
                    return 0 == g
                        ...
                        : ((c = this._hitUnderSegment(e, t, i, n, h, A, !0)),
                          (p = s(h, A)) < 0
                              ...
                              : 0 == p
                                ? g + c
                                : ((u = -l(r, o)), ((d = -l(h, A)) > 0 && u < 0) || (d < 0 && u > 0) ? g + g + c : c));
                }),
                    ...
                    for (var M = 0; M < Q - 1; ++M) {
                        function N(e, t) {
                            var i = x[0] - 3 * x[1] + 3 * x[2] - x[3],
                                ...
                                w = 3 * y - c * (4 * u + 9 * p);
                            return (
                                (m * a * e - 3 * (i * m) * t + 3 * (u * m - 3 * a * (2 * c * l + A * s) + 9 * c * (s * s))) * (e * e) +
                                (3 * (f * a) * e - f * i * t + 3 * (u * f - 3 * (2 * c * r + A * n) * i + 9 * c * (n * n))) * (t * t) +
                                3 *
                                    ((_ * a +
                                        6 * C * s +
                                        3 * w * l +
                                        9 * b * h -
                                        ((2 * u + 3 * p) * i * a + 9 * (2 * c * n * s + n * r * m - f * s * l)) * t) *
                                        e -
                                        (_ * i + 6 * C * n + 3 * w * r + 9 * b * o) * t) +
                                (u * (_ - 9 * (A * d + 2 * c * g)) + 27 * (v * d + y * g) - 81 * (c * p) * g)
                            );
                        }
                        ...
                        function U(e, t) {
                            ...
                            for (n = 0; n < 4; ++n) {
                                if (((r = 3 == n ? 0 : n + 1), (i = a.segmentSide(x[n], P[n], x[r], P[r], e, t)), 3 == n && 0 == i))
                                    return 0;
                                if (i * a.segmentSide(x[n], P[n], x[r], P[r], o, s) < 0) return -1;
                            }
                            return 1;
                        }
                        ((S = 0 == M ? G[M] : T),
                            (T = G[M + 1]),
                            0 == S && 1 == T
                                ? ((x[0] = e), (x[1] = r), (x[2] = s), (x[3] = i), (P[0] = t), (P[1] = o), (P[2] = l), (P[3] = n))
                                : (a.getCtrlPts(e, i, r, s, S, T, x), a.getCtrlPts(t, n, o, l, S, T, P)),
                            a.isEqualEps(x[0], x[1]) && a.isEqualEps(P[0], P[1])
                                ? (I += this._evalConicReg(x[0], P[0], x[3], P[3], x[2], P[2], U, N, h, A))
                                : (I += this._evalConicReg(x[0], P[0], x[3], P[3], x[1], P[1], U, N, h, A)));
                    }
                    return I;
                }),
                        ...
                        for (; i.readVertex(_); )
                            switch (_.command) {
                                case r.Command.Move:
                                    ...
                                    break;
                                case r.Command.Line:
                                    if ((++m, (y = this._hitTestSegment(h, A, _.x, _.y, e, t, v, m, s)))) return y;
                                    (o && (b += this._hitUnderSegment(h + C, A, _.x + C, _.y, e + C, t)), (h = _.x), (A = _.y));
                                    break;
                                case r.Command.Curve:
                                    if ((++m, (c = _.x), (p = _.y), i.readVertex(_))) {
                                        if ((y = this._hitTestCurve(h, A, c, p, _.x, _.y, e, t, v, m, s))) return y;
                                ...
                                case r.Command.Curve2:
                                    if ((++m, (c = _.x), (p = _.y), i.readVertex(_) && ((u = _.x), (d = _.y), i.readVertex(_)))) {
                                        if ((y = this._hitTestCurve2(h, A, c, p, u, d, _.x, _.y, e, t, v, m, s))) return y;
                                        (o && (b += this._hitUnderCurve2(h + C, A, c + C, p, u + C, d, _.x + C, _.y, e + C, t)),
                                            (h = c),
                                            (A = p));
                                    }
                                    break;
                                case r.Command.Close:
                                    if (g != h || f != A) {
                                        if ((++m, (y = this._hitTestSegment(h, A, g, f, e, t, v, m, s)))) return y;
                        ...
                        function A(e, t, i, n, r, o) {
                            ...
                            (h(i, n),
                                0 != (l = i - 2 * r + e) &&
                                    (s = (e - r) / l) > 0 &&
                                    s < 1 &&
                                    h((e * i - r * r) / (i - 2 * r + e), (A = a.getCurveAtT(t, n, o, s))),
                                0 != (l = n - 2 * o + t) &&
                                    (s = (t - o) / l) > 0 &&
                                    s < 1 &&
                                    ((A = (t * n - o * o) / (n - 2 * o + t)), h(a.getCurveAtT(e, i, r, s), A)));
                        }
                        ...
                        function c(e, t, i, n, r, o, s, l) {
                            ...
                            function f(e, t, i) {
                                ...
                                0 == e
                                    ...
                                    : 0 == (n = t * t - 4 * e * i)
                                      ? g(-t / (2 * e))
                                      : n > 0 && ((r = Math.sqrt(n)), g((-t + r) / (2 * e)), g((-t - r) / (2 * e)));
                            }
                        ...
                        for (var p, u, d, g, f, m, y = new r(); e.readVertex(y); )
                            switch (y.command) {
                                ...
                                case r.Command.Curve:
                                    ((d = y.x),
                                        (g = y.y),
                                        e.readVertex(y) && (t ? A(p, u, d, g, y.x, y.y) : (h(d, g), h(y.x, y.y)), (p = d), (u = g)));
                                    break;
                                case r.Command.Curve2:
                                    ((d = y.x),
                                        (g = y.y),
                                        e.readVertex(y) &&
                                            ...
                                            (m = y.y),
                                            e.readVertex(y) &&
                                                (t ? c(p, u, d, g, f, m, y.x, y.y) : (h(d, g), h(f, m), h(y.x, y.y)), (p = d), (u = g))));
                                    break;
                                case r.Command.Close:
                                    break;
                                default:
                        ...
                        switch (c.command) {
                            ...
                            case r.Command.Curve:
                                ((o = c.x),
                                    (s = c.y),
                                    e.readVertex(c) &&
                                        ((p += a.getArcLengthQuadratic(new n(t, i), new n(o, s), new n(c.x, c.y))), (t = o), (i = s)));
                                break;
                            case r.Command.Curve2:
                                ((o = c.x),
                                    (s = c.y),
                                    e.readVertex(c) &&
                                        ...
                                        c.y,
                                        e.readVertex(c) &&
                                            ((p += a.getArcLengthCubic(new n(t, i), new n(o, s), new n(l, cx2), new n(c.x, c.y))),
                                            (t = o),
                                            (i = s))));
                                break;
                            case r.Command.Close:
                        ...
                        for (var o, s, l, h, A, c, p = new r(), u = 0, d = null, g = null; e.readVertex(p); ) {
                            ...
                            switch (p.command) {
                                case r.Command.Move:
                                    ...
                                    break;
                                case r.Command.Line:
                                    if (++u === t || f) return new n((p.x - o) * i + o, (p.y - s) * i + s);
                                    ((o = p.x), (s = p.y));
                                    break;
                                case r.Command.Curve:
                                    if ((++u, (l = p.x), (h = p.y), e.readVertex(p))) {
                                        f = !e.hasVertexForRead();
                                        if (u === t || f) return new n(a.getCurveAtT(o, l, p.x, i), a.getCurveAtT(s, h, p.y, i));
                                        ((o = l), (s = h));
                                    }
                                    break;
                                case r.Command.Curve2:
                                    ...
                                    break;
                                case r.Command.Close:
                                    if (++u === t || f) return new n((d - o) * i + o, (g - s) * i + s);
                                    ((d = o), (g = s));
                                    break;
                                default:
                    ...
                    function s(e, t) {
                        (4 === e.length &&
                            ...
                            (a.isEqualEps(e[2], e[1], r) && a.isEqualEps(t[2], t[1], r))
                                ...
                                : a.isEqualEps(e[2], e[3], r) && a.isEqualEps(t[2], t[3], r) && (e.splice(2), t.splice(2))),
                            3 === e.length &&
                                ((a.isEqualEps(e[0], e[1], r) && a.isEqualEps(t[0], t[1], r)) ||
                                    (a.isEqualEps(e[2], e[1], r) && a.isEqualEps(t[2], t[1], r))) &&
                                (e.splice(1), t.splice(1)));
                ...
                (s.prototype._collinearBezier = function (e, t, i, n, r) {
                    ...
                    if (4 === i.length) {
                        ...
                        if (4 === e.length) {
                            if (
                                this._hitTestCurve2(e[0], t[0], e[3], t[3], e[1], t[1], e[2], t[2], s, l, o, 0, {}) &&
                                this._hitTestCurve2(e[0], t[0], e[3], t[3], e[1], t[1], e[2], t[2], h, A, o, 0, {}) &&
                            ...
                            this._hitTestCurve(e[0], t[0], e[2], t[2], e[1], t[1], h, A, o, 0, {}) &&
