            ...
            (IsFiniteNonNegativeNumber.inherit(b, r),
                ...
                (b.prototype.getGeometryBBox = function (e) {
                    return e || this.isVisible()
                        ? e
                            ...
                            : (null == this._geometryBBox && (this._geometryBBox = this._calculateGeometryBBox()), this._geometryBBox)
                        : null;
                }),
                (b.prototype.getPreTransformRect = function (e) {
                    return this.isVisible()
                        ? ((null != this._preTransformRect && _.equals(e, this._preTransformRectTrf)) ||
                              ((this._preTransformRect = this._calculatePreTransformRect(e)), (this._preTransformRectTrf = e)),
                ...
                (b.prototype.getPaintBBox = function (e, t, i) {
                    return i || this.isVisible()
                        ? i
                            ...
                            : (null == this._paintBBox && (this._paintBBox = this._calculatePaintBBox(t)), this._paintBBox)
                        : null;
                }),
                    ...
                    if (this.hasMixin(n.Container)) {
                        for (var r = null, o = this.getFirstChild(); null != o; o = o.getNext())
                            if (o instanceof b) {
                                ...
                                (s && (a = (a && a.united(s)) || s),
                                    a && (a.getHeight() > 0 || a.getWidth() > 0) && (r = r ? r.united(a) : a));
                            }
                ...
                (b.prototype.getChildrenPaintBBox = function (e, t, i) {
                    return i
                        ...
                        : (null == this._childrenPaintBBox && (this._childrenPaintBBox = this._calculateChildrenPaintBBox(e, t, i)),
                ...
                (b.prototype.hitTest = function (e, t, i, r, o, a, s, l, h, A) {
                    ...
                    if ((t && (c = t.mapRect(c)), !c.expanded(a, a, a, a).containsPoint(e))) return null;
                    var u = null;
                    if (0 !== o && this.hasMixin(n.Container))
                        if (this.hasMixin(b.Accelerated)) {
                            var g = t ? t.inverted().mapPoint(e) : e,
                                ...
                                m = this.retrieveChildrenInPaintBBox(f, v.RETRIEVE_MODE_INTERSECT);
                            if (m) {
                                m.sort(function (e, t) {
                ...
                (b.prototype.toBitmap = function (e, t, i, n, r, o, a, l, d) {
                    ...
                    var f = 1,
                        ...
                        v = 0;
                    if (
                        (e && ("number" == typeof e ? (f = e) : e instanceof h && (f = e.toPoint() / g.getWidth())),
                        t && ("number" == typeof t ? (m = t) : t instanceof h && (m = t.toPoint() / g.getHeight())),
                        o)
                    ) {
                        var b = o / h.DPI;
                        ((f *= b), (m *= b));
                ...
                (b.prototype._paint = function (e, t) {
                    this.hasMixin(b.Stylable)
                        ? this._paintStyle(e, this.getPaintBBox(null, t, e.isIncludingInvisible()))
                        : this._paintChildren(e, t);
                }),
                (b.prototype._preparePaint = function (e, t) {
                    return (
                        this.hasMixin(b.Stylable) && e.getRootCanvas().setMasked("m" === this.$_sbl || "!m" === this.$_sbl),
                        !this.hasFlag(b.Flag.NoPaint) && !!(this.isPaintable(e, t) || (e && e.isIncludingInvisible()))
                    );
                }),
                (b.prototype._finishPaint = function (e) {}),
                (b.prototype._paintChildren = function (e, t) {
                    if (this.hasMixin(n.Container))
                        for (var i = this.getFirstChild(); null != i; i = i.getNext()) i instanceof b && i.paint(e);
                }),
                    ...
                    if (e && e.invertible())
                        if (this.hasMixin(m)) {
                            ...
                            (t = this.getGeometryBBox())
                                ? ((n = e.inverted().mapQuadrilateral(t)), (t = d.fromPoints.apply(null, n)))
                                : (t = null);
                        }
                ...
                (b.prototype._handleChange = function (e, t) {
                    if (e == b._Change.InvalidationRequest) this.isPaintable() && this._requestInvalidation();
                        ...
                        (this._canEventBeSent(b.GeometryChangeEvent) &&
                            this._sendEvent(new b.GeometryChangeEvent(this, b.GeometryChangeEvent.Type.Before)),
                        ...
                        var s = (this.isPaintable() && this.isVisible() && this.getPaintBBox()) || null,
                            l = this.getGeometryBBox(),
                            h = !d.equals(this._savedPaintBBox, s);
                        (this.getParent() &&
                            (0 === i
                                ? this.getParent()._notifyChange(b._Change.ChildGeometryUpdate, [this, h, a])
                                : h && 1 === i && this.getParent()._notifyChange(b._Change.ChildVisualUpdate, [this])),
                            this._canEventBeSent(b.GeometryChangeEvent) &&
                                this._sendEvent(new b.GeometryChangeEvent(this, b.GeometryChangeEvent.Type.After)),
                            this.isPaintable() && !o && (h && this._invalidateOldPaintBBox(), this._requestInvalidation()),
                            !this._savedGeometryBBox ||
                                !l ||
                                this.isRestoring() ||
                                this.isRecordedTransaction() ||
                                d.equals(this._savedGeometryBBox, l) ||
                                (y.isEqualEps(this._savedGeometryBBox.getWidth(), l.getWidth(), 1e-10) &&
                                    y.isEqualEps(this._savedGeometryBBox.getHeight(), l.getHeight(), 1e-10)) ||
                                this._notifyChange(b._Change.GeometrySizeChanged, [this, this._savedGeometryBBox]),
                        ...
                        if (
                            ...
                            this.hasMixin(b.Stylable) && (this._resetFxCacheAndState(), this._effects))
                        )
                        ...
                        (this._canEventBeSent(b.GeometryChangeEvent) &&
                            this._sendEvent(new b.GeometryChangeEvent(this, b.GeometryChangeEvent.Type.Child)),
                        ...
                        t instanceof b &&
                            (this._notifyChange(b._Change.ChildGeometryUpdate, [t, 1]), t._handleChange(b._Change.InvalidationRequest));
                    else if (e == n._Change.BeforeChildRemove) t instanceof b && this._requestInvalidateNode(t);
                    else if (e == n._Change.AfterChildRemove) t instanceof b && this._notifyChange(b._Change.ChildGeometryUpdate, [t, 1]);
                    ...
                    (this.hasMixin(b.Layout) && this._handleLayoutChange(e, t),
                        ...
                        this.hasMixin(b.Accelerated) && this._handleChildrenStructureChange(e, t),
                                        ...
                                        if (o && a && o !== a) {
                                            if (o[0] !== a[0] || o[1] !== a[1] || o[2] !== a[2] || o[3] !== a[3])
                                                ...
                                                var s = this._paintBBox,
                                                    l = this.getParent();
                                                if ("Compound Shape" === n.getName(l)) this._resetFxCacheAndState();
                                                else if (
                                                    l instanceof b &&
                                                    l.isPaintable() &&
