module.exports = function (e, t, i) {
            ...
            (r.inherit("Compound Shape", g, o),
                ...
                (g.prototype._prepareVertices = function () {
                    ...
                    if (!e) return new A();
                    for (
                        var t = this.$trf && !this.$trf.isIdentity() && this.$trf.invertible() ? this.$trf.inverted() : null,
                            i = [new l(e, t)],
                            r = [],
                            o = new Date().getTime(),
                            a = e;
                ...
                (g.prototype._handleChange = function (e, t) {
                    if ((this._handleVisualChangeForProperties(e, t, g.VisualProperties), e == r._Change.BeforePropertiesChange))
                        ...
                        if (
                            (t.properties.indexOf("vis") >= 0 && this._beginBlockChanges([p._Change.ChildGeometryUpdate]),
                            t.properties.indexOf("trf") >= 0 && this._vertexSource)
                        ) {
                            var i = this.$trf;
                            this._vertexSource instanceof l
                                ? this._vertexSource.setTransform(i)
                                : this._vertexSource && (this._vertexSource = new l(this._vertexSource, i));
                        }
                    } else
                ...
                (g.prototype._styleFinishGeometryChange = function (e) {
                    ...
                    if (t) {
                        ...
                        try {
                            ...
                            for (var A = o.getChildByIndex(s); null !== A; A = o.getNext()) o.removeChild(A);
                        } finally {
                            o._endBlockChanges([
                                r._Change.BeforeChildRemove,
                                r._Change.AfterChildRemove,
                ...
                (g.prototype._stylePropertiesUpdated = function (e, t) {
                    if (this._mainShape()) {
                        ...
                        if (n.length) {
                            this._beginBlockChanges([r._Change.BeforePropertiesChange, r._Change.AfterPropertiesChange]);
                            for (var l = this.getFirstChild(); null !== l; l = l.getNext()) l.setProperties(n, o);
                            this._endBlockChanges([r._Change.BeforePropertiesChange, r._Change.AfterPropertiesChange]);
                        }
                    }
                }),
                (g.prototype._mergeBoxes = function () {
                    ...
                    e =
                        this._mainShape() instanceof g
                            ...
                            : this._mainShape().getGeometryBBox() || this._mainShape()._calculateGeometryBBox();
                    for (var t = null, i = this.getFirstChild().getNext(); null !== i; i = i.getNext()) {
                        i.$bool === n.AND &&
                            (r = i instanceof g ? i._mergeBoxes() : i.getGeometryBBox() || i._calculateGeometryBBox()) &&
                            (t ? (t = t.united(e.intersected(r))) : e && (t = e.intersected(r)));
                    }
