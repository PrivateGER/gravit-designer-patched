            ...
            i.apply = function (e, t, i, a) {
                ...
                if (!(isNaN(s) || s < 1 || s > 254)) {
                    var l,
                        ...
                        M = new o(),
                        N = M;
                    for (A = 1; A < R; A++) if (((N = N.next = new o()), A == G)) var U = N;
                    N.next = M;
                    var V = null,
                        O = null;
                    d = u = 0;
                    var L = n[s],
                        Y = r[s],
                        X = e.length;
                    for (A = 0; A < X; A += 4) (I = e[A + 3]) > 0 && ((I /= 255), (e[A] *= I), (e[A + 1] *= I), (e[A + 2] *= I));
                    for (h = 0; h < i; h++) {
                        for (
                            w = E = B = x = g = f = m = y = 0,
                                _ = G * (P = e[u]),
                    ...
                    for (A = 0; A < X; A += 4) (I = e[A + 3]) > 0 && ((I = 255 / I), (e[A] *= I), (e[A + 1] *= I), (e[A + 2] *= I));
                }
            };
            var n = [
                ...
                r = [
                    ...
                    23, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24, 24,
