            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(g, o, [o.LabelHolder]),
                ...
                (g.prototype.movePart = function (e, t, i, n, r, a, s, l) {
                    ...
                    if (e === o.LabelHolder.LABEL_PART_ID && l) {
                        ...
                        p = this._collisionlessTransform
                            ? this.getElement().doCollisionlessTransform(new h(1, 0, 0, 1, u.getX() - g.getX(), u.getY() - g.getY()))
                ...
                (g.prototype.getCustomBBox = function (e, t) {
                    ...
                    if (this.getElement().getScene() && this.getElement().getScene().isFixedSized())
                        ...
                        } else this.getElement().getScene().isFixedSized() && (i = this._getLabelBBox(e));
                    return i;
                }),
                ...
                (g.prototype._applyPartMove = function (e, t, i, n) {
                    ...
                    if (e === o.LabelHolder.LABEL_PART_ID) {
                        var A,
                            p = s.getEditor(a),
                            u = this._transform.mapRect(this.getElement().getGeometryBBox()).getSide(l.Side.CENTER),
                            d = null,
                            f = Number.MAX_VALUE;
                        if (
                            (g.SWITCH_ORDER &&
                                a.iteratePages(
                                    function (e) {
                                        A || (A = e);
                                        var t = e.getGeometryBBox().getSide(l.Side.CENTER).subtract(u),
                                            i = t.dot(t);
                                        (i < f && ((f = i), (d = e)), e);
                                    }.bind(this)
                                ),
                            ...
                            (this.getElement().setProperty("off", v.translated(_.getX(), _.getY())),
                        ...
                        var b = this.getElement().getGeometryBBox(),
                            ...
                            x = C.getY() - b.getY(),
                            P =
                                ((v = (this.getElement().getProperty("off") || new h()).translated(B, x)),
                                this.getElement().getProperty("w")),
                            S = this.getElement().getProperty("h");
                        w * E != 0 && this.getElement().setProperties(["w", "h", "off"], [P * w, S * E, v]);
                    }
                    o.prototype._applyPartMove.call(this, e, t, i, n);
                }),
                (g.prototype.edTransform = function (e, t, i, n) {
                    ((this._collisionlessTransform || n.doCollisionlessTransform) && (e = this.getElement().doCollisionlessTransform(e)),
                ...
                (g.prototype.paint = function (e, t) {
                    if (!t.configuration.multiPageView) {
                        ...
                        if (i.getActivePage() && i.getActivePage() !== this.getElement()) return;
                    }
