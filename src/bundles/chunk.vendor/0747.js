            ...
            (r.inherit(m, p),
                ...
                (m.prototype.movePart = function (e, t, i, n, r, o, a) {
                    ...
                    if (e === m.INSIDE_PART_ID || e === m.OUTSIDE_PART_ID) {
                        ...
                        (this._elementPreview.setProperties(["oa", "or", "ia", "ir"], [w, E, b, C]), this.requestInvalidation());
                    }
                    return s;
                }),
                (m.prototype._applyPartMove = function (e, t, i, n) {
                    if (e === m.INSIDE_PART_ID || e === m.OUTSIDE_PART_ID) {
                        var r = this._elementPreview.getProperties(["oa", "or", "ia", "ir"]);
                        (this.resetPartMove(e, t), this._element.setProperties(["oa", "or", "ia", "ir"], r));
                    }
                        ...
                        this.getPaintElement().iterateSegments(
                            function (i, n, r) {
                                var o = n ? m.INSIDE_PART_ID : m.OUTSIDE_PART_ID,
                                    ...
                                    s = this._partSelection && this._partSelection.indexOf(o) >= 0;
                                a.inverted && (s = !s);
