module.exports = function (e, t, i) {
            ...
            ((r.prototype._yStrips = null),
                    ...
                    if (this._yStrips.length) {
                        ...
                        if (o.idx !== this._yStrips.length) {
                            ...
                            if (
                                ...
                                ((this._yStrips[p][0] = r),
                                    void 0 !== l && (this._yStrips[p][1] = Math.max(l, this._yStrips[p][1])),
                                    (A[0] = Math.max(u, n)),
                                    (A[1] = r),
                            ...
                            if (c !== p || !o.outside || !h.outside) {
                                ...
                                for (var d = c; d <= p; d++) {
                                    var g = this._intervals[d],
                                        ...
                                        v = void 0,
                                        b = void 0;
                                    (f.outside ? (_ = f.idx) : ((b = g[f.idx][1]), (g[f.idx][1] = t), (_ = f.idx + 1)),
                                        m.outside || (void 0 !== b && f.idx == m.idx ? (y = [i, b]) : (g[m.idx][0] = i)),
                                        (v = m.idx),
                ...
                (r.prototype.merge = function (e, t) {
                    ...
                    if (h.idx === this._yStrips.length) return (this._yStrips.push([s, l]), void this._intervals.push([[o, a]]));
                    var A,
                    ...
                    if (
                        ...
                        ((this._yStrips[d][0] = l),
                            void 0 !== A && (this._yStrips[d][1] = Math.max(A, this._yStrips[d][1])),
                            (p[0] = Math.max(g, s)),
                            (p[1] = l),
                            this._yStrips.splice(d, 0, p),
