                ...
                (m.prototype._merge = function (e, t) {
                    ...
                    if (
                        ...
                        var u = r[r.length - 1],
                            d = u.getParent(),
                            g = u.getNext();
                        if (p) for (; d instanceof c; ) ((g = d.getNext()), (d = d.getParent()));
                        else for (; d instanceof c || d instanceof o; ) ((g = d.getNext()), (d = d.getParent()));
                        d && d.insertChild(n, g);
                        try {
                            ...
                            ((i = null),
                                ...
                                (r = y.concat(_)).forEach(function (t) {
                                    var r,
                                        s = t.getParent();
                                    for (
                                        (s && i && s === i) || (s instanceof o && e === a.OR) || t.setProperty("bool", e),
                                            s && s.removeChild(t);
