module.exports = function (module, exports, require) {
            ...
            ((u = true),
                    ...
                    if (!(o = r ? this._fxaaUnpremultiplied : this._fxaaPremultiplied))
                        try {
                            o = new c(
                                this.glEffect,
                                c._fxaaVertexSource,
                                r ? c._fxaaFragmentSourceUnpremultiplied : c._fxaaFragmentSourcePremultiplied
                            );
                        } catch (e) {
                            r ? (this._fxaaUnpremultiplied = {}) : (this._fxaaPremultiplied = {});
                        }
                    o instanceof c &&
                        (r ? (this._fxaaUnpremultiplied = o) : (this._fxaaPremultiplied = o),
                        o.simpleShader.call(
                            o,
                            {
                ...
                (c._fxaaFragmentSourceUnpremultiplied = c._fxaaFragmentSourceBase + "}"),
            ...
            ((c.warpShader = function (e, t) {
                ...
                (c.compileSource = function (e, t, i) {
                    ...
                    var a,
                        ...
                        l = c._getShaderCache(),
                        h = l[s];
                    if (h) for (var A = 0; A < h.length; A++) if ((a = h[A]).src == t) return a.program;
                ...
                (c.prototype.destroy = function () {
                    (this._fxaaUnpremultiplied && this._fxaaUnpremultiplied instanceof c && this._fxaaUnpremultiplied.destroy(),
                        this._fxaaPremultiplied && this._fxaaPremultiplied instanceof c && this._fxaaPremultiplied.destroy());
                }),
                ...
                (c.prototype.drawRect = function (e, t, i, n, r) {
                    ...
                    a &&
                        ...
                        a.bufferData(a.ARRAY_BUFFER, new Float32Array([e, t, e, n, i, t, i, n]), a.STATIC_DRAW),
                ...
                (c._renderTile = function (e, t, i, n, r, a, l, h) {
                    ...
                    (A.clearColor(0, 0, 0, 0),
                        ...
                        d
                            ? ((A.canvas.width = s.nextPowerOf2(y)), (A.canvas.height = s.nextPowerOf2(_)))
                            : u
                              ? (A.canvas.width !== Math.ceil(y) && (A.canvas.width = Math.ceil(y)),
                                A.canvas.height !== Math.ceil(_) && (A.canvas.height = Math.ceil(_)))
                              : (A.canvas.width < s.nextPowerOf2(y) && (A.canvas.width = s.nextPowerOf2(y)),
                                A.canvas.height < s.nextPowerOf2(_) && (A.canvas.height = s.nextPowerOf2(_))));
                    var C = r.getWidth(),
                        w = r.getHeight(),
                        E = h.shader,
                        B = h.properties,
            ...
            ((c.shouldEnableTiles = function (e, t) {
                ...
                (c.apply = function (e, t, i, n, s, l, A) {
                    ...
                    if (e instanceof r) {
                        ...
                        ((s = new a(Math.floor(s.getX()), Math.floor(s.getY()), s.getWidth(), s.getHeight())),
                            (b = new a(Math.floor(b.getX()), Math.floor(b.getY()), b.getWidth(), b.getHeight())));
                        ...
                        if (C) {
                            ...
                            for (var R = [], D = []; F < P; ) {
                                for (
                                    T = E - w[1] - w[3], F + E >= P ? (T = P - F) : 0 === F && (T += w[1]), T < 1 && (T = 1), I = 0;
                                    I < x;

                                ) {
                                    ((S = E - w[0] - w[2]), I + E >= x ? (S = x - I) : 0 === I && (S += w[0]), S < 1 && (S = 1));
                                    var k = new a(I, F, E, E),
                                        G = new a(0 === I ? 0 : I + w[0], 0 === F ? 0 : F + w[1], S, T);
                            ...
                            ? h.map(function (e) {
                                  ...
                                  return (
                                      ((r = s
                                          ...
                                          : e.scaled(o.getWidth() / i.getWidth(), o.getHeight() / i.getHeight())).getX() < 0 ||
                                          r.getY() < 0) &&
                                          (r = new a(
                                              Math.max(0, r.getX()),
                                              Math.max(0, r.getY()),
