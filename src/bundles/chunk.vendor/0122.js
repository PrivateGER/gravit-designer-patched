module.exports = function (module, exports, require) {
            ...
            (o.inheritAndMix("group", f, n, [o.Container, a.Transform, a.Layout, a.Stylable, a.Accelerated]),
                ...
                (f.prototype._calculatePaintBBox = function (e, t) {
                    var i;
                    return (
                        (i = this.getProperty("frm") ? this.getGeometryBBox(t) : n.prototype._calculatePaintBBox.call(this, e, t)),
                            ...
                            try {
                                (this._paintChildren(e),
                                    void 0 !== e.canvas.putVertices(a) &&
                                        e.canvas.fillVertices(d.BLACK, 1, u.CompositeOperator.DestinationIn),
                    ...
                    if (
                        (e == a._Change.ChildGeometryUpdate
                            ...
                            : e === o._Change.Store
                              ...
                              : e === o._Change.Restore &&
                                this.restoreProperties(t.blob, f.GeometryProperties, function (e, t) {
                ...
                (f.prototype.setFrame = function (e) {
                    var t = this.getAngle(),
                        i = null;
                    if ((null === t || A.isEqualEps(t, 0, 1e-4) || (i = new l().rotated(-t)), e && !this.getProperty("frm"))) {
                        var n = i ? this.getPreTransformRect(i) : this.getGeometryBBox();
                        if (n) {
                            this.setProperties(["frm", "trf"], [n, i]);
                            for (var r = this.getFirstChild(); null != r; r = r.getNext())
                                r.hasMixin(a.Anchor) &&
                                    (r.getProperty("hacr") || r.setProperty("hacr", r.oldHacr ? r.oldHacr : a.Anchor.AnchorType.Start),
                                    r.getProperty("vacr") || r.setProperty("vacr", r.oldVacr ? r.oldVacr : a.Anchor.AnchorType.Start));
                        }
