module.exports = function (e, t, i) {
            ...
            (i(507),
                    ...
                    if (this.$_links && this.$__ids) {
                        var e = {},
                            t = function (i) {
                                if (i.hasMixin(r.Reference) && i.getOldReferenceId() && this.$_links.hasOwnProperty(i.getOldReferenceId()))
                                    ((this.$_links[i._referenceId] = this.$_links[i.getOldReferenceId()]),
                                    ...
                                    (this.acceptChildren(
                                        function (t) {
                                            if (
                                                ...
                                                i.$rtxt.indexOf(t.getOldReferenceId() || t._referenceId) >= 0
                                            ) {
                                                var o = this.$_links[t._referenceId];
                                                if (
                                                    ((this.$_links[t._referenceId] = (o || []).concat([i.getSceneId()])),
                        ...
                        this.$_links)) {
                            ...
                            if (h) {
                                    ...
                                    if (A instanceof v) {
                                        ...
                                        for (var c = 0; c < a.length; c++) {
                                            (_ = a[c]) instanceof u &&
                                                _.hasProperty("sref") &&
                                                _.getProperty("sref") &&
                                                (A.getOldReferenceId() === _.getProperty("sref") && (_.$sref = A.getReferenceId()),
                                ...
                                } else (console.warn("Invalid reference id."), delete this.$_links[s]);
                            }
                        }
                    ...
                    if (!this._isRestoring && !this.$rb) {
                        ...
                        if ((this._refreshLinks(), this.isLinked(t, e)))
                            ...
                            (this._linksLookup || (this._linksLookup = {}),
                                n.hasOwnProperty(i) || ((n[i] = []), (this._linksLookup[i] = [])),
                                n[i].push(t.getSceneId()),
                                this.setProperty("_links", n),
                                t instanceof g && (t._invalidatePaintBoxForChildUpdate(), this._invalidateArea(null, t)));
                        }
                    }
                }),
                    ...
                    if (this._linksAreSane) {
                        if (this._linksLookup)
                            if ("string" == typeof e)
                                ...
                                for (var i in this._linksLookup) this._linkLookupHasSceneNode(i, e) && t(this._workspace.getReference(i));
                    } else
                ...
                (Q.prototype.refCount = function (e) {
                    var t = 0;
                    if (!this._linksAreSane) return -1;
                    if ("string" == typeof e) for (var i in this.$_links) this.$_links[i].indexOf(e) >= 0 && t++;
                    else if (e && this._linksLookup) for (var i in this.$_links) this._linkLookupHasSceneNode(i, e) >= 0 && t++;
                    return t;
                }),
                ...
                (Q.prototype.updateActivePageForElem = function (e) {
                    ...
                    } else e instanceof g && (e.hasFlag(r.Flag.Active) || e.hasFlag(r.Flag.Selected) || this.setActivePage(e));
                }),
                ...
                (Q.prototype.updateActiveLayerForElem = function (e) {
                    ...
                    for (var i = this.getFirstChild(); null !== i; i = i.getNext()) i instanceof g && i !== t && i.setActiveLayer(null);
                }),
                            ...
                            ((node = A[c]),
                                node instanceof g &&
                                    ...
                                    e.dirtyMatcher &&
                                        ...
                                        s ? e.dirtyMatcher.transform(l.preMultiplied(s.inverted())) : e.dirtyMatcher.transform(l),
                                        (s = l)),
                                    node.paint(e)));
                ...
                (Q.prototype.hitTest = function (e, t, i, n, r, o, a, s, l, h, A, c) {
                    ...
                    if (!A && p)
                        return c
                            ? u.prototype.hitTest.call(p.getAnnotations(), e, t, i, n, r, o, a, s, l, h)
                            : u.prototype.hitTest.call(p, e, t, i, n, r, o, a, s, l, h);
                    var d = this.getPaintBBox(A);
                    if (!d || d.isEmpty()) return null;
                    if ((t && (d = t.mapRect(d)), B.pagesCanOverlap && !d.expanded(o, o, o, o).containsPoint(e))) return null;
                    ...
                    if ((0 == v.length && (v = null), v)) {
                        for (var C = 0; C < v.length; C++) {
                            var w,
                                ...
                                P = null;
                            if (
                                ((P = t ? t.preMultiplied(new y(1, 0, 0, 1, x.getX(), x.getY())) : new y(1, 0, 0, 1, x.getX(), x.getY())),
                                c)
                            )
                ...
                (Q.prototype.getCollisions = function (e, t, i, n, r, o, a) {
                    var s = this.getActivePage(),
                        l = [];
                    if (a) return [];
                    if (!o && s) return u.prototype.getCollisions.call(this.getActivePage(), e, t, i, n, r);
                    if (o) {
                ...
                (Q.prototype.insertChild = function (e, t) {
                    return e instanceof a
                        ? (this._isRestoring &&
                              (this._styles && this._styles.getParent() === this && (this.removeChild(this._styles), (this._styles = e)),
                              e.repairSdf()),
                        ...
                        : e instanceof x
                          ...
                          : e instanceof g
                            ? (r.Container.prototype.insertChild.call(this, e, t),
                              this.isEvenOddMaster() ? this.reassignMasterPages() : this.$mpg && this._fixSingleMpg(e, this.$mpg),
                ...
                (Q.prototype.removeChild = function (e) {
                    (r.Container.prototype.removeChild.call(this, e),
                        e instanceof g && this.isEvenOddMaster() && this.reassignMasterPages());
                }),
                    ...
                    if (e === r._Change.PrepareRestore) {
                            ...
                            function (e, n) {
                                ...
                                if ("lmd" === e)
                                    return t.options && t.options.save
                                        ? ((this.$lmd = isNaN(t.options.lastModifiedDate) ? Date.now() : t.options.lastModifiedDate),
                                          this.$lmd)
                                        : null;
                                if ("cfs" === e || "cid" === e) {
                        ...
                        if (d >= 0) {
                            ...
                            if (((this.$lgm = f || this.$gm), f === Q.GridMode.Axonometric && this.$gm !== Q.GridMode.Axonometric)) {
                                ...
                                (b < 0 && !this.$ga1 ? (t.properties.push("ga1"), t.values.push(Q.AXONO_ANGLE1)) : (m = t.values[b]),
                                    C < 0 && !this.$ga2 ? (t.properties.push("ga2"), t.values.push(Q.AXONO_ANGLE2)) : (_ = t.values[C]),
                                    !this.$gaw && w < 0
                                ...
                                null !== E &&
                                    (x < 0 && this.$gah !== E
                                        ...
                                        : x >= 0 && !T.isEqualEps(E, t.values[x], 1e-9) && (t.values[x] = E));
                            } else
                                f !== Q.GridMode.Axonometric &&
                                    this.$gm === Q.GridMode.Axonometric &&
                                    (this.$gy || (t.properties.push("gy"), t.values.push(this.$gx)));
                        } else if (
                            this.$gm === Q.GridMode.Axonometric &&
                            (t.properties.indexOf("ga1") >= 0 || t.properties.indexOf("ga2") >= 0 || t.properties.indexOf("gaw") >= 0)
                        ) {
                            ((m = (b = t.properties.indexOf("ga1")) >= 0 ? t.values[b] : this.$ga1),
                                (_ = (C = t.properties.indexOf("ga2")) >= 0 ? t.values[C] : this.$ga2),
                                (v = (w = t.properties.indexOf("gaw")) >= 0 ? t.values[w] : this.$gaw),
                        ...
                        if (
                            ((R = t.properties.indexOf("_links")) >= 0 && this.$rb && (t.values.splice(R, 1), t.properties.splice(R, 1)),
                            t.properties.indexOf("mpg") >= 0)
                        )
                            (M = this.getProperty("mpg")) && M._detachFromParent(this);
                        if (t.properties.indexOf("ompg") >= 0) (N = this.getProperty("ompg")) && N._detachFromParent(this);
                        if (t.properties.indexOf("empg") >= 0) (U = this.getProperty("empg")) && U._detachFromParent(this);
                    } else if (e === r._Change.AfterPropertiesChange) {
                        if (t.properties.indexOf("mpg") >= 0) (M = this.getProperty("mpg")) && M._attachToParent(this);
                        if (t.properties.indexOf("ompg") >= 0) (N = this.getProperty("ompg")) && N._attachToParent(this);
                        if (t.properties.indexOf("empg") >= 0) (U = this.getProperty("empg")) && U._attachToParent(this);
                        ...
                        this.isFixedSized() &&
                            ...
                            this._invalidateArea(this._getInvalidationArea(this._invalidateFrom), null));
                        ...
                        ((M = this.getProperty("mpg")) && M._setWorkspace(e === r._Change.WorkspaceDetach ? null : this._workspace),
                            (N = this.getProperty("ompg")) && N._setWorkspace(e === r._Change.WorkspaceDetach ? null : this._workspace),
                            (U = this.getProperty("empg")) && U._setWorkspace(e === r._Change.WorkspaceDetach ? null : this._workspace));
                    }
                ...
                (Q.prototype.decreaseReferenceCounter = function () {
                    if (
                        ...
                        ((this._referenceCounter = this._referenceCounter - 1), 0 === this._referenceCounter)
                    ) {
