module.exports = function (e, t, i) {
            ...
            (r.inheritAndMix("ancotext", l, o, [a, a.Linkable]),
                ...
                (l.prototype._handleChange = function (e, t) {
                    if (e === r._Change.Store) {
                        ...
                        if (this.recordedTransaction || t.options.recordedTransaction) {
                            for (
                                var s = Object.keys(a.MetaProperties), l = t.options.recordedProperties || {}, h = {}, A = 0, c = s.length;
                                A < c;
                                A++
                            ) {
                                var p = s[A];
                        ...
                        e === r._Change.Restore
                            ...
                            : e === r._Change.BeforePropertiesChange && this.handleBeforePropertiesChange(t);
                ...
                (l.prototype._handleReferencesOnSceneAttach = function () {
                    (o.prototype._handleReferencesOnSceneAttach.call(this, this._getRestoredAnnotableReferences()),
