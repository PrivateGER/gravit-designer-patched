                ...
                (l.prototype._invalidatePath = function () {
                    ...
                    try {
                        ...
                        if ((o.isEqualEps(c, this.$sa) && i > p) || (o.isEqualEps(p, this.$sa) && i > p + o.PIHALF))
                            (r.setProperties(
                                ["x", "y", "tp", "ah"],
                                [Math.cos(this.$sa), Math.sin(this.$sa), a.AnchorPoint.Type.Symmetric, !0]
                            ),
                                e.appendChild(r));
                        else {
                            ...
                            ((_ = new a.AnchorPoint()).setProperties(
                                ...
                                (_ = new a.AnchorPoint()).setProperties(
                                    ["x", "y", "tp", "ah"],
                                    [Math.cos(p + o.PIHALF), Math.sin(p + o.PIHALF), a.AnchorPoint.Type.Symmetric, !0]
                                ),
                                u.appendChild(_),
                        ...
                        if (A) this.setProperty("closed", !0);
                            ...
                            if (!n && o.isEqualEps(t, i))
                                ...
                                (o.getCtrlPtsCasteljau(
                                    ...
                                    n ||
                                        ((r = new a.AnchorPoint()).setProperties(
                                            ["hlx", "hly", "x", "y", "tp", "ah"],
                                            [b[2], C[2], b[3], C[3], a.AnchorPoint.Type.Asymmetric, !1]
                                        ),
                                        (h = !0),
                                        e.appendChild(r)));
                            }
                            ...
                            (e.getFirstChild().getNext() == e.getLastChild() &&
                                ...
                                r.setProperties(["x", "y", "tp", "ah"], [Math.cos(t), Math.sin(t), a.AnchorPoint.Type.Symmetric, !0]),
                                e.appendChild(r),
                                (w = r)),
                                this.setProperty("closed", !0));
                            for (var E = e.getFirstChild(); null != E; E = E.getNext()) E.setProperty("ah", !1);
                            (w && e.removeChild(w),
                                s &&
