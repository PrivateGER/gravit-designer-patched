module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.mix(l, [o, s]),
                ...
                (l.deserialize = function (e) {
                    for (var t = new l(), i = 0; i < e.length; i += 3) t.addVertex(e[i], e[i + 1], e[i + 2]);
                    return t;
                }),
                ...
                (l.clone = function (e, t) {
                        ...
                        if (t) {
                            if (i.command === a.Command.Move) {
                                if (n && n.command === a.Command.Close) {
                                    ...
                                    (h < 0 && (o.unshift((r = new a())), (r.command = a.Command.Close)),
                                        o[o.length - 1].command === a.Command.Close && (o[o.length - 1].command = a.Command.Move));
                                }
                            } else if (n) (o.push((r = new a())), (r.command = i.command), (r.x = n.x), (r.y = n.y));
                            else if (i.command !== a.Command.Move) throw new Error("Path doesn't start with moveTo!");
                        } else (o.push((r = new a())), (r.command = i.command), (r.x = i.x), (r.y = i.y));
                    ...
                    if (t) {
                        var c,
                            p,
                            u = o[0];
                        if (u.command !== a.Command.Move) return (DEBUG && console.log("Line should start with moveTo"), null);
                        ...
                        for (h = 0; h < o.length - 1; h++) {
                            ...
                            if (d && d.command == a.Command.Curve2) {
                                var g = o[h + 1],
                                    f = o[h + 2],
                                    m = o[h + 3];
                                if (!(g && f && m)) return (DEBUG && console.log("Wrong path."), null);
                                ((u.x = f.x),
                                    (u.y = f.y),
                    ...
                    } else for (h = 0; h < o.length; h++) ((u = o[h]), A.addVertex(u.command, u.x, u.y));
