            ...
            (require(1078),
                ...
                (u.prototype.deactivate = function (e, t) {
                    (r.prototype.deactivate.call(this, e, t),
                        this._pathUnderMouse && (this._pathUnderMouse.removeFlag(c.Flag.Highlighted), (this._pathUnderMouse = null)),
                    ...
                    ((t && t.length && t[0].element instanceof a) ||
                        ...
                        t &&
                            ...
                            (!(t[0].element instanceof h) ||
                                ...
                                ((this._pathUnderMouse = t[0].element), this._pathUnderMouse.setFlag(c.Flag.Highlighted))));
                }),
                (u.prototype._mouseDown = function () {
                    this._pathUnderMouse &&
                        ((this._sourcePath && this._pathUnderMouse === this._sourcePath) ||
                            ...
                            this._sourcePath ? (this._targetPath = this._pathUnderMouse) : (this._sourcePath = this._pathUnderMouse),
