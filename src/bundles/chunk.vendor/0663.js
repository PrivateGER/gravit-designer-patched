module.exports = function (e, t, i) {
            ...
            (r.inheritAndMix(u, r, [h]),
                ...
                (u.prototype.getWidth = function () {
                    for (var e = 0, t = 0; t < this._numHorizontal; t++) e += this._paintCanvases[t * this._numVertical].getWidth();
                    return e;
                }),
                (u.prototype.getHeight = function () {
                    for (var e = 0, t = 0; t < this._numVertical; t++) e += this._paintCanvases[t].getHeight();
                    return e;
                }),
                ...
                (u.prototype.paintAndRender = function (e, t, i, n, r, o, a, s) {
                    ...
                    ((l.callback = s),
                        ...
                        (l.screen = o),
                        (l.viewTransform = i),
                        this._renderQueue ? this._renderQueue.push(l) : (this._renderQueue = [l]),
                ...
                (u.prototype._paintAndRenderInternal = function (e, t, i, n, r, h, c, p) {
                    var u,
                        ...
                        x = 0,
                        P = [];
                    ((d = c || 1 === m._paintCanvases.length || m.isThreaded() ? m._iterateGrid : m._iterateGridAsync).call(
                        m,
                        function (c, u, d) {
                ...
                (u.prototype._getGridIndexForNativeCanvas = function (e) {
                    for (var t = 0; t < this._paintCanvases.length; t++)
                        if (this._paintCanvases[t].getRendererContext()) {
                            if (this._paintCanvases[t].getRendererContext().$realCtx.canvas === e) return t;
                        } else if (e instanceof n) {
                            if (self._paintCanvases[t] === e) return t;
                        } else if (self._paintCanvases[t]._canvasContext.canvas === e) return t;
                    return -1;
                }),
                ...
                (u.prototype.moveContent = function (e, t) {
                    ...
                    (i.resize(this.getWidth(), this.getHeight()),
                        ...
                        this.drawFragmentTo(this._panHelper, e.getX(), e.getY(), e.getX(), e.getY(), e.getWidth(), e.getHeight()));
                    var n = t,
                        r = e.getX() - t.getX(),
                        o = e.getY() - t.getY(),
                        s = this;
                    this._iterateGrid(function (e, t, i) {
                        ...
                        (A ? A.clearRect(0, 0, e.getWidth(), e.getHeight()) : e.clearRect(0, 0, e.getWidth(), e.getHeight()),
                            !h.isEmpty() &&
                                A &&
                                A.drawImage(
                ...
                (u.prototype.drawFragmentTo = function (e, t, i, n, r, o, s) {
                    ...
                    this._iterateGrid(function (t, i, o) {
                        var s = new a(i, o, t.getWidth(), t.getHeight()),
                            h = l.intersected(s);
                        h.isEmpty() ||
                            e.drawImageFragment(t, h.getX() - i, h.getY() - o, h.getX() + n, h.getY() + r, h.getWidth(), h.getHeight());
                    });
                }),
                (u.prototype.drawFragmentFrom = function (e, t, i, n, r, o, s) {
                    ...
                    (this._iterateGrid(function (t, i, o) {
                        var s = new a(i, o, t.getWidth(), t.getHeight()),
                            h = l.intersected(s);
                        h.isEmpty() ||
                            t.drawImageFragment(e, h.getX() + n, h.getY() + r, h.getX() - i, h.getY() - o, h.getWidth(), h.getHeight());
                    }),
                        (this._consolidatedCanvas = null));
                }),
                        ...
                        if (
                            ((n = this._iterateGrid(function (t, n, o) {
                                if (i) {
                                    ...
                                    if (s.$realCanvas !== i && s.$renderedBitmap !== i && s !== i) return;
                                }
                            ...
                            for (var o = new a(0, 0, i.width, i.height), s = 0; s < r.length; ++s) {
                                ...
                                (l = l.intersected(o)).isEmpty() ||
                                    e.drawImageFragment(i, l.getX(), l.getY(), l.getX(), l.getY(), l.getWidth(), l.getHeight());
                            }
                    } else
                ...
                (u.prototype.destroy = function () {
                    for (var e = 0; e < this._paintCanvases.length; e++) this._paintCanvases[e].destroy();
                    (this._panHelper.destroy(),
                        this._consolidatedCanvas && (this._consolidatedCanvas.destroy(), (this._consolidatedCanvas = null)),
                        this.cleanCache());
                }),
                ...
                (u.prototype.setImageSmoothingQuality = function (e) {
                    for (var t = 0; t < this._paintCanvases.length; t++) this._paintCanvases[t].setImageSmoothingQuality(e);
                }),
