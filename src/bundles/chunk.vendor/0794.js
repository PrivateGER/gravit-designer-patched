                ...
                (u.prototype.parse = function () {
                    if (this._node) {
                        (s.prototype.parse.apply(this, arguments),
                            (this._parent && this._parent instanceof p.getClassFromName("shapeGroup") && this._parent.hasClippingMask()) ||
                        ...
                        (e &&
                            (this._node.hasMixin(GStylable) &&
                                ...
                                this._node.setProperty("_stop", void 0 !== e.contextSettings.opacity ? e.contextSettings.opacity : 1)),
