                    ...
                    try {
                        ((function (e, t) {
                                ...
                                if ("error" in t);
                                    ...
                                    if ("progress" == i && t.data && t.data.length) h(t.data[0]);
                                        ...
                                        if (("done" == i && h(100), "data" in t)) {
                                            for (var n = [], r = 0; r < t.data.length; r++) n[r] = t.data[r];
                                            ("result" in t &&
                                                t.result &&
                                                t.result.byteLength &&
                                                t.result.byteLength > 4 &&
                                                ((n[n.length] = new Int32Array(t.result, 0, 1)),
                                                (n[n.length] = new Uint8Array(t.result, 4, t.result.byteLength - 4))),
                                                d.workerAPI[i].apply(d, n),
                                                "error" == i && n == o.ErrorCodes.General
                                                    ? (null !== f && clearTimeout(f), g.terminate(), d.ready() || d.workerAPI.done.apply(d))
                            ...
                            (f = setTimeout(function () {
                                (g.terminate(),
                                    d.ready() || (d.workerAPI.done.apply(d), d.workerAPI.error.apply(d, [o.ErrorCodes.Timeout])));
                            }, 3e5)));
                    } catch (e) {
