module.exports = function (e, t, n) {
            ...
            (o.inherit("imagegrid", m, r),
                ...
                (m.Images = function () {}),
                o.inheritAndMix("imagegrid.images", m.Images, o, [o.Container, o.Multireference]),
                    ...
                    if (this.$grid) {
                        ...
                        if (i) {
                            ...
                            if (
                                ...
                                var A = (this.$im || []).slice(),
                                    c = (this.$off || []).slice();
                                ((A[h] = e), (c[h] = [n, n]), this.setProperties(["im", "off"], [A, c]));
                            }
                        }
                    }
                }),
                    ...
                    if (e) {
                        if (e == o._Change.Store)
                            (this.storeProperties(t.blob, m.GeometryProperties),
                                this.storeProperties(t.blob, m.VisualProperties, function (e, t) {
                                    return "im" === e && t
                                        ? t.map(function (e) {
                            ...
                            (this.restoreProperties(t.blob, m.GeometryProperties),
                                this.restoreProperties(t.blob, m.VisualProperties, function (e, t) {
                                    return "im" === e && t
                                        ? t.map(function (e) {
                        ...
                        else if (e == a._Change.FinishGeometryUpdate) this._vertexSource = null;
                            ...
                            this.$im &&
                                ...
                                e === o._Change.ParentAttached && this._images._attachToParent(this));
                ...
                (m.prototype.getSubnodeIds = function (e) {
                    (r.prototype.getSubnodeIds.call(this, e),
                        this._images &&
                            (e[this._images.getMultireferenceId()] && this._images.resetMultireference(),
