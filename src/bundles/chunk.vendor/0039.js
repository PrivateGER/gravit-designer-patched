            ...
            (IsFiniteNonNegativeNumber.inherit(l, IsFiniteNonNegativeNumber),
                ...
                (l.getOutlineColor = function (e, t, i, n, r) {
                    ...
                    ((t = Math.max(0, Math.min(e.canvas.getWidth() - 1))),
                        ...
                        (o = e.computedBackgroundColor ? e.computedBackgroundColor : e.canvas.getBitmap().getPixelValue(t, i).slice(0, 3)),
                        ...
                        for (var g = r.getPaintLayers(), f = g ? g.getLayers() : [], m = [], y = f.length - 1; y >= 0; y--) {
                            ...
                            if (_ instanceof GStylable.FillPaintLayer) {
                                var v = _.getProperty("_pt"),
                                    b = _.getProperty("_vs"),
                                    C = _.getProperty("_op");
                                if (v && b) if ((w = v.getAverageColor()) && (m.unshift(w), (w[3] *= C), (w[3] *= d), w[3] >= 1)) break;
                            }
                        }
                        if (m.length) {
                    ...
                    return A && h && a.closeEnough(A.toScreen(), l, 100) ? new a([0, 0, 40]) : h ? new a(l) : n;
                }),
                (l.Flag = {
                    Selected: 1,
                    Detail: 2,
                ...
                (l.closeEditor = function (e) {
                    if (e) {
                        for (var t = e.getEditors(); t && t.length; ) (l.closeEditor(t[0]), (t = e.getEditors()));
                ...
                (l.prototype.setFlag = function (e, t) {
                    0 == (this._flags & e) &&
                        (t || this.requestInvalidation(), (this._flags = this._flags | e), t || this.requestInvalidation());
                }),
                ...
                (l.prototype.insertEditor = function (e, t) {
                    ...
                    if (t && this._editors && (i = this._editors.indexOf(t)) < 0) throw new Error("Unknown reference editor.");
                    if (null != e._parentEditor) throw new Error("Editor already appended.");
                    (this._editors || (this._editors = []),
                        i >= this._editors.length ? this._editors.push(e) : this._editors.splice(i, 0, e),
                    ...
                    if (this.hasFlag(l.Flag.Selected)) {
                        ...
                        if (e && this._partSelection) {
                            if (t) {
                                ...
                                for (r = 0; r < t.length; ++r) this._indexOfPartId(this._partSelection, t[r]) < 0 && i.push(t[r]);
                                0 === i.length && (i = null);
                            }
                ...
                (l.prototype.getOwnedPartsSelectionLength = function () {
                    ...
                    if (this.hasFlag(l.Flag.Selected) && this._editors)
                        for (var t = 0; t < this._editors.length; ++t) e += this._editors[t].getPartsSelectionLength();
                    return e;
                }),
                ...
                (l.prototype.selectToolDragStartAction = function (e, t) {
                    var i = null;
                    if (this._editors)
                        for (var n = 0; n < this._editors.length; ++n) if ((i = this._editors[n].selectToolDragStartAction(e, t))) return i;
                ...
                (l.prototype._paintChildren = function (e, t, i) {
                    if (this._editors)
                        for (var n = 0; n < this._editors.length; ++n) (i && !i(this._editors[n])) || this._editors[n].paint(e, t);
                }),
                ...
                (l.prototype._indexOfPartId = function (e, t) {
                    if (e && e.length > 0) for (var i = 0; i < e.length; ++i) if (this._partIdAreEqual(e[i], t)) return i;
                    return -1;
                }),
                ...
                (l.prototype._setTransform = function (e) {
                    r.equals(this._transform, e) ||
                        (this.hasFlag(l.Flag.Outline) ? this.requestInvalidation() : this.setOutlineTmpFlag(),
                        (this._transform = e),
