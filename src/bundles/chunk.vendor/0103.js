module.exports = function (e, t, i) {
            ...
            var p = ("undefined" != typeof window && window.requestAnimationFrame) || setTimeout,
                ...
                (d.getRenderer = function (e, t, i, n, r) {
                    return this._enabled && this._debugEnabled && (this._debugPhase || e)
                        ...
                        : this._enabled && (this._renderPhase || e)
                          ? new o(null, null, null, null, t, i, this, this.isMultiThreaded() || r, n)
                ...
                (d.render = function (e, t, i, a) {
                    ...
                    if (
                        ...
                        (e.canvas.$realCanvas && (e.canvas.$realCanvas = null),
                            e.canvas.$renderedBitmap && (e.canvas.$renderedBitmap.close(), (e.canvas.$renderedBitmap = null)));
                        var F = [];
                        (this._toInitializeWorkers[I].forEach(function (e) {
                            ...
                            } else if (e.canvas.$renderedBitmap) throw new Error("Rendered bitmap encountered but no bitmap source found");
                        }),
                        ...
                        return (
                            (R.onmessage = function (t) {
                                if (
                                    ...
                                    t.data.finished && d._scheduledRenderings && d._scheduledRenderings.length)
                                ) {
                        ...
                        if ((a = this._renderJobs[e.__contextId])) {
                            if (null !== a.timeout)
                                return (
                                    ...
                                    console.warn("This means that for example rendering is in progress, but second launched"),
                                    null
                                );
                        } else {
                            var D = {};
                            for (var k in this._renderParameters) D[k] = this._renderParameters[k];
                            var G = r;
                    ...
                    for (; w < C; ) {
                        ...
                        if (u === o.EXEC)
                            if (f === o._setWidth) e.canvas.$realCanvas.width = e.canvas._w = E[0];
                            else if (f === o._setHeight) e.canvas.$realCanvas.height = e.canvas._h = E[0];
                                              ...
                                              : 1 === v
                                                ...
                                                : 3 === v
                                                  ...
                                                  : 5 === v
                                                    ...
                                                    : 7 === v
                                                      ? c[g].call(c, E[0], E[1], E[2], E[3], E[4], E[5], E[6])
                                                      : 8 === v
                                                        ? c[g].call(c, E[0], E[1], E[2], E[3], E[4], E[5], E[6], E[7])
                                                        : 9 === v
                                                          ? c[g].call(c, E[0], E[1], E[2], E[3], E[4], E[5], E[6], E[7], E[8])
                                                          : 10 === v
                                                            ? c[g].call(c, E[0], E[1], E[2], E[3], E[4], E[5], E[6], E[7], E[8], E[9])
                                                            : 11 === v
                                                              ? c[g].call(
                                                                    c,
                                                                    E[0],
                        ...
                        if (((w = e.__execPtr), !P && a.isExpired())) {
                            ...
                            return (
                                o.clearPrevious(e),
                                a.hasSave() && _("Renderer: exiting render loop without reaching save location", 2),
                                a.pushSave({
                                    ctx: e,
                                    callback: i,
                                    len: C,
                ...
                0 !==
                    (i =
                        e.canvas.renderingName || e.canvas.renderedName
                            ? parseInt((e.canvas.renderingName || e.canvas.renderedName).match(/[0-9]+$/)[0])
                            : null === i
                              ? ++m
                              : i || 0) ||
                    e.canvas.rendering ||
                    ...
                    if (p !== o.DELETE)
                        if (p !== o.FINISH)
                                ...
                                if (p !== o.FAKE) {
                                    for (;;) {
                                        ...
                                        if ("string" == typeof v) v = '"' + v + '"';
                                            ...
                                            var E = "pattern" + i + "_" + f;
                                            (v.$renderedVariable || ((h += v.dumpCode(l, E, this, i, n)), f++),
                                                (v = v.dumpCode(l, E, this, i, n)));
                                        } else if (v instanceof Float32Array) v = "new Float32Array([" + v.join(",") + "])";
                                        else if (v instanceof Int32Array) v = "new Int32Array([" + v.join(",") + "])";
                                        else if (v instanceof Float64Array) v = "new Float64Array([" + v.join(",") + "])";
                                        else {
                                            if (v instanceof Array) throw new Error("Array parameter not supported");
                                            if (null === v) v = "null";
                                    ...
                                    if ("_setWidth" === u) h += s + ".width = " + y[0] + "\n";
                                    else if ("_setHeight" === u) h += s + ".height = " + y[0] + "\n";
                                        ...
                                        if (p !== o.MOV) return (_("Invalid op", 2), h + "<== ERROR ###");
                                        h += l + "." + u + " = " + y[0] + ";\n";
                                    }
                                    a = e.__execPtr;
                            ...
                            if (((a = e.__execPtr), i > 0)) {
                                if ((_("### Finish id = " + i + "; finishSrc rendering? " + x.rendering), x.rendering)) break;
                                continue;
                            }
