            ...
            ((a.unlistifyFilter = function (e) {
                ...
                (a.prototype.listify = function (e, t) {
                    ...
                    return (
                        c.length &&
                            (h && (c = h.concat(c)),
                            A && (c = c.concat(A)),
                            (p = this.doc.checkSanity(i, s, c)) && this.doc.range(i, s).setText(c)),
                        p
                    );
                }),
                (a.prototype.parts = function (e, t) {
                    ...
                    t.some(function (t) {
                        return (
                            ...
                            (t.ordinal >= i.end ||
                                void (t.ordinal >= i.start && t.ordinal + t.length <= i.end ? e(t) : i.parts(e, t.children())))
                        );
                    });
                }),
                    ...
                    if (this.isList()) {
                        ...
                        if (this.start === this.end) {
                            ...
                            if (t.end === this.doc.frame.length - 1)
                                if (
                                    !r.create(t.runs, t).filter(a.unlistifyFilter).map(n.getPlainText).all().join("") &&
                ...
                (a.prototype.setFormatting = function (e, t) {
                    ...
                    for (var o = 0; o < e.length; o++) {
                        var a = e[o],
                            s = t[o];
                        "align" === a || "lineSpacing" === a || "paragraphSpacing" === a || "paragraphIndent" === a || "listMarker" === a
                            ? this.doc.paragraphRange(this.start, this.end)._setSingleFormatting(a, s)
                            : this.start === this.end
