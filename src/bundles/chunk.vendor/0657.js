module.exports = function (e, t, i) {
            ...
            n.inheritAndMix("GPGAnchor", c, n, [n.Store, n.Properties, s, n.Multireference]);
            ((c.GeometryProperties = {
                    ...
                    if (this._orderedEdges)
                        if (this._orderedEdges.length > 1)
                            for (var n = null, r = 0; r < this._orderedEdges.length; ++r) {
                                if ((n = this._orderedEdges[r]).type == t)
                                    if ((t == c.EdgeType.Out ? this._outEdges : this._inEdges)[n.idx] == e) {
                                        var o = r + 1 < this._orderedEdges.length ? this._orderedEdges[r + 1] : this._orderedEdges[0],
                                            s = o.type == c.EdgeType.Out ? this._outEdges : this._inEdges;
                                        if (i) {
                                            var l = n.getAngle(),
                                                h = o.getAngle();
                                            l > h && (h += A.PI2);
                            ...
                            if ((n = this._orderedEdges[0]).type == t)
                                if ((t == c.EdgeType.Out ? this._outEdges : this._inEdges)[n.idx] == e) {
                                    if (i) ((p = n.getAngle() + Math.PI), (u = 0.001 * Math.cos(p)), (d = 0.001 * Math.sin(p)));
                                    return {
                                        edge: e,
                                        type: t,
                    ...
                    if (this._orderedEdges && this._orderedEdges.length && 1 != this._orderedEdges.length) {
                        ...
                        if (!(s < 2)) {
                            var u = this._orderedEdges.length - 1,
                                ...
                                g = d.type == c.EdgeType.Out ? this._outEdges[d.idx] : this._inEdges[d.idx],
                                f = u;
                            if (!a(g))
                                for (u = 0; u < this._orderedEdges.length - 1 && !a(g); ++u)
                                    ((g =
                                        (d = this._orderedEdges[u]).type == c.EdgeType.Out ? this._outEdges[d.idx] : this._inEdges[d.idx]),
                                        (f = u));
                            if (a(g))
                                for (p = f == this._orderedEdges.length - 1 ? 0 : f + 1; p < this._orderedEdges.length; ++p) {
                                    ...
                                    if (a(y)) {
                                        ...
                                        if ((_ > v && (v += A.PI2), v - _ > Math.PI || 2 == s)) {
                                            ...
                                            b.getAnchorPoints()
                                                .getLastChild()
                                                .setProperties(["hrx", "hry"], [C.getProperty("hrx"), C.getProperty("hry")]);
                                            for (var w = C.getNext(); null != w; w = w.getNext()) {
                                                var E = new h.AnchorPoint();
                                                (E.deserialize(w.serialize()), b.getAnchorPoints().appendChild(E));
                                            }
                                            (g.getProperty("_bw") > y.getProperty("_bw") ? b.assignStyleFrom(y) : b.assignStyleFrom(g),
                ...
                (c.prototype._handleChange = function (e, t) {
                    ...
                    else if (e === n._Change.Restore) t.blob.hasOwnProperty("props") && this.deserialize(t.blob.props);
