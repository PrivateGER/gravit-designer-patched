            ...
            ((i.prototype.setState = function (e, t) {
                ...
                (l.prototype.insertToken = function (e, t, n) {
                    return e.every(function (e) {
                        ...
                        ? (this.tokens.splice.apply(this.tokens, [t, 0].concat(e)), n || this.dispatch("insertToken", [e, t]), e)
                        : {
                ...
                (l.prototype.runContextCheck = function (e) {
                    ...
                    this.contextCheckers.forEach(function (r) {
                        ...
                        if (
                            (!a &&
                                r.checkStart(e) &&
                                ((a = new n(t, null, o)), (i.getContext(o).openRange = a), i.dispatch("contextStart", [o, t])),
                            a && r.checkEnd(e))
                        ) {
