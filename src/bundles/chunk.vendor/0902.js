                ...
                ((e.BorderPaintLayer = function (t, i, n, r) {
                    ...
                    (e.BorderPaintLayer.prototype.assignFrom = function (t) {
                        (t instanceof e.BorderPaintLayer &&
                            this.transferProperties(t, [e.BorderPaintLayer.VisualProperties, e.BorderPaintLayer.GeometryProperties]),
                    ...
                    (e.BorderPaintLayer.prototype._handleChange = function (t, i) {
                        if (t == r._Change.Restore) {
                            ...
                            for (var l = ["_bpt", "_bvs", "_bop", "_bpx"], h = 0; h < l.length; h++) {
                                var A = l[h],
                                    c = A.replace(/b/g, "");
                                i.blob.hasOwnProperty(A) && (i.blob[c] = i.blob[A]);
                            }
                            ("_bmo" in i.blob && ((i.blob._btmo = i.blob._bmo), (i.blob._bhmo = i.blob._bmo)),
                                "_bmi" in i.blob && ((i.blob._btmi = i.blob._bmi ? 1 : 0), (i.blob._bhmi = i.blob._bmi ? 1 : 0)),
                                "_btmi" in i.blob && "boolean" == typeof i.blob._btmi && (i.blob._btmi = i.blob._btmi ? 1 : 0),
                                "_bhmi" in i.blob && "boolean" == typeof i.blob._bhmi && (i.blob._bhmi = i.blob._bhmi ? 1 : 0),
                                this.restoreProperties(i.blob, e.BorderPaintLayer.VisualProperties),
                                this.restoreProperties(i.blob, e.BorderPaintLayer.MetaProperties),
                                this.restoreProperties(i.blob, e.BorderPaintLayer.GeometryProperties, function (e, t) {
                                    return ("_bhm" === e || "_btm" === e) && t && t instanceof Array ? n.deserialize(t) : t;
                                }));
                        } else if (t == r._Change.Store)
                            (this.storeProperties(i.blob, e.BorderPaintLayer.VisualProperties),
                                this.storeProperties(i.blob, e.BorderPaintLayer.MetaProperties),
                                this.storeProperties(i.blob, e.BorderPaintLayer.GeometryProperties, function (e, t) {
                        ...
                        (e.PaintLayer.prototype._handleChange.call(this, t, i),
                            this._handleVisualChangeForProperties(t, i, e.BorderPaintLayer.VisualProperties),
