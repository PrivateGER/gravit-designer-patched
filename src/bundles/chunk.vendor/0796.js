            ...
            (IsFiniteNonNegativeNumber.inherit(A, s),
                ...
                (A.prototype._postParse = function () {
                    for (var e = this.getChildren(), t = 0; t < e.length; t++) {
                        var i = e[t];
                        if (i.hasClippingMask()) return void i._clip(e.splice(t + 1, e.length));
                    }
                }),
                ...
                (A.prototype._getTransformation = function () {
                    var e = this._getTransform().decomposed(),
                        ...
                        i = e.scale.scaled(1 / Math.abs(e.scale._sx), 1 / Math.abs(e.scale._sy));
                    return new r()
                ...
                (A.prototype.visitReferences = function (e) {
                    for (var t = e(this._data), i = this._data.parent; i && !t; ) ((t = e(i)), (i = i.parent));
                }),
