module.exports = function (e, t, i) {
            ...
            (a.inherit(y, l),
                ...
                r.inheritAndMix("anchorPoint", y.AnchorPoint, r, [r.Properties, r.Multireference, r.Reference, o, r.Identity, r.Store]),
                (y.AnchorPoint.Type = {
                    Asymmetric: "TA",
                    Symmetric: "TS",
                    Mirror: "TM",
                ...
                (y.AnchorPoint.prototype.serialize = function () {
                    var e = [];
                    return (
                        null !== this.$tp && this.$tp !== y.AnchorPoint.GeometryProperties.tp && e.push(this.$tp),
                        this.$ah && this.$ah !== y.AnchorPoint.GeometryProperties.ah && e.push(this.$ah),
                        e.push(s.packPoint(this.$x, this.$y)),
                        this._multiReferenceId && (e.push("&"), e.push(this._multiReferenceId)),
                        this._referenceId && (e.push("#"), e.push(this._referenceId)),
                        this.$ah ||
                            ((null === this.$hlx && null === this.$hly) || (e.push("h"), e.push(s.packPoint(this.$hlx, this.$hly))),
                            (null === this.$hrx && null === this.$hry) || (e.push("H"), e.push(s.packPoint(this.$hrx, this.$hry)))),
                        ((null !== this.$cl && !f.isEqualEps(this.$cl, y.AnchorPoint.GeometryProperties.cl)) ||
                            (null !== this.$cr && !f.isEqualEps(this.$cr, y.AnchorPoint.GeometryProperties.cr))) &&
                ...
                (y.AnchorPoint.prototype.deserialize = function (e) {
                    ...
                    if (
                        ...
                        t < e.length && "#" === e[t] && ((this._referenceId = e[t + 1]), (t += 2)),
                        i)
                    )
                        for (; t + 1 < e.length; ) {
                            if ("h" === e[t]) {
                        ...
                        for (; t + 2 < e.length; )
                            ("h" === e[t]
                                ...
                                : "H" === e[t]
                                  ...
                                  : "C" === e[t] && ((this.$cl = e[t + 1]), (this.$cr = e[t + 2])),
                                (t += 3));
                }),
                (y.AnchorPoint.prototype._getTransformedCopy = function (e) {
                    var t = new y.AnchorPoint(),
                        i = null !== this.$hlx ? e.mapPoint(new c(this.$hlx, this.$hly)) : null,
                        n = null !== this.$hrx ? e.mapPoint(new c(this.$hrx, this.$hry)) : null,
                ...
                (y.AnchorPoint.prototype._handleChange = function (e, t) {
                    ...
                    if (e == r._Change.Store) t.blob.stream = this.serialize();
                        ...
                        (e == r._Change.BeforePropertiesChange || e == r._Change.AfterPropertiesChange) &&
                        ...
                        if (e === r._Change.BeforePropertiesChange) {
                            ...
                            for (var h = ["x", "y", "hlx", "hly", "hrx", "hry"], A = 0; A < h.length; ++A) {
                                var c = t.properties.indexOf(h[A]);
                                if (c >= 0) {
                                    var p = t.values[c];
                                    (p != 1 / 0 && p != -1 / 0 && (null != p || (0 != A && 1 != A)) && null != p && p == p) ||
                            ...
                            (((this.$tp != y.AnchorPoint.Type.Symmetric || this.$ah || null == this.$hlx || null == this.$hrx) &&
                                (this.$tp != y.AnchorPoint.Type.Mirror || this.$ah || (null == this.$hlx && null == this.$hrx))) ||
                                (((t.properties.indexOf("hrx") >= 0 || t.properties.indexOf("hry") >= 0) &&
                    ...
                    if (e) {
                        ...
                        (o && (s = Math.sqrt(f.ptSqrDist(this.$x, this.$y, o.$x, o.$y))),
                            ...
                            this.$ah
                                ? (!o ||
                                  !r ||
                                  (o.$tp != y.AnchorPoint.Type.Symmetric && o.$tp != y.AnchorPoint.Type.Mirror) ||
                                  f.isEqualEps(s, 0) ||
                                  f.isEqualEps(a, 0)
                                      ...
                                      : ((t = s * y.AnchorPoint.HANDLE_COEFF),
                                        ...
                                        (f.isEqualEps(this.$hrx, i, y.defaultEps) && f.isEqualEps(this.$hry, n, y.defaultEps)) ||
                                            this.setProperties(["hrx", "hry"], [i, n])),
                                  !r ||
                                  !o ||
                                  (r.$tp != y.AnchorPoint.Type.Symmetric && r.$tp != y.AnchorPoint.Type.Mirror) ||
                                  f.isEqualEps(s, 0) ||
                                  f.isEqualEps(a, 0)
                                      ...
                                      : ((t = a * y.AnchorPoint.HANDLE_COEFF),
                                        ...
                                        (f.isEqualEps(this.$hlx, i, y.defaultEps) && f.isEqualEps(this.$hly, n, y.defaultEps)) ||
                                            this.setProperties(["hlx", "hly"], [i, n])))
                                : (null != this.$hlx &&
                                      o &&
                                      !f.isEqualEps(s, 0) &&
                                      ((t = Math.sqrt(f.ptSqrDist(this.$x, this.$y, this.$hlx, this.$hly))),
                                      (i = this.$x + ((this.$x - o.$x) / s) * t),
                                      (n = this.$y + ((this.$y - o.$y) / s) * t),
                                      (f.isEqualEps(this.$hlx, i, y.defaultEps) && f.isEqualEps(this.$hly, n, y.defaultEps)) ||
                                          this.setProperties(["hlx", "hly"], [i, n])),
                                  null != this.$hrx &&
                                      r &&
                                      !f.isEqualEps(a, 0) &&
                                      ((t = Math.sqrt(f.ptSqrDist(this.$x, this.$y, this.$hrx, this.$hry))),
                                      (i = this.$x + ((this.$x - r.$x) / a) * t),
                                      (n = this.$y + ((this.$y - r.$y) / a) * t),
                                      (f.isEqualEps(this.$hrx, i, y.defaultEps) && f.isEqualEps(this.$hry, n, y.defaultEps)) ||
                                          this.setProperties(["hrx", "hry"], [i, n]))));
                        ...
                        (this._leadHr
                            ? ((t = Math.sqrt(f.ptSqrDist(this.$x, this.$y, this.$hrx, this.$hry))),
                              f.isEqualEps(t, 0, y.defaultEps) ||
                                  ((e = Math.sqrt(f.ptSqrDist(this.$x, this.$y, this.$hlx, this.$hly))),
                            ...
                            : ((t = Math.sqrt(f.ptSqrDist(this.$x, this.$y, this.$hlx, this.$hly))),
                              f.isEqualEps(t, 0, y.defaultEps) ||
                                  ((e = Math.sqrt(f.ptSqrDist(this.$x, this.$y, this.$hrx, this.$hry))),
                ...
                (y.AnchorPoint.prototype._calculateMirrorPoint = function () {
                    if (this._leadHr && null != this.$hrx) {
                        ...
                        (f.isEqualEps(this.$hlx, e, y.defaultEps) && f.isEqualEps(this.$hly, t, y.defaultEps)) ||
                            this.setProperties(["hlx", "hly"], [e, t]);
                    } else if (!this._leadHr && null != this.$hlx) {
                        ((e = this.$x + (this.$x - this.$hlx)), (t = this.$y + (this.$y - this.$hly)));
                        (f.isEqualEps(this.$hrx, e, y.defaultEps) && f.isEqualEps(this.$hry, t, y.defaultEps)) ||
                        ...
                        if (this.$tp == y.AnchorPoint.Type.Symmetric || this.$tp == y.AnchorPoint.Type.Mirror) {
                            ...
                            if ((h && !l) || (h && this.$x == l.$x && this.$y == l.$y))
                                ...
                                if (null == (n = f.getCircumcircleCenter(l.$x, l.$y, this.$x, this.$y, h.$x, h.$y)))
                                    ...
                                    ((t = Math.sqrt(f.ptSqrDist(this.$x, this.$y, n.getX(), n.getY()))),
                                        (r = (this.$y - n.getY()) / t),
                                        (o = (n.getX() - this.$x) / t),
                                        (a = (l.$x + h.$x) / 2),
                                        (s = (l.$y + h.$y) / 2),
                                        f.segmentSide(this.$x, this.$y, a, s, l.$x, l.$y) !=
                                            f.segmentSide(this.$x, this.$y, a, s, this.$x - r, this.$y - o) && ((r = -r), (o = -o)));
                                    var g = f.ptDist(this.$x, this.$y, n.getX(), n.getY()),
                                        m = f.ptDist(this.$x, this.$y, l.$x, l.$y) / g,
                                        _ = 2 * Math.asin(m / 2);
                                    ((i =
                                        (((Math.sqrt(f.ptSqrDist(this.$x, this.$y, l.$x, l.$y)) / m) * _) / f.PIHALF) *
                                        ...
                                        (_ = 2 * Math.asin(m / 2)),
                                        (i =
                                            (((Math.sqrt(f.ptSqrDist(this.$x, this.$y, h.$x, h.$y)) / m) * _) / f.PIHALF) *
                                            y.AnchorPoint.BEST_CIRCLE_COEFF),
                                        (u = this.$x + r * i),
                                        (d = this.$y + o * i));
                                }
                            ...
                            if (l && (l.$x != this.$x || l.$y != this.$y))
                                if (l.$tp == y.AnchorPoint.Type.Symmetric || l.$tp == y.AnchorPoint.Type.Mirror) {
                                    ...
                                    (f.isEqualEps(this.$hlx, c, y.defaultEps) && f.isEqualEps(this.$hly, p, y.defaultEps)) ||
                            ...
                            if (h && (h.$x != this.$x || h.$y != this.$y))
                                if (h.$tp == y.AnchorPoint.Type.Symmetric || h.$tp == y.AnchorPoint.Type.Mirror) {
                                    ...
                                    (f.isEqualEps(this.$hrx, u, y.defaultEps) && f.isEqualEps(this.$hry, d, y.defaultEps)) ||
                ...
                (y.AnchorPoints.prototype.serialize = function (e) {
                    ...
                    if (((t = this._multiReferenceId ? ["&", this._multiReferenceId] : []), this._sketchPath && t.push(3735932941), i))
                        for (var n = this.getFirstChild(); null !== n; n = n.getNext()) t.push(n._getTransformedCopy(i).serialize());
                    else for (n = this.getFirstChild(); null !== n; n = n.getNext()) t.push(n.serialize());
                    return t;
                }),
                ...
                (y.AnchorPoints.prototype._invalidateLeft = function (e) {
                    if (
                        e &&
                        ((e.$ah || e.$tp == y.AnchorPoint.Type.Connector) && e._invalidateCalculations(),
                        e.$tp == y.AnchorPoint.Type.Symmetric || e.$tp == y.AnchorPoint.Type.Mirror)
                    ) {
                ...
                (y.AnchorPoints.prototype._getPathStartPt = function (e) {
                    ...
                    return (
                        e && ((t = t._getTransformedCopy(e)), (n = n._getTransformedCopy(e)), (i = i._getTransformedCopy(e))),
                        t.$cl &&
                        t.$cr &&
                        ...
                        i &&
                        (i.$tp != y.AnchorPoint.Type.Connector || i.$x != t.$x || i.$y != t.$y)
                ...
                (y.AnchorPoints.prototype._getShoulderPoint = function (e, t, i, n, r, o) {
                    var a,
                        s,
                        l = f.ptDist(e, t, n, r),
                        h = (s = null == i || i <= 0 ? 0 : i) + (null == o || o <= 0 ? 0 : o);
                ...
                (y.AnchorPoints.prototype._getRightShoulderPoint = function (e, t, i, n) {
                    ...
                    } else r = this._getShoulderPoint(e.$x, e.$y, e.$cr, t.$x, t.$y, t.$cl);
                    return r;
                }),
                (y.AnchorPoints.prototype._getLeftShoulderPoint = function (e, t, i, n) {
                    ...
                    } else r = this._getShoulderPoint(e.$x, e.$y, e.$cl, t.$x, t.$y, t.$cr);
                    return r;
                }),
                (y.AnchorPoints.prototype._addMiddleVertices = function (e, t, i, n, r) {
                    ...
                    (null != t.$hlx && null != t.$hly && null != i.$hrx && null != i.$hry
                        ...
                        t.$cr
                            ? (null == h
                                  ? ((o = this._getShoulderPoint(t.$x, t.$y, t.$cl, i.$x, i.$y, i.$cr)),
                                    e.addVertex(p.Command.Line, o.getX(), o.getY()))
                                  : null == s
                                    ? ((o = f.getPointAtLength(t.$x, t.$y, h, A, t.$cl, this._sketchPath)),
                                      e.addVertex(p.Command.Curve, o.getX(), o.getY()),
                                      e.addVertex(p.Command.Curve, h, A))
                                    : ((o = f.getPointAtLength(t.$x, t.$y, s, l, t.$cl, this._sketchPath)),
                              ...
                              this._addCornerToVertices(e, o.getX(), o.getY(), a.getX(), a.getY(), t.$x, t.$y, t.$tp))
                            : null == h
                              ? e.addVertex(p.Command.Line, t.$x, t.$y)
                              : null == s
                                ? (e.addVertex(p.Command.Curve, t.$x, t.$y), e.addVertex(p.Command.Curve, h, A))
                    ...
                    t != n || i != r
                        ? (t == o && i == a) || (n == o && r == a)
                            ...
                            : s == y.CornerType.Rounded || s == y.CornerType.InverseRounded
                              ? (t == n && t == o) || (i == r && i == a)
                                  ? (e.addVertex(p.Command.Curve, n, r), e.addVertex(p.Command.Curve, o, a))
                                  : (s == y.CornerType.Rounded ? ((m = o), (_ = a)) : ((m = t + n - o), (_ = i + r - a)),
                                ...
                                : s == y.CornerType.Bevel
                                  ...
                                  : s == y.CornerType.Inset
                                    ? ((g = t + n - o),
                                      ...
                                      e.addVertex(p.Command.Line, n, r))
                                    : (e.addVertex(p.Command.Line, o, a), e.addVertex(p.Command.Line, n, r))
                        : (o == t && a == i) || (e.addVertex(p.Command.Line, o, a), e.addVertex(p.Command.Line, n, r));
                }),
                (y.AnchorPoints.prototype._addPathEndVertices = function (e, t) {
                    ...
                    (t && ((r = r._getTransformedCopy(t)), (o = o._getTransformedCopy(t))),
                        null != r.$hlx && null != r.$hly && null != o.$hrx && null != o.$hry
                            ...
                            : (null != r.$hlx && null != r.$hly) || (null != o.$hrx && null != o.$hry)
                              ? (null != r.$hlx && null != r.$hly ? ((i = r.$hlx), (n = r.$hly)) : ((i = o.$hrx), (n = o.$hry)),
                        ...
                        e == r._Change.BeforeChildInsert
                            ...
                            : e == r._Change.AfterChildInsert
                              ? ((n = this.getPreviousPoint(l)) &&
                                    ...
                                    (f.isEqualEps(l.$x - a, 0, y.defaultEps) && f.isEqualEps(l.$y - s, 0, y.defaultEps)) ||
                                ...
                                (l.$ah || l.$tp == y.AnchorPoint.Type.Connector) && l._invalidateCalculations(),
                ...
                (y.prototype.getSubnodeIds = function (e) {
                    (l.prototype.getSubnodeIds.call(this, e),
                        this._anchorPoints &&
                            (e[this._anchorPoints.getMultireferenceId()] && this._anchorPoints.resetMultireference(),
                            (e[this._anchorPoints.getMultireferenceId()] = this._anchorPoints),
                ...
                (y.prototype._handleVisualChangeForProperties = function (e, t, i) {
                    (e == r._Change.AfterPropertiesChange &&
                        ...
                        ((this._collidesWithChildrenSeparate = void 0), (this._collidesWithChildren = void 0)),
                ...
                (y.prototype._handleChange = function (e, t) {
                    if ((this._handleVisualChangeForProperties(e, t, y.VisualProperties), e === r._Change.Store)) {
                        ...
                        e === r._Change.ParentAttached || e === r._Change.ParentDetach
                            ? this._anchorPoints &&
                              ...
                              e === r._Change.ParentAttached && this._anchorPoints._attachToParent(this))
                            : (e !== r._Change.WorkspaceAttached && e !== r._Change.WorkspaceDetach) ||
                              (this._anchorPoints &&
                    ...
                    (l.prototype._handleChange.call(this, e, t),
                        e !== g._Change.FinishGeometryUpdate || (this.isRecordedTransaction() && !this.isRestoring())
                ...
                (y.prototype._referenceEvent = function (e) {
                    if (e.target === this) {
                        ...
                        if ("text" === r.getName(e.reference)) {
                            ...
                            if (!(e.reference instanceof y.AnchorPoint && "connector" === r.getName(e.reference.getPath()))) return;
                        ...
                        var t = null,
                            ...
                            p = function () {
                                ...
                                return null !== n && null !== r
                                    ? ((s = new c(n, r)), (l = "l"), s)
                                    : ((s = new c(a.getProperty("x"), a.getProperty("y"))), (l = "a"), s);
                            }.bind(this);
                        s;

                    )
                        (i ? ((t = i), (i = n), (n = s)) : ((t = s), (i = s = p()), (n = s = p())),
                ...
                (y.prototype.transferStyledCorners = function (e) {
                    for (
                        var t = this.getAnchorPoints(), i = e.getAnchorPoints().getFirstChild(), n = t.getFirstChild();
                        i && n;
