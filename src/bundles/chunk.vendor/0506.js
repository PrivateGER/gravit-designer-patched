module.exports = function (e, t, i) {
            ...
            (n.inheritAndMix("annlst", c, r, [n.Container, n.Properties, n.Store]),
                ...
                (c.prototype.appendAnnotation = function (e, t, i, n, r) {
                    for (var a = -1, s = this.getFirstChild(); null !== s; s = s.getNext()) a = Math.max(a, s.getProperty("seq") || 0);
                    (e.setProperties(
                ...
                (c.prototype.paint = function (e) {
                    if (this.isPaintable(e)) for (var t = this.getFirstChild(); null !== t; t = t.getNext()) t instanceof a && t.paint(e);
                }),
                ...
                (c.prototype._calculatePreTransformRect = function (e) {
                    ...
                    if (e && e.invertible()) {
                        ...
                        (t = this.getGeometryBBox())
                            ? ((i = e.inverted().mapQuadrilateral(t)), (t = s.fromPoints.apply(null, i)))
                            : (t = null);
                ...
                (c.prototype.getPreTransformRect = function (e) {
                    return (
                        (null != this._preTransformRect && h.equals(e, this._preTransformRectTrf)) ||
                ...
                (c.prototype._handleChange = function (e, t) {
                    if (e === n._Change.PrepareRestore) this.restored = !0;
                        ...
                        this.storeProperties(
                            ...
                            c.MetaProperties,
                            function (e, i) {
                                return "pgid" !== e || (t.options && (!t.options || t.options.copy))
                                    ? ("Guid" === e || "sid" === e || "aid" === e || "pgid" === e) && t.options && t.options.copy
                                        ? null
                                        : i
                                    : this.getParent()
                    ...
                    else if (e === n._Change.Restore) this.restoreProperties(t.blob, c.MetaProperties);
                    else if (e === a._Change.InvalidationRequest) this.isPaintable() && this._requestInvalidation();
                        ...
                        (this._canEventBeSent(a.GeometryChangeEvent) &&
                            this._sendEvent(new a.GeometryChangeEvent(this, a.GeometryChangeEvent.Type.Before)),
                            (this._savedGeometryBBox = this.getGeometryBBox()),
                            (this._savedPaintBBox = (this.isPaintable() && this.getPaintBBox()) || null));
                        ...
                        (this.getParent() &&
                            (0 === o
                                ? this.getParent()._notifyChange(a._Change.ChildGeometryUpdate, [this, A, i])
                                : A && 1 === o && this.getParent()._notifyChange(a._Change.ChildVisualUpdate, [this])),
                            this._canEventBeSent(a.GeometryChangeEvent) &&
                                this._sendEvent(new a.GeometryChangeEvent(this, a.GeometryChangeEvent.Type.After)),
                            this.isPaintable() && !l && (A && this._invalidateOldPaintBBox(), this._requestInvalidation()),
                        ...
                        (this._invalidateGeometryForChildUpdate(t[1]),
                            this._canEventBeSent(a.GeometryChangeEvent) &&
                                this._sendEvent(new a.GeometryChangeEvent(this, a.GeometryChangeEvent.Type.Child)),
                        ...
                        t instanceof a &&
                            (this._notifyChange(a._Change.ChildGeometryUpdate, [t, 1]), t._handleChange(a._Change.InvalidationRequest));
                    else if (e == n._Change.BeforeChildRemove) t instanceof a && this._requestInvalidateNode(t);
                    else if (e == n._Change.AfterChildRemove) t instanceof a && this._notifyChange(a._Change.ChildGeometryUpdate, [t, 1]);
