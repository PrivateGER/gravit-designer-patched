            ...
            (n.inherit(y, p),
                    ...
                    if (e.id === y.SHOULDER_PART_ID) {
                        ...
                        if (w) {
                            var E = _.inverted().mapPoint(i),
                                ...
                                Q = g.getPointAtLength(b.getX(), b.getY(), w.limLPos.getX(), w.limLPos.getY(), k),
                                M = g.getPointAtLength(b.getX(), b.getY(), w.limRPos.getX(), w.limRPos.getY(), G),
                                N = n.mapPoint(Q),
                                U = n.mapPoint(M),
                                V = c ? c.mapPoint(m) : m,
                            ...
                            (o
                                ...
                                : this.getPaintElement().getProperty(Y + "_uf") &&
                                  (null !== L && null !== O ? (L > O ? (O = L) : (L = O)) : null !== L ? (O = L) : (L = O)),
                                this.getPaintElement().setProperties([Y + "_sx", Y + "_sy"], [O, L]),
                                ...
                                if (
                                    ...
                                    (this._processCornerVisualization(
                                        ...
                                        function (e, i, n, r, o, a) {
                                            var s = r.mapPoint(n);
                                            (this._element.getProperty("uf") && !this.isPartSelected(l)) ||
                                                (t.canvas.strokeLine(
                                                    o.getX(),
                                                    o.getY(),
                                                    s.getX(),
                                            ...
                                            (A.inverted && (c = A.hasOwnProperty("selectable") ? A.inverted : !c),
                                                f.paintAnnotation(
                                                    t,
                                                    null,
                                                    s,
                ...
                (y.prototype._getShoulderLimits = function (e, t, i, n, r) {
                    var o = null,
                        ...
                        u = h.annotationHandles.rectangle.margin + h.annotationHandles.rectangle.size;
                    c > u &&
                        p > u &&
                        (o = {
                            limLPos: l,
                ...
                (y.prototype._processCornerVisualization = function (e, t, i, n) {
                    ...
                    if (f) {
                        ...
                        var _,
                            ...
                            E = g.getPointAtLength(p.getX(), p.getY(), f.limLPos.getX(), f.limLPos.getY(), C),
                            B = g.getPointAtLength(p.getX(), p.getY(), f.limRPos.getX(), f.limRPos.getY(), w),
                            x = c.inverted(),
                            P = x.mapPoint(E),
                            S = x.mapPoint(B);
                        switch (i) {
