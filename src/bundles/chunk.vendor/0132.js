module.exports = function (e, t, i) {
            ...
            ((o.parseLength = function (e, t) {
                ...
                return (
                    a &&
                        a.length > 0 &&
                        ((a = a.trim().toLowerCase()).length >= 2 && "p" == a.charAt(0) && "t" == a.charAt(1)
                            ? (r = o.Unit.PT)
                              ...
                              : a.length >= 2 && "p" == a.charAt(0) && "c" == a.charAt(1)
                                ...
                                : a.length >= 2 && "i" == a.charAt(0) && "n" == a.charAt(1)
                                  ...
                                  : a.length >= 2 && "m" == a.charAt(0) && "m" == a.charAt(1)
                                    ? (r = o.Unit.MM)
                                    : a.length >= 2 && "c" == a.charAt(0) && "m" == a.charAt(1)
                                      ? (r = o.Unit.CM)
                                      : a.length >= 1 && "m" == a.charAt(0) && (r = o.Unit.M)),
                    new o(i, r)
                );
            }),
            ...
            ((s.Lexer = function () {
                        ...
                        if (
                            ...
                            void 0 !==
                                (e = (function () {
                                    var e, n;
                                    if (A((e = o())) || "." === e) {
                                        if (((n = ""), "." !== e)) for (n = a(); A((e = o())); ) n += a();
                                        if ("." === e || "," === e) for (n += a(); A((e = o())); ) n += a();
                                        if ("e" === e || "E" === e) {
                                            if (((n += a()), "+" !== (e = o()) && "-" !== e && !A(e)))
                                                throw (
                                                    (e = "character " + e),
                                                    i >= t && (e = "<end>"),
                                                    new SyntaxError("Unexpected " + e + " after the exponent sign")
                                                );
                                            for (n += a(); A((e = o())); ) n += a();
                                        }
                                        if (h(e)) for (n += a(); h((e = o())); ) n += a();
                                        if ("." === n) throw new SyntaxError("Expecting decimal digits after the dot sign");
                                        return c(r.Number, n);
                                    }
                                })()))
                        )
                ...
                (s.Parser = function () {
                    ...
                    function n(t) {
                        var n = [];
                        if (!i(e.next(), "(")) throw new SyntaxError('Expecting ( in a function call "' + t + '"');
                        if (
                            (i(e.peek(), ")") ||
                                (n = (function () {
                                    for (var t, n = []; void 0 !== (t = l()) && (n.push(t), i(e.peek(), ",")); ) e.next();
                                    return n;
                                })()),
                            !i(e.next(), ")"))
                        )
                    ...
                    function r() {
                        ...
                        return i((o = e.peek()), "-") || i(o, "+")
                            ...
                            : (function () {
                                  var r, o;
                                  if (void 0 === (r = e.peek())) throw new SyntaxError("Unexpected termination of expression");
                                  ...
                                  if (i(r, "(")) {
                                      if ((e.next(), (o = a()), !i((r = e.next()), ")"))) throw new SyntaxError("Expecting )");
                                      return {
                                          Expression: o,
                                      };
                                  }
                    ...
                    return {
                        parse: function (t) {
                            var i, n;
                            if ((e.reset(t), (i = l()), void 0 !== (n = e.next()))) throw new SyntaxError("Unexpected token " + n.value);
                            return {
                                Expression: i,
                            };
                        },
                ...
                (s.Evaluator = function (e) {
                    ...
                    function n(t) {
                        ...
                        if (t.hasOwnProperty("Identifier")) {
                            if (i.Constants.hasOwnProperty(t.Identifier)) return i.Constants[t.Identifier];
                            if (i.Variables.hasOwnProperty(t.Identifier)) return i.Variables[t.Identifier];
                        ...
                        if (t.hasOwnProperty("FunctionCall")) {
                            if (((s = t.FunctionCall), i.Functions.hasOwnProperty(s.name))) {
                                for (l = [], h = 0; h < s.args.length; h += 1) l.push(n(s.args[h]));
