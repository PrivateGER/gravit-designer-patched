module.exports = function (module, exports, require) {
            ...
            function a(e, t) {
                ((this._fontManager = t),
                    this._fontManager.addEventListener(r.FontAvailableEvent, this._fontEvent, this),
                    this._fontManager.addEventListener(r.FontUnavailableEvent, this._fontEvent, this),
                    (this._fontCallback = {}),
                    (this._missingFonts = []),
                ...
                (a.prototype.ready = function () {
                    return (
                        this._unresolvedFonts.length <= this._resolvedFonts.length &&
                            ...
                            (this._fontManager &&
                                (this._fontManager.removeEventListener(r.FontAvailableEvent, this._fontEvent, this),
                                this._fontManager.removeEventListener(r.FontUnavailableEvent, this._fontEvent, this)),
