            ...
            (r.inherit(b, s),
                    ...
                    if (e || null === e) {
                        ...
                        if (
                            (this._transformBox &&
                                ...
                                this.requestInvalidation()),
                            (r = this._getGraphicEditor().getSelectionEditor()) && r.hasFlag(u.Flag.HideEditor))
                        )
                ...
                (b.prototype.updateTBoxUnderMouse = function (e, t, i) {
                        ...
                        ? ((n = new u.PartInfo(this._tBoxData.editor, this._tBoxData.id, this._tBoxData.data)),
                          o.isRotating(n.id) &&
                              (n.data.rotationSegment = a
                                  ? this._transformBox.getRotationSegment(e, t.preMultiplied(new g(1, 0, 0, 1, a.getX(), a.getY())))
                    ...
                    if (
                        ...
                        this._tBoxMode == b.TBoxMode.PASSIVE && this._mouseInfo.id == o.INSIDE)
                    ) {
                        h = t.mapRect(c);
                    ...
                    return (
                        ...
                        (this._visualsArea || d) && (this.requestInvalidation(), (this._visualsArea = d), this.requestInvalidation()),
                        {
                            newPInfo: s,
                ...
                (b.prototype.startTBoxTransform = function (e) {
                    e &&
                        (this._visualsArea && (this.requestInvalidation(), (this._visualsArea = null)),
                        ...
                        o.isSkewing(this._tBoxData.id)
                            ...
                            : o.isRotating(this._tBoxData.id)
                              ...
                              : this._tBoxData.id >= 0 && this._tBoxData.id < o.Handles.ROTATION_CENTER
                ...
                (b.prototype._updateSelectionTransformBox = function (e, t) {
                    ...
                    if (i && i.length) {
                        ...
                        (A && A.afterTBoxChange(this.getElement(), n, this._transformBox),
                            this.requestInvalidation(),
                            this._transformBox ? this._updateTBoxMode(b.TBoxMode.PASSIVE) : this._updateTBoxMode(b.TBoxMode.NA),
                            (this._tBoxData = null),
                            (this._mouseInfo = null),
