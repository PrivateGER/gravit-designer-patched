            ...
            (IsFiniteNonNegativeNumber.inherit(te, w),
                    ...
                    if (this.hasSelection()) {
                        for (var t = null, i = 0; i < this._selection.length; ++i) {
                            ...
                            n &&
                                ...
                                (t = t ? t.united(n) : new P(n.getX(), n.getY(), n.getWidth(), n.getHeight()));
                        }
                        return t;
                    }
                    return null;
                                ...
                                h &&
                                    (h.hasSelectionEditing()
                                        ...
                                        : h instanceof o ||
                                          h instanceof a ||
                                          h instanceof s ||
                                          (e ? h.removeFlag(r.Flag.ResizeAll) : h.setFlag(r.Flag.ResizeAll)));
                            }
                    }
                }),
                ...
                (te.prototype.keysOn = function (e) {
                    if (e && e.length && this._keysOff && this._keysOff.length) {
                        for (var t = 0; t < e.length; ++t)
                            for (var i = this._keysOff.length - 1; i >= 0; --i) this._keysOff[i] == e[t] && this._keysOff.splice(i, 1);
                ...
                (te.prototype.getMappingScopes = function (e) {
                    ...
                    else (r = (r = this._scene.querySingle("layer:active")) || this._scene.getActivePage()) && i.push(r);
                    return i;
                }),
                (te.prototype.release = function () {
                    ((te.MODIFIED_EVENT.sender = null),
                        ...
                        this._scene.removeEventListener(n.AfterInsertEvent, this._afterNodeInsert, this),
                        this._scene.removeEventListener(n.BeforeRemoveEvent, this._beforeNodeRemove, this),
                        this._scene.removeEventListener(n.BeforeFlagChangeEvent, this._beforeFlagChange, this),
                        this._scene.removeEventListener(n.AfterFlagChangeEvent, this._afterFlagChange, this),
                        this._scene.removeEventListener(S.GeometryChangeEvent, this._geometryChange, this));
                }),
                ...
                (te.prototype.getAnnotationsExceptions = function (e) {
                    ...
                    function n(e) {
                        if (e.getProperty("uid") === t)
                            for (var n = e.getFirstChild(); null !== n; n = n.getNext()) n instanceof c && i.push(n);
                        else i.push(e);
                    }
                        ...
                        try {
                            for (var i = n.order(t, true), r = 0; r < i.length; ++r) {
                                ...
                                if (o instanceof Y && a && !this._selectionDetail)
                                    ...
                                    var s = G.getEditor(o);
                                    if (a && o instanceof Y && !s.isDeletePartsAllowed()) continue;
                                    for (
                                        a = o.getParent(),
                                            (s = G.getEditor(o)) && s.isDeletePartsAllowed() && !s.isRemovalBlocked()
                                                ? s.deletePartsSelected()
                                                : s && !s.isRemovalBlocked() && a && (o.removeFlag(n.Flag.Selected), a.removeChild(o));
                                ...
                                } else o instanceof h && !o.hasFlag(S.Flag.PartialLocked) && this._scene.deleteActiveLayer(o);
                            }
                        } finally {
                        ...
                        if (!r)
                            if (s && s.length)
                                if ((this._selection || (this._selection = []), e)) {
                                    for (l = 0; l < s.length; ++l) this._selection.indexOf(s[l]) < 0 && this._tryAddToSelection(s[l]);
                    ...
                    if (t) {
                        ...
                        if (
                            ...
                            (this._guides.beginMap(d),
                                (y = this._guides.mapPoint(y, i ? o.DetailMap.Mode.DetailOnFilterOn : o.DetailMap.Mode.FilterOff, g)),
                        ...
                        if (this._selEditor) this._selEditor.resize(e, t, n);
                            ...
                            if (
                                !(r = r.filter(function (e) {
                                    return (
                                        !(e instanceof Y) || (e instanceof Y && 0 == (e.getProperty("plkt") & Y.ProgramLck.NoSizeChanges))
                                    );
                                })).length
                            )
                                return;
                                            ...
                                            (e
                                                ? g.hasMixin(n.Store)
                                                    ? (f = g.clone({
                                                      ...
                                                      p.push(f),
                                                      (u = u.concat(this.getLinkedElementsInSelection(f, p))),
                                                      A.push(g))
                                                    : (f = null)
                                                : g.hasFlag(S.Flag.PartialLocked) && (f = null)),
                                            f ? d.applyTransform(i ? g : f, r, e ? u : h) : d.resetTransform());
                                    }
                                }
                ...
                (te.prototype.insertElements = function (e, t, i, r, o, a, s) {
                    ...
                    if (!l || !l.isLocked()) {
                        ...
                        if (c.length) {
                            ...
                            if (l) if (l.getProperty("plkt") & Y.ProgramLck.NoNewChildren) return;
                            if (a instanceof Y) if (a.getProperty("plkt") & Y.ProgramLck.NoNewChildren) return;
                        }
                        var p = s || null,
                            u = null,
                            d = null,
                ...
                (te.prototype.convertSelectionToPaths = function (e) {
                    ...
                    if (this._selection && this._selection.length)
                        for (var r = 0; r < this._selection.length; ++r) {
                            ...
                            (o instanceof R && !(o instanceof g)) || !(!o.hasMixin(s) || o instanceof y || o instanceof T)
                                ? t.push(o)
                                : i.push(o);
                        }
                    if (t.length) {
                        ...
                        try {
                            ...
                            for (r = 0; r < t.length; ++r) {
                                ...
                                if (a instanceof R) {
                                    ...
                                    (A = new g(a.getProperty("closed"), a.getProperty("evenodd"), c)) &&
                                        (A.assignFrom(a), (a = null), l.insertChild(A, h), i.push(A));
                                } else if (a instanceof B) {
                                    var p = a.getTextShapes();
                                    if ((l.removeChild(a), p))
                                        for (var d = p.length - 1; d >= 0; d--) (l.insertChild(p[d], h), i.push(p[d]));
                    ...
                    if (this._selection && this._selection.length) {
                        ...
                        if (i.length > 1) {
                            ...
                            for (r = 0; r < i.length; ++r) {
                                var l;
                                if ((l = i[r]) instanceof g) (l.getParent().removeChild(l), e.getPaths().appendChild(l.clone()));
                                else {
                            ...
                            switch (e) {
                                ...
                                case te.ArrangeOrderType.SendBackward:
                                    ...
                                    if (null !== c) {
                                        for (var p = null; !p && c; )
                                            (c instanceof S &&
                                                (c.hasFlag(n.Flag.Selected) || (te.validateBlockInsertion(s, a, c) && (p = c))),
                                                (c = c.getPrevious()));
                ...
                (te.prototype.arrangeAlign = function (e, t, i, n, r, o) {
                    ...
                    if (!n) for (h = 0; h < t.length; ++h) n = n ? n.united(t[h].bbox) : t[h].bbox;
                    ...
                    try {
                        for (h = 0; h < t.length; ++h) {
                            var c = i ? s : t[h].bbox,
                                p = t[h].element,
                                u = G.getEditor(p),
                                d = p.getParent() && A && u && !u.isAlignPartsAllowed() && !o ? p.getParent().getGeometryBBox() : l || n;
                            if (!d || d.getWidth() + d.getHeight() === 0 || p.hasFlag(S.Flag.FullLocked)) return;
                            switch (e) {
                ...
                (te.prototype.updateByMousePosition = function (e, t, r, o) {
                    ...
                    if (o.multiPageView) {
                        ...
                        if (s && !s.isEmpty()) {
                            ...
                            var y = a.retrieveChildrenInPaintBBox(g, ee.RETRIEVE_MODE_INTERSECT),
                                _ = y.indexOf(A);
                            (_ >= 0 && y.splice(_, 1),
                                y.sort(function (e, t) {
                ...
                (te.prototype.exportStates = function () {
                    ...
                    var e = function (t) {
                            ...
                            if ("object" != typeof t) {
                                if ("function" == typeof t || t instanceof Date) throw new Error("error serializing");
                                return t;
                            }
                            if (t) {
                ...
                (te.prototype.commitTransaction = function (e, t) {
                    ...
                    var i = null,
                        n = this._scene.getWorkspace() ? this._scene.getWorkspace().getTransactionRecorder() : null;
                    ...
                    if ((i || (i = r.actions ? r.actions.slice() : null), i && i.length > 0)) {
                        ...
                        (t && (o.relatedData = t),
                            ...
                            this.pushState(e, this._transactionRedo.bind(this), this._transactionUndo.bind(this), o));
                    }
                }),
                (te.prototype.pushState = function (e, t, i, n) {
                    (this._undoStates.length >= m.maxUndoSteps && this._undoStates.shift(),
                        ...
                        this.hasEventListeners(te.ModifiedEvent) &&
                            (n.relatedData
                                ? this.trigger(new te.ModifiedEvent(n.relatedData, te.ModifiedEvent.Type.Raw))
                ...
                (te.prototype.undoState = function () {
                    if (this._undoStates.length > 0) {
                        ...
                        (this._redoStates.push(e),
                            this._scene.trigger(new V.RecordedTransactionStartedEvent(this._scene)),
                            e.revert(e.data),
                            this._scene.trigger(new V.RecordedTransactionFinishedEvent(this._scene)),
                            this.hasEventListeners(te.ModifiedEvent) &&
                                (e.data.relatedData
                                    ? this.trigger(new te.ModifiedEvent(e.data.relatedData, te.ModifiedEvent.Type.Undo))
                                    : this.trigger(te.MODIFIED_EVENT)));
                    }
                }),
                (te.prototype.redoState = function () {
                    if (this._redoStates.length > 0) {
                        ...
                        (this._undoStates.push(e),
                            ...
                            this.hasEventListeners(te.ModifiedEvent) &&
                                (e.data.relatedData
                                    ? this.trigger(new te.ModifiedEvent(e.data.relatedData, te.ModifiedEvent.Type.Redo))
                                    : this.trigger(te.MODIFIED_EVENT)));
                    }
                }),
                        ...
                        if (
                            ...
                            r &&
                                (this.hasEventListeners(te.InlineEditorEvent) &&
                                    this.trigger(new te.InlineEditorEvent(r, te.InlineEditorEvent.Type.TryOpen)),
                                r.canInlineEdit()))
                        )
                            return (
                                this.hasEventListeners(te.InlineEditorEvent) &&
                                    this.trigger(new te.InlineEditorEvent(r, te.InlineEditorEvent.Type.BeforeOpen)),
                                r.beginInlineEdit(t),
                ...
                (te.prototype._updatedSelection = function () {
                    if (0 === this._selectionUpdateCounter) {
                        ((this._lastCloneSelection = null),
                            this.hasEventListeners(te.SelectionChangedEvent) && this.trigger(te.SELECTION_CHANGED_EVENT));
                ...
                (te.prototype._finishEditorInlineEdit = function (e) {
                    ...
                    if (t && t.isInlineEdit()) {
                        this.hasEventListeners(te.InlineEditorEvent) &&
                            this.trigger(new te.InlineEditorEvent(t, te.InlineEditorEvent.Type.BeforeClose));
                        var i = null;
                ...
                (te.prototype.blinkSelection = function (e, t) {
                    if (this._selection && this._selection.length) {
                        var i = this._selection.slice(),
                            ...
                            o = function () {
                                for (var e = 0; e < i.length; ++e) i[e].setFlag(n.Flag.Highlighted);
                            },
                            a = e / t;
                        o();
