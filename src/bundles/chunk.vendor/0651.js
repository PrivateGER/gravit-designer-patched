module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(A, o),
                ...
                (A.PolySegment = function (e, t, i, n, r) {
                    ((this.point = e),
                        (this.isCap = !!r),
                        !t || !i || !n || n < 0 ? (this.bulge = 0) : ((this.bulge = t), (this.center = i), (this.radius = n)));
                }),
                ...
                (A.PolySegmentContainer.prototype.insertSegment = function (e, t) {
                    return (
                        ...
                        this.head
                            ? t
                                ? (this.head == t ? (this.head = e) : ((e.previous = t.previous), (t.previous.next = e)),
                                  (e.next = t),
                                  (t.previous = e))
                ...
                (A.PolySegmentContainer.prototype.prependContainer = function (e) {
                    (this.head
                        ? ((e.end.next = this.head), (this.head.previous = e.end), (this.head = e.head))
                        : ((this.head = e.head), (this.end = e.end)),
                        (this.count += e.count));
                }),
                (A.PolySegmentContainer.prototype.appendContainer = function (e) {
                    (this.head
                        ? ((this.end.next = e.head), (e.head.previous = this.end), (this.end = e.end))
                        : ((this.head = e.head), (this.end = e.end)),
                        (this.count += e.count));
                }),
                ...
                (A.prototype.rewindVertices = function (e) {
                    return (
                        0 == e && ((this._pieces = null), (this._pieceIdx = 0), (this._startVertex = null), this._source.rewindVertices(0))
                    );
                }),
                (A.prototype.readVertex = function (e) {
                    if (this._pieces && this._pieces.length && this._readVertex(e)) return true;
                    ...
                    for (;;) {
                        ...
                        if (this._polyline.count) {
                            ...
                            if (this._pieces.length) {
                                ...
                                this._pieceIdx = 0;
                                if (this._readVertex(e)) return true;
                            }
                        }
                        if (null == this._startVertex) return false;
                    }
                }),
                    ...
                    if (this._isQudraticCurveFlat(e, t, i, n)) {
                        ...
                        if (h.isEqualEps(l, 0, a) || h.isEqualEps(c, 0, a)) {
                            ...
                            if (h.isEqualEps(p, 0, a)) {
                                ...
                                return (
                                    this._polyline.insertSegment(s),
                                    (s = new A.PolySegment(new r((e.getX() + t.getX()) / 2, (e.getY() + t.getY()) / 2), 0)),
                                    void this._polyline.insertSegment(s)
                                );
                            }
                            var u = new r((t.getX() - e.getX()) / l, (t.getY() - e.getY()) / l),
                                ...
                                m = new r(l * (d.getX() - u.getX() * f), l * (d.getY() - u.getY() * f)),
                                y = l * f - c,
                                _ = c * f - l,
                                v = new r(m.getX() + y * u.getX() + _ * d.getX(), m.getY() + y * u.getY() + _ * d.getY());
                            ((y = Math.sqrt(h.vDotProduct(m.getX(), m.getY(), m.getX(), m.getY()))),
                                (_ = Math.sqrt(h.vDotProduct(v.getX(), v.getY(), v.getX(), v.getY()))));
                            var b = function () {
                            ...
                            if (h.isEqualEps(y, 0, a) || h.isEqualEps(_, 0, a)) b();
                                ...
                                if (h.isEqualEps(I, 0, a) || h.isEqualEps(P, 0, a) || h.isEqualEps(S, 0, a) || h.isEqualEps(B, 0, a)) b();
                                else {
                                    var F = (B * x) / P + (S * T) / I,
                                        R = (-B * S) / (P * I * 2),
                                        D = [];
                                    ...
                                    if (null != D[0] && D[0] < 1 && D[0] > 0) k = D[0];
                                        ...
                                        if (!(null != D[1] && D[1] < 1 && D[1] > 0)) return void b();
                                        k = D[1];
                                    }
                                    var G = (k * p * I) / S,
                                        Q = (k * p * P) / B;
                                    if (h.isEqualEps(x, 1, a) || h.isEqualEps(T, 1, a)) b();
                                        ...
                                        var M = Math.sqrt((1 - x) / 2),
                                            ...
                                            O = Math.sqrt((1 + T) / 2),
                                            L = (Q * O) / V,
                                            Y = new r(e.getX() + U * C.getX(), e.getY() + U * C.getY()),
                                            X = new r(i.getX() + L * w.getX(), i.getY() + L * w.getY());
                                        ...
                                        if (
                                            ...
                                            var ee = new r(
                                                ...
                                                te = Math.abs(U - h.ptDist(ee.getX(), ee.getY(), Y.getX(), Y.getY()));
                                            K < te && ((K = te), ($ = D[0]));
                                        }
                                        if (null != D[1] && D[1] < H && D[1] > 0) {
                                            var ie = new r(
                                                ...
                                                ne = Math.abs(U - h.ptDist(ie.getX(), ie.getY(), Y.getX(), Y.getY()));
                                            K < ne && ((K = ne), ($ = D[1]));
                                        }
                                        if (
                                            ((D = []),
                                            h.getQuadraticRoots(y, -2 * z + j + J, z + J - L * l * q, D),
                                            ...
                                            var re = new r(
                                                ...
                                                oe = Math.abs(L - h.ptDist(re.getX(), re.getY(), X.getX(), X.getY()));
                                            K < oe && ((K = oe), ($ = D[0]));
                                        }
                                        if (null != D[1] && D[1] < 1 && D[1] > H) {
                                            var ae = new r(
                                                ...
                                                se = Math.abs(L - h.ptDist(ae.getX(), ae.getY(), X.getX(), X.getY()));
                                            K < se && ((K = se), ($ = D[1]));
                                        }
                                        if (K > n && o < A.MAX_RECURS) {
                                            ...
                                            (h.divideQuadraticCurve(e.getX(), t.getX(), i.getX(), $, le, Ae),
                                                h.divideQuadraticCurve(e.getY(), t.getY(), i.getY(), $, he, ce),
                                                this.addCurveToPolyline(e, new r(le[1], he[1]), new r(le[2], he[2]), n, o),
                                                this.addCurveToPolyline(new r(Ae[0], ce[0]), new r(Ae[1], ce[1]), i, n, o));
                                        } else {
                                            var pe = new r(e.getX() + G * (u.getX() + g.getX()), e.getY() + G * (u.getY() + g.getY())),
                                                ue = M / (N + 1);
                ...
                (A.prototype.addCubicCurveToPolyline = function (e, t, i, n, r) {
                    ...
                    for (
                        var s, l, A = [], c = h.getCubicCurveSplits(o, a, A), p = new Float64Array(4), u = new Float64Array(4), d = 0;
                        d < c - 1;
                        ++d
                    ) {
                        ((s = A[d]),
                ...
                (A.prototype._addCubicSegmToPolyline = function (e, t, i, n) {
                    ...
                    if (this._isCubicCurveFlat(e, t, i)) {
                        ...
                        if (u && d) {
                            ...
                            if (!d) return void this._polyline.insertSegment(new A.PolySegment(new r(o, a), 0));
                            p = new r(e[2], t[2]);
                        }
                        ...
                        if (h.isEqualEps(o, _) || h.isEqualEps(a, v) || h.isEqualEps(s, _) || h.isEqualEps(l, v)) {
                            ...
                            if (z > 0) {
                                var q = 0,
                                    K = 1;
                                ((X = h.evalPoly(V, 5, q)),
                                    h.isEqualEps(X, 0) && ((q += 0.005), (X = h.evalPoly(V, 5, q))),
                                    (H = h.evalPoly(V, 5, K)),
                                    h.isEqualEps(H, 0) && ((K -= 0.005), (H = h.evalPoly(V, 5, K))),
                                    z > 1 &&
                            ...
                            if (0 == z);
                                ...
                                for (var ne = 0; ne < ie.length; ++ne) {
                                    (null == ($ = h.locateByNewton(ie[ne][0], ie[ne][1], ie[ne][2], ie[ne][3], V, 5, O, L, 0.005, J)) &&
                                        ($ = (ie[ne][0] + ie[ne][1]) / 2),
                            ...
                            if (j > i && n < A.MAX_RECURS) {
                                ...
                                (h.getCtrlPtsCasteljau(e[0], e[1], e[2], e[3], 0.5, null, oe, se),
                                    h.getCtrlPtsCasteljau(t[0], t[1], t[2], t[3], 0.5, null, ae, le),
                ...
                (A.prototype.generatePolyLine = function (e, t) {
                    for (var i, n = null, o = t, s = o, l = new a(), c = true; c && this._source.readVertex(l); )
                        switch (l.command) {
                            ...
                            case a.Command.Line:
                                s
                                    ? ((i = new A.PolySegment(new r(s.x, s.y), 0)), this._polyline.insertSegment(i), (s = l), (l = new a()))
                                    : ((s = l), (l = new a()));
                                break;
                            ...
                            case a.Command.Curve2:
                                if (s) {
                                    ...
                                    this._source.readVertex(l) &&
                                        ...
                                        (this.addCubicCurveToPolyline(p, new r(l.x, l.y), new r(d.x, d.y), u, e), (l = new a()));
                                } else ((s = l), (l = new a()));
                                break;
                ...
                (A.prototype.generatePolyOffset = function (e, t, i, n) {
                    ...
                    (t && i) || this._polyline.closed || l
                        ? (y && y.length > 1 ? this._gcppFilter(y, this._polyline, e, 3 * n, this._polyoutset) : (this._polyoutset = y),
                          _ && _.length > 1 ? this._gcppFilter(_, this._polyline, e, 3 * n, this._polyinset) : (this._polyinset = _))
                ...
                (A.prototype.generateOffset = function (e, t, i) {
                    ...
                    (t && e && !this._polyline.closed
                        ? (this._genCurves(this._polyoutset, n, i), this._genCurves(this._polyinset, n, i))
                        : (t && this._genCurves(this._polyoutset, n, i), e && this._genCurves(this._polyinset, n, i)),
                            ...
                            if (
                                (t * e.bulge > 0
                                    ...
                                    : h.isEqualEps(e.radius, o, i) ||
                                      (e.radius > o ? (c = (l -= o) / e.radius) : ((l = o - e.radius), (c = o / e.radius))),
                                null != c)
                            ) {
                                var p = e.center.getX(),
                                    u = e.center.getY();
                                e.next
                                    ...
                                    : ((d = this._polyline.head.point.getX()), (g = this._polyline.head.point.getY()));
                ...
                (A.prototype._insersectOffsetSegments = function (e, t, i) {
                    if (0 == e.bulge && 0 == t.bulge) {
                        ...
                        if (0 == e.bulge) {
                            ...
                            if (
                                (h.circleLineIntersection(A, c, p, u, t.center.getX(), t.center.getY(), t.radius, n),
                                null != n[0] && ((a = A + p * n[0]), (s = c + u * n[0]), (l = n[0])),
                                null != n[0] && null != n[1])
                            ) {
                                var d = A + p * n[1],
                                    g = c + u * n[1],
                            ...
                            if (
                                (h.circleLineIntersection(A, c, p, u, e.center.getX(), e.center.getY(), e.radius, n),
                                null != n[0] && ((a = A + p * n[0]), (s = c + u * n[0]), (l = n[0])),
                                null != n[0] && null != n[1])
                            ) {
                    ...
                    if (o) {
                        ...
                        for (var a = new A.IntersectionResult(), s = 0; s < e.count - 1; ++s)
                            if (
                                ...
                                (o = o.next),
                                h.isEqualEps(r.point2.getX(), o.point.getX(), n) && h.isEqualEps(r.point2.getY(), o.point.getY(), n))
                            )
                                i.insertSegment(new A.PolySegment(o.point, o.bulge, o.center, o.radius, o.isCap));
                            else if ((a.clear(), this._insersectOffsetSegments(r, o, a), 0 == r.bulge && 0 == o.bulge))
                                a.point
                                    ? (a.intTypes[0].TIP && a.intTypes[1].TIP) ||
                                      (a.intTypes[0].FIP && a.intTypes[1].FIP && a.intTypes[0].PFIP)
                                        ? (i.insertSegment(new A.PolySegment(a.point, 0)).isCap = o.isCap)
                                ...
                                if (a.point)
                                    if (
                                        (a.intTypes[0].TIP && a.intTypes[1].TIP) ||
                                        (a.intTypes[0].TIP && a.intTypes[1].FIP && !a.intTypes[1].PFIP) ||
                        ...
                        if (this._polyline.closed)
                            if (
                                ((r = new A.PolyOffsetSegment(o.basepoint, i.end.point, o.point2, i.end.bulge, o.center, o.radius)),
                                (o = e.head),
                                h.isEqualEps(r.point2.getX(), o.point.getX(), n) && h.isEqualEps(r.point2.getY(), o.point.getY(), n))
                            )
                                ...
                                a.point
                                    ? (a.intTypes[0].TIP && a.intTypes[1].TIP) ||
                                      (a.intTypes[0].FIP && a.intTypes[1].FIP && a.intTypes[0].PFIP)
                                        ? (i.insertSegment(new A.PolySegment(a.point, 0)), (i.head.point = a.point))
                    ...
                    return (
                        ...
                        s
                            ? new A.PolySegment(
                                  ...
                                  s,
                                  t.basepoint,
                                  h.ptDist(e.point2.getX(), e.point2.getY(), t.basepoint.getX(), t.basepoint.getY())
                              )
                ...
                (A.prototype._calculateBulge = function (e, t, i, n, r, o, a) {
                    ...
                    if (h.isEqualEps(s, l, 1e-8)) {
                        ...
                        var u = Math.sqrt(s);
                        ((A = ((t - o) / u) * ((i - r) / u) - ((e - r) / u) * ((n - o) / u) < 0 ? -A : A),
                ...
                (A.prototype._calcIntersectionPoints = function (e, t, i, n) {
                    for (var r, o = e.head, a = 0; a < e.count - 1; ++a) {
                        r = t.head;
                        for (var s = 0; s < t.count - 1; ++s) (this._calcSegmIntersectionPoints(o, r, a, s, i, n), (r = r.next));
                        o = o.next;
                    }
                }),
                    ...
                    if (e.bulge || t.bulge)
                        if (!e.bulge && t.bulge) {
                            ...
                            if (
                                ...
                                null != y[0] && y[0] >= 0 && y[0] <= 1 && (!a || !h.isEqualEps(y[0], 1)))
                            ) {
                                ...
                                (((u = this._calculateBulge(
                                    ...
                                    u >= t.bulge) ||
                                    (u > 0 && u <= t.bulge)) &&
                                    (r.push(new A.IntersectionPt(c, p, y[0], e, i)), o.push(new A.IntersectionPt(c, p, u, t, n)));
                            }
                            if (null != y[1] && y[1] >= 0 && y[1] <= 1 && (!a || !h.isEqualEps(y[1], 1))) {
                                ...
                                (((u = this._calculateBulge(
                                    ...
                                    u >= t.bulge) ||
                                    (u > 0 && u <= t.bulge)) &&
                                    (r.push(new A.IntersectionPt(c, p, y[1], e, i)), o.push(new A.IntersectionPt(c, p, u, t, n)));
                            }
                        } else if (e.bulge && !t.bulge) {
                            ((y = [null, null]), (s = t.next.point.getX() - t.point.getX()), (l = t.next.point.getY() - t.point.getY()));
                            if (
                                (h.circleLineIntersection(
                                    t.point.getX(),
                                    t.point.getY(),
                                ...
                                null != y[0] && y[0] >= 0 && y[0] <= 1 && (!a || !h.isEqualEps(y[0], 0)))
                            ) {
                                ...
                                (((u = this._calculateBulge(
                                    ...
                                    u >= e.bulge) ||
                                    (u > 0 && u <= e.bulge)) &&
                                    (r.push(new A.IntersectionPt(c, p, u, e, i)), o.push(new A.IntersectionPt(c, p, y[0], t, n)));
                            }
                            if (null != y[1] && y[1] >= 0 && y[1] <= 1 && (!a || !h.isEqualEps(y[1], 0))) {
                                ...
                                (((u = this._calculateBulge(
                                    ...
                                    u >= e.bulge) ||
                                    (u > 0 && u <= e.bulge)) &&
                                    (r.push(new A.IntersectionPt(c, p, u, e, i)), o.push(new A.IntersectionPt(c, p, y[1], t, n)));
                            }
                        } else {
                            y = [null, null];
                            if (
                                ...
                                y[0] && (!a || (!h.isEqualEps(y[0].getX(), t.point.getX()) && !h.isEqualEps(y[0].getY(), t.point.getY()))))
                            ) {
                                ...
                                if ((d < 0 && d >= e.bulge) || (d > 0 && d <= e.bulge)) {
                                    ...
                                    ((g < 0 && g >= t.bulge) || (g > 0 && g <= t.bulge)) &&
                                        (r.push(new A.IntersectionPt(y[0].getX(), y[0].getY(), d, e, i)),
                                        o.push(new A.IntersectionPt(y[0].getX(), y[0].getY(), g, t, n)));
                                }
                            }
                            if (
                                y[1] &&
                                (!a || (!h.isEqualEps(y[1].getX(), t.point.getX()) && !h.isEqualEps(y[1].getY(), t.point.getY())))
                            ) {
                                ...
                                if ((f < 0 && f >= e.bulge) || (f > 0 && f <= e.bulge)) {
                                    ...
                                    ((m < 0 && m >= t.bulge) || (m > 0 && m <= t.bulge)) &&
                                        (r.push(new A.IntersectionPt(y[1].getX(), y[1].getY(), f, e, i)),
                                        o.push(new A.IntersectionPt(y[1].getX(), y[1].getY(), m, t, n)));
                                }
                            }
                        }
                    else if (!a) {
                ...
                (A.prototype._splitForClipping = function (e, t) {
                    for (var i, n, o = 1e-4, a = 0, s = e.head, l = s, c = [], p = 0; p < t.length; ++p) {
                        ...
                        (s.bulge
                            ? h.isEqualEps(t[p].x, s.point.getX(), o) && h.isEqualEps(t[p].y, s.point.getY(), o)
                                ? (c[p].insertSegment(new A.PolySegment(s.point, 0)).isCap = s.isCap)
                                : (s == l
                                      ? c[p].insertSegment(new A.PolySegment(s.point, t[p].slope, s.center, s.radius, s.isCap))
                                      : ((i = (t[p].slope - t[p - 1].slope) / (1 + t[p].slope * t[p - 1].slope)),
                                        c[p].insertSegment(new A.PolySegment(s.point, i, s.center, s.radius, s.isCap))),
                                  (c[p].insertSegment(new A.PolySegment(new r(t[p].x, t[p].y), 0)).isCap = n),
                                  (i = (l.bulge - t[p].slope) / (1 + l.bulge * t[p].slope)),
                                  (s = new A.PolySegment(new r(t[p].x, t[p].y), i, s.center, s.radius, s.isCap)))
                            : ((n = s.isCap),
                              (c[p].insertSegment(new A.PolySegment(s.point, 0)).isCap = n),
                              (h.isEqualEps(t[p].x, s.point.getX(), o) && h.isEqualEps(t[p].y, s.point.getY(), o)) ||
                                  ((s = new A.PolySegment(new r(t[p].x, t[p].y), 0)), (c[p].insertSegment(s).isCap = n))),
                            (a = u),
                            l.next &&
                ...
                (A.prototype._excludeCircleInside = function (e, t, i, n, o) {
                    for (
                        var a,
                            s = 0,
                            l = new A.PolySegment(e.head.point, e.head.bulge, e.head.center, e.head.radius, e.head.isCap),
                            c = e.head,
                            p = null,
                            u = 0;
                        u < t.length;
                        ...
                        if (l.bulge) {
                            m = [null, null];
                            if (
                                (h.circleCircleIntersection(c.center.getX(), c.center.getY(), c.radius, i[u].x, i[u].y, n, m), null != m[0])
                            ) {
                                var d = this._calculateBulge(
                                    l.point.getX(),
                                    l.point.getY(),
                                ...
                                (d < 0 && d > l.bulge) || (d > 0 && d < l.bulge)
                                    ? (p.insertSegment(new A.PolySegment(l.point, d, c.center, c.radius, c.isCap)),
                                      (p.insertSegment(new A.PolySegment(m[0], 0)).isCap = l.isCap),
                                      o.push(p))
                                    : p.count && ((p.insertSegment(new A.PolySegment(l.point, 0)).isCap = l.isCap), o.push(p));
                            }
                            if (null == m[1] || l.isCap) p.end && ((l = new A.PolySegment(p.end.point, 0)).isCap = p.end.isCap);
                            else {
                                var g = this._calculateBulge(
                                    l.point.getX(),
                                    l.point.getY(),
                                ...
                                } else p.end && ((l = new A.PolySegment(p.end.point, 0)).isCap = p.end.isCap);
                            }
                        } else {
                            var m = [null, null],
                            ...
                            if ((h.circleLineIntersection(l.point.getX(), l.point.getY(), y, _, i[u].x, i[u].y, n, m), null != m[0]))
                                if (m[0] <= 0) p.count && ((p.insertSegment(new A.PolySegment(l.point, 0)).isCap = l.isCap), o.push(p));
                                else if (m[0] > 0 && m[0] < 1 && !l.isCap) {
                                    var v = l.point.getX() + y * m[0],
                                        b = l.point.getY() + _ * m[0];
                                    ((p.insertSegment(new A.PolySegment(l.point, 0)).isCap = l.isCap),
                                        (p.insertSegment(new A.PolySegment(new r(v, b), 0)).isCap = l.isCap),
                                        o.push(p));
                                } else
                                    ((p.insertSegment(new A.PolySegment(l.point, 0)).isCap = l.isCap),
                                        (p.insertSegment(new A.PolySegment(c.next.point, 0)).isCap = c.next.isCap),
                                        o.push(p));
                            var C = l.isCap;
                    ...
                    for (p = null, a = s; a < e.count; ++a)
                        l &&
                            ...
                            p.insertSegment(l),
                            (l = (c = c.next) ? new A.PolySegment(c.point, c.bulge, c.center, c.radius, c.isCap) : null));
                }),
                    ...
                    return e.bulge || i.bulge
                        ? i.bulge
                            ? e.bulge
                                ...
                                : this._getSegmToArcSqrDist(i.point, i.bulge, i.center, i.radius, n, e.point, t, r * r)
                            : this._getSegmToArcSqrDist(e.point, e.bulge, e.center, e.radius, t, i.point, n, r * r)
                ...
                (A.prototype._getSegmToArcSqrDist = function (e, t, i, n, r, o, a, s) {
                    ...
                    if ((h.circleLineIntersection(o.getX(), o.getY(), p, u, i.getX(), i.getY(), n, c), null != c[0] && null == c[1])) {
                        var d = c[0] * p + o.getX(),
                            g = c[0] * p + o.getY(),
                            f = this._calculateBulge(e.getX(), e.getY(), d, g, i.getX(), i.getY(), t),
                            m = d - o.getX(),
                            y = g - o.getY();
                        ((m < 0 && p <= m) || (m >= 0 && p >= m)) && ((y < 0 && u <= y) || (y >= 0 && u >= y))
                            ? (f < 0 && t <= f) || (f >= 0 && t >= f)
                                ? (A = 0)
                                : ((A = h.sqrSegmentDist(o.getX(), o.getY(), a.getX(), a.getY(), e.getX(), e.getY())),
                                  (l = h.sqrSegmentDist(o.getX(), o.getY(), a.getX(), a.getY(), r.getX(), r.getY())) < A && (A = l))
                        ...
                        if (null == c[0]) {
                            var _ = [null];
                            if (
                                ((l = h.sqrSegmentDist(o.getX(), o.getY(), a.getX(), a.getY(), i.getX(), i.getY(), _)), _[0] > 0 && _ < 1)
                            ) {
                                var v = o.getX() + _[0] * (a.getX() - o.getX()),
                                    ...
                                    w = i.getX() + C * (v - i.getX()),
                                    E = i.getY() + C * (b - i.getY()),
                                    B = this._calculateBulge(e.getX(), e.getY(), w, E, i.getX(), i.getY(), t);
                                ((B < 0 && t <= B) || (B >= 0 && t >= B)) &&
                                    (A = h.sqrSegmentDist(o.getX(), o.getY(), a.getX(), a.getY(), w, E));
                            }
                        }
                        ((l = h.sqrSegmentDist(o.getX(), o.getY(), a.getX(), a.getY(), e.getX(), e.getY())) < A && (A = l),
                            A > 0 &&
                                ((l = h.sqrSegmentDist(o.getX(), o.getY(), a.getX(), a.getY(), r.getX(), r.getY())) < A && (A = l),
                                A > 0 &&
                                    ((l = this._getPtToArcSqrDist(e, t, i, n, r, o)) < A && (A = l),
                                    A > 0 && (l = this._getPtToArcSqrDist(e, t, i, n, r, a)) < A && (A = l))));
                    }
                    return A;
                }),
                (A.prototype._getPtToArcSqrDist = function (e, t, i, n, r, o) {
                    ...
                    if (h.isEqualEps(s, 0)) a = n * n;
                        ...
                        var l = n / Math.sqrt(s),
                            ...
                            p = this._calculateBulge(e.getX(), e.getY(), A, c, i.getX(), i.getY(), t);
                        (p < 0 && t <= p) || (p >= 0 && t >= p)
                            ? (a = h.ptSqrDist(o.getX(), o.getY(), A, c))
                            : ((a = h.ptSqrDist(o.getX(), o.getY(), e.getX(), e.getY())),
                              (s = h.ptSqrDist(o.getX(), o.getY(), r.getX(), r.getY())) < a && (a = s));
                    }
                    return a;
                }),
                (A.prototype._getArcToArcSqrDist = function (e, t, i, n, o) {
                    ...
                    if (!(_[0] || (h.isEqualEps(a, l) && h.isEqualEps(s, A)))) {
                        ...
                        ((w = -w), (E = -E), (B = [null, null]), h.circleLineIntersection(l, A, w, E, a, s, e.radius, B));
                        for (v = 0; v < 2 && null != B[v]; ++v)
                            ((b = l + w * B[v]),
                                (C = A + E * B[v]),
                                (d =
                    ...
                    for (var n, o = 0; o < e.length; ++o)
                        if ((n = e[o]).count > 0) {
                            for (
                                var s = n.head,
                                    l = [],
                                    h = new r(this._roundOut(s.point.getX()), this._roundOut(s.point.getY())),
                                    A = h,
                                    c = 0;
                                c < n.count - 1;
                                ++c
                                ...
                                if (s.bulge) {
                                    ...
                                    (l.push({
                                        ...
                                        c == n.count - 2 &&
                                            (A = new r(this._roundOut(s.next.point.getX()), this._roundOut(s.next.point.getY()))));
                                s = s.next;
                            }
                            var u = {
                                stPt: h,
                ...
                (A.prototype._genBeziers = function (e, t, i, n, r, o, s) {
                    ...
                    for (l /= h; h <= 32 && this._getCubicBezierArcError(l, r) > o; ) ((l /= 2), (h *= 2));
                    i > 0 && (l = -l);
                    for (
                        var A,
                            c,
                ...
                (A.prototype._rewindVertices = function () {
                    for (var e = 0; e < this._pieces.length; ++e) this._pieces[e].rewindVertices(0);
                }),
                (A.prototype._readVertex = function (e) {
                    return (
                        !(!this._pieces[this._pieceIdx] || !this._pieces[this._pieceIdx].readVertex(e)) ||
                        (++this._pieceIdx, this._pieces[this._pieceIdx] && this._pieces[this._pieceIdx].readVertex(e))
                    );
                }),
