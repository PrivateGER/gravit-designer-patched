module.exports = function (e, t, i) {
            ...
            ((f.SMALL_SIZE = a),
                ...
                (f.RendererCanvas.prototype.isRendered = function () {
                    return (
                        !!this.parent &&
                        !!this.parent.$realCtx &&
                        (0 === this.parent.__len ? !this.renderingSkipped : !!f.finished(this.parent))
                    );
                }),
            ...
            ((f.Renderable = function (e, t) {
                ...
                (f.Renderable.render = function (e, t, i, n) {
                    if (void 0 === e.$rendered) {
                        ...
                        ((e.$rendered = v[e.$renderable_type]._render.call(e, t, i, n)),
                            void 0 !== e.$rendered && e.__renderableId && (c[e.__renderableId] = e));
                    }
                    return e.$rendered;
                }),
                (f.Renderable.dumpCode = function (e, t, i, n, r, o) {
                    if (!e.$renderedVariable) {
                        if (((e.$renderedVariable = i), e.ctx.__multiThreaded && e.ctx.__persistent)) {
                            ...
                            if (a) return ((e.$renderedVariable = a.$renderedVariable), a.$renderedVariable);
                        }
                ...
                (f.forceRestore = function (e) {
                    if ("2d" === e.__contextType && e.$realCtx) for (var t = 0; t < e.$maxRestoreCount; t++) e.$realCtx.restore();
                }),
                (f.dispose = function (e, t) {
                    e.__buffer &&
                        ...
                        (e.__len = 0),
                        (e.__resetPoint = 0),
                        "webgl" === e.__contextType && e instanceof f && e.__clearScheduled(t),
                        e.__persistent ||
                            (e.__isRoot ||
                                (e.canvas &&
                                    e.canvas.$realCanvas &&
                                    "webgl" !== e.__contextType &&
                                    (e.__multiThreaded ? u.push(e.canvas.$realCanvas) : p.push(e.canvas.$realCanvas),
                                    (e.canvas.$realCanvas = null))),
                            g + e.__buffer.byteLength < s && (d.push(e.__buffer), (g += e.__buffer.byteLength)),
                            (e.__buffer = null),
                            (e.__byteOps = null),
                            (e.__intOps = null),
                            (e.__fltOps = null),
                            (e.__uintOps = null)),
                        (!e.__persistent || (e.__multiThreaded && "undefined" == typeof importScripts)) &&
                ...
                (f.initializeContext = function (e, t) {
                    if (e.__multiThreaded && e.__persistent) {
                        ...
                        i &&
                            ...
                            e.canvas.$renderedBitmap || (e.canvas.$renderedBitmap = i.canvas.$renderedBitmap),
                            (e.$realCtx = i.$realCtx));
                    }
                ...
                (f.syncContext = function (e) {
                    e.__persistent &&
                        ...
                        (e.canvas &&
                            e.canvas.$realCanvas &&
                            ((e.canvas._w = e.canvas.$realCanvas.width), (e.canvas._h = e.canvas.$realCanvas.height)),
                        "webgl" === e.__contextType &&
                    ...
                    __realCtx: {
                        get: function () {
                            return this.$realCtx
                                ...
                                : this.__multiThreaded
                                  ? null
                                  : ((this.$realCtx = this.canvas.__realCanvas.getContext(this.__contextType, this.__contextAttributes)),
                                    this.$realCtx);
                        },
                    },
                }));
