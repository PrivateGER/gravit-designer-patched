module.exports = function (module, exports, require) {
            ...
            function w() {
                (h.call(this),
                    ...
                    this.addEventListener(o.BeforeInsertEvent, this._beforeGeometryChange, this),
                    this.addEventListener(o.BeforeRemoveEvent, this._beforeGeometryChange, this),
                    ...
                    this.addEventListener(o.AfterPropertiesChangeEvent, this._geometryChange, this));
            }
            (o.inheritAndMix("Paths Graph", w, h, [u]),
                ...
                (w.Edges.prototype._handleChange = function (e, t) {
                    if (e == o._Change.BeforeChildInsert) {
                        if (this._parent && this._parent instanceof w) {
                            var i = t,
                                n = i.getSourceId() ? this._parent.getAnchors().getById(i.getSourceId()) : null,
                                r = i.getDestinationId() ? this._parent.getAnchors().getById(i.getDestinationId()) : null;
                ...
                (w.prototype.addGraphLine = function (e, t, i, n, r) {
                    if (
                        ...
                        e.getAnchorPoints().getFirstChild() != e.getAnchorPoints().getLastChild()
                    )
                        try {
                            ...
                            if (t && t.getType() == w.GraphPosition.PosType.Anchor) {
                                ...
                                e.getAnchorPoints()
                                    .getFirstChild()
                                    .setProperties(["x", "y"], [a.getProperty("x"), a.getProperty("y")]);
                            }
                            if (i && i.getType() == w.GraphPosition.PosType.Anchor) {
                                var h = i.getPosSpec().getAnchor();
                                e.getAnchorPoints()
                                    .getLastChild()
                                    .setProperties(["x", "y"], [h.getProperty("x"), h.getProperty("y")]);
                            }
                            var A = [];
                            ...
                            for (u = 0; u < A.length; ++u) {
                                for (var m = A[u], y = [], _ = this._edges.getFirstChild(); _; _ = _.getNext()) {
                                    ...
                                    if (b && b.length) {
                                        b.sort(f);
                                        for (
                                            var C = [], E = 0, B = _.getPathBase().getAnchorPoints().getFirstChild().getNext();
                                            null != B;
                                            B = B.getNext(), ++E
                                        );
                                        for (var x = 0; x < b.length; ++x) {
                                            (1 == (F = b[x]).polySeg1.seg && v.isEqualEps(F.slope1, 0)) ||
                                ...
                                if (y.length) {
                                    ...
                                    for (x = 0; x < y.length; ++x) {
                                        var F;
                                        (1 == (F = y[x][0]).polySeg0.seg && v.isEqualEps(F.slope0, 0)) ||
                    ...
                    try {
                        ...
                        if ((this._splitPathBase(e.getPathBase(), t, i, o), o.length > 1)) {
                            ...
                            for (var p = 0; p < o.length; ++p)
                                if (
                                    ((l = 0 == p ? h : a), o[p].getAnchorPoints().getFirstChild() != o[p].getAnchorPoints().getLastChild())
                                ) {
                                    if (p == o.length - 1) a = A;
                                    else {
                                        a = new y();
                                        var u = o[p].getAnchorPoints().getLastChild();
                                        (a.setProperties(["x", "y"], [u.getProperty("x"), u.getProperty("y")]),
                                            this.addAnchor(a),
                                            r.push(a));
                                    }
                                    var d = new s();
                            ...
                            var i = function (e) {
                                if (!e.getExtPoint()) {
                                    ...
                                    if (e.getFirstChild() && e.getFirstChild().getExtPoint()) {
                                        for (var i = [], n = e.getFirstChild(); n; n = n.getNext()) i.push(n.getFacet().getPath());
                ...
                (w.prototype._constructFacets = function (e) {
                    for (
                        ...
                        for (
                            var r = e.edges[n], o = r.getAnchors(), a = t[r.getId()], s = null, l = [], h = null, A = 0;
                            A < o.length;
                            ++A
                        ) {
                            var c = o[A],
                            ...
                            for (
                                var u = c,
                                    ...
                                    g = new f.DirectedEdge(
                                        d,
                                        d.getSource() == u ? f.DirectedEdge.Direction.Straight : f.DirectedEdge.Direction.Reverse
                                    );
                                d && !i(a, u);
                                ...
                                (e.extFacet || h || (_ = true),
                                    (m =
                                        g.getProperty("direction") == f.DirectedEdge.Direction.Straight
                                            ...
                                            : (u = d.getSource()).getNextEdgeOrdered(d, y.EdgeType.Out, _))
                                        ? ((a =
                                              t[
                ...
                (w.prototype.prepareFacetsUpdate = function () {
                    this._facetsUpdateCounter
                        ? ++this._facetsUpdateCounter
                        : ((this._facetsUpdateCounter = 1), (this._oldGraph = this.clone()));
                }),
                ...
                (w.prototype._splitPathBase = function (e, t, i, n) {
                    ...
                    if (h) {
                        for (var A = false, c = null, p = null, u = h.getNext(), d = 0; null != u; h = u, u = u.getNext(), ++d) {
                            ...
                            if (
                                ...
                                for (var B = 0; o < r.length && r[o].seg == d; ++o) {
                                    ...
                                    if (v.isEqualEps(x, 0) && (!P || (v.isEqualEps(P.getX(), g) && v.isEqualEps(P.getY(), f))))
                                        A ||
                                            (a.getAnchorPoints().getLastChild().setProperties(["hrx", "hry"], [null, null]),
                                        ...
                                        if (!A) {
                                            if (((c = new _.AnchorPoint()), 1 == x && 0 == B))
                                                (c.deserialize(u.serialize()), c.setProperties(["hrx", "hry"], [null, null]));
                                        ...
                                        if (((A = false), (c = new _.AnchorPoint()), null !== b && null !== w && null !== C && null !== E))
                                            (v.getCtrlPts(g, m, b, w, B, x, s),
                                                ...
                                                c.setProperties(
                                                    ["x", "y", "hlx", "hly"],
                                                    [P ? P.getX() : s[3], P ? P.getY() : l[3], s[2], l[2]]
                                                ));
                                        else if ((null !== b && null !== C) || (null !== w && null !== E)) {
                                            (null !== b && null !== C ? ((S = b), (T = C)) : ((S = w), (T = E)),
                                                v.getCtrlPtsQuadratic(g, m, S, B, x, s),
                                                v.getCtrlPtsQuadratic(f, y, T, B, x, l),
                                                p.setProperties(["hrx", "hry"], [s[1], l[1]]),
                                                c.setProperties(["x", "y"], [P ? P.getX() : s[2], P ? P.getY() : l[2]]));
                                        } else
                                            c.setProperties(["x", "y"], [P ? P.getX() : g + x * (m - g), P ? P.getY() : f + x * (y - f)]);
                                        (a.getAnchorPoints().appendChild(c),
                                            a && a.getAnchorPoints().getFirstChild() != a.getAnchorPoints().getLastChild() && n.push(a),
                                            (a = new _()),
                                            (p = new _.AnchorPoint()).setProperties(["x", "y"], [c.getProperty("x"), c.getProperty("y")]),
                                            a.getAnchorPoints().appendChild(p));
                                    }
                                    B = x;
                                }
                            ...
                            } else ((c = new _.AnchorPoint()).deserialize(u.serialize()), a.getAnchorPoints().appendChild(c));
                        }
                        a && a.getAnchorPoints().getFirstChild() != a.getAnchorPoints().getLastChild() && n.push(a);
                    }
                }),
                ...
                (w.prototype._splitPathLineAtSelfIntersections = function (e, t) {
                    ...
                    if ((M = e.getAnchorPoints().getFirstChild())) {
                        ...
                        for (var o = M.getNext(), a = 0; null != o; M = o, o = o.getNext(), ++a) {
                            ...
                            for (var c = o, u = c.getNext(), d = a + 1; null != u; c = u, u = u.getNext(), ++d) {
                                ...
                                if (f && f.length)
                                    for (var m = 0; m < f.length; ++m)
                                        (1 != f[m].slope0 ||
                                            0 != f[m].slope1 ||
                                            (r && M == e.getAnchorPoints().getFirstChild() && c == o)) &&
                                            ((M == e.getAnchorPoints().getFirstChild() && 0 == f[m].slope0) ||
                                                n.push(new s.SplitPoint(a, f[m].slope0, f[m].pt)),
                                            (u == e.getAnchorPoints().getLastChild() && 1 == f[m].slope1) ||
                            ...
                            if (null !== x || B.length)
                                if (x)
                                    ((y = new p(v.evalCubic(D[0], D[1], D[2], D[3], x), v.evalCubic(k[0], k[1], k[2], k[3], x))),
                                        n.push(new s.SplitPoint(a, x, y)));
                                else {
                                    B[0] > 0 &&
                                        ((y = new p(v.evalCubic(D[0], D[1], D[2], D[3], B[0]), v.evalCubic(k[0], k[1], k[2], k[3], B[0]))),
                                        n.push(new s.SplitPoint(a, B[0], y)));
                                    var G = (B[0] + B[1]) / 2;
                                    ((y = new p(v.evalCubic(D[0], D[1], D[2], D[3], G), v.evalCubic(k[0], k[1], k[2], k[3], G))),
                    ...
                    if (n.length) {
                        ...
                        for (
                            var Q = [], M = e.getAnchorPoints().getFirstChild(), N = new p(M.getProperty("x"), M.getProperty("y")), U = 0;
                            U < n.length;
                            ++U
                        ) {
                            var V = n[U],
                        ...
                        if (
                            ...
                            v.isEqualEps(N.getX(), O.getX()) && v.isEqualEps(N.getY(), O.getY()))
                        ) {
                            V = n[n.length - 1];
                ...
                (w.prototype._addGraphLine = function (e, t, i, n) {
                    if (e.getAnchorPoints().getFirstChild() == e.getAnchorPoints().getLastChild()) return i || t;
                    var r,
                        o,
                        a = e.getAnchorPoints().getFirstChild();
                    if (t && t.getType() == w.GraphPosition.PosType.Anchor)
                        ((r = t.getPosSpec().getAnchor()), a.setProperties(["x", "y"], [r.getProperty("x"), r.getProperty("y")]));
                    else {
                        for (
                            var l = a.getProperty("x"), h = a.getProperty("y"), A = null, c = this._anchors.getFirstChild();
                            c && !A;
                            c = c.getNext()
                        )
                            v.isEqualEps(c.getProperty("x"), l, w.defaultEps) &&
                                ...
                                (A = c);
                        A
                            ? ((r = A), a.setProperties(["x", "y"], [A.getProperty("x"), A.getProperty("y")]))
                            : ((r = new y()).setProperties(["x", "y"], [l, h]), this.addAnchor(r));
                    }
                    var p = e.getAnchorPoints().getLastChild();
                    if (i && i.getType() == w.GraphPosition.PosType.Anchor)
                        ((o = i.getPosSpec().getAnchor()), p.setProperties(["x", "y"], [o.getProperty("x"), o.getProperty("y")]));
                    else {
                        for (
                            l = p.getProperty("x"), h = p.getProperty("y"), A = null, c = this._anchors.getFirstChild();
                            c && !A;
                            c = c.getNext()
                        )
                            v.isEqualEps(c.getProperty("x"), l, w.defaultEps) &&
                ...
                (w.prototype._handleChange = function (e, t) {
                    if (e === o._Change.Store)
                        ((t.blob.anchors = o.serialize(this._anchors)),
                            this._edges.getFirstChild() && (t.blob.edges = o.serialize(this._edges)),
                            this._facets.getFirstChild() && (t.blob.facets = o.serialize(this._facets)));
                    else if (e === o._Change.Restore) {
                        t.blob.hasOwnProperty("anchors") &&
                            ((this._anchors = o.deserialize(t.blob.anchors)), this._anchors._setParent(this));
                        var i = null;
                    ...
                    if ((h.prototype._handleChange.call(this, e, t), e === o._Change.Restore && this._edges))
                        for (a = this._edges.getFirstChild(); a; a = a.getNext()) a.getProperty("cSt") || a.assignStyleFrom(this);
                }),
                ...
                (w.prototype.readVertex = function (e) {
                    return this._currentEdge && !this._currentFacet
                        ? !(!this._vertexSource || !this._vertexSource.readVertex(e)) ||
                              (this._vertexSource && (this._currentEdge = this._currentEdge.getNext()),
                              this._currentEdge
                                  ? (this.$trf
                    ...
                    if (e.configuration.isOutline(e)) h.prototype._paintBorder.call(this, e, t, i);
                        ...
                        if (i.$_pt && i.$_bw > 0 && i.$_op > 0 && true === i.$_vs) {
                            ...
                            try {
                                ...
                                if (s) {
                                    var l = 0.5 * i.$_bw;
                                    if (this.$trf) ((l /= this.$trf.getScaleFactor()), (s = s.expanded(l, l, l, l)));
                                ...
                                if (A && A.paint) {
                                    ...
                                    A.transform &&
                                        ...
                                        i.$_px && !i.$_px.isIdentity() && (f = f.preMultiplied(i.$_px)));
                                    var m = e.canvas;
                                    if (f) {
                                ...
                                if (!o.painted && o.getProperty("cSt", false, null, true)) {
                                    ...
                                    try {
                                        ...
                                        (b.each(
                                            ...
                                            r.drawCanvas(_, 0, 0, null, d.CompositeOperator.DestinationOut),
                                            r.drawCanvas(_, 0, 0, null, d.CompositeOperator.SourceOver),
                                            _.finish());
                                    } finally {
                                        e.popCanvas();
                                    }
