module.exports = function (e, t, i) {
            ...
            (((o.prototype = r.prototype).createDefaultTable = function () {
                ...
                (o.prototype.addAlternate = function (e, t, i, r) {
                    ...
                    var a = t.sub,
                        l = this.binSearch(o.coverage.glyphs, a);
                    (l < 0 && ((l = -1 - l), o.coverage.glyphs.splice(l, 0, a), o.alternateSets.splice(l, 0, 0)),
                ...
                (o.prototype.addLigature = function (e, t, i, r) {
                    ...
                    (s ||
                        ...
                        (o.subtables[0] = s)),
                        n.assert(1 === s.coverage.format, "Ligature: unable to modify coverage table format " + s.coverage.format));
                    var l = t.sub[0],
                        h = t.sub.slice(1),
                        A = {
                            ligGlyph: t.by,
                    ...
                    if (c >= 0) {
                        for (var p = s.ligatureSets[c], u = 0; u < p.length; u++) if (a(p[u].components, h)) return;
                        p.push(A);
                    } else ((c = -1 - c), s.coverage.glyphs.splice(c, 0, l), s.ligatureSets.splice(c, 0, [A]));
                }),
