module.exports = function (module, exports, require) {
            ...
            (r.inheritAndMix("layer", g, s, [r.Container, h.Transform, h.Layout, h.Anchor, h.Stylable, h.Accelerated]),
                ...
                (g.prototype._calculatePaintBBox = function (e, t) {
                    var i;
                    return (
                        (i = this.getProperty("frm") ? this.getGeometryBBox(t) : s.prototype._calculatePaintBBox.call(this, e, t)),
                            ...
                            try {
                                (this._paintChildren(e),
                                    void 0 !== e.canvas.putVertices(s) &&
                                        e.canvas.fillVertices(o.BLACK, 1, u.CompositeOperator.DestinationIn),
                    ...
                    if (e && !this.getProperty("frm")) {
                        ...
                        if (t) {
                            ...
                            for (var i = this.getFirstChild(); null != i; i = i.getNext())
                                i.hasMixin(h.Anchor) &&
                                    (i.getProperty("hacr") || i.setProperty("hacr", i.oldHacr ? i.oldHacr : h.Anchor.AnchorType.Start),
                                    i.getProperty("vacr") || i.setProperty("vacr", i.oldVacr ? i.oldVacr : h.Anchor.AnchorType.Start));
                        }
                        ...
                        if (this.dependentUpdate) {
                            if (!this._noAnchoringPropsUpdate) {
                                var i = t.properties.indexOf("frm"),
                                    ...
                                    o = t.values[i],
                                    a = o.getWidth() > h.Transform.MinimalDimention ? o.getWidth() : h.Transform.MinimalDimention,
                                    s = o.getHeight() > h.Transform.MinimalDimention ? o.getHeight() : h.Transform.MinimalDimention,
                                    l = n.getWidth() > h.Transform.MinimalDimention ? n.getWidth() : h.Transform.MinimalDimention,
                                    A = n.getHeight() > h.Transform.MinimalDimention ? n.getHeight() : h.Transform.MinimalDimention,
                                    c = new p()
