module.exports = function (e, t, i) {
            ...
            function s(e, t, i, n, r) {
                var o;
                return (
                    (t & n) > 0 ? ((o = e.parseByte()), 0 == (t & r) && (o = -o), (o = i + o)) : (o = (t & r) > 0 ? i : i + e.parseShort()),
                    o
                );
            }
                ...
                if (
                    ...
                    for (r = [], l = 0; l < c; l += 1)
                        if (((a = h.parseByte()), r.push(a), (8 & a) > 0))
                            for (var p = h.parseByte(), u = 0; u < p; u += 1) (r.push(a), (l += 1));
                    if ((n.argument(r.length === c, "Bad flags."), A.length > 0)) {
                        ...
                        if (c > 0) {
                            ...
                            var f = 0;
                            for (l = 0; l < c; l += 1) ((a = r[l]), ((d = g[l]).x = s(h, a, f, 2, 16)), (f = d.x));
                            var m = 0;
                            for (l = 0; l < c; l += 1) ((a = r[l]), ((d = g[l]).y = s(h, a, m, 4, 32)), (m = d.y));
                        }
                        e.points = g;
                    } else e.points = [];
                    ...
                    for (var y = !0; y; ) {
                        ...
                        ((1 & r) > 0
                            ...
                            (8 & r) > 0
                                ...
                                : (64 & r) > 0
                                  ? ((_.xScale = h.parseF2Dot14()), (_.yScale = h.parseF2Dot14()))
                                  : (128 & r) > 0 &&
            ...
            function A(e) {
                ...
                for (
                    ...
                    for (var c = 0; c < o.length; ++c)
                        if (((s = l), (l = h), (h = o[(c + 1) % o.length]), l.onCurve)) t.lineTo(l.x, l.y);
                        else {
                            var p = s,
                                u = h;
                            (s.onCurve ||
