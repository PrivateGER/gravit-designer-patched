module.exports = function (module, exports, require) {
            ...
            function h(e, t, i, r, o) {
                (l.call(this, i),
                    (this._scene = t),
                    (this._isUnitRuler = r),
                    this._scene.addEventListener(n.AfterPropertiesChangeEvent, this._afterPropertiesChangeEvent, this));
                ...
                ((this._htmlElement.style.position = "absolute"),
                    ...
                    r
                        ...
                        : ((this._orientation = e || h.Orientation.Horizontal),
                          ...
                          "pixelated" !== this._canvas.style.imageRendering && (this._canvas.style.imageRendering = "nearest-neighbor"),
            ...
            (IsFiniteNonNegativeNumber.inherit(h, l),
                ...
                (h.prototype.resize = function (e, t) {
                    if (this._isUnitRuler) this._htmlElement.style.width = e + "px";
                        ...
                        (this._orientation == h.Orientation.Horizontal && (e = window.screen.availWidth),
                            (this._canvas.width = e * i),
                            (this._canvas.height = t * i),
                            (this._canvas.style.width = e + "px"),
                            (this._canvas.style.height = t + "px"),
                            this._orientation === h.Orientation.Vertical && (this._verticalWidth = e),
                            this._paint());
                    }
                }),
                (h.prototype._paint = function () {
                    if (this.isDisplayed()) {
                        var e = s.getScreenDPI(),
                            ...
                            i = this.getHeight() * e,
                            n = this._context,
                            r = window.getComputedStyle(this._htmlElement, null).getPropertyValue("color");
                        (n.clearRect(0, 0, t, i), (n.fillStyle = r), (n.strokeStyle = r), (n.lineWidth = 1));
                        var l = 9 * e;
                        ((n.font = l + "px Verdana"),
                            n.save(),
                            this._orientation === h.Orientation.Vertical && (n.translate(t, 0), n.rotate((Math.PI / 180) * 90)),
                            n.beginPath());
                        var A = 0,
                            c = l,
                            p = (19 * e) / 1.5,
                ...
                (h.prototype._createUnitRuler = function (e) {
                    ((this._htmlElement.style.width = "19px"),
                        ...
                        (this._htmlElement.style.justifyContent = e.rulerLeftFill ? "flex-end" : "center"));
                }),
                (h.prototype._updateUnitRuler = function (e) {
                    if (!this._htmlElement.firstChild) {
                        ...
                        ((t.style.font = "9px Verdana"),
                            ...
                            (t.style.color = window.getComputedStyle(this._htmlElement, null).getPropertyValue("color")),
