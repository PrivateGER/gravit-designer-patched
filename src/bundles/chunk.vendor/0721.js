module.exports = function (e, t, i) {
            ...
            ((o[1] = function () {
                ...
                (o[2] = function () {
                    ...
                    return (
                        n.argument(1 === e, "GSUB Multiple Substitution Subtable identifier-format must be 1"),
                        {
                            substFormat: e,
                            coverage: this.parsePointer(r.coverage),
                ...
                (o[3] = function () {
                    var e = this.parseUShort();
                    return (
                        n.argument(1 === e, "GSUB Alternate Substitution Subtable identifier-format must be 1"),
                        {
                            substFormat: e,
                            coverage: this.parsePointer(r.coverage),
                ...
                (o[4] = function () {
                    var e = this.parseUShort();
                    return (
                        n.argument(1 === e, "GSUB ligature table identifier-format must be 1"),
                        {
                            substFormat: e,
                            coverage: this.parsePointer(r.coverage),
            ...
            ((o[5] = function () {
                ...
                (o[8] = function () {
                    var e = this.parseUShort();
                    return (
                        n.argument(1 === e, "GSUB Reverse Chaining Contextual Single Substitution Subtable identifier-format must be 1"),
                        {
                            substFormat: e,
                            coverage: this.parsePointer(r.coverage),
                            backtrackCoverage: this.parseList(r.pointer(r.coverage)),
            ...
            ((l[1] = function (e) {
                ...
                (l[3] = function (e) {
                    return (
                        n.assert(1 === e.substFormat, "Lookup type 3 substFormat must be 1."),
                        new a.Table(
                            "substitutionTable",
                            [
                                {
                ...
                (l[4] = function (e) {
                    return (
                        n.assert(1 === e.substFormat, "Lookup type 4 substFormat must be 1."),
                        new a.Table(
                            "substitutionTable",
                            [
                                {
