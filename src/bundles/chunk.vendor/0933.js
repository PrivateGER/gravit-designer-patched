module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(h, r),
                        ...
                        if (e instanceof a && e.isMaster()) {
                            ...
                            if (
                                ...
                                (l && l.afterSpecialChange(e, s),
                                    ...
                                    e.addEventListener(a.AfterThumbnailUpdate, t._updateThumbnail.bind(t)));
                            }
                        }
                    });
                }),
                            ...
                            if ((r.prototype.removeEntry.call(this, i, t), n)) {
                                ...
                                (s && s.afterSpecialChange(n, a),
                                    this._scene._canEventBeSent(o.AfterSpecialChangeEvent) &&
                                        this._scene._sendEvent(new o.AfterSpecialChangeEvent(n, a)));
                            }
                        }
                ...
                (h.prototype.release = function () {
                    var e = this;
                    (this._scene.removeEventListener(o.AfterInsertEvent, this._afterInsert, this),
                        this._scene.removeEventListener(o.BeforeRemoveEvent, this._beforeRemove, this),
                                ...
                                (t.onload = function () {
                                    if (0 !== t.naturalWidth && 0 !== t.naturalHeight && !i.image) {
                                        ...
                                        (e.resize(t.naturalWidth, t.naturalHeight),
                                            ...
                                            e.drawImage(t),
                                            (i.image = e),
                                            i.symbol && i.symbol.trigger(new a.AfterThumbnailUpdate(i.symbol, e)));
                                    }
                                }));
                        }
