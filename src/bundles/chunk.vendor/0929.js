module.exports = function (module, exports, require) {
            ...
            ((o.prototype._uid = null),
                ...
                (o.prototype.getAnchors = function () {
                    return [this._srcAnchor ? this._srcAnchor.getAnchor() : null, this._dstAnchor ? this._dstAnchor.getAnchor() : null];
                }),
                ...
                (o.prototype.setSource = function (e) {
                    e instanceof n
                        ? (this._srcAnchor = e)
                        : (e instanceof r || (e.hasMixin && e.hasMixin(r))) && (this._srcAnchor = new n(null, e));
                }),
                (o.prototype.setDestination = function (e) {
                    e instanceof n
                        ? (this._dstAnchor = e)
                        : (e instanceof r || (e.hasMixin && e.hasMixin(r))) && (this._dstAnchor = new n(null, e));
                }),
