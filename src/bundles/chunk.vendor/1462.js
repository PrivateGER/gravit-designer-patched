                    ...
                    return {
                        ...
                        overrideDefsSource: function (e, t) {
                            this.defs.forEach(function (i) {
                                (i.documentElement.getAttribute("in") === e && i.documentElement.setAttribute("in", t),
                                    i.documentElement.getAttribute("in2") === e && i.documentElement.setAttribute("in2", t),
                                    i.documentElement.getAttribute("in3") === e && i.documentElement.setAttribute("in3", t));
                            });
                        },
                    };
                }),
                            ...
                            (0 != this.defs.length || i.in || (i.in = "SourceGraphic"),
                                n.each(
                                    ...
                                    function (e, t) {
                                        "SourceGraphic" != t &&
                                            "SourceAlpha" != t &&
                                            (e.startsWith("in") || "target" === e || "out" === e || "result" === e) &&
                                            (i[e] = this.prefix + t);
                                    }.bind(this)
                                ));
                    ...
                    if (i.length)
                        if (i.length > 1) {
                            var r = this._groupEqualFilters(i),
                                o = t.ownerDocument.createElementNS("http://www.w3.org/2000/svg", "feMerge"),
                                a = function (i, r) {
                                    if (
                    ...
                    if (i.length) {
                        ...
                        if (
                            ...
                            (0 == i.length
                                ...
                                : ((a = (o = i[i.length - 1]).defs[o.defs.length - 1]).documentElement.setAttribute("result", "FilterOut"),
                                  n.each(o.defs, function (e, t) {
                                      "feBlend" === t.documentElement.tagName &&
                                          "SourceGraphic" === t.documentElement.getAttribute("in") &&
                                          t.documentElement.setAttribute("in", "SourceGraphicIgnore");
                                  })),
                                o.addFilter(
                                    "feComponentTransfer",
                                    {
                                    ...
                                    null,
                                    ['<feFuncA xmlns="http://www.w3.org/2000/svg" type="table" tableValues="0 ' + this.fill_opacity + '"/>']
                                ),
                                a &&
                                    o.addFilter("feBlend", {
