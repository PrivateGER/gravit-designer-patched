            ...
            ((d.UpdateEvent = function (e) {
                ...
                (d.equals = function (e, t) {
                    ...
                    return (
                        ...
                        !(
                            !i ||
                            ((e._transform || e._transform !== t._transform) && !r.equals(e._transform, t._transform)) ||
                ...
                (d.prototype.setTexture = function (e) {
                    (this._url && this._scene && c.isDictionary(this._url) && this._scene.getDictionary().removeEntry(this._url),
                        e &&
                            ...
                            "string" == typeof e
                                ? o.equals(e, this._url) || ((this._url = e), (this._node = null), this._initializeImage())
                                : e instanceof HTMLCanvasElement || e instanceof p.RendererCanvas || e instanceof u.RendererCanvas
                                  ? ((this._node = null), (this._url = null), this._initializeImage(e))
                                  : ((this._url = null), (this._image = null), (this._node = e.clone()))));
                }),
                (d.prototype.getTexture = function () {
                    if (!this._invalidate && this._cachedBitmap) return this._cachedBitmap;
                        ...
                        if (
                            ...
                            return (
                                u
                                    .getHTMLElement()
                                    .getContext("2d")
                                    .drawImage(this._cachedBitmap.getHTMLElement(), 0, 0, u.getWidth(), u.getHeight()),
                                u
                            );
                        }
                    } else
                ...
                (d.prototype._deserializeFromBlob = function (e) {
                    ((this._transform = e.hasOwnProperty("t") ? r.deserialize(e.t) : null),
                        (this._url = e.u),
                ...
                (d.prototype._resolvedImage = function (e) {
                    ((this._storedUrl = e),
                        (this._image && this._image.src === e) ||
                            ...
                            e && e.match(/^(http|https|\/\/)/) ? (this._image.crossOrigin = "Anonymous") : (this._image.crossOrigin = null),
                            (this._image.src = e)));
                }),
                ...
                (d.prototype.createTextureTransform = function (e, t, i) {
                    ...
                    switch ((this.getScaleMode() == d.ScaleMode.Tile && (A = c = this.getTileSize()), this.getSizeMode())) {
                        ...
                        case d.SizeMode.Percent:
                            ((A = ((this.getWidth() / 100) * s.getWidth()) / o.getWidth()),
                                (c = ((this.getHeight() / 100) * s.getHeight()) / o.getHeight()));
                            break;
                    ...
                    if (!g.isIdentity()) {
                        var f = u.translate.multiplied(g).decomposed().translate.inverted().getTranslation(),
