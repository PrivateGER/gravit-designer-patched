                    ...
                    for (; this._ctx._texts.length; ) {
                        ...
                        if (t) {
                            ...
                            ((s = e.peek()).appendChild(a),
                                ...
                                s.appendChild(o),
                                a.setAttribute("clip-path", "url(#" + t.getAttribute("id") + ")"),
                        ...
                        if (h instanceof m) {
                            ...
                            if (
                                (h instanceof y
                                    ...
                                    : h instanceof _ && (u = b.createSvgRadialGradient(e, e.svgDoc, h)),
                                !u)
                            )
                                continue;
                ...
                (w.GSVGTLRender.prototype.drawMarker = function (e, t, i) {
                    if (!(this._renderMode & s.RENDERFLAG_STROKE)) {
                        ...
                        if (
                            ...
                            (this._node.hasStyleFill() || "transparent" !== this.fillStyle) && (n |= 1 << c.Mode.FILL),
                            !((n -= 1) < 0))
                        ) {
                            var r,
                ...
                (w.GSVGTLRender.prototype.drawText = function (e, t, i, r, o) {
                    if (!(this._renderMode & s.RENDERFLAG_STROKE) && e !== h.NBSP) {
                        ...
                        if (
                            ...
                            (this._node.hasStyleFill() || "transparent" !== this.fillStyle) && (a |= 1 << c.Mode.FILL),
                            !((a -= 1) < 0))
                        ) {
                            var l,
                                d = this._transform.scaled(1 / this._transform._sx, 1 / this._transform._sy).translated(t, i),
