module.exports = function (e, t, i) {
            ...
            function R(e, i) {
                ...
                for (var l = 0; l < s; l++)
                    ((n = a[l]),
                        e.touched(n) ||
                            ((r = n.prevTouched(e)) !== n &&
                                (r === (o = n.nextTouched(e)) && e.setRelative(n, n, e.distance(r, r, !1, !0), e, !0),
            ...
            function G(e, i) {
                ...
                for (var c = h.distance(s, s, !1, !0), p = n.length - 2, u = 0; u < p; u++) ((r = n[u]), l.setRelative(r, r, c, h));
            }
                                ...
                                if (((v.prototype = i), l)) {
                                    ...
                                    for (var A = 0; A < l.length; A++) {
                                        ...
                                        ((o = new v("glyf", p.instructions)),
                                            t.DEBUG && (console.log("---EXEC COMP " + A + "---"), (o.step = -1)),
                                            b(p, o, a, s));
                                        for (
                                    ...
                                    e.instructions &&
                                        ...
                                        t.DEBUG && (console.log("---EXEC COMPOSITE---"), (o.step = -1)),
                                        C(o),
                                        (r.length -= 2));
                                } else
                ...
                (n = [
                    ...
                    function (e) {
                        for (var i = e.stack, n = e.loop, r = e.fv, o = i.pop() / 64, a = e.z2; n--; ) {
                            var s = i.pop(),
                                l = a[s];
                            (t.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - n) + ": " : "") + "SHPIX[]", s, o),
                                r.setRelative(l, l, o),
                                r.touch(l));
                        }
                        e.loop = 1;
                    ...
                    function (e) {
                        for (
                            ...
                            var c = i.pop(),
                                p = A[c];
                            (t.DEBUG && console.log(e.step, (e.loop > 1 ? "loop " + (e.loop - o) + ": " : "") + "IP[]", c, n, "<->", r),
