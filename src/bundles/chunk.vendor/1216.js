module.exports = function (e, t, i) {
            ...
            ((Z.prototype._resources = null),
                    ...
                    if (h instanceof Y) {
                        ...
                        if (this._doc.isDownsamplingImages()) {
                            ...
                            if (
                                ...
                                if (m && y && f.getWidth() < m && f.getHeight() < y) {
                                    var _ = Math.min(f.getWidth() / c.width, f.getHeight() / c.height),
                                        b = document.createElement("canvas");
                                    ((b.width = Math.ceil(c.width * _)),
                                        (b.height = Math.ceil(c.height * _)),
                                        b.getContext("2d").drawImage(c, 0, 0, c.width, c.height, 0, 0, c.width * _, c.height * _),
                                        (c = b));
                                }
                            }
                        }
                        ...
                        (this._hasBlendMode() || 1 != this.globalAlpha) &&
                            this._graphics.setGStateResource(
                                this._createGStateResource(this.globalAlpha, v.OPERATIONFLAG_FILL, this.globalCompositeOperation)
                            );
                ...
                (Z.prototype.replaceWithBitmap = function (e, t, i, n, r) {
                    ...
                    var c = new T(h.getWidth(), 0, 0, h.getHeight(), h.getX(), this._y(h.getY()) - h.getHeight()),
                            ...
                            e._graphics.accept(
                                function (i, a) {
                                    if (i.equals(p)) {
                                        ...
                                        (n && s.add(new w(new H(n.getX(), this._y(n.getY()) - n.getHeight(), n.getWidth(), n.getHeight()))),
                                            s.add(new Q(c)),
                                            s.add("/" + o.getName() + " Do"),
                                            e._graphics.add(s, a++));
                ...
                (Z.prototype._createImageResource = function (e, t, i) {
                    ...
                    if (n != I.CMYK && n != I.RGB) throw new Error("Unsupported color space");
                    t && n === I.RGB && (n = I.RGBA);
                        ...
                        h = function (e, i) {
                            ...
                            if (s())
                                if (t) {
                                    ...
                                    new L()
                                        .concurrencyEncode(this._doc, this._doc.getWorkers(), e.buffer)
                                        .then(
                                            function (e) {
                                                var t = new U();
                                                (t.setBuffer(new Uint8Array(e)), a.getPDFObject().setFilter(t), h.done());
                    ...
                    if (s()) {
                        var A = function (t) {
                            ...
                            (new X()
                                .concurrencyRaster(this._doc, this._doc.getWorkers(), r.buffer, e.width, e.height, n, !!t)
                                .then(
                                    function (e) {
                                        (h(e[0], t || e[1]), i.done());
                                    }.bind(this)
                ...
                (Z.prototype.drawCanvas = function (e, t, i, n, r) {
                    if ((null != n && n < 1) || this._hasBlendMode(r)) {
                        ...
                        var s = new T().translated(this._pageOrigin.getX(), this._pageOrigin.getY()).inverted().getMatrix(),
                            l = s[4],
                            h = s[5],
                            A = new M();
                        (A.push(l),
                ...
                (Z.prototype.createSMaskGStateResource = function (e, t) {
                    var i = new T().translated(this._pageOrigin.getX(), this._pageOrigin.getY()),
                        n = new M([0, 0]);
                ...
                (Z.prototype.stroke = function () {
                    if (this._hasStroke()) {
                        ...
                        if (i instanceof S && this.canvas._paintContext._borderPaintLayer) {
                            ...
                            (n.transform && (i.$trf && (n.transform = n.transform.multiplied(i.$trf)), (t = t.multiplied(n.transform))),
                                (e = n.paint));
                        }
                        ...
                        if (o.isValid()) {
                            ...
                            ((a.strokeStyle = o),
                                ...
                                this.dashArray && this.dashArray.length && (a.lineDash = new F(this.dashArray)));
                            var s = this._graphics;
                            if (1 != this.globalAlpha || this._hasBlendMode(this.globalCompositeOperation)) {
                                var l = this._createGStateResource(this.globalAlpha, v.OPERATIONFLAG_STROKE, this.globalCompositeOperation),
                                    h = new v(this._doc);
                ...
                (Z.prototype.fill = function (e) {
                    if (this._isBackgroundFill()) this._graphics.peek().getValue() instanceof C && this._graphics.pop();
                        ...
                        if (n.isValid()) {
                            ...
                            var a = this._graphics,
                                s = this._createStyleSMaskGStateResource(n, v.OPERATIONFLAG_FILL);
                            if (
                                (s && ((a = new v(this._doc)).setGStateResource(s), this._graphics.add(a)),
