            ...
            module.exports = function (e) {
                ((e.Layout = function () {}),
                    ...
                    (e.Layout.prototype._handleLayoutChange = function (t, i) {
                        if (!this.isRecordedTransaction())
                            if (t === e._Change.GeometrySizeChanged && this.getFirstChild() && !this._relayout)
                                ...
                                !(t === n._Change.AfterPropertiesChange && i.properties.indexOf("trf") >= 0) ||
                    ...
                    (e.Layout.prototype._layoutAnchorContents = function (t, i, n) {
                        var o = n;
                        if (!n) {
                            var a = i.getWidth() > e.Transform.MinimalDimention ? i.getWidth() : e.Transform.MinimalDimention,
                                s = i.getHeight() > e.Transform.MinimalDimention ? i.getHeight() : e.Transform.MinimalDimention,
                                l = t.getWidth() > e.Transform.MinimalDimention ? t.getWidth() : e.Transform.MinimalDimention,
                                h = t.getHeight() > e.Transform.MinimalDimention ? t.getHeight() : e.Transform.MinimalDimention;
                            o = new r()
