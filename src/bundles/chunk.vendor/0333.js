            ...
            ((s.prototype._isPanning = null),
                ...
                (s.prototype.panView = function (e, t, i) {
                    ...
                    if (a) {
                        ...
                        s &&
                            ((this._cumulativeTranslationSinceDragStartPoint = this._cumulativeTranslationSinceDragStartPoint.translated(
                                s.getX(),
                                s.getY()
                            )),
                            (this._translationMovement = new n().translated(s.getX(), s.getY())));
