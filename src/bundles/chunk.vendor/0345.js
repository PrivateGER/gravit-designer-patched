module.exports = function (module, exports, require) {
            ...
            function c(e, t) {
                ...
                ("number" == typeof e
                    ...
                    : e instanceof Image || e instanceof HTMLImageElement
                      ...
                      : !(e instanceof c) && e._canvasContext instanceof CanvasRenderingContext2D
                        ? (o = e._canvasContext.canvas)
                        : e instanceof c || !(e._canvasContext instanceof l || e._canvasContext instanceof h)
            ...
            ((c.ImageType = {
                ...
                (c.prototype.getHTMLElement = function (e) {
                    return e && (this._canvas instanceof l.RendererCanvas || this._canvas instanceof h.RendererCanvas)
                ...
                (c.prototype.toImageBlob = function (e, t, i, n) {
                    ...
                    -1 === r.indexOf(e) &&
                        (/jpeg/i.test(e) || /jpg/i.test(e) ? (e = c.ImageType.JPEG) : /png/i.test(e) && (e = c.ImageType.PNG));
                    var l = [t, e];
                    if ((i && (l = l.concat(i)), !this._canvas)) return null;
                    if ("function" == typeof this._canvas.toBlob) {
                        if (-1 === r.indexOf(e) || isNaN(n) || n === o.DPI) return this._canvas.toBlob.apply(this._canvas, l);
                        var h = [
                            function (i) {
                ...
                (c.prototype.clone = function (e) {
                    if ((e = e || new r(0, 0, this.getWidth(), this.getHeight())).getWidth() < 1 || e.getHeight() < 1) return null;
                    var t = new c(e.getWidth(), e.getHeight()),
                        i = this._canvasContext.getImageData(e.getX(), e.getY(), e.getWidth(), e.getHeight());
                ...
                (c.prototype.trim = function () {
                    for (
                        var e,
                            t = this._canvasContext.getImageData(0, 0, this.getWidth(), this.getHeight()),
                            i = t.data.length,
                            n = {
                                top: null,
                                left: null,
                ...
                (c.prototype.modifyPixels = function (e, t, i, n) {
                    if (0 === (i = i || new r(0, 0, this.getWidth(), this.getHeight())).getWidth() || 0 === i.getHeight()) return null;
                    var o = this._canvasContext.getImageData(i.getX(), i.getY(), i.getWidth(), i.getHeight());
                    return (
                        o.runModifier && n ? o.runModifier(e, i.getWidth(), i.getHeight(), t) : e(o.data, i.getWidth(), i.getHeight(), t),
