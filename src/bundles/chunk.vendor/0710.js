            ...
            ((t.parse = function (e, t) {
                ...
                if (((o.format = A.parseUShort()), 12 === o.format))
                    ...
                    !(function (e, t, i, n, o) {
                        ...
                        for (a = 0; a < s - 1; a += 1)
                            for (
                                var u, d = l.parseUShort(), g = h.parseUShort(), f = A.parseShort(), m = c.parseUShort(), y = g;
                                y <= d;
                                y += 1
                            )
                                (0 !== m
                    ...
                    if (0 !== o.format) throw new Error("Only format 4 and 12 cmap tables are supported.");
                    !(function (e, t) {
                ...
                (t.make = function (e) {
                    ...
                    for (n.segments = [], t = 0; t < e.length; t += 1) {
                        for (var r = e.get(t), s = 0; s < r.unicodes.length; s += 1) a(n, r.unicodes[s], t);
                    ...
                    (!(function (e) {
                        ...
                        (i = n.segments.length),
                        (n.segCountX2 = 2 * i),
                        (n.searchRange = 2 * Math.pow(2, Math.floor(Math.log(i) / Math.log(2)))),
                    ...
                    return (
                        ...
                        (n.length = 14 + 2 * l.length + 2 + 2 * h.length + 2 * A.length + 2 * c.length + 2 * p.length),
                        n
                    );
                }));
        };
