            ...
            (n.inherit(p, c),
                ...
                (d.prototype.add = function (e) {
                    (this.getLastWord() ||
                        ...
                        (this.descent = Math.max(Math.abs(this.descent), Math.abs(e.descent))),
                        e.transform.getRotationFactor() <= 0
                            ? ((this.endPoint = l.max(this.endPoint, e.endPoint)), (this.startPoint = l.min(this.startPoint, e.startPoint)))
                ...
                (g.prototype.isSameLine = function (e) {
                    var t = this.word.transform
                            ...
                            .getY(),
                        i = e.word.transform.rotated(e.word.transform.getRotationFactor()).mapPoint(new l(e.word.x, e.word.y)).getY();
