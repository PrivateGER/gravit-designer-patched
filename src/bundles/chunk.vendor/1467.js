module.exports = function (module, exports, require) {
            ...
            ((m.Mode = {
                ...
                (m.prototype.add = function (e) {
                    ...
                    t
                        ? t.origin.mapPoint(new r(0, 0)).getY() !== e.origin.mapPoint(new r(0, 0)).getY() &&
                ...
                (_.prototype._getGradient = function (e) {
                    for (var t = 0; t < this.words.length; t++) if (this.words[t][e] instanceof s) return this.words[t][e];
                    return null;
                }),
                (_.prototype.renderSVG = function (e, t, i) {
                    l.each(
                        ...
                        function (r, o) {
                            ...
                            (l.setAttribute("transform", "matrix(" + g.formatMatrix(a.getMatrix()).join(",") + ")"),
                            ...
                            (B instanceof s || y.set("stroke", B),
                                o.mode >= m.Mode.STROKE && y.set("stroke-width", g.formatNumber(o.lineWidth)),
                                y.setElementStyle(l),
                                l.append(p),
                                e.peek().append(l));
                        }.bind(this)
                ...
                (v.prototype._getGradient = function (e) {
                    for (var t = 0; t < this.lines.length; t++) if (this.lines[t]._getGradient(e)) return this.lines[t]._getGradient(e);
                    return null;
                }),
                    ...
                    var c = function (t) {
                        ...
                        if (
                            (t instanceof o
                                ...
                                : t instanceof a && (i = p.createSvgRadialGradient(e, e.svgDoc, t)),
                            !i)
                        )
