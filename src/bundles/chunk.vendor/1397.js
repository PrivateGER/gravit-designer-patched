                ...
                (p.prototype.paintInlineImageXObject = function (e) {
                        ...
                        (!(function (e, t) {
                            if ("undefined" != typeof ImageData && t instanceof ImageData) e.putImageData(t, 0, 0);
                                ...
                                if (t.kind === h) {
                                        ...
                                        for (o = n < d ? 16 : u, i = 0, r = 0; r < o; r++) {
                                            for (var x = v - m, P = 0, S = x > w ? p : 8 * x - 7, T = -8 & S, I = 0, F = 0; P < T; P += 8)
                                                ((F = y[m++]),
                                                    ...
                                                    (b[i++] = 2 & F ? E : B),
                                                    (b[i++] = 1 & F ? E : B));
                                            for (; P < S; P++) (0 === I && ((F = y[m++]), (I = 128)), (b[i++] = F & I ? E : B), (I >>= 1));
                                        }
                                        for (; i < C; ) b[i++] = 0;
                                    ...
                                    if (t.kind !== A) throw new Error("bad image kind: " + t.kind);
                    ...
                    for (var _ = t, v = i, b = "prescale1"; (u > 2 && _ > 1) || (f > 2 && v > 1); ) {
                        ...
                        (u > 2 && _ > 1 && (u /= _ / (C = Math.ceil(_ / 2))),
                            ...
                            (y = (o = this.cachedCanvases.getCanvas(b, C, w)).context).clearRect(0, 0, C, w),
