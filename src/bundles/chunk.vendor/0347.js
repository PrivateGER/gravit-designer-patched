            ...
            (n.inheritAndMix("GPGEdge", d, n, [n.Store, n.Container, n.Properties, a, GStylable, n.Multireference]),
                ...
                (d.prototype._styleRepaint = function (e) {
                    this._parent instanceof n.MapContainer &&
                        ...
                        this._parent.getParent()._notifyChange(p._Change.InvalidationRequest);
                }),
                (d.prototype._styleFinishGeometryChange = function (e) {
                    this._parent instanceof n.MapContainer &&
                        this._parent.getParent() &&
                        "Paths Graph" === n.getName(this._parent.getParent()) &&
                        this._parent.getParent()._notifyChange(p._Change.FinishGeometryUpdate, 1);
                }),
                ...
                (d.prototype.getStartAngle = function () {
                    ...
                    return (
                        (null !== n && null !== r) ||
                            ...
                            (r = e.getProperty("hly")),
                            (null !== n && null !== r) || ((n = e.getProperty("x")), (r = e.getProperty("y")))),
                ...
                (d.prototype.getFirstSegment = function (e, t) {
                    ...
                    if ((r.deserialize(n.getNext().serialize()), t && t > 0 && t < 1)) {
                        ...
                        if (null !== o && null !== a && null !== s && null !== l) {
                            ...
                            (A.getCtrlPtsCasteljau(i.getProperty("x"), o, s, r.getProperty("x"), t, 1, h),
                                A.getCtrlPtsCasteljau(i.getProperty("y"), a, l, r.getProperty("y"), t, 1, p),
                                i.setProperties(["hrx", "hry"], [h[1], p[1]]),
                                r.setProperties(["hlx", "hly", "x", "y", "hrx", "hry"], [h[2], p[2], h[3], p[3], null, null]));
                        } else if ((null !== o && null !== a) || (null !== s && null !== l)) {
                            var u = null !== o && null !== a ? o : s,
                                d = null !== o && null !== a ? a : l;
                            ((h = new Float64Array(3)), (p = new Float64Array(3)));
                            (A.divideQuadraticCurve(i.getProperty("x"), u, r.getProperty("x"), t, h),
                                A.divideQuadraticCurve(i.getProperty("y"), d, r.getProperty("y"), t, p),
                                i.setProperties(["hrx", "hry"], [h[1], p[1]]),
                                r.setProperties(["hlx", "hly", "x", "y", "hrx", "hry"], [null, null, h[2], p[2], null, null]));
                        } else {
                            var g = A.getPointAtSegment(i.getProperty("x"), i.getProperty("y"), r.getProperty("x"), r.getProperty("y"), t);
                            r.setProperties(["x", "y", "hrx", "hry"], [g.getX(), g.getY(), null, null]);
                        }
                    }
                    var f = new c();
                    return (
                        e
                            ? (r.flip(), f.getAnchorPoints().appendChild(r), i.flip(), f.getAnchorPoints().appendChild(i))
                            : (f.getAnchorPoints().appendChild(i), f.getAnchorPoints().appendChild(r)),
                        f
                    );
                }),
                (d.prototype.getLastSegment = function (e, t) {
                    ...
                    if ((r.deserialize(n.getPrevious().serialize()), t && t > 0 && t < 1)) {
                        ...
                        if (null !== o && null !== a && null !== s && null !== l) {
                            var h = new Float64Array(4),
                                p = new Float64Array(4);
                            (A.getCtrlPtsCasteljau(r.getProperty("x"), o, s, i.getProperty("x"), 1 - t, 2, h),
                                A.getCtrlPtsCasteljau(r.getProperty("y"), a, l, i.getProperty("y"), 1 - t, 2, p),
                                r.setProperties(["hlx", "hly", "x", "y", "hrx", "hry"], [null, null, h[0], p[0], h[1], p[1]]),
                                i.setProperties(["hlx", "hly"], [h[2], p[2]]));
                        } else if ((null !== o && null !== a) || (null !== s && null !== l)) {
                            var u = null !== o && null !== a ? o : s,
                                d = null !== o && null !== a ? a : l;
                            ((h = new Float64Array(3)), (p = new Float64Array(3)));
                            (A.divideQuadraticCurve(r.getProperty("x"), u, i.getProperty("x"), 1 - t, null, h),
                                A.divideQuadraticCurve(r.getProperty("y"), d, i.getProperty("y"), 1 - t, null, p),
                                r.setProperties(["hlx", "hly", "x", "y", "hrx", "hry"], [null, null, h[2], p[2], null, null]),
                            ...
                            r.setProperties(["hlx", "hly", "x", "y"], [null, null, g.getX(), g.getY()]);
                        }
                    }
                    var f = new c();
                    return (
                        e
                            ? (i.flip(), f.getAnchorPoints().appendChild(i), r.flip(), f.getAnchorPoints().appendChild(r))
                            : (f.getAnchorPoints().appendChild(r), f.getAnchorPoints().appendChild(i)),
                        f
                    );
                }),
                ...
                (d.prototype._paintBorder = function (e, t, i, n, r) {
                    ...
                    var a = e.canvas,
                        ...
                        _ = s.LineCap.Butt;
                    m && y
                        ? ((_ = r.$_blc), (r.$_bhm || r.$_btm) && (_ = r.$_btmi || r.$_bhmi ? s.LineCap.Butt : s.LineCap.Square))
                        : m || y
                          ? r.$_blc != s.LineCap.Round || (r.$_blj != s.LineJoin.Round && r.$_blj != s.LineJoin.Miter)
                              ? this.$_blc == s.LineCap.Square &&
                                r.$_blj == s.LineJoin.Miter &&
                                ((_ = s.LineCap.Square),
                                ((r.$_bhm && m) || (r.$_btm && y)) && (_ = r.$_btmi || r.$_bhmi ? s.LineCap.Butt : s.LineCap.Square))
                              : ((_ = s.LineCap.Round),
                                ((r.$_bhm && m) || (r.$_btm && y)) &&
                                    (r.$_btmi || r.$_bhmi
                                        ? (_ = s.LineCap.Butt)
                    ...
                    if (n)
                        void 0 !== a.putVertices(A) &&
                            (a.strokeVertices(h.BLACK, p, r.$_bds, _, r.$_blj, r.$_bml, 1), o._paintBorderMarkers(e, h.BLACK, r));
                    else {
                        ...
                        try {
                            ...
                            if (w) {
                                var E = 0.5 * r.$_bw;
                                if (t) ((E /= t.getScaleFactor()), (w = w.expanded(E, E, E, E)));
                            ...
                            if (B && B.paint && void 0 !== b.putVertices(A)) {
                                ...
                                B.transform &&
                                    ...
                                    ((x = B.transform),
                                    t && (x = x.multiplied(t)),
                                    r.$_px && !r.$_px.isIdentity() && (x = x.preMultiplied(r.$_px)));
