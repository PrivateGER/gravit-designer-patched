module.exports = function (module, exports, require) {
            ...
            (n.inheritAndMix("ann", a, r, [n.Container, n.Properties, n.Store, n.Reference, o]),
                ...
                (a.prototype._handleChange = function (e, t) {
                    if (e === n._Change.Store) {
                        ...
                        if (this.recordedTransaction || t.options.recordedTransaction) {
                            for (
                                var s = Object.keys(o.MetaProperties), l = t.options.recordedProperties || {}, h = {}, A = 0, c = s.length;
                                A < c;
                                A++
                            ) {
                                var p = s[A];
                    ...
                    } else if (e === n._Change.Restore) this.restoreProperties(t.blob, a.MetaProperties, this.restoreAction.bind(this, t));
                    else if (e == n._Change.AfterPropertiesChange) {
                        t.properties.indexOf("vis") >= 0 && this._updateVisibility();
                    } else e === n._Change.BeforePropertiesChange && this.handleBeforePropertiesChange(t);
