                ...
                ((N.MAXLENGTH = 8192),
                    ...
                    (N._deserializeContent = function (e, t) {
                        if ("fontColor" === e) {
                            ...
                            if ("object" == typeof t) return 3 === t._value.length ? new _(t._value) : new T(t._value);
                        }
                        return t;
                    }),
                    ...
                    Object.defineProperty(N.prototype, "_deserializedBackupPaths", {
                        get: function () {
                            if (this.__deserializedBackupPaths) return this.__deserializedBackupPaths;
                                ...
                                var i = e.cloneAnchorPoints(),
                                    n =
                                        e instanceof F || e.getProperty("closed")
                                            ? new F(e.getProperty("closed"), e.getProperty("evenodd"), i)
                    ...
                    (N.prototype._attachPath = function (e, t) {
                        ...
                        if (i) {
                            ...
                            (i.setPath(
                                ...
                                t ? (this.$tptho ? this.$tptho - n / 2 + 0.5 : -n / 2 + 0.5) : this.$tptho,
                                this.$tpthl
                            ),
                                t && (this.hasPathAttached() || this.isRecordedTransaction() || (this._oldTrf = this.getProperty("trf"))),
                    ...
                    (N.prototype._calculatePreTransformRect = function (e) {
                        ...
                        if (e && e.invertible()) {
                            ...
                            (t = this.getGeometryBBox())
                                ? ((i = e.inverted().mapQuadrilateral(t)), (t = C.fromPoints.apply(null, i)))
                                : (t = null);
                    ...
                    (N.prototype._calculateGeometryBBox = function (e) {
                        if (this.isFakeText()) {
                            for (
                                var t = this._deserializedBackupPaths.length ? this._deserializedBackupPaths[0].getGeometryBBox(e) : null,
                                    i = 1;
                                i < this._deserializedBackupPaths.length;
                                i++
                            )
                        ...
                        if (this._runsDirty || !r.getCanvas()) {
                            ...
                            (r.setWidth(this.$aw ? f.AUTO : this._getWidth() - 2 * N.HMARGIN),
                                ...
                                (-1 === this.$h || this.hasPathAttached()) && (this.$h = r.getHeight() + 2 * N.VMARGIN));
                        }
                        if (e) {
                            if (r.constructor === f) {
                    ...
                    (N.prototype._calculatePaintBBox = function (e, t) {
                        ...
                        if (i) {
                            ...
                            if (n) {
                                var r = Math.max(2 * n.getLeftPadding(), 2 * n.getRightPadding()),
                                    o = 2 * n.getTopPadding();
                                if (
                    ...
                    (N.prototype.setText = function (e, t, i) {
                        ...
                        if (((e = this._shorten(e)), M.OperatingSystem.Windows && (e = a.replaceMicrosoftLineFeed(e)), r)) {
                            ...
                            if (
                                ...
                                this._startText || (this._startText = p ? JSON.stringify(r.getRichContent(), N._serializeContent) : e),
                                !p)
                            )
                                return;
                            if (((this._setTextWhenAvailable = !1), (this._tempText = null), t)) {
                                ...
                                for (m = c, c = 0; c < v && n.charAt(g - c - 1) == f.charAt(d - c - 1); ) c++;
                    ...
                    (N.prototype.getPlainText = function () {
                        var e = null,
                            t = this.getTLCore();
                        return (
                            t ? (e = t.getDocumentRange().plainText()) || (e = this._startText) : this._tempText && (e = this._tempText),
                            e
                        );
                    }),
                    ...
                    (N.prototype.getTextShapes = function () {
                        ...
                        (e.setWidth(this.$aw ? f.AUTO : this._getWidth() - 2 * N.HMARGIN),
                            e.setHeight(this.$ah ? f.AUTO : this._getHeight() - 2 * N.VMARGIN));
                        var t = [],
                            i = [],
                        ...
                        if (n && "transparent" !== n) {
                            ...
                            for (var r = t.length - 2; r >= 0; r--) {
                                ...
                                o.fill == a.fill &&
                                    ...
                                    (t.splice(r, 1), o.vertices && a.vertices && a.vertices.appendVertices(o.vertices));
                            }
                            m = this.$trf || new B();
                    ...
                    (N.prototype.readVertex = function (e, t) {
                        ...
                        if (
                            ...
                            (i && e.command !== S.Command.Close && this.$trf) ||
                                (this.hasPathAttached() && this._tlCore && this._tlCore.isInitialized()))
                        ) {
                            var n;
                            if (this.hasPathAttached()) {
                    ...
                    (N.prototype.assignFrom = function (e) {
                        (e instanceof N && this.transferProperties(e, [N.GeometryProperties, N.MetaProperties]),
                    ...
                    (N.prototype.hasVertexForRead = function () {
                        return this.isFakeText()
                            ? this._deserializedBackupPaths[this._vertexIterator] &&
                                  this._deserializedBackupPaths[this._vertexIterator].hasVertexForRead()
                    ...
                    (N.prototype.setBounds = function (e, t, i, n) {
                        if (!this.hasPathAttached()) {
                            var r = this.$trf,
                                o = new B().scaled(i / this._getWidth(), n / this._getHeight()).translated(e, t);
                            if (r) {
                                var a = r.inverted();
                                a && (o = o.multiplied(a));
                            }
                    ...
                    (N.prototype.transformSourceBBox = function (e, t, i, n, r) {
                        if (e) {
                            ...
                            m.getMatrix();
                            return (
                                (m = m.preMultiplied(new B(o[0] < 0 ? -1 : 1, 0, 0, o[3] < 0 ? -1 : 1, y.getX(), y.getY()))),
                                this.setProperties(["w", "h", "trf", "aw", "ah"], [u, d, m, g, f]),
                                this._notifyChange(E._Change.FinishGeometryUpdate),
                                h && A
                                    ? new B((u / h) * (o[0] < 0 ? -1 : 1), 0, 0, (d / A) * (o[3] < 0 ? -1 : 1), y.getX(), y.getY())
                                    : null
                            );
                        }
                        return null;
                    ...
                    (N.prototype._detailHitTest = function (e, t, i, n) {
                        if (this.isFakeText() && N.HITTEST_TEXT) return b.prototype._detailHitTest.call(this, e, t, i, n);
                        var r;
                        if ((this.isFakeText() || (r = this.getTLCore()), N.HITTEST_TEXT && r && r.getCanvas())) {
                            ...
                            for (var u = 0; u < p.length; u++)
                                for (
                                    ...
                                    0 !== _[w] &&
                                        (d = (i - (g = (w >> 2) % h)) * (i - g) + (i - (f = (w >> 2) / h)) * (i - f)) < v &&
                                        ((v = d), (C = w));
                    ...
                    (N.prototype.getTLCore = function () {
                        ...
                        if (!this._tlCore.isInitialized()) {
                            ...
                            for (
                                var t, i, n = this._tlCore.getDocumentRange(), r = this.getStylePropertySets(), o = r.length - 1;
                                o >= 0;
                                o--
                            ) {
                            ...
                            if (
                                ...
                                this._beginBlockChanges([E._Change.PrepareGeometryUpdate, E._Change.FinishGeometryUpdate]);
                                ...
                                (this._endBlockChanges([E._Change.PrepareGeometryUpdate, E._Change.FinishGeometryUpdate]),
                            ...
                            case "_fc":
                                o =
                                    i instanceof _
                                        ...
                                        : null === i
                                          ? "transparent"
                                          : ("string" == typeof i || i instanceof String) && (o = n.deserialize(i))
                                            ? o.toScreenCSS()
                                            : i;
                                break;
                            case "_pal":
                    ...
                    (N.prototype.getProperty = function (e, t, i, n, r) {
                        ...
                        if (r) {
                            ...
                            if (
                                ...
                                for (var a in ((c = A.getFormatting()), A.doc.nextInsertFormatting)) c[a] = A.doc.nextInsertFormatting[a];
                            ...
                            if ("content" == V) ((m = t[J] || this._startText), (y = !0));
                                ...
                                (D =
                                    k instanceof F || k.getProperty("closed")
                                        ? new F(k.getProperty("closed"), k.getProperty("evenodd"), O)
                        ...
                        for (J = 0; J < e.length; J++) {
                            ...
                            (L && (y = !0),
                                "fontWeight" == L
                                    ...
                                    : "fontStyle" == L
                                      ? (Y instanceof Array && (Y = 1 !== Y.length || Y[0] instanceof Array ? null : Y[0]), (f = Y))
                                      : "fontFamily" == L
                            ...
                            for (var J = 0; J < W.length; J++)
                                for (var q = 0; q < Z.length; q++)
                                    for (var K = 0; K < H.length; K++) {
                                        (X = this._workspace.getFontManager().getFont(W[J], Z[q], H[K])).isResolved() ||
                                            (j.indexOf(X) < 0 && j.push(X), this._requireResolvedFont(X));
                                    }
                            var $ = {
                                    fontFamily: p,
                                    fontStyle: f,
                                ...
                                ee = function (e, t) {
                                    for (
                                        ...
                                        if (
                                            ...
                                            var f = this._shorten(JSON.parse(e.content, N._deserializeContent)),
                                                m = {};
                                            m.fontFamily = p;
                                            var y = {};
                                            ((y.fontFamily = u),
                            ...
                            if (
                                ...
                                if (U) {
                                    if (!R && this._attachedPath) {
                                        ...
                                        (D =
                                            this._attachedPath instanceof F || this._attachedPath.getProperty("closed")
                                                ? new F(
                    ...
                    (N.prototype._replaceFF = function (e, t, i) {
                        if (e && t && i) {
                            ...
                            if (e instanceof Array) for (var r = 0; r < e.length; ++r) n(e[r]);
                            else n(e);
                        }
                    }),
                    ...
                    (N.prototype._fixText = function (e) {
                        return (
                            e instanceof Array || !(e instanceof Object) || e instanceof String || !e.hasOwnProperty("text") || (e = [e]),
                            e
                        );
                    }),
                    ...
                    (N.prototype.isFakeText = function () {
                        return (
                            ...
                            this._isVirgin &&
                            ((this._serializedBackupPaths && !!this._serializedBackupPaths.length) ||
                                (this._deserializedBackupPaths && !!this._deserializedBackupPaths.length))
                        );
                    }),
                    ...
                    (N.prototype._fixFontAttributes = function (e) {
                        if (e.ct && (e._tff || e._tfs || e._tfw)) {
                            ...
                            for (var i = 0; i < e.ct.length; i++) {
                                ...
                                if (
                                    (e._tff &&
                                        this._getGravitValue("fontFamily", n.fontFamily) !== e._tff &&
                                        (t && console.warn("invalid tff"), delete e._tff),
                                    e._tfw &&
                                        this._getGravitValue("fontWeight", n.fontWeight) !== e._tfw &&
                    ...
                    (N.prototype._handleChange = function (e, t) {
                        if (e === r._Change.Store) {
                            ...
                            (n && !this._tempText
                                ...
                                this.storeProperties(t.blob, N.GeometryProperties, function (e, t) {
                                    return "ttrf" === e && t
                                        ? B.serialize(t)
                                        : "content" === e && i
                                            ...
                                            try {
                                                if (this.isFakeText())
                                                    this._deserializedBackupPaths &&
                                                        (i = this._deserializedBackupPaths.map(function (e) {
                                                            return r.store(e);
                                                        }));
                                                else {
                                ...
                                var d = function (e, t, i, n) {
                                        if (e && t) {
                                            ...
                                            if ("text" === r) d(e.ct, t, i);
                                                ...
                                                for (var l = e.$, h = 0; h < l.length; h++) d(l[h], t, i);
                                        }
                                    }.bind(this),
                                    g = [];
                                (d(o, g, null, !0),
                            ...
                            S
                                ? (t.properties.splice(y, 1),
                                  t.values.splice(y, 1),
                                  T && (y < _ && _--, t.properties.splice(_, 1), t.values.splice(_, 1)))
                        ...
                        if (n) {
                            ...
                            try {
                                var c = n.getCanvas(y.RENDERFLAG_FILL),
                                    u = !!c && (!(c instanceof k.RendererCanvas) || (c instanceof k.RendererCanvas && c.isRendered()));
                                if (
                                    1 * A !== this._lastResolutionFill ||
                                    this._runsDirty ||
                                    !u ||
                                    (this._lastFillPaintLayer !== i &&
                                        ((i && i.hasStyle()) || (this._lastFillPaintLayer && this._lastFillPaintLayer.hasStyle())))
                                ) {
                                    if (r && r.transform) {
                                        if (i.$_pt && i.$_pt instanceof m && i.$_pt.getTransform()) {
                                            var d = a ? B.getNativeRectTransformation(a) : new B(),
                                                ...
                                                b = a ? a.getHeight() : 1,
                                                C = g
                                                    .multiplied(new B(_, 0, 0, _, -_ * f.getX(), -_ * f.getY()))
                                                    .multiplied(d)
                                                    .multiplied(new B(1 / _, 0, 0, 1 / _, f.getX() * v * _, f.getY() * b * _));
                                            r.transform = C;
                                        }
                                    ...
                                    (n.render(this._isEdited, 1 * A, w, y.RENDERFLAG_FILL | y.RENDERFLAG_VERTEX | y.RENDERFLAG_SCALEBITMAP),
                                ...
                                ((E = (E = this.$trf
                                    ...
                                    : new (Function.prototype.bind.apply(B, [null].concat(x.getMatrix())))()).preMultiplied(S)),
                                    s.setTransform(E));
                                        ...
                                        (s.drawImage(
                                            ...
                                            c instanceof k.RendererCanvas ||
                                                (M.hardware === M.Hardware.Desktop &&
                                                    ((void 0 !== t && t.release && "node" === t.release.name) ||
                                ...
                                if (u && u.paint) {
                                    ...
                                    try {
                                        var f = n.getCanvas(y.RENDERFLAG_STROKE),
                                            _ = !(f instanceof k.RendererCanvas) || (f instanceof k.RendererCanvas && f.isRendered());
                                        if (
                                            ...
                                            if ((i.$_ba !== p.BorderAlignment.Center && (d *= 2), u.transform && u.transform.isValid())) {
                                                if (i.$_pt && i.$_pt instanceof m && i.$_pt.getTransform()) {
                                                    var v = a ? B.getNativeRectTransformation(a) : new B(),
                                                        ...
                                                        P = a ? a.getHeight() : 1,
                                                        S = b
                                                            .multiplied(new B(w, 0, 0, w, -w * C.getX(), -w * C.getY()))
                                                            .multiplied(v)
                                                            .multiplied(new B(1 / w, 0, 0, 1 / w, C.getX() * E * w, C.getY() * P * w));
                                                    u.transform = S;
                                                }
                                            ...
                                            (n.render(
                                                ...
                                                1 * A,
                                                F,
                                                y.RENDERFLAG_STROKE | y.RENDERFLAG_VERTEX | y.RENDERFLAG_SCALEBITMAP
                                            ),
                                        ...
                                        ((R = (R = this.$trf
                                            ...
                                            : new (Function.prototype.bind.apply(B, [null].concat(D.getMatrix())))()).preMultiplied(Q)),
                                            s.setTransform(R));
                    ...
                    (N.prototype.createShapePaint = function (e, t, i) {
                        if (t instanceof s) {
                            ...
                            if (
                                ((a = (a = a.scaled(1 / o, 1 / o)).translated(r.getX() * l, r.getY() * l)),
                                this.$trf && this.$trf.invertible())
                            ) {
                                var A = this.$trf.inverted(),
                                    c = A.getTranslation();
                                a = (a = (a = (a = a.multiplied(A)).translated(-c.getX(), -c.getY())).translated(
                                    c.getX() * o * l,
                                    c.getY() * o * l
                                )).translated(-N.HMARGIN, -N.VMARGIN);
                            }
                            return (
                                this._resetFxCacheAndState(),
                                {
                                    ...
                                    for (var n = this._fontsToResolve.length - 1; n >= 0; --n)
                                        if (
                                            ...
                                            for (var r = this._deferredRangeSetters.length - 1; r >= 0; --r)
                                                this._deferredRangeSetters[r].func.call(this, this._deferredRangeSetters[r].vars) &&
                            ...
                            if (e) {
                                ...
                                if (t) {
                                    ...
                                    if (i && (!this._lastActualBounds || this._lastActualBounds.b !== i.b)) {
                                        ...
                                        var n,
                                            r,
                                            o = this.getProperty("_tfi") || u.defaultFormatting.fontSize,
                                            a = t.getHeight() / i.b;
                                        a > 1
                                            ? ((n = Math.max(6, Math.floor(o))), (r = Math.min(72, Math.ceil(o * a) + 5)))
                                            : ((n = Math.max(6, Math.floor(o * a) - 5)), (r = Math.ceil(o)));
