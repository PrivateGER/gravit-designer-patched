module.exports = function (e, t, i) {
            ...
            (o.inheritAndMix("GPGFacet", v, o, [o.Store, o.Properties, s, o.Multireference]),
                ...
                (v.prototype.getStylePropertySets = function () {
                    return [s.PropertySet.BorderPaintLayers, s.PropertySet.FillPaintLayers];
                }),
                ...
                (v.prototype.init = function (e) {
                    ...
                    for (var t, i = null, n = null, r = 0; r < e.length; ++r) {
                        ...
                        if ((this._directedEdges.appendChild(o), n)) {
                            if ((t = o.getStartPoint()).getX() != n.getX() && t.getY() != n.getY()) return (this._init(), !1);
                        } else i = o.getStartPoint();
                        n = o.getEndPoint();
                    }
                    if (i.getX() != n.getX() && i.getY() != n.getY()) return (this._init(), !1);
                    for (var a = new f.AnchorPoints(), s = null, h = null, A = this._directedEdges.getFirstChild(); A; A = A.getNext()) {
                        ...
                        (c.getAnchorPoints().removeChild(p),
                            a.getFirstChild()
                                ? a
                                      ...
                                      .setProperties(
                                          ["ah", "tp", "hrx", "hry"],
                                          [!1, f.AnchorPoint.Type.Asymmetric, p.getProperty("hrx"), p.getProperty("hry")]
                                      )
                        ...
                        a.getLastChild().setProperties(["ah", "tp", "hrx", "hry"], [!1, f.AnchorPoint.Type.Asymmetric, s, h]);
                    }
                ...
                (v.prototype.isInside = function (e, t) {
                    if (this._path) {
                        var i = new m();
                        if (r.hitTest(e.getX(), e.getY(), this._path, 0, !0, i, t)) return !i.outline;
                    }
                    return !1;
                }),
                (v.prototype.getPath = function () {
                                        ...
                                        if (
                                            ...
                                            if (
                                                ...
                                                (A.strokeVertices(d.White, 1, null, null, null, 1, s.$_op, u.CompositeOperator.SourceOver),
                                                    l.transform && (g = A.setTransform(A.getTransform(!0).preMultiplied(l.transform))));
