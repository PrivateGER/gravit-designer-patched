            ...
            ((h.prototype._options = null),
                ...
                (h.prototype._popStyles = function (e) {
                    ...
                    ((this._isStroke = t._isStroke),
                        ...
                        (this._dc_globalCompositeOperation = t._dc_globalCompositeOperation),
                ...
                (h.prototype.moveTo = function (e, t) {
                    Number.isNaN(e) ||
                        Number.isNaN(t) ||
                        (this._svg.length > 0 && (this._svg += " "), (this._svg += "M " + l.formatNumber(e) + " " + l.formatNumber(t)));
                }),
                (h.prototype.lineTo = function (e, t) {
                    Number.isNaN(e) ||
                        Number.isNaN(t) ||
                        (this._svg.length > 0 && (this._svg += " "), (this._svg += "L " + l.formatNumber(e) + " " + l.formatNumber(t)));
                }),
                (h.prototype.quadraticCurveTo = function (e, t, i, n) {
                    Number.isNaN(e) ||
                        ...
                        (this._svg +=
                            "Q " + l.formatNumber(e) + " " + l.formatNumber(t) + " " + l.formatNumber(i) + " " + l.formatNumber(n)));
                }),
                ...
                (h.prototype.drawImage = function (e, t, i) {
                    if (e._canvasContext)
                        if (e._canvasContext instanceof h) {
                            ...
                            (0 != n._svg.length ||
                                ("destination-out" != n.globalCompositeOperation && "destination-in" != n.globalCompositeOperation) ||
                                ...
                                (e._canvasContext.globalCompositeOperation = this._dc_globalCompositeOperation),
                                e._canvasContext._pushStyles(this._svgStyles));
                        } else console.error("GSVGContext:drawImage does not accept type " + e);
                }),
