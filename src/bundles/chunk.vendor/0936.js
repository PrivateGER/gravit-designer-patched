                ...
                (s.prototype.drawFragmentTo = function (e, t, i, n, r, a, s) {
                    ...
                    this._iterateGrid(function (t, i, a) {
                        var s = new o(i, a, t.getWidth(), t.getHeight()),
                            h = l.intersected(s);
                        h.isEmpty() ||
                            (e.clearRect(h.getX() + n, h.getY() + r, h.getWidth(), h.getHeight()),
                            e.drawImageFragment(t, h.getX() - i, h.getY() - a, h.getX() + n, h.getY() + r, h.getWidth(), h.getHeight()));
                    });
                }),
                ...
                (s.prototype.drawFragmentFrom = function (e, t, i, r, a, s, l) {
                    ...
                    for (
                        h = this._itemWidth * Math.floor(p.getX() / this._itemWidth),
                            c = A = this._itemHeight * Math.floor(p.getY() / this._itemHeight);
                        h < p.getX2();
                        ...
                        for (A = c; A < p.getY2(); ) {
                            ...
                            if (!d.isEmpty()) {
                                ...
                                (g.canvas.clearRect(d.getX() - h, d.getY() - A, d.getWidth(), d.getHeight()),
