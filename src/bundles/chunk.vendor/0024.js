module.exports = function (module, exports, require) {
            ...
            (Object.defineProperty(h.userConfig, "userName", {
                get: function () {
                    return String.get(new s("GEditorOptions", "text.anonymous-user"), "Anonymous");
                },
                enumerable: true,
                configurable: true,
            }),
                (h.isPreserveAspectRatioEnabledForSide = function (e) {
                    return (
                        !(!h.annotationHandles.preserveAspectRatio || !h.annotationHandles.preserveAspectRatio.enabled) &&
