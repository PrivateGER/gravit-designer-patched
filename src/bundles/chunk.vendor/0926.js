module.exports = function (module, exports, require) {
            ...
            function o(e, t) {
                if (e._runs !== t._runs) throw new Error("Characters for different documents");
            }

            function a(e, t) {
                for (; t < e.length; t++) if (0 != n.getTextLength(e[t].text)) return new r.Character(e, t, 0);
            ...
            ((r.prototype._runArray = null),
                ...
                (r.Character = function (e, t, i) {
                    ((this._runs = e),
                        (this._run = t),
                        (this._offset = i),
                        (this.char = t >= e.length ? null : e[t].text ? n.getTextChar(e[t].text, i) : null));
                }),
