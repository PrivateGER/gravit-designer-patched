                ...
                (o.hardware = (function () {
                    ...
                    try {
                        var e = [
                                ...
                                [[r.DEVICE.VENDOR, "Samsung"], r.DEVICE.MODEL, [r.DEVICE.TYPE, r.DEVICE.TABLET]],
                            ],
                            t = new r({
                                device: e,
                            }).getResult(),
                    ...
                    return (
                        "undefined" != typeof navigator &&
                            navigator.userAgent &&
                            ((a = !!navigator.userAgent.match(/(iPad|SCH-I800|xoom|kindle)/i)),
                            ...
                            (l = !!navigator.userAgent.match(/(macintosh)/i) && navigator.maxTouchPoints && navigator.maxTouchPoints > 1)),
                        a || l ? o.Hardware.Tablet : s ? o.Hardware.Phone : o.Hardware.Desktop
                    );
                })()),
