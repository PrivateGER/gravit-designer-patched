            ...
            (IsFiniteNonNegativeNumber.inheritAndMix(R, d, [r.Container, w.Transform, w.Layout, w.Stylable, w.Accelerated, p]),
                ...
                (R.prototype.getAngle = function () {
                    ...
                    if (t && !t.isEmpty()) {
                        ...
                        (this.$trf && ((i = this.$trf.mapPoint(i)), (n = this.$trf.mapPoint(n))),
                            (e = S.normalizeAngleRadians(-Math.atan2(n.getY() - i.getY(), n.getX() - i.getX()))) > Math.PI && (e -= S.PI2));
                    }
                    return e;
                }),
                    ...
                    if (e.intersectsRect(t, n)) {
                        ...
                        if (r & w.CollisionFlag.FullyContained) {
                            ...
                            G
                                ...
                                : this.hasStyleFill() &&
                                  (G = v((I = 1 === B.length ? S.getSecondPoly() : S._makePolygon(this)), S.getFirstPoly().point)) &&
                                  a(
                                      E
                                          ? {
                                                element: this,
                            ...
                            function (i, r) {
                                ...
                                try {
                                    (this._paintFill(e, t, r),
                                        n.drawCanvas(o, 0, 0, null, i > 0 ? u.CompositeOperator.DestinationIn : null));
                                } finally {
                ...
                (R.prototype.createShapePaint = function (e, t, i) {
                    ...
                    if (t instanceof s) {
                        ...
                        return (
                            this.$trf && this.$trf.invertible() && (c = c.multiplied(this.$trf.inverted())),
                    ...
                    if (t instanceof l) {
                        ...
                        return (
                            t.addEventListener(l.UpdateEvent, this._requestInvalidation.bind(this), this),
                ...
                (R.prototype.getPatternBBox = function (e) {
                    ...
                    return (
                        (t && !t.isEmpty()) ||
                            ((t = this.getGeometryBBox(e)), this.$trf && this.$trf.invertible() && (t = this.$trf.inverted().mapRect(t))),
                        t
                    );
                }),
                ...
                (R.prototype._paintFill = function (e, t, i) {
                    if (!e.configuration.isOutline(e) && this.hasStyleFill()) {
                        ...
                        if (r) {
                            ...
                            if (
                                (r.transform &&
                                    (this.$trf && (r.transform = r.transform.multiplied(this.$trf)),
                    ...
                    if (this.getFirstChild()) {
                        ...
                        if (n.containsRect(i)) {
                            if (void 0 === this._collidesWithChildren) {
                                ...
                                (r.addVertex(P.Command.Move, i.getX(), i.getY()),
                                    r.addVertex(P.Command.Line, i.getX(), i.getY() + i.getHeight()),
                                    r.addVertex(P.Command.Line, i.getX() + i.getWidth(), i.getY() + i.getHeight()),
                                    r.addVertex(P.Command.Line, i.getX() + i.getWidth(), i.getY()),
                                ...
                                (this.getCollisions(
                                    ...
                                    (this._collidesWithChildrenSeparate = 0 === a.length && o.length > 0));
                            }
                            if (this._collidesWithChildren) {
                                for (var s = this.getFirstChild(); null !== s; s = s.getNext()) s instanceof w && s.paint(e);
                                return;
                            }
                        ...
                        if (e.canvas.hasClip()) {
                            ...
                            try {
                                ...
                                try {
                                    for (s = this.getFirstChild(); null !== s; s = s.getNext()) s instanceof w && s.paint(e);
                                } finally {
                                    h.resetClip();
                                }
                            ...
                            c &&
                                (void 0 !== e.canvas.putVertices(this) &&
                                    (e.canvas.fillVertices(v.BLACK, 1, u.CompositeOperator.DestinationIn), c.drawCanvas(e.canvas)),
                                e.canvas.finish(),
                                e.popCanvas());
                        }
                    }
                    ...
                    if (this.hasStyleBorder()) {
                        ...
                        if (
                            ...
                            try {
                                ...
                                a.each(
                                    ...
                                    function (t, n) {
                                        ...
                                        if (r && r.paint) {
                                            (_.putVertices(y),
                                                _.strokeVertices(r.paint, A / 2, i.$_bds, i.$_blc, i.$_blj, i.$_bml, 1),
                            ...
                            if (w && w.paint && void 0 !== _.putVertices(y)) {
                                ...
                                (_.strokeVertices(w.paint, A, i.$_bds, i.$_blc, i.$_blj, E, i.$_op, i.getBlendingForContext(e)),
                    ...
                    if (this.hasStyleBorder()) {
                        ...
                        if (A && A.paint && void 0 !== o.putVertices(a)) {
                            ...
                            A.transform &&
                                ...
                                r.$_px && !r.$_px.isIdentity() && (m = m.preMultiplied(r.$_px)));
                ...
                (R.prototype._handleChange = function (e, t) {
                    if ((this._handleGeometryChangeForProperties(e, t, R.GeometryProperties), e === r._Change.Store))
                        ...
                        for (var i = this.getFirstChild(); null !== i; i = i.getNext())
                            i.hasMixin(w.Anchor) &&
                                (i.getProperty("vacr") || i.setProperty("vacr", w.Anchor.AnchorType.Start),
                                i.getProperty("hacr") || i.setProperty("hacr", w.Anchor.AnchorType.Start));
                ...
                (R.prototype._styleFinishGeometryChange = function (e) {
                    if ((w.Stylable.prototype._styleFinishGeometryChange.call(this, e), e)) {
                        ...
                        if ((this.getParent() instanceof R && this.getParent().isFakeContainer() && (t = this.getParent()), t)) {
                            ...
                            this._endBlockChanges([r._Change.BeforePropertiesChange, r._Change.AfterPropertiesChange]);
                        }
                    }
                }),
                ...
                (R.prototype._detailHitTest = function (e, t, i, n, r) {
                    if (this.hasStyleBorder()) {
                        ...
                        for (
                            var s = o * t.getScaleFactor() + 2 * i, l = new T(), h = this._getVertexHitCandidates(e, t, i), c = 0;
                            c < h.length;
                            c++
                        )
                    ...
                    if (this.hasStyleFill() || n) {
                        ...
                        var p = e,
                            u = t;
                        if (
                            (t && t.invertible() && ((u = null), (p = t.inverted().mapPoint(e))),
