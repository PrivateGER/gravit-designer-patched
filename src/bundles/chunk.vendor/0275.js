            ...
            (h.inherit(F, A),
                ...
                (F.prototype._applyPartMove = function (e, t, i, n) {
                    (e === b.RESIZE_HANDLE_PART_ID || e === b.ROTATION_HANDLE_PART_ID
                        ...
                        : (e.type != F.PartType.LeftHandle && e.type != F.PartType.RightHandle && e.type != F.PartType.Segment) ||
                            ...
                            for (
                                        ...
                                        (this._transformPreviewPointCoordinates(t, "x", "y", e),
                                            t.getProperty("ah") ||
                                                (null != t.getProperty("hlx") &&
                                                    ...
                                                    this._transformPreviewPointCoordinates(t, "hlx", "hly", e),
                                                null != t.getProperty("hrx") &&
                                                    null != t.getProperty("hry") &&
                                                    this._transformPreviewPointCoordinates(t, "hrx", "hry", e)));
                                    }.bind(this),
                                    a = 0;
                                ...
                                s.type === F.PartType.Point
                                    ...
                                    : s.type === F.PartType.Segment &&
                                      ...
                                      ((this._transformSubType = i.type), i.type == F.SegmentData.HitRes && (o(s.apLeft), o(s.apRight)));
                            }
                        }
                        if (this._selectionMode == F.SelectionMode.Anchors) {
                                ...
                                for (a = 0; a < this._partSelection.length; ++a) {
                                    for (var h = this._partSelection[a].point, A = h.getInEdges(), c = 0; c < A.length; ++c) {
                                        (d = A[c]).getSource().hasFlag(n.Flag.Selected)
                                            ? this._moveEdgesLinks[d.getId()] || (this._moveEdgesLinks[d.getId()] = d)
                            ...
                            if (u.length)
                                for (a = 0; a < u.length; ++a) {
                                    ...
                                    if ((d = this._element.getEdges().getById(g)) && m) {
                                        for (
                                            var y = d.getPathBase(), _ = new f(), v = y.getAnchorPoints().getFirstChild();
                                            null != v;
                                            v = v.getNext()
                                        )
                            ...
                            for (a = 0; a < this._partSelection.length; ++a) {
                                ...
                                for (A = w.getInEdges(), c = 0; c < A.length; ++c) {
                                    y = A[c].getPathBase();
                                    var E = this._element.getEdges().getById(A[c].getId()).getPathBase(),
                                        B =
                                            ((v = y.getAnchorPoints().getLastChild()),
                                            E.getAnchorPoints().getLastChild()._getTransformedCopy(l));
                                    v.setProperties(
                                        ["x", "y", "hlx", "hly"],
                                        [B.getProperty("x"), B.getProperty("y"), B.getProperty("hlx"), B.getProperty("hly")]
                                    );
                                }
                                for (p = w.getOutEdges(), c = 0; c < p.length; ++c) {
                                    ((y = p[c].getPathBase()),
                                        (E = this._element.getEdges().getById(p[c].getId()).getPathBase()),
                                        (v = y.getAnchorPoints().getFirstChild()),
                                        (B = E.getAnchorPoints().getFirstChild()._getTransformedCopy(l)));
                                    v.setProperties(
                                        ["x", "y", "hrx", "hry"],
                                        [B.getProperty("x"), B.getProperty("y"), B.getProperty("hrx"), B.getProperty("hry")]
                                    );
                                }
                                var x = this._partSelection[a].point.getPoint();
                                ((x = l.mapPoint(x)), w.setProperties(["x", "y"], [x.getX(), x.getY()]));
                            }
                        }
                        this.requestInvalidation();
                ...
                (F.prototype.resetTransform = function () {
                    (this.releasePreview(),
                        this._selectionMode == F.SelectionMode.Anchors &&
                            ((this._moveEdgesLinks = null), (this._updateFirstPtELinks = null), (this._updateLastPtELinks = null)),
                        (this._transformSubType = null),
                        C.prototype.resetTransform.call(this));
                }),
                (F.prototype.canApplyTransform = function () {
                    return (
                        (this._partSelection && this._partSelection.length > 0 && !this.hasFlag(b.Flag.ResizeAll)) ||
                ...
                (F.prototype._applyTransform = function (e, t, i, n) {
                    if (e instanceof f && this._partSelection && this._partSelection.length > 0 && !this.hasFlag(b.Flag.ResizeAll)) {
                        ...
                        if (this._partSelection && this._partSelection.length > 0 && !this.hasFlag(b.Flag.ResizeAll)) {
                            ...
                            else this._selectionMode == F.SelectionMode.Anchors && (a = this._partSelection.slice());
                            a && a.length && this._partsGeometryChanged(a);
                        } else this._transform && !this._transform.isIdentity() && A.prototype._applyTransform.call(this, e, t, i, n);
                        this.resetTransform();
                    }
                }),
                                ...
                                if (g && m)
                                    if (w.isEqualEps(c.slope, 0, 0.001))
                                        ...
                                        var y,
                                            ...
                                            B = c;
                                        if (
                                            (null !== p.getProperty("hrx") && null !== p.getProperty("hry")) ||
                                            (null !== u.getProperty("hlx") && null !== u.getProperty("hly"))
                                        )
                ...
                (F.prototype.getStylableParts = function () {
                    if (
                        ...
                        !this.hasFlag(b.Flag.ResizeAll) &&
                        (this._selectionMode == F.SelectionMode.Edge || this._selectionMode == F.SelectionMode.Facets)
                    ) {
                        for (var e = [], t = 0; t < this._partSelection.length; ++t) {
                            var i =
                                this._selectionMode == F.SelectionMode.Edge ? this._partSelection[t].edge : this._partSelection[t].facet;
                            if (i)
                ...
                (F.prototype._attach = function () {
                    ...
                    null != e &&
                        (e.addEventListener(p.GeometryChangeEvent, this._geometryChange, this),
                        e.addEventListener(n.AfterPropertiesChangeEvent, this._checkCustomStyle, this),
                        e.addEventListener(n.AfterInsertEvent, this._checkCustomStyle, this),
                        e.addEventListener(n.BeforeRemoveEvent, this._checkCustomStyle, this));
                }),
                (F.prototype._detach = function () {
                    ...
                    (null != t &&
                        ...
                        t.removeEventListener(n.AfterPropertiesChangeEvent, this._checkCustomStyle, this),
                        t.removeEventListener(n.AfterInsertEvent, this._checkCustomStyle, this),
                        t.removeEventListener(n.BeforeRemoveEvent, this._checkCustomStyle, this)),
                ...
                (F.prototype.hitAnchorPoint = function (e, t, i, n) {
                    if (e) {
                        ...
                        return (
                            ...
                            B.getAnnotationBBox(r, new o(e.getProperty("x"), e.getProperty("y")), s.annotationHandles.path.node.size)
                                .expanded(n, n, n, n)
                                .containsPoint(t)
                        );
                    }
                ...
                (F.prototype._getPartInfoAt = function (e, t, i) {
                    if (this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll)) {
                        ...
                        if (!this._editMode && this._pathBaseInEdit && this._selectionMode == F.SelectionMode.Edge) {
                            ...
                            if ((this._iteratePoints(this._pathBaseInEdit, null, A), d)) return d;
                        }
                    ...
                    if (this.hasFlag(b.Flag.ResizeAll)) {
                        ...
                        if (v && (v.id == b.RESIZE_HANDLE_PART_ID || v.id == b.ROTATION_HANDLE_PART_ID)) return v;
                    }
                    return null;
                }),
                    ...
                    if (e && e.editor == this)
                        if (e.id.type == F.PartType.Segment || e.id.type == F.PartType.Point) {
                            ...
                            if (e.id.type == F.PartType.Segment)
                                ...
                                for (
                                    var a = 0, s = e.id.edge.getPathBase().getAnchorPoints().getFirstChild();
                                    s && s != e.id.point;
                                    s = s.getNext(), ++a
                                );
                    ...
                    if (this._showAnnotations() && !this.hasFlag(b.Flag.ResizeAll))
                        for (
                            var r = (h = this.getGraphPaintElement()).getTransform(),
                                o = ((i = s.annotationHandles.path.graph), h.getAnchors().getFirstChild());
                            o;
                            o = o.getNext()
                        ) {
                            ...
                            this._iteratePoints(
                                ...
                                function (i) {
                                    (i.leftHandlePosition && this._paintControlHandle(e, t, i.position, i.leftHandlePosition),
                                        i.rightHandlePosition && this._paintControlHandle(e, t, i.position, i.rightHandlePosition));
                                ...
                                for (a = 0; a < r.length; ++a) {
                                    ...
                                    l ||
                                        (s.point
                                            ...
                                            : s.type == F.PartType.Segment &&
                                              (s.apLeft.removeFlag(n.Flag.Selected), s.apRight.removeFlag(n.Flag.Selected)));
                                }
                            if (c)
                                for (a = 0; a < c.length; ++a) {
                                    (s = c[a]).point
                                        ...
                                        : s.type == F.PartType.Segment &&
                                          (s.apLeft.setFlag(n.Flag.Selected), s.apRight.setFlag(n.Flag.Selected));
                                }
                        }
                        this.requestInvalidation();
                    }
                    ...
                    if (e && e.length) {
                        for (var n = !1, r = 0; r < e.length && !n; ++r)
                            switch (e[r].type) {
                                ...
                                case F.PartType.Segment:
                                    ((t = F.SelectionMode.Edge),
                                        this._editMode && e[r].type == F.PartType.Point && (e[r].type = F.PartType.Segment),
                                        (i = e[r].type));
                                    break;
                                case F.PartType.Facet:
                                    t == F.SelectionMode.None && ((t = F.SelectionMode.Facets), (i = F.PartType.Facet));
                            }
                        if (i) for (r = e.length - 1; r >= 0; --r) e[r].type != i && e.splice(r, 1);
                    }
                    return t;
                }),
                ...
                (F.prototype._paintOutline = function (e, t, i, r, o) {
                    ...
                    if (l instanceof d) A.prototype._paintOutline.call(this, e, t, i, r, o);
                    else {
                    ...
                    if (l instanceof d) {
                        ...
                        (r || this._selectionMode != F.SelectionMode.Edge || (y = t.selectionSecondOutlineColor),
                ...
                (F.prototype._iteratePoints = function (e, t, i) {
                    ...
                    for (var l = r.getFirstChild(); null != l; l = l.getNext()) {
                        ...
                        if (l.hasFlag(n.Flag.Selected) || (c && c.hasFlag(n.Flag.Selected)))
                            null !== (h = new o(l.getProperty("hrx"), l.getProperty("hry"))).getX() &&
                                null !== h.getY() &&
                ...
                (F.prototype.getPointsSelectionType = function () {
                    ...
                    if (this._partSelection && !this.hasFlag(b.Flag.ResizeAll))
                        if (this._partSelection.length > 1) e = F.PointsSelectionType.Several;
                ...
                (F.prototype.updatePartSelectionUnderCollision = function (e, t, i) {
                    ...
                    if (
                        (a.length &&
                            ...
                            (i
                                ? this._element.hasFlag(n.Flag.Highlighted) || this._element.setFlag(n.Flag.Highlighted)
                        ...
                        (this._element.hasFlag(n.Flag.Highlighted) && this._element.removeFlag(n.Flag.Highlighted),
                    ...
                    if (
                        ...
                        for (var r = 0; r < this._partSelection.length; ++r)
                            if (this._partSelection[r].type === F.PartType.Anchor) {
                                ...
                                for (
                                    var l = this._elementPreview.getAnchors().getById(this._partSelection[r].point.getId()),
                ...
                (F.prototype.movePoint = function (e, t, i, n) {
                    var r = this.getTransformFromNative(i),
                        a = r.inverted(),
                        s = a.mapPoint(t);
                    if (e.getProperty("ah")) e.setProperties(["x", "y"], [s.getX(), s.getY()]);
                    else {
                        var l = n || e,
                            h = l.getProperty("hlx"),
                            A = l.getProperty("hly"),
                        ...
                        e.setProperties(["x", "y", "hlx", "hly", "hrx", "hry"], [s.getX(), s.getY(), h, A, c, p]);
                    }
                }),
                ...
                (F.prototype.highlightPart = function (e, t) {
                    this.hasFlag(b.Flag.ResizeAll) ||
                        (((e.type != F.PartType.Segment && e.type != F.PartType.Point) || e.edge.hasFlag(n.Flag.Selected)) &&
                            (e.type != F.PartType.Anchor || e.point.hasFlag(n.Flag.Selected)) &&
                            (e.type != F.PartType.Facet || e.facet.hasFlag(n.Flag.Selected))) ||
                ...
                (F.prototype._movePreviewPointCoordinates = function (e, t, i, n, r, a, s) {
                    ...
                    (A && (c = A.mapPoint(c)),
                        this._transformPreviewPointCoordinates(e, t, i, new g(1, 0, 0, 1, l.getX() - c.getX(), l.getY() - c.getY())));
                }),
                ...
                (F.prototype._geometryChange = function (e) {
                    e.type == p.GeometryChangeEvent.Type.Before && e.element == this._element
                        ? this.requestInvalidation()
                ...
                (F.prototype._partsGeometryChanged = function (e) {
                    ...
                    try {
                        ...
                        if (
                            this._selectionMode == F.SelectionMode.Edge ||
                            (1 == e.length && e[0].type == F.PartType.Segment && this._transformSubType == F.SegmentData.Handles)
                        )
                            ...
                            this._selectionMode == F.SelectionMode.Anchors &&
                            (this._moveEdgesLinks || this._updateLastPtELinks || this._updateFirstPtELinks)
                        ) {
                                ...
                                if (i) {
                                    ...
                                    if (t) {
                                        ...
                                        r.getAnchorPoints()
                                            ...
                                            .setProperties(
                                                ["x", "y", "hrx", "hry"],
                                                [o.getProperty("x"), o.getProperty("y"), o.getProperty("hrx"), o.getProperty("hry")]
                                            );
                                    } else {
                                        ...
                                        r.getAnchorPoints()
                                            ...
                                            .setProperties(
                                                ["x", "y", "hlx", "hly"],
                                                [o.getProperty("x"), o.getProperty("y"), o.getProperty("hlx"), o.getProperty("hly")]
                                            );
                                    }
                                }
                            }.bind(this);
                            ...
                            for (n = 0; n < e.length; ++n) {
                                ...
                                (n != e.length - 1 || x.length || this._element._endBlockEvents([p.GeometryChangeEvent]),
                                    S && P.setProperties(["x", "y"], [S.getProperty("x"), S.getProperty("y")]));
                            }
                            for (n = 0; n < x.length; ++n) {
                                ...
                                if ((T = v.getEdges().getById(E.getId()))) {
                                    ...
                                    (n == x.length - 1 && this._element._endBlockEvents([p.GeometryChangeEvent]),
                                        this._element.addGraphLine(
                                            c,
                                            new d.GraphPosition(d.GraphPosition.PosType.Anchor, new d.GraphPosition.AnchorSpec(y)),
                                            new d.GraphPosition(d.GraphPosition.PosType.Anchor, new d.GraphPosition.AnchorSpec(_)),
                                            E
                                        ));
                                }
                            }
