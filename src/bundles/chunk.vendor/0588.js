            ...
            (n.inherit("GGLColorAdjustEffect", l, r),
                ...
                (l.prototype._handleChange = function (e, t) {
                    (e === n._Change.Store
                        ...
                        : e === n._Change.Restore && this.restoreProperties(t.blob, l.MetaProperties),
                ...
                (l.prototype.applyNativeEffect = function (e, t, i, n) {
                    ...
                    (h > 0 ? (h > 1 && (h = 1), (h = 1 + h / (1.001 - h))) : (h = 1 + a.clamp(-1, h, 0)),
                        (r = a.clamp(-1, r, 1) + 1),
                        (r *= r),
                        s > 0 ? (s > 1 && (s = 1), (s = 1 + s / (1.001 - s))) : (s = 1 + a.clamp(-1, s, 0)),
