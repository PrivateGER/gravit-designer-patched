            ...
            ((A.prototype._icon = null),
                ...
                (A.prototype.getAnnotationBBox = function (e, t, i) {
                    return r
                        ...
                        .expanded(n.annotPickDistance, n.annotPickDistance, n.annotPickDistance, n.annotPickDistance);
                }),
                            ...
                            function () {
                                if (200 == t.status && t.response) {
                                    ...
                                    ((i.onload = function (e) {
                                        ...
                                        ((this._icon = new a()),
                                            this._icon.addEventListener(a.StatusEvent, this._statusEvent, this),
                ...
                (A.prototype._statusEvent = function (e) {
                    e.status !== a.ImageStatus.Loading &&
                        ...
                        this._icon.removeEventListener(a.StatusEvent, this._statusEvent, this));
                }),
