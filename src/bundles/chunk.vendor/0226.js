                ...
                d = (function () {
                    function e(e, t, i, n) {
                        ...
                        ((this.id = r.createTexture()),
                            ...
                            e && t && r.texImage2D(r.TEXTURE_2D, 0, this.format, e, t, 0, this.format, this.type, null),
                            A.addTexture(this));
                    }
                    return (
                        (e.prototype.id = -1),
                        ...
                        (e.prototype.clone = function () {
                            ...
                            if (t) {
                                ...
                                return (
                                    ...
                                    t.copyTexImage2D(t.TEXTURE_2D, 0, this.format, 0, 0, this.width, this.height, 0),
                        ...
                        (e.prototype.initFromBytes = function (e, t, i) {
                            ...
                            n &&
                                ...
                                i instanceof l.ImageDataArray
                                    ? n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, e, t, 0, n.RGBA, this.type, i.uint8Array)
                                    : n.texImage2D(n.TEXTURE_2D, 0, n.RGBA, e, t, 0, n.RGBA, this.type, new Uint8Array(i)));
                        }),
                        (e.prototype.initFromCanvas = function (e, t, i) {
                            ...
                            if (n) {
                                if (
                                    ...
                                    (this.type = n.UNSIGNED_BYTE),
                                    n.bindTexture(n.TEXTURE_2D, this.id),
                                    void 0 === t || void 0 === t || (e.width === t && e.height === i))
                                )
                        ...
                        (e.prototype.initFromCanvasCropped = function (e, t, i, n, r, o, a, s, l) {
                            ...
                            p &&
                                ...
                                0 !== t || 0 !== i || s !== e.width || l !== e.height || s !== n || l !== r
                                    ? (((A = g()).canvas.width = s),
                                      (A.canvas.height = l),
                                      A.clearRect(0, 0, s, l),
                        ...
                        (e.prototype.destroy = function () {
                            ...
                            e &&
                                ...
                                (e instanceof WebGLRenderingContext && this.id instanceof l.WebGLTexture
                                    ? e.deleteTexture(this.id.render())
                                    : e instanceof WebGLRenderingContext && this.id instanceof h.WebGLTexture
                                      ? this.id.destroy()
                        ...
                        (e.prototype.ensureFormat = function (e, t, i, n) {
                            ...
                            if (r) {
                                ...
                                (e == this.width && t == this.height && i == this.format && n == this.type) ||
                                    ((this.width = e),
                                    (this.height = t),
                                    (this.format = i),
                                    (this.type = n),
                                    r.bindTexture(r.TEXTURE_2D, this.id),
                                    r.texImage2D(r.TEXTURE_2D, 0, this.format, e, t, 0, this.format, this.type, null));
                            }
                        }),
                ...
                return (
                    ...
                    e.SUPPORTED_TEXTURE_FORMAT === e.FLOAT
                        ...
                        : e.SUPPORTED_TEXTURE_FORMAT === e.HALF_FLOAT &&
                          (e.getExtension("OES_texture_half_float", t), e.getExtension("OES_texture_half_float_linear", t)),
                    e
                );
            }
            ((c.flushCanvasForSPECIALBrowsers = function (e) {
                if (e instanceof l.RendererCanvas || e instanceof h.RendererCanvas) e.flushCanvas();
                else {
                    var t = document.createElement("canvas");
                    ((t.width = 1), (t.height = 1), t.getContext("2d").drawImage(e, 0, 0));
                }
                ...
                (c.createTexture = function () {
                    ...
                    if (
                        5 == arguments.length &&
                        (e instanceof HTMLCanvasElement || e instanceof l.RendererCanvas || e instanceof h.RendererCanvas)
                    )
                    ...
                    if ("number" != typeof e && "string" != typeof e) return d.fromBytes(t, i, e);
                    var t,
                        i,
                        r = arguments[2];
                ...
                (c.getGLContext = function () {
                    ...
                    if (((n = p.SUPPORTED_TEXTURE_FORMAT), "undefined" == typeof document)) return null;
