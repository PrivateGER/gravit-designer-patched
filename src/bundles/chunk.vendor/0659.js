            ...
            var n = require(68),
                r = (function () {
                    ...
                    function i(e, t) {
                        ...
                        for (i = 0; i < a; i++) {
                            for (n = 0; n < e[i]; n++) {
                                for ((l = o.pop()).children[l.index] = t[r]; l.index > 0; ) l = o.pop();
                    ...
                    function r(t, i, n, r, o, a, s, l, h) {
                        ...
                        function g() {
                            ...
                            if (255 == (u = t[i++])) {
                                var e = t[i++];
                                if (e) throw "unexpected marker: " + ((u << 8) | e).toString(16);
                            }
                            return ((d = 7), u >>> 7);
                        }
                                            ...
                                            switch (b) {
                                                case 0:
                                                    var A = f(t.huffmanTableAC),
                                                        c = 15 & A;
                                                    o = A >> 4;
                                                    if (0 === c) o < 15 ? ((_ = m(o) + (1 << o)), (b = 4)) : ((o = 16), (b = 1));
                                                    else {
                        ...
                        for (R = 1 == I ? r[0].blocksPerLine * r[0].blocksPerColumn : A * n.mcusPerColumn, o || (o = R); G < R; ) {
                            ...
                            if (((_ = 0), 1 == I)) for (E = r[0], S = 0; S < o; S++) (w(E, T, G), G++);
                            else
                                for (S = 0; S < o; S++) {
                                    for (B = 0; B < I; B++)
                                        for (D = (E = r[B]).h, k = E.v, x = 0; x < k; x++) for (P = 0; P < D; P++) C(E, T, G, x, P);
                                    if (++G === R) break;
                                }
                            if (((d = 0), (F = (t[i] << 8) | t[i + 1]) < 65280)) throw "marker was not found";
                        ...
                        (t.prototype = {
                            ...
                            parse: function (t) {
                                    ...
                                    for (i in e.components)
                                        if (e.components.hasOwnProperty(i)) {
                                            ...
                                            for (
                                                ...
                                                for (var u = [], d = 0; d < h; d++) u.push(new Int32Array(64));
                                                c.push(u);
                                            }
                                ...
                                for (var U = 0; U < d.length; U++) {
                                    ...
                                    for (var O in V) ((V[O].quantizationTable = u[V[O].quantizationIdx]), delete V[O].quantizationIdx);
                                }
                                ...
                                switch (this.components.length) {
                                    ...
                                    case 2:
                                        for (i = this.components[0], n = this.components[1], p = 0; p < t; p++)
                                            for (
                                                s = i.lines[0 | (p * i.scaleY * B)], l = n.lines[0 | (p * n.scaleY * B)], c = 0;
                                                c < e;
                                                c++
                                            )
                                                ((u = s[0 | (c * i.scaleX * E)]),
                                        ...
                                        for (
                                            ...
                                            for (
                                                ...
                                                (w
                                                    ? ((u = s[0 | (c * i.scaleX * E)]),
                                                      (d = l[0 | (c * n.scaleX * E)]),
                                                      (v = a(u + 1.402 * ((g = h[0 | (c * r.scaleX * E)]) - 128))),
                                                      (b = a(u - 0.3441363 * (d - 128) - 0.71413636 * (g - 128))),
                                                      (C = a(u + 1.772 * (d - 128))))
                                                    : ((v = s[0 | (c * i.scaleX * E)]),
                                                      (b = l[0 | (c * n.scaleX * E)]),
                                                      (C = h[0 | (c * r.scaleX * E)])),
                                            ...
                                            for (
                                                ...
                                                (w
                                                    ? ((u = s[0 | (c * i.scaleX * E)]),
                                                      ...
                                                      (y = 255 - a(u - 0.3441363 * (d - 128) - 0.71413636 * (g - 128))),
                            ...
                            copyToImageData: function (e) {
                                ...
                                switch (this.components.length) {
                                    ...
                                    case 4:
                                        for (i = 0; i < h; i++)
                                            for (t = 0; t < l; t++) {
                                                var d = [c[p++] / 255, c[p++] / 255, (r = c[p++] / 255), c[p++] / 255],
                                                    g = n.cmykToRGB(d);
