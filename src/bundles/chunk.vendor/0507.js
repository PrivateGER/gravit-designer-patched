module.exports = function (e, t, i) {
            ...
            ((h.queryAll = function (e, t, i) {
                ...
                for (var m, y = 0; (m = f[y]); y++) {
                    ...
                    if (
                        ...
                        for (var v = 0, b = h.length; v < b; v++) l = m.combine(l, h[v], m, p, _);
                ...
                (s.recompile = function () {
                    var e,
                        t = [","],
                        i = ["!"];
                    for (e in b) " " != e && t[e.length > 1 ? "unshift" : "push"](s.escapeRegExp(e));
                    for (e in w) i.push(e);
                    l = new RegExp(
                        "[\\w\\u00a1-\\uFFFF][\\w\\u00a1-\\uFFFF-]*|[#.](?:[\\w\\u00a1-\\uFFFF-]|\\\\:|\\\\.)+|[ \\t\\r\\n\\f](?=[\\w\\u00a1-\\uFFFF*#.[:])|[ \\t\\r\\n\\f]*(" +
                            t.join("|") +
            ...
            h.parse = function (e) {
                ...
                for (l.lastIndex = 0; (a = l.exec(i)); ) {
                    if (a[11]) {
                        if (s.verbose) throw SyntaxError('Syntax error, "' + h + '" unexpected at #' + l.lastIndex + ' in "' + i + '"');
                        return (this[t] = []);
                    }
            ...
            h.compute = function (e) {
                ...
                if (
                    ...
                    if (r || 1 != A.length) for (t = 0; (i = A[t]); t++) n = u(n, y, m(i));
                        ...
                        ((o = u(o, y, c)),
                            (r = function (e) {
                                for (var t, i = e.getNodesByName(l || "*"), n = [], r = 0; (t = i[r]); r++) y(t, A[0]) && n.push(t);
                                return n;
                            }));
                    }
                for (
                ...
                return (
                    (e.simple = !n) ? (e.matchAux = d) : ((e.matchAux = n), (o = u(o, n))),
                    (e.match = o || d),
            ...
            var b = (s.combinators = {
                    " ": function (e, t, i, n, r, o) {
                        ...
                        for (var l, h = 0, A = i.matchAux; (l = a[h]); h++) r(l) && A(l, n) && e.push(l);
                        return e;
                    },
                    ">": function (e, t, i, n, r) {
                        for (var o, a = i.search(t), s = 0; (o = a[s]); s++) o.getParent() == t && r(o) && i.matchAux(o, n) && e.push(o);
                        return e;
                    },
                    "+": function (e, t, i, n, r) {
                        for (; (t = t.getNext()); ) {
                    ...
                    "<": function (e, t, i, r, o) {
                        for (; (t = t.getParent()) && !(t instanceof n); ) o(t) && i.match(t, r) && e.push(t);
                        return e;
                    },
                    "^": function (e, t, i, n, r) {
                        return (
                            (t = t.getFirstChild()) && (r(t) && i.match(t, n) ? e.push(t) : (e = s.combinators["+"](e, t, i, t, n))),
                            e
                        );
                    },
                    "++": function (e, t, i, n, r) {
                    ...
                    "--": function (e, t, i, n, r) {
                        for (; (t = t.getPrevious()); ) r(t) && this.match(t, n) && e.push(t);
                        return e;
                    },
                }),
                C = (s.pseudos = {
            ...
            for (var P = ["parse", "queryAll", "querySingle", "match", "filter"], S = 0; P[S]; S++) s.generise(P[S]);
            (s.recompile(),
