            ...
            (o.inherit(s, n),
                    ...
                    if (
                        this._wrapper.wrap(
                            function (e) {
                                "number" == typeof e
                                    ? (this._currHeight = e)
                                    : ((this._currLength = e.ordinal + e.length - this.ordinal), this.lines.push(e));
                            }.bind(this),
                            t,
                            this._bboxSpacing
                        )
                ...
                (s.prototype.realBounds = function () {
                    if (null === this._realBounds) {
                        for (
                            var e = Number.MAX_VALUE, t = Number.MAX_VALUE, i = -Number.MAX_VALUE, n = -Number.MAX_VALUE, o = 0;
                            o < this.lines.length;
                            o++
                        ) {
                            var a = this.lines[o];
                        ...
                        e === Number.MAX_VALUE || t === Number.MAX_VALUE || i === -Number.MAX_VALUE || n === -Number.MAX_VALUE
                ...
                (s.prototype.baseline = function () {
                    for (var e = 0; e < this.lines.length; e++)
                        if ("number" == typeof this.lines[e].baseline) return this.lines[e].baseline;
                    return 0;
                }),
