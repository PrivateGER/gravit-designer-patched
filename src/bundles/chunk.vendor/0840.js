            ...
            (r.inherit("mirrorEffect", u, o.Effect),
                ...
                (u.equals = function (e, t) {
                    return (
                        e instanceof u &&
                        t instanceof u &&
                        e.arePropertiesEqual(t, Object.keys(u.GeometryProperties).concat(Object.keys(u.VisualProperties)))
                    );
                }),
                ...
                (u.prototype.render = function (e, t, i, n, r) {
                    if (this.$pat && this.$opc > 0) {
                        ...
                        ((t._canvasContext.globalAlpha = 1),
                            (t._blender.globalCompositeOperation = h.CompositeOperator.SourceOver),
                            t._blender.drawImage(_, 0, 0, t.getWidth(), t.getHeight(), 0, -u - 2 * d - c, t.getWidth(), t.getHeight()),
                            e.setScale(s),
                            t.setScale(o),
                            t.setTransform(f),
                ...
                (u.prototype._handleChange = function (e, t) {
                    (e === r._Change.Store
                        ...
                        : e === r._Change.Restore &&
                          ...
                          this.restoreProperties(t.blob, u.VisualProperties, function (e, t) {
