module.exports = function (module, exports, require) {
            ...
            (IsFiniteNonNegativeNumber.inherit(B, m),
                        ...
                        this._graphEditor
                            ? this._graphEditor.getGraph().getWorkspace()
                                ? ((this._graphRef = this._graphEditor.getGraph()),
                                  this._graphEditor.getActiveExtendingMode() ? (this._mode = B.Mode.Append) : (this._mode = B.Mode.Edit))
                                : ((this._mode = B.Mode.Append), (this._graphRef = null), (this._graphEditor = null))
                ...
                (B.prototype._addPoint = function (e, t, i, n) {
                    if (this._graphEditor && !i) {
                        ...
                        if (r) {
                            ...
                            ((a = r.inverted().mapPoint(a)), e.setProperties(["x", "y"], [a.getX(), a.getY()]));
                        }
                    }
                    if (t)
                        if (this._graphEditor) {
                            if ((this._graphEditor.requestInvalidation(), this._mode == B.Mode.Append)) {
                                if (this._dpathRef)
                                    ...
                                    (l.setProperty("fpt", null),
                                        ...
                                        (this._pathBaseRef = l));
                                    var h = new o();
                                    (h.setProperties(["x", "y"], [e.getProperty("x"), e.getProperty("y")]),
                                        this._transactionType == B.Transaction.NoTransaction &&
                            ...
                            if ((this._createPathsGraph(e), !this._graphEditor || !this._pathBaseRef)) return;
                            (this._graphEditor.selectOnePoint(e),
                                this._checkMode(),
                                this._renewPreviewLink(),
                                (this._editPt = this._dpathRef.getAnchorPoints().getLastChild()),
                ...
                (B.prototype._createPathsGraph = function (e) {
                    ...
                    var i = new _(),
                        n = new o();
                    (n.setProperties(["x", "y"], [e.getProperty("x"), e.getProperty("y")]),
                        i.addAnchor(n),
                    ...
                    if (t - this._mDownTime < B.DBLCLICKTM)
                        ...
                        if (
                            ...
                            if ((this._renewPreviewLink(), this._newPoint && this._graphEditor)) {
                                    ...
                                    if (((this._mouseDownPartInfo = r), this._mouseDownPartInfo.id.type == c.PartType.Anchor)) {
                                        ...
                                        (l && (o = l.mapPoint(o)),
                                            this._graphEditor.movePoint(
                                                this._editPt,
                                                this._view.getWorldTransform(this._view.getScene().getActivePage()).mapPoint(o),
                                ...
                                (A && (A.removeFlag(s.Flag.Selected), this._editPt.setFlag(s.Flag.Selected)),
                                    this._graphEditor.requestInvalidation());
                    ...
                    if (!(new Date().getTime() - this._mDownTime < B.DBLCLICKTM) && this._released) {
                        ...
                        if (((this._lastMouseEvent = e), this._checkMode(), this._mode == B.Mode.Append)) {
                            ...
                            if (!this._newPoint && this._graphEditor) {
                                ...
                                (this._editor.getGuides().beginMap(this._editor.getMappingScopes()),
                                    (n = this._editor.getGuides().mapPoint(n, a.DetailMap.Mode.DetailOnFilterOn)),
                                    this._editor.getGuides().finishMap(),
                    ...
                    if (
                        ...
                        if (
                            ...
                            if (n.modifiers.optionKey)
                                this._editPt.setProperties(["tp", "hrx", "hry"], [v.AnchorPoint.Type.Asymmetric, l, h]);
                            else {
                                ...
                                if (this._mode != B.Mode.Edit && !this._newPoint && c)
                                    ...
                                    var p = o + o - l,
                                        u = a + a - h;
                                    this._editPt.setProperties(["tp", "hrx", "hry", "hlx", "hly"], [A, l, h, p, u]);
                                }
                            }
                        } else {
                            var d = s.getX() - o,
                                ...
                                this._dragStarted || !this._refPt || this._editPt
                                    ? this._dragStarted
                                        ? (this._updatePointProperties(e.client),
                                          ...
                                          this._commitChanges(),
                                          this._setCursorForPosition(null, e.client))
                                        : (this._commitChanges(), this._setCursorForPosition(null, e.client))
                                ...
                                (this._mouseDownPartInfo &&
                                    ...
                                    i
                                        ? (this._graphEditor.updatePartSelection(false),
                                          ...
                                          this._commitChanges(),
                                          this._setCursorForPosition(null, e.client))
                                        : (this._commitChanges(), this._setCursorForPosition(A.Pen)));
                            }
                            this._refPt = null;
                        } finally {
                            this._finishTransaction();
                ...
                (B.prototype._keyDown = function (e) {
                    (m.prototype._keyDown.call(this, e),
                        e.key === g.Constant.ESC
                            ...
                            : e.key === g.Constant.ENTER && ((this._lastMouseEvent = null), this._enterAction()));
                }),
                        ...
                        : e.changed.optionKey &&
                          ...
                          this._released
                              ? this._newPoint &&
                                (this._editPt.setProperties(
                                    ["tp"],
                                    [n.modifiers.optionKey ? v.AnchorPoint.Type.Symmetric : v.AnchorPoint.Type.Asymmetric]
                                ),
                                this._graphEditor.requestInvalidation())
                              : (n.modifiers.optionKey && (this._firstAlt = !this._dragStarted), this._mouseDrag(this._lastMouseEvent)));
                }),
                ...
                (B.prototype._enterAction = function () {
                    this._released &&
                        (this._checkMode(),
                        this._graphEditor && (this._graphEditor.setActiveExtendingMode(E.ExtendingMode.Off), this._commitChanges()),
                ...
                (B.prototype._constrainIfNeeded = function (e, t, i, r) {
                    ...
                    if (n.modifiers.shiftKey) {
                        ...
                        (r
                            ? (a = r)
                            : i &&
                              (a = this._mode == B.Mode.Append ? i.getAnchorPoints().getLastChild() : i.getAnchorPoints().getFirstChild()),
