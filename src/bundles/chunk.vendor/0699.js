            ...
            ((r = r.map(function (e) {
                ...
                if (t) {
                    (Object.keys(t.translationsExtended).forEach(function (e) {
                        ...
                        else t.translations[e] = Object.assign({}, t.translationsExtended[e]);
                    }),
                    ...
                    if (t.translationsExtended)
                        for (r in (a = JSON.parse(JSON.stringify(t.translationsExtended)))) for (o in a[r]) a[r][o] = "";
                    e.translations = e.translations.map(function (e) {
                        if (!e.isDefault) {
                            ...
                            for (r in a)
                                e.translationsExtended[r] = Object.assign(
                                    {},
                                    a[r],
                                    e.translationsExtended.hasOwnProperty(r) ? e.translationsExtended[r] : {}
                                );
                            for (var r in t.translations)
                                if (e.translationsExtended)
                                    for (var o in (e.translationsExtended.hasOwnProperty(r) || (e.translationsExtended[r] = {}),
                                    t.translations[r]))
                        ...
                        return (
                            s &&
                                (s.translations && (e.translationsTemporary = Object.assign({}, s.translations)),
                                s.translationsExtended && (e.translationsExtendedTemporary = Object.assign({}, s.translationsExtended))),
                            e
                        );
                    });
                }
